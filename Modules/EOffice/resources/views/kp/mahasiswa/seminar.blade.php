        ...
        <div class="flex-1 flex flex-col min-h-0 overflow-hidden rounded-lg" style="margin:8px; border:1px solid #DFE1E7; background:#fff;">
            ...
            @else
                ...
                <div class="sikape-card p-6 mb-8">
                    <p class="text-xs font-semibold uppercase tracking-widest mb-5" style="color:var(--grey-400);">Progres Seminar KP</p>
                ...
                <div class="grid grid-cols-1 gap-8">
                    ...
                    <div class="mt-8 pt-6">
                        <div class="mb-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div>
                                <h2 class="text-sm font-bold text-slate-800 uppercase tracking-wider mb-1">Dokumen Pelaksanaan</h2>
                                <p class="text-[11px] text-slate-500 italic">Daftar dokumen sesuai ketentuan Koordinator KP</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            @if($templatesDokumen && $templatesDokumen->isNotEmpty())
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl border border-slate-200 bg-white hover:border-indigo-300 hover:shadow-sm transition-all gap-4">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-[11px] text-slate-500 mt-0.5">{{ $tmpl->description ?? 'Dokumen Pasca KP' }}</p>
                                        ...
                                        <div class="flex flex-wrap items-center gap-2 w-full sm:w-auto">
                                            ...
                                            @if($tmpl->is_uploadable)
                                                <form action="{{ route('eoffice.kp.mahasiswa.dokumen.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-wrap items-center gap-2 w-full sm:w-auto" x-data="{ fileName: '' }">
                                                    ...
                                                    <button type="submit" x-show="fileName" style="display: none;" class="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 text-xs font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors">
                                                        Simpan
                                                    </button>
                                                </form>
                                            @endif
                                ...
                                @endforeach
                            @else
                                <div class="p-8 text-center bg-slate-50 border border-slate-100 rounded-xl border-dashed">
                                    <svg class="w-8 h-8 text-slate-300 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                    <p class="text-xs font-semibold text-slate-500">Belum ada dokumen yang disyaratkan.</p>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between {{ $currentStep === 2 ? 'bg-indigo-50/40' : '' }}">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm
                                    ...
                                    @if($step2Done)<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg>
                                    @else<svg class="w-4 h-4 text-current" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                    @endif
                                </div>
                                <div>
                        ...
                        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between {{ $currentStep === 3 ? 'bg-indigo-50/40' : '' }}">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm
                                    ...
                                    @if($step3Done)<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg>

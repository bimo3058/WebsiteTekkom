<x-eoffice::layouts.koordinator title="Tambah Penilaian">
    <div class="max-w-5xl mx-auto space-y-6 pb-20">

        <form action="{{ route('eoffice.kp.koordinator.master-rubrik.store') }}" method="POST">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div class="md:col-span-8 flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode" value="{{ old('kode') }}" placeholder="contoh : CPMK-1"
                                required
                        ...
                        {{-- Deskripsi --}}
                        <div x-data="{ count: {{ strlen(old('deskripsi', '')) }} }">
                            <label class="block text-[13px] font-semibold text-[#344054] mb-1.5"
                            ...
                            <div class="relative">
                                <textarea name="deskripsi" rows="3" required maxlength="200"
                                    ...
                                    style="font-family: 'Inter Tight', sans-serif;">{{ old('deskripsi') }}</textarea>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="role_penilai" required
                                    ...
                                    style="font-family: 'Inter Tight', sans-serif;">
                                    <option value="dosen_pembimbing" {{ old('role_penilai') == 'dosen_pembimbing' ? 'selected' : '' }}>Dosen Pembimbing</option>
                                    <option value="koordinator" {{ old('role_penilai') == 'koordinator' ? 'selected' : '' }}>Koordinator</option>
                                </select>
                                <div
                            ...
                            <div>
                                <label class="block text-[13px] font-semibold text-[#344054] mb-1.5"
                                    style="font-family: 'Inter Tight', sans-serif;">Bobot (%) <span
                                        class="text-[#D92D20] ml-0.5">*</span></label>
                                <input type="number" name="bobot" value="{{ old('bobot', 10) }}" min="0" max="100"

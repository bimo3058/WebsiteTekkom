<x-eoffice::layouts.koordinator title="Edit Periode">
    ...
    <div x-data="periodeWizard()" x-init="initDates()" class="w-full pb-20">
        ...
        <form id="periodeWizardForm" x-ref="form"
            action="{{ route('eoffice.kp.koordinator.periode.update', $periode->id) }}" method="POST">
            @csrf
            @method('PUT')
        ...
        function periodeWizard() {
            return {
                ...
                formData: {
                    ...
                    komponen_penilaian: {!! json_encode(collect(old('komponen_penilaian', $periode->komponenNilai))->values()->toArray()) !!}
                },

                            ...
                            <td style="padding:8px 12px; position:relative;">
                                ...
                                <div x-show="openOptions" style="display:none;" x-transition
                                    ...
                                    <a href="{{ route('eoffice.kp.koordinator.periode.edit', $periode->id) }}"
                                        class="block px-3 py-1.5 text-xs font-semibold text-gray-700 hover:bg-gray-50 flex items-center gap-2">
                                    ...
                                    <form action="{{ route('eoffice.kp.koordinator.periode.destroy', $periode->id) }}"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="w-full text-left px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-50 flex items-center gap-2">
                                            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round"

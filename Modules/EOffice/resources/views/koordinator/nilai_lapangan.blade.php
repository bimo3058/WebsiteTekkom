...
<div class="flex h-screen w-full overflow-hidden">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex-1 overflow-y-auto py-6 px-4">
            ...
            <!-- Active Menu -->
            <a href="{{ route('eoffice.kp.koordinator.nilai_lapangan') }}" class="flex items-center px-4 py-3 mb-1 text-indigo-700 bg-indigo-50/50 font-semibold rounded-xl transition-all text-sm relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1 before:bg-indigo-600 before:rounded-r-full">

<x-eoffice::layouts.koordinator title="Dashboard">
    ...
    {{-- ── Page Header ── --}}
    <div class="mb-6 lg:mb-8 flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
        <div>
        ...
        <div style="min-width:220px;">
            <label style="display:block; font-family:'Inter Tight',sans-serif; font-size:11px; font-weight:700; color:#A0AABF; text-transform:uppercase; letter-spacing:0.06em; margin-bottom:6px;">
                Tampilkan Periode
            </label>
            <select x-model="selectedPeriode" style="
                width:100%; padding:8px 12px;
                border:1px solid #E4E7EC; border-radius:8px;
                font-family:'Inter Tight',sans-serif; font-size:13px; font-weight:600; color:#0D0D12;
            ...
            <div style="padding:16px; background:#F8F5FF; border-radius:12px; border:1px solid #D3C4FC;">
                ...
                <div class="flex items-end gap-2">
                    <span style="font-family:'Inter Tight',sans-serif; font-size:48px; font-weight:600; line-height:1; color:#0B266E; letter-spacing:-0.02em;"
                        x-text="stats.total_mahasiswa"></span>
            ...
            <div style="padding:16px; background:#FFFBEB; border-radius:12px; border:1px solid #FDE68A;">
                ...
                <div class="flex items-end gap-2">
                    <span style="font-family:'Inter Tight',sans-serif; font-size:48px; font-weight:600; line-height:1; color:#92400E; letter-spacing:-0.02em;"
                        x-text="stats.menunggu_dosen"></span>
            ...
            <div style="padding:16px; background:#F0FDF4; border-radius:12px; border:1px solid #BBF7D0;">
                ...
                <div class="flex items-end gap-2">
                    <span style="font-family:'Inter Tight',sans-serif; font-size:48px; font-weight:600; line-height:1; color:#14532D; letter-spacing:-0.02em;"
                        x-text="stats.menunggu_validasi"></span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        >
            <div style="width:48px; height:48px; background:#F8F5FF; border-radius:10px; border:1px solid #D3C4FC; display:flex; align-items:center; justify-content:center; margin-bottom:20px;">
        ...
        onmouseout="this.style.borderColor='#F1F1F3'; this.style.boxShadow='0px 1px 3px rgba(0,0,0,0.06), 0px 1px 2px rgba(0,0,0,0.04)';"
        >
            <div style="width:48px; height:48px; background:#F0FDF4; border-radius:10px; border:1px solid #BBF7D0; display:flex; align-items:center; justify-content:center; margin-bottom:20px;">
            ...
            <a href="{{ route('eoffice.kp.koordinator.validasi_berkas') }}" style="
                display:inline-flex; align-items:center; justify-content:center;
                gap:8px; padding:10px 20px; background:#ffffff; color:#15803D;
                font-family:'Inter Tight',sans-serif; font-size:14px; font-weight:600;
                border-radius:10px; border:1.5px solid #15803D; text-decoration:none;
                width:fit-content; transition:background 0.2s; letter-spacing:0.01em;
            "

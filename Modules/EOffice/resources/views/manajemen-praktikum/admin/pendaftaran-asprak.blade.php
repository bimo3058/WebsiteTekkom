...
<div class="flex items-center justify-between flex-shrink-0">
    <div>
        ...
        <div class="text-[12px] text-[#666D80] mt-[2px]">Review dan proses permohonan calon asprak</div>
    </div>
...
<div class="flex flex-col bg-white border border-[#DFE1E7] rounded-[14px] overflow-hidden shadow-[0_1px_2px_rgba(228,229,231,.24)] flex-1 min-h-0">
    ...
    <div class="overflow-y-auto flex-1">
        ...
        @empty
        <div class="py-14 text-center text-[13px] text-[#666D80]">Tidak ada data pendaftaran asprak.</div>
        @endforelse
    </div>

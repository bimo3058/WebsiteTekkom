...
<head>
    ...
    <title>SIKP - {{ $title ?? 'Dosen Dashboard' }}</title>
                    ...
                    <div class="flex items-center gap-1.5">
                        ...
                        <div class="flex items-center gap-2.5 cursor-pointer group">
                            <div
                                ...
                                <span
                                    class="font-bold text-xs leading-none">{{ strtoupper(substr(auth()->user()->name ?? 'D', 0, 1)) }}</span>
                            </div>
                            <div class="hidden sm:flex flex-col leading-none">
                                <span
                                    class="text-[13px] font-semibold text-[#272835]">{{ auth()->user()->name ?? 'Dosen Pembimbing' }}</span>

        ...
        <aside
            ...
            <nav class="flex-1 overflow-y-auto overflow-x-hidden flex flex-col [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
                ...
                @foreach($sections as $section)
                    ...
                    <div x-data="{ openSec: {{ ($sectionActive || !$multiRole) ? 'true' : 'false' }} }" class="mb-[2px]">
                        ...
                        @if($multiRole)
                            ...
                            <button @click="if(sidebarOpen) openSec = !openSec; else { sidebarOpen = true; openSec = true; }"
                                ...
                                <span
                                    ...
                                    :class="sidebarOpen ? 'opacity-100' : 'opacity-0 w-0'"
                                    style="color:#353849">{{ strtoupper($section['label']) }}</span>
                        ...
                        x-transition:leave="transition ease-in duration-100" x-transition:leave-end="opacity-0" @endif
                            @if($multiRole) class="pl-[16px] mb-[4px]" @endif>
                            ...
                            @foreach($section['groups'] as $groupLabel => $items)
                                ...
                                @foreach($items as $item)
                                    ...
                                    <a href="{{ $item['href'] }}"
                                        ...
                                        style="background:#EEF1FA; color:#293C79;" @else style="color:#353849;"
                                            onmouseover="this.style.background='#F6F8FA'; this.style.color='#0D0D12'"
                                        onmouseout="this.style.background='transparent'; this.style.color='#353849'" @endif>
                                        @if($active)
                                        ...
                                        <svg class="w-[18px] h-[18px] flex-shrink-0 transition-colors"
                                            style="color:{{ $active ? '#293C79' : '#666D80' }}" viewBox="0 0 24 24" fill="none"
                                        ...
                                        @endif
                                            <button type="submit"
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <div
                                                        class="text-[13px] font-{{ $p->id === $switcherActiveId ? 'semibold' : 'medium' }} text-[#0D0D12] truncate">
                                                        {{ $p->nama }}</div>
                                                    <div class="text-[11px] text-[#666D80]">{{ $p->kode ?? 'Tanpa kode' }} ·
                        ...
                        <div class="flex items-center" style="gap: 10px;">
                            ...
                            <div class="hidden sm:block">
                                <div class="font-semibold leading-tight tracking-tight"
                                    style="font-size: 13px; color: #0D0D12;">{{ $user->name }}</div>

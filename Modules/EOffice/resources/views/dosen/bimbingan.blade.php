...
<body class="bg-slate-50 text-slate-800 antialiased" x-data="bimbinganApp()"
            ...
            <header
                ...
                <div class="flex items-center">
                    ...
                    <nav class="hidden sm:flex items-center space-x-2 text-sm text-slate-500 font-medium">
                        <span class="text-indigo-700 font-semibold bg-indigo-50 px-2.5 py-1 rounded-md">Bimbingan
                            Mahasiswa</span>
                    </nav>
                </div>
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="bg-slate-50 border-b border-slate-200">
                                        <th
                                            class="py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider w-1/4">
                                            Mahasiswa</th>
                                        <th
                                            class="py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider w-1/4">
                                            Informasi KP</th>
                                        <th
                                            class="py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider w-1/5">
                                            Progress & Status</th>
                                        <th
                                    ...
                                    <template x-for="item in filteredMahasiswa" :key="item.id">
                                        <tr class="hover:bg-slate-50/70 transition-colors group">
                                            ...
                                            <td class="py-4 px-6">
                                                <div class="max-w-xs">
                                                    <p class="text-sm font-semibold text-slate-800 truncate"
                                                        title="item.judul_kp" x-text="item.judul_kp"></p>
                                                    <div
                                                        class="flex items-center gap-1.5 mt-1 text-xs text-slate-500 truncate">
                                            ...
                                            <td class="py-4 px-6 text-center">
                                                <template
                                                    x-if="item.nilai_laporan !== null && item.nilai_laporan !== undefined">
                                                    <span

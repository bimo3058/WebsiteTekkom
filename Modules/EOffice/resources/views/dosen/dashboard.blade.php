                ...
                <nav class="px-4 py-4 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('eoffice.kp.dosen.validasi_berkas') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors">
                            ...
                            <tbody class="bg-white divide-y divide-slate-200">
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('eoffice.kp.dosen.bimbingan.show', $kp->id) }}" class="text-blue-600 hover:text-blue-900 bg-blue-50 px-3 py-1.5 rounded-md hover:bg-blue-100 transition-colors">Tinjau</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>

<x-manajemenmahasiswa::layouts.mahasiswa>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('manajemenmahasiswa.pengaduan.create', ['jalur' => $payload['is_anonim'] ? 'konfidensial' : 'reguler']) }}" class="btn-outline-custom">← Ubah</a>
    </div>
    ...
    <div class="custom-card">
        ...
        <form method="POST" action="{{ route('manajemenmahasiswa.pengaduan.store') }}" class="mt-4">
            ...
            <div class="d-flex justify-content-end gap-3 mt-4 pt-4" style="border-top: 1px solid #f3f4f6;">
                <a href="{{ route('manajemenmahasiswa.pengaduan.create', ['jalur' => $payload['is_anonim'] ? 'konfidensial' : 'reguler']) }}" class="btn-outline-custom">Kembali</a>

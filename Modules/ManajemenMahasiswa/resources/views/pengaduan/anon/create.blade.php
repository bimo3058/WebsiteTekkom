...
{{-- Struktur & gaya disamakan dengan pengaduan/create.blade.php (jalur reguler). --}}
@push('styles')
    <style>
...
@section('content')
    {{-- Seluruh teks halaman (judul, banner jalur, error) berada di dalam card.
         Sengaja TANPA tombol/tautan kembali ke area login: pelapor konfidensial tidak
         boleh merasa terhubung ke akunnya. Untuk keluar cukup menutup halaman. --}}
    <form method="POST" action="{{ route('manajemenmahasiswa.pengaduan.anon.confirm', ['token' => $token]) }}" class="form-card" enctype="multipart/form-data" style="position: relative;">
        ...
        <div class="d-flex align-items-center gap-3 mb-4 p-3 px-4 rounded-3" style="background: #f1f5f9; border: 1.5px solid #cbd5e1;">
            ...
            <div>
                ...
                <div class="text-muted" style="font-size: 12px;">Identitas Anda tidak disimpan pada tiket, sehingga tidak dapat dilihat admin.</div>
            </div>
        </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control form-control-custom" value="Dirahasiakan" disabled>
                <div class="form-text mt-2 fw-medium" style="color: #9ca3af; font-size: 13px;">
                    Nama tidak disimpan. Hindari menuliskan nama/NIM Anda di pesan atau di dalam berkas bukti.
                </div>
            </div>
            <div class="col-md-6">

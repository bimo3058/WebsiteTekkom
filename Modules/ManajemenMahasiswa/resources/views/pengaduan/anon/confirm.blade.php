...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('manajemenmahasiswa.pengaduan.track', ['token' => $token]) }}" class="btn-outline-custom">← Ubah</a>
    </div>
    ...
    <div class="custom-card">
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <div class="section-value">Ya (identitas disembunyikan)</div>
            </div>
        ...
        <form method="POST" action="{{ route('manajemenmahasiswa.pengaduan.anon.store', ['token' => $token]) }}" class="mt-4">
            @csrf
            ...
            <div class="d-flex justify-content-end gap-3 mt-4 pt-4" style="border-top: 1px solid #f3f4f6;">
                <a href="{{ route('manajemenmahasiswa.pengaduan.track', ['token' => $token]) }}" class="btn-outline-custom">Kembali</a>

...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('manajemenmahasiswa.pengaduan.track', ['token' => $token]) }}" class="btn-back">
    ...
    <div class="form-card">
        ...
        <form method="POST" action="{{ route('manajemenmahasiswa.pengaduan.anon.store', ['token' => $token]) }}" class="mt-4">
            ...
            <div class="d-flex justify-content-end gap-3 mt-4 pt-4" style="border-top: 1px solid #f3f4f6;">
                <a href="{{ route('manajemenmahasiswa.pengaduan.track', ['token' => $token]) }}" class="btn-back">Kembali</a>

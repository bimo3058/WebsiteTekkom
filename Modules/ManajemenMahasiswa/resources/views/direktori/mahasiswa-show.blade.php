...
<div class="profile-header">
    ...
    <div style="position: absolute; top: 20px; right: 24px;" class="d-flex gap-2">
        ...
        @endif
        @if(($isPengurus || $isAdmin) && $cvProfile)
            <a href="{{ route('manajemenmahasiswa.direktori.mahasiswa.cv-builder-preview', $mhs->id) }}" target="_blank" class="btn-outline-custom" style="background: rgba(255,255,255,0.15); border-color: rgba(255,255,255,0.3); color: white;">

<div class="sidebar">
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h5 class="fw-bold mb-0 text-dark" style="font-size: 15px; letter-spacing: -0.01em;">Portal Dosen</h5>
    ...
    <nav class="sidebar-nav d-flex flex-column gap-1">
        <x-manajemenmahasiswa::ui.sidebar-item route="{{ route('manajemenmahasiswa.dosen.dashboard') }}"
            routeName="manajemenmahasiswa.dosen.dashboard" label="Dashboard">
            <x-slot:iconSlot>

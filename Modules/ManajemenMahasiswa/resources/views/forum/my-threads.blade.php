<x-manajemenmahasiswa::layouts.forum-layout>
    ...
    <div class="dash-box-header">
        <h1 style="font-size:18px; font-weight:800; color:#0D0D12; margin:0 0 2px; letter-spacing:-0.02em;">Forum Saya</h1>
        <p style="font-size:12px; color:#666D80; font-weight:500; margin:0;">Thread yang kamu buat di Forum Diskusi</p>
    </div>

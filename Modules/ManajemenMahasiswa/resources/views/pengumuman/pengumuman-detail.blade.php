<x-manajemenmahasiswa::layouts.admin>
    ...
    @push('styles')
        <style>
            ...
            /* ── Komposisi isi ──────────────────────────────────────────────
               Isi memakai lebar penuh kotak supaya sisinya tidak kosong;
               hanya poster yang di-center sebagai titik fokus. */
            .detail-head {
                padding-bottom: 16px;
                margin-bottom: 20px;
            ...
            .detail-image-wrapper {
                /* width:fit-content — kotak menyusut mengikuti gambar (tidak ada
                   area kosong di sisi poster), lalu margin auto membuatnya center. */
            ...
            /* ── Isi pengumuman ─────────────────────────────────────────── */
            .content-section {
                font-size: 14px; color: var(--c-fg-sec, #353849); line-height: 1.8;
            ...
            .btn-pin-global { color: var(--c-warning, #956321); }
            .btn-pin-global:hover {
                background: var(--c-warning-subtle, #F9ECCB);
                border-color: var(--c-warning, #956321);
            ...
            @media (max-width: 640px) {
                .detail-title h5 { font-size: 20px; }
                        ...
                        @if($canPinGlobal)
                            <form action="{{ route('manajemenmahasiswa.pengumuman.pin', $pengumuman->id) }}" method="POST" style="margin:0;">
                                ...
                                <button type="submit" class="btn-action btn-pin-global">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="{{ $pengumuman->is_pinned ? 'currentColor' : 'none' }}" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">

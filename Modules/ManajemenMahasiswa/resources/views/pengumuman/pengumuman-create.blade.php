<x-manajemenmahasiswa::layouts.admin>
    ...
    <!-- Form -->
    <form action="{{ route('manajemenmahasiswa.pengumuman.store') }}" method="POST" enctype="multipart/form-data" id="createForm">
        @csrf
        ...
        <div class="form-card">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-select-custom">
                        ...
                        <option value="event_prodi" {{ old('kategori') === 'event_prodi' ? 'selected' : '' }}>Event Prodi</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="target_audience" class="form-select-custom" required>
                        ...
                        <option value="mahasiswa" {{ old('target_audience') === 'mahasiswa' ? 'selected' : '' }}>Mahasiswa</option>
                        <option value="alumni" {{ old('target_audience') === 'alumni' ? 'selected' : '' }}>Alumni</option>
                        <option value="dosen" {{ old('target_audience') === 'dosen' ? 'selected' : '' }}>Dosen</option>
                        <option value="pengurus" {{ old('target_audience') === 'pengurus' ? 'selected' : '' }}>Pengurus</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <textarea name="konten" class="form-textarea" placeholder="Tulis isi pengumuman di sini (minimal 50 karakter)..." required>{{ old('konten') }}</textarea>

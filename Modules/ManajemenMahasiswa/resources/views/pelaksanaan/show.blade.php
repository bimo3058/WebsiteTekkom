...
<div class="d-flex justify-content-between align-items-start">
    <div class="detail-header">
        ...
        <div>
            ...
            <p class="mb-0" style="font-size:.82rem;color:var(--c-fg-muted);font-weight:500;">Informasi kegiatan pada subbab pelaksanaan</p>
        </div>
    </div>
    ...
    <div class="d-flex gap-2">
        ...
        @if($pesanBukanPengelola && $proker->status !== 'selesai')
            <p class="mb-0 text-end align-self-center" style="max-width:340px;font-size:.78rem;color:var(--c-fg-muted);font-weight:500;">

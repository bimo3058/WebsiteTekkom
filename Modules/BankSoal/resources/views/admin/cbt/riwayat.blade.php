        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <form action="{{ route('banksoal.admin.cbt.riwayat') }}" method="GET" class="flex gap-2">
                    <select name="periode_id" onchange="this.form.submit()" class="text-sm border-slate-200 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-white py-2 pl-3 pr-8">

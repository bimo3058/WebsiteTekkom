<x-banksoal::layouts.dosen-admin>
    ...
    <form action="{{ route('banksoal.rps.dosen.store') }}" method="POST" enctype="multipart/form-data"
        ...
        data-route-dosen="{{ route('banksoal.rps.dosen.dosen') }}" data-cpmk-row-builder="1">
        @csrf
        ...
        <div id="method_upload_panel" class="{{ $creationMethod === 'upload' ? '' : 'hidden' }}">
                    ...
                    <div id="cpmkRows" class="cpmk-rows" data-cpmk-rows>
                        <div class="cpmk-row" data-cpmk-row data-row-index="0">
                            ...
                            <div style="display:flex;align-items:flex-end;">
                                <button type="button" class="btn-danger-sm" data-remove-cpmk-row><i
            ...
            <div class="form-actions" style="display: flex; justify-content: flex-end; gap: 12px; margin-top: 24px;">
                ...
                <button type="submit" class="btn btn-primary" id="btnSubmitManual"><i class="fas fa-paper-plane"></i>
                    Ajukan RPS</button>
            </div>
        </div>
                ...
                <div class="sub-tab-panel hidden" id="sub_tab_referensi-catatan_panel">
                        ...
                        <div id="references_container">
                            <div class="ref-row">
                                <input type="text" name="referensi_data[]" class="field-control"
                                    ...
                                    required>
                                <button type="button" class="btn-danger-sm btn-remove-ref" style="flex-shrink: 0;"><i
                                        class="fas fa-trash"></i></button>
                            </div>
                        </div>
                    ...
                    <div style="display: flex; justify-content: space-between; gap: 12px; margin-top: 16px;">
                        <button type="button" class="btn btn-secondary btn-prev-sub-tab" data-prev-tab="setelah-uts"><i
                                class="fas fa-chevron-left"></i> Back</button>
                        <button type="submit" class="btn btn-primary" id="btnSubmitGenerator"><i
                                class="fas fa-paper-plane"></i> Ajukan & Generate PDF</button>
                    </div>
                </div>
            </div>
        </div>

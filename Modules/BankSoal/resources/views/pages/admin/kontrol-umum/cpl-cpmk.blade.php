<x-banksoal::layouts.admin>
    ...
    <script>
        ...
        function openImportModal(type) {
            ...
            document.getElementById('importModalTitle').textContent = `Upload Excel/CSV ${label}`;
            
            // Set action URL dynamically
            document.getElementById('importForm').action = type === 'cpl' 
                ? '{{ route("banksoal.api.v1.admin.cpl.import") }}' 
                : '{{ route("banksoal.api.v1.admin.cpmk.import") }}';

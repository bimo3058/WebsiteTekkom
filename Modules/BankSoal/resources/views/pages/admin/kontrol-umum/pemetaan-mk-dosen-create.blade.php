    ...
    <div class="pm-page">
        ...
        <div class="tab-content active" id="tab0">
            <div class="mapping-grid">
                ...
                <div class="panel">
                    <div class="panel-header">
                        <h2>Pilih Dosen</h2>
                        <p>Centang satu atau lebih Dosen</p>
                    </div>
                    <div class="panel-search">
                        <div class="srch"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg><input type="text" placeholder="Cari Dosen..."
        ...
        <div class="tab-content" id="tab1">
            <div class="mapping-grid">
                <div class="panel">
                    <div class="panel-header">
                        <h2>Dosen Terpilih</h2>
                        <p>Pilih satu Dosen</p>
                    </div>
                    <div class="panel-search">
                        <div class="srch"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            const T = [
                {
                    ...
                    endpoint: '{{ route("banksoal.api.v1.admin.pemetaan.dosen-mk.sync") }}', leftKey: 'mk_id', rightKey: 'user_ids'
                },
                {
                    leftPool: [], rightPool: [], selId: null, selIds: new Set(), lq: '', lp: 1, rq: '', rp: 1,
                    endpoint: '{{ route("banksoal.api.v1.admin.pemetaan.dosen-mk-by-dosen.sync") }}', leftKey: 'user_id', rightKey: 'mk_ids'
                },
            ];
            let opt = { mk: [], dosen: [] };

                ...
                <form id="importCsvForm" action="{{ route('banksoal.arsip.dosen.upload-csv') }}" method="POST" enctype="multipart/form-data" onsubmit="return handleImportSubmit(event)">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <x-banksoal::ui.alpine-select id="arsip-create-csv-1-mk_id" label="Mata Kuliah">
                                <select id="arsip-create-csv-1-mk_id" aria-label="Mata Kuliah" name="mk_id" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-primary focus:ring-4 focus:ring-primary/5 outline-none transition-all" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-banksoal::ui.alpine-select id="arsip-create-csv-2-tipe_ujian" label="Kategori Ujian">
                                    <select id="arsip-create-csv-2-tipe_ujian" aria-label="Kategori Ujian" name="tipe_ujian" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-primary focus:ring-4 focus:ring-primary/5 outline-none transition-all" required>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-banksoal::ui.alpine-select id="arsip-create-csv-3-semester" label="Semester">
                                    <select id="arsip-create-csv-3-semester" aria-label="Semester" name="semester" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-primary focus:ring-4 focus:ring-primary/5 outline-none transition-all" required>
                    ...
                    <div class="mt-6 pt-6 border-t border-slate-100">
                        <button type="submit" id="importSubmitBtn" class="bs-archive-primary bs-archive-submit">

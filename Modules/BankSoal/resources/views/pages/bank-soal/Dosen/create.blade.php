<x-banksoal::layouts.dosen-admin>
    <x-banksoal::dosen.page-header title="Buat Soal Baru" subtitle="Lengkapi formulir untuk menambahkan butir soal ke bank soal.">
        <x-slot:actions>
    ...
    <x-banksoal::dosen.panel title="Form Soal" subtitle="Gunakan format pilihan ganda dan tandai satu jawaban benar." padding="p-0">

                    ...
                    <table class="table table-custom mb-0 align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('gpm.validasi-rps.review') }}" class="btn text-white rounded-3 px-3 py-2 fw-semibold text-decoration-none" style="background-color: #2563eb; font-size: 0.8rem;">Review Sekarang</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('gpm.validasi-bank-soal') }}" class="btn text-white rounded-3 px-3 py-2 fw-semibold text-decoration-none" style="background-color: #2563eb; font-size: 0.8rem;">Review Sekarang</a>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3 py-2 fw-semibold" style="font-size: 0.75rem;">RPS</span></td>

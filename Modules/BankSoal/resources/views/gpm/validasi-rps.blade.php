            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Tenggat: {{ \Carbon\Carbon::parse($activePeriode->tanggal_mulai)->locale('id')->translatedFormat('d M Y') }} s.d. {{ \Carbon\Carbon::parse($activePeriode->tanggal_selesai)->locale('id')->translatedFormat('d M Y') }}</p>
                    </div>
                </div>
                        ...
                        <div class="bg-white border border-slate-200 rounded-2xl p-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500">{{ \Carbon\Carbon::parse($periode->tanggal_mulai)->locale('id')->translatedFormat('d M Y H:i') }} s.d. {{ \Carbon\Carbon::parse($periode->tanggal_selesai)->locale('id')->translatedFormat('d M Y H:i') }}</p>
                                </div>
                            </div>
    ...
    <div data-tabs>
        ...
        <div class="hidden" data-tab-panel="revisi">
            ...
            <div class="mx-4 mt-4 mb-4 rounded-xl border border-slate-200 bg-slate-50 p-3 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between"
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm" id="table-revisi">
                        <thead class="bg-slate-50 text-[11px] uppercase tracking-wider text-slate-500 border-y border-slate-200">
                            <tr>
                                <th class="px-6 py-4 text-left">Mata Kuliah</th>
                                <th class="px-6 py-4 text-left">Dosen Pengampu</th>
        ...
        <div class="hidden" data-tab-panel="disetujui">
            ...
            <div class="mx-4 mt-4 mb-4 rounded-xl border border-slate-200 bg-slate-50 p-3 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between"
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm" id="table-disetujui">
                        <thead class="bg-slate-50 text-[11px] uppercase tracking-wider text-slate-500 border-y border-slate-200">
                            <tr>
                                <th class="px-6 py-4 text-left">Mata Kuliah</th>
                                <th class="px-6 py-4 text-left">Dosen Pengampu</th>

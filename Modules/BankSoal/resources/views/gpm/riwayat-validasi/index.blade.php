<x-banksoal::layouts.gpm-master>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 mb-8">
        <div class="bg-white border border-slate-200 rounded-2xl p-6 text-center flex flex-col items-center hover:border-primary/20 hover:shadow-lg transition-all">
            ...
            <a href="{{ route('banksoal.rps.gpm.riwayat-validasi.rps') }}" class="mt-auto inline-flex items-center justify-center w-full rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-white hover:bg-primary/90">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 text-center flex flex-col items-center hover:border-primary/20 hover:shadow-lg transition-all">
            ...
            <a href="{{ route('banksoal.soal.gpm.riwayat-validasi.bank-soal') }}" class="mt-auto inline-flex items-center justify-center w-full rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-white hover:bg-primary/90">

                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('banksoal.rps.dosen.index') }}"
                        ...
                        <svg class="w-5 h-5 flex-shrink-0 {{ $isRps ? 'text-primary' : 'text-slate-400 group-hover:text-slate-500' }}"
                             fill="{{ $isRps ? 'currentColor' : 'none' }}" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                        <span x-show="sidebarOpen" class="text-sm font-medium whitespace-nowrap" x-transition.opacity.duration.300ms>Manajemen RPS</span>
                    </a>
                    ...
                    <a href="{{ route('banksoal.arsip.dosen.index') }}"
                        ...
                        <svg class="w-5 h-5 flex-shrink-0 {{ $isArsip ? 'text-primary' : 'text-slate-400 group-hover:text-slate-500' }}"
                             fill="{{ $isArsip ? 'currentColor' : 'none' }}" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/>
                        </svg>
                        <span x-show="sidebarOpen" class="text-sm font-medium whitespace-nowrap" x-transition.opacity.duration.300ms>Arsip Soal</span>
                    </a>

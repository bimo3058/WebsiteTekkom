...
<body>
    ...
    <div class="sidebar d-flex flex-column py-4">
        ...
        <nav class="nav flex-column mb-auto">
            ...
            <a class="nav-link nav-link-custom {{ request()->routeIs('gpm.validasi-rps*') ? 'active' : '' }}" href="{{ route('gpm.validasi-rps') ?? '#' }}">
                <i class="fas fa-check-circle icon-width me-2"></i> Validasi RPS
            </a>
            <a class="nav-link nav-link-custom {{ request()->routeIs('gpm.validasi-bank-soal*') ? 'active' : '' }}" href="{{ route('gpm.validasi-bank-soal') ?? '#' }}">
                <i class="fas fa-question-circle icon-width me-2"></i> Validasi Bank Soal
            </a>
            <a class="nav-link nav-link-custom {{ request()->routeIs('gpm.riwayat-validasi*') ? 'active' : '' }}" href="{{ route('gpm.riwayat-validasi') ?? '#' }}">

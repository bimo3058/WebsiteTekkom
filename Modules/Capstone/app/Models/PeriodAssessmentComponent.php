...
{
    protected $table = 'capstone_period_assessment_components';
    protected $fillable = [
        'period_id',
        'template_id',
        'type',
    ...
    public function scores()
    {
        ...
        return \Modules\Capstone\Repositories\AssessmentScoreRepository::getByComponentId($this->id, 'period_component_id');
    }

...
export function registerTaSubmission(Alpine){
    Alpine.data('capstoneTaSubmission',()=>({
        loading:true,error:'',data:null,schedule:null,grades:null,uploading:false,selectedType:'',file:null,progress:0,date,palette:gradePalette,
        ...
        get currentStep(){return ({TA_DOCUMENTS_REQUIRED:0,TA_DOCUMENTS_UNDER_REVIEW:1,TA_DOCUMENTS_APPROVED:2,TA_READY_FOR_SIDANG:3,TA_REGISTERED:3,TA_SCHEDULED:4,TA_DEFENDED:4})[this.currentStatus] || 0;},

...
get canBid(){return this.isLeader && !this.group?.title_id && !this.group?.is_solo && this.group?.status==='READY_FOR_BIDDING' && this.members.length>=this.minMembers && !this.group?.period?.is_finalized && this.slots>0 && (this.bidFlow?.can_submit_bid??true) && !this.bids.some(b=>String(b.title_id)===String(this.title?.id));},

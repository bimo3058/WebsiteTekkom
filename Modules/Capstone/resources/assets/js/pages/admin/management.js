import {basePage,api,rows,unwrap,query,dialog,allRows} from './shared.js';
import {context} from '../../api.js';
export function adminGroups(detail=false){return Object.assign(basePage(),{detail,group:null,lecturers:[],supervisorId:'',status:'',pagination:{last_page:1,total:0},
...
export function expoAdmin(){return Object.assign(basePage(),{editing:null,form:{},action:'',
...
export function semproAdmin(){return Object.assign(basePage(),{groups:[],lecturers:[],locations:[],form:{},mode:'create',reason:'',
...
export function finalizationAdmin(){return Object.assign(basePage(),{titles:[],groups:[],lecturers:[],loads:[],locked:false,action:'',form:{},

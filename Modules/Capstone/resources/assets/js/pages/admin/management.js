...
export function adminGroups(detail=false){return {...basePage(),detail,group:null,lecturers:[],supervisorId:'',status:'',pagination:{last_page:1,total:0},
...
export function expoAdmin(){return {...basePage(),editing:null,form:{},action:'',
...
export function semproAdmin(){return {...basePage(),groups:[],lecturers:[],locations:[],form:{},mode:'create',reason:'',
...
export function finalizationAdmin(){return {...basePage(),titles:[],groups:[],lecturers:[],loads:[],locked:false,action:'',form:{},

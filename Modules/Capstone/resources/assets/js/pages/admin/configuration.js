...
export function assessmentConfig(peer=false,edit=false){return Object.assign(basePage(),{peer,edit,type:peer?'PEER_REVIEW':(context.params?.id || 'SEMPRO'),templates:[],selectedIds:[],copyFrom:'',version:0,
...
export function gradeConfig(){return Object.assign(basePage(),{weights:{pdc1:{},pdc2:{},ta:{}},version:0,

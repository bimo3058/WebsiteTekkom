import {basePage,api,rows,unwrap,query,download,dialog} from './shared.js';
export function progressAdmin(){return Object.assign(basePage(),{status:'',
...
export function peerDashboard(){return Object.assign(basePage(),{
    async init(){try{await this.periodsLoad(false);await this.load();}catch(e){this.error=e.message;this.loading=false;}},
...
export function documentUploads(){return Object.assign(basePage(),{summary:{},source:'',status:'',dateFrom:'',dateTo:'',groupId:'',pagination:{last_page:1,total:0},expanded:null,

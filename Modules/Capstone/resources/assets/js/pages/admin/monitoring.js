...
export function progressAdmin(){return {...basePage(),status:'',
...
export function peerDashboard(){return {...basePage(),
    async init(){try{await this.periodsLoad(false);await this.load();}catch(e){this.error=e.message;this.loading=false;}},
...
export function documentUploads(){return {...basePage(),summary:{},source:'',status:'',dateFrom:'',dateTo:'',groupId:'',pagination:{last_page:1,total:0},expanded:null,

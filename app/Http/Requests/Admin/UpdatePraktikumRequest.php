...
class UpdatePraktikumRequest extends FormRequest
{
    ...
    {
        $id = $this->route('praktikum');
        
        return [
            'nama'         => ['sometimes', 'required', 'string', 'max:255'],
            'kode'         => ['nullable', 'string', 'max:50', "unique:praktikum,kode,{$id}"],
            'deskripsi'    => ['nullable', 'string'],
            'dosen_id'     => ['nullable', 'uuid', 'exists:pengguna,id'],
            'koor_id'      => ['nullable', 'uuid', 'exists:pengguna,id'],
            'tahun_ajaran' => ['sometimes', 'required', 'integer', 'min:2000', 'max:2100'],
    ...
    public function messages(): array
    {
        return [
            ...
            'kode.unique'   => 'Kode praktikum sudah digunakan oleh praktikum lain.',

                        ...
                        <div style="display: flex; align-items: center; gap: 12px;" @click.away="open = false">
                            ...
                            <div style="position: relative; font-size: 13px; font-family: inherit;">
                                <div @click="open = !open" 
                                    ...
                                    <svg :style="open ? 'color: #0B266E; transform: rotate(180deg);' : 'color: #111827; transform: rotate(0deg);'" width="14" height="14" style="width: 14px; min-width: 14px; height: 14px; min-height: 14px; stroke-width: 2px; transition: transform 0.2s;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">

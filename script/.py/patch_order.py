...
# Match the current header mp-card wrapper
pattern = r'<div class="mp-card" style="margin-bottom:24px; padding:16px 24px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:16px;">.*?</div>\s*</div>'

new_header = """<div class="mp-card" style="margin-bottom:24px; padding:16px 24px; display:flex; gap:16px; align-items:center; width:100%; justify-content:space-between;">
        
        <div style="font-size:16px; font-weight:700; color:#0D0D12; white-space:nowrap; flex-shrink:0;">Absensi & Nilai</div>
        ...
        <div style="display:flex; align-items:center; gap:12px; flex:1; justify-content:flex-end;">
            ...
            <select x-model="globalShift" class="mp-input" style="width:140px; height: 38px; flex-shrink:0;">

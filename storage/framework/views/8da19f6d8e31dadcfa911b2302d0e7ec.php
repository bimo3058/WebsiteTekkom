...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mp-page-header">
        <div class="flex flex-col md:flex-row md:items-center justify-between w-full gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <form id="roomFilterForm" method="GET" action="<?php echo e(route('eoffice.peminjaman.user.kalender')); ?>"
    ...
    <div x-data="bookingKalender()" @mouseup.window="stopDrag()">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mode === 'week'): ?>
            ...
            <?php $minTWidth = 64 + (7 * $ruangans->count() * 75); ?>
                        ...
                        <thead>
                            ...
                            <tr style="background: #F1F3F9;">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $weekDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <th colspan="<?php echo e($ruangans->count()); ?>" <?php echo e($day->isToday() ? 'id=col-today' : ''); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ruangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            ...
                                            <td rowspan="<?php echo e($cData['rowspan']); ?>"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($href): ?>
                                                    ...
                                                    <button type="button"
                                                        @mousedown.prevent="startDrag('<?php echo e($ruang->id); ?>', '<?php echo e($ruang->nama); ?>', '<?php echo e($dateStr); ?>', '<?php echo e($hStr); ?>')"
                                                        ...
                                                        @mouseout="!isDragging && ($el.style.background = '<?php echo e($bg); ?>'); !isDragging && ($el.style.transform = 'scale(1)')"
                                                        class="select-none"
                                                        :style="isDragging && dragStartPoint?.roomId === '<?php echo e($ruang->id); ?>' && dragStartPoint?.dateStr === '<?php echo e($dateStr); ?>' && dragSelection.includes('<?php echo e($hStr); ?>') 
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    : 'display:flex; align-items:center; justify-content:center; min-height:34px; height: 100%; width:100%; font-size:9px; font-weight:700; color:#065F46; cursor:pointer; background: <?php echo e($bg); ?>; border:1px solid <?php echo e($border); ?>; border-radius:5px; transition:all 0.15s;'"
                                                        title="Booking <?php echo e($ruang->nama); ?> — <?php echo e($day->translatedFormat('D, d M')); ?> pukul <?php echo e($hStr); ?>">
                                                        ✓
                                                    </button>
                                                <?php else: ?>
                                                    <?php
                                                    ...
                                                    <div
                                                        style="display:flex; flex-direction:column; align-items:center; justify-content:center; min-height:34px; height:100%; width:100%; padding: 4px; overflow:hidden;
                                                                                                                                                                                                                                                                                                                   background:<?php echo e($bg); ?>; border:1px dashed <?php echo e($border); ?>; border-radius:5px;
                                                                                                                                                                                                                                                                                                                   text-align:center; white-space:normal; word-break:break-word; line-height:1.25; max-width:100%;
                                                                                                                                                                                                                                                                                                                   font-size:9px; font-weight:800; color:<?php echo e($tColor); ?>;
                                                                                                                                                                                                                                                                                                                   cursor:<?php echo e($cursor); ?>; opacity: <?php echo e($isPast ? '0.5' : '1'); ?>;">
                                                        <?php echo e($label); ?>
        ...
        <div x-show="showModal" x-cloak style="display: none;"
            ...
            <div x-show="showModal" x-transition:enter="ease-out duration-300"
                ...
                <div class="px-6 py-5 overflow-y-auto flex-1 bg-white">
                    <form id="bookingForm" method="POST" action="<?php echo e(route('eoffice.peminjaman.user.booking.store')); ?>"
                        ...
                        <div class="space-y-3">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" class="mp-input w-full bg-gray-50 text-gray-700 font-medium"
                                        value="<?php echo e($user->name ?? 'Student'); ?>" readonly>
                                </div>
                                <div>
                                    <label
                                        ...
                                        / NIP</label>
                                    <input type="text" class="mp-input w-full bg-gray-50 text-gray-700 font-medium"
                                        value="<?php echo e($nim ?? '00000'); ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_telepon" class="mp-input w-full"
                                    value="<?php echo e($phone ?? ''); ?>" required placeholder="Contoh: 08123456789">
                            </div>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-ruangan\user\kalender\index.blade.php ENDPATH**/ ?>
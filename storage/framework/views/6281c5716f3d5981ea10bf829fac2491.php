...
<div class="sk-login-root">
    ...
    <div class="sk-card">
        ...
        <div class="sk-back-link">
            Ingat password kamu? <a href="<?php echo e(route('login')); ?>">Kembali ke login</a>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>
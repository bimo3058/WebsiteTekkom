...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('pengurus_himpunan')): ?>
                <form method="POST" action="<?php echo e(route('manajemenmahasiswa.switch.mode')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\dashboard\alumni.blade.php ENDPATH**/ ?>
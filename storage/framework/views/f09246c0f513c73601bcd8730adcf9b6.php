...
<head>
    ...
    <title>SIKP - <?php echo e($title ?? 'Dosen Dashboard'); ?></title>
...
<body class="antialiased bg-[#ECEFF3]">
    <div x-data="{ sidebarOpen: true, ...(typeof pageData !== 'undefined' ? pageData : {}) }"
        ...
        <div data-mobile-sidebar-holder class="flex-shrink-0 relative z-20 bg-white border-r border-[#DFE1E6]"
            ...
            <?php if (isset($component)) { $__componentOriginal31e6b4d58994bfd6f78c25f2036fc4ee = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal31e6b4d58994bfd6f78c25f2036fc4ee = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.ui.sidebar-dosen','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('eoffice::ui.sidebar-dosen'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal31e6b4d58994bfd6f78c25f2036fc4ee)): ?>
<?php $attributes = $__attributesOriginal31e6b4d58994bfd6f78c25f2036fc4ee; ?>
<?php unset($__attributesOriginal31e6b4d58994bfd6f78c25f2036fc4ee); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal31e6b4d58994bfd6f78c25f2036fc4ee)): ?>
<?php $component = $__componentOriginal31e6b4d58994bfd6f78c25f2036fc4ee; ?>
<?php unset($__componentOriginal31e6b4d58994bfd6f78c25f2036fc4ee); ?>
<?php endif; ?>
        </div>
                    ...
                    <div class="flex items-center gap-1.5">
                        ...
                        <div class="flex items-center gap-2.5 cursor-pointer group">
                            <div
                                ...
                                <span
                                    class="font-bold text-xs leading-none"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'D', 0, 1))); ?></span>
                            </div>
                            <div class="hidden sm:flex flex-col leading-none">
                                <span
                                    class="text-[13px] font-semibold text-[#272835]"><?php echo e(auth()->user()->name ?? 'Dosen Pembimbing'); ?></span>
                                <span class="text-[11px] text-[#808897] font-normal mt-0.5">Dosen Pembimbing</span>
                            </div>
                        </div>
                    </div>
                </header>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\components\layouts\dosen.blade.php ENDPATH**/ ?>
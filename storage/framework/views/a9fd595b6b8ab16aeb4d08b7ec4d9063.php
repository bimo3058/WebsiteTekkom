...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-praktikum.ui.select','data' => ['name' => 'semester','options' => $semesterOptions,'selected' => request('semester', ''),'placeholder' => 'Semua Semester','onChange' => '$event.target.form.submit()','minWidth' => '160px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('eoffice.manprak.admin.matkul-praktikum.index')); ?>"
    ...
    <div class="mp-card-body p-0">
        ...
        <?php $sortedItems = $matkulList->getCollection()->sortBy(['semester', 'kode']); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $sortedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="grid gap-4 px-5 py-4 border-b border-[#F6F8FA] hover:bg-[#FAFAFA] transition-colors items-center"
             style="grid-template-columns: 120px 80px 1fr 60px 90px;">

            
            <div>
                <span class="text-[12px] font-mono font-bold text-[#0B266E]"><?php echo e($mk->kode); ?></span>
            </div>

            
            <div class="text-[13px] font-semibold text-[#353849]"><?php echo e($mk->semester); ?></div>

            
            <div class="min-w-0">
                <div class="text-[13px] font-semibold text-[#0D0D12] truncate"><?php echo e($mk->nama); ?></div>
            </div>

            
            <div class="text-[13px] font-medium text-[#353849] text-center">
                <?php echo e($mk->sks); ?> SKS
            </div>
            ...
            <div class="flex items-center justify-center gap-1.5">
                ...
                <form method="POST" action="<?php echo e(route('eoffice.manprak.admin.matkul-praktikum.destroy', $mk->id)); ?>"
                      onsubmit="return confirm('Hapus mata kuliah <?php echo e(addslashes($mk->nama)); ?>?')" class="inline">
    ...
    <div class="p-4 border-t border-[#DFE1E7]"><?php echo e($matkulList->links()); ?></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div x-show="dropdownOpen" style="display:none;"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($s = 1; $s <= 8; $s++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <label class="flex items-center justify-between px-3 py-2.5 rounded-[6px] cursor-pointer text-[13px] transition-colors mb-0.5 last:mb-0"
                                       :class="selected == '<?php echo e($s); ?>' ? 'bg-[#F6F8FA] text-[#0B266E] font-medium' : 'text-[#353849] hover:bg-[#F6F8FA]'">
                                    <input type="radio" value="<?php echo e($s); ?>" x-model="selected" @change="dropdownOpen = false" class="hidden">
                                    <span class="truncate">Semester <?php echo e($s); ?></span>
                                    <svg x-show="selected == '<?php echo e($s); ?>'" class="w-4 h-4 flex-shrink-0 text-[#0B266E]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup_kode\admin\matkul-praktikum.blade.php ENDPATH**/ ?>
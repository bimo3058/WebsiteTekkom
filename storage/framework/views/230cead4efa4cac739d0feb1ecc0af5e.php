...
<?php endif; ?>
    ...
    <div class="max-w-3xl mx-auto py-8">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <form action="<?php echo e(route('banksoal.soal.gpm.parameter.update', $parameter->id)); ?>" method="POST" class="p-8 space-y-6" onsubmit="if(this.checkValidity()){ window.showLoader(); return true; }">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="rps" <?php echo e(old('jenis', $parameter->jenis) == 'rps' ? 'selected' : ''); ?>>Validasi RPS</option>
                            <option value="soal" <?php echo e(old('jenis', $parameter->jenis) == 'soal' ? 'selected' : ''); ?>>Validasi Bank Soal</option>
                        </select>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="number" name="bobot" id="bobot" value="<?php echo e(old('bobot', $parameter->bobot)); ?>" min="1" max="100" class="w-full pl-4 pr-12 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all outline-none <?php $__errorArgs = ['bobot'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('aspek', $parameter->aspek)); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\gpm\parameter\edit.blade.php ENDPATH**/ ?>
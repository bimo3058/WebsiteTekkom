...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => ['title' => 'Tambah Penilaian']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Tambah Penilaian']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

    <div class="max-w-5xl mx-auto space-y-6 pb-20">

        <form action="<?php echo e(route('eoffice.kp.koordinator.master-rubrik.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-8">
                <h1 class="text-[24px] font-bold text-[#0D0D12]" style="font-family: 'Inter Tight', sans-serif;">Tambah
                    Penilaian</h1>
                <p class="text-[14px] text-[#666D80] font-medium mt-1" style="font-family: 'Inter Tight', sans-serif;">
                    Buat template komponen penilaian baru untuk digunakan dalam konfigurasi periode.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div class="md:col-span-8 flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode" value="<?php echo e(old('kode')); ?>" placeholder="contoh : CPMK-1"
                                required
                        ...
                        <div x-data="{ count: <?php echo e(strlen(old('deskripsi', ''))); ?> }">
                            <label class="block text-[13px] font-semibold text-[#344054] mb-1.5"
                            ...
                            <div class="relative">
                                <textarea name="deskripsi" rows="3" required maxlength="200"
                                    ...
                                    style="font-family: 'Inter Tight', sans-serif;"><?php echo e(old('deskripsi')); ?></textarea>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="role_penilai" required
                                    ...
                                    style="font-family: 'Inter Tight', sans-serif;">
                                    <option value="dosen_pembimbing" <?php echo e(old('role_penilai') == 'dosen_pembimbing' ? 'selected' : ''); ?>>Dosen Pembimbing</option>
                                    <option value="koordinator" <?php echo e(old('role_penilai') == 'koordinator' ? 'selected' : ''); ?>>Koordinator</option>
                                </select>
                                <div
                            ...
                            <div>
                                <label class="block text-[13px] font-semibold text-[#344054] mb-1.5"
                                    style="font-family: 'Inter Tight', sans-serif;">Bobot (%) <span
                                        class="text-[#D92D20] ml-0.5">*</span></label>
                                <input type="number" name="bobot" value="<?php echo e(old('bobot', 10)); ?>" min="0" max="100"
                            ...
                            <div>
                                ...
                                <div class="mt-2.5">
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', 1) ? 'checked' : ''); ?> class="sr-only peer">
                                        <div
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\rubrik\create.blade.php ENDPATH**/ ?>
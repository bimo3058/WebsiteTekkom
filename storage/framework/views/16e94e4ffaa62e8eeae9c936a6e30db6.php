...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div id="tab-cpl" class="tab-content active">
        ...
        <div class="upload-section">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                ...
                <a href="<?php echo e(route('banksoal.api.v1.admin.cpl.export-template')); ?>" style="color: var(--primary-blue); font-size: 13px; font-weight: 600; text-decoration: none;">Unduh Template</a>
            </div>
    ...
    <script>
        const API_URL = '<?php echo e(route("banksoal.api.v1.admin.cpl.store")); ?>';
        const IMPORT_URL = '<?php echo e(route("banksoal.api.v1.admin.cpl.import")); ?>';
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\admin\kontrol-umum\cpl-create.blade.php ENDPATH**/ ?>
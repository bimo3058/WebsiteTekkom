    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-wrap {
            ...
            margin: 0 auto 24px; position: relative; color: #185fa5;
        }
        ...
        .icon-dot {
            ...
            width: 10px; height: 10px; background: #378add;
        ...
        footer a { color: #185fa5; text-decoration: none; font-weight: 500; }
    </style>
...
<?php /**PATH C:\WebsiteTekkom - Copy\resources\views\errors\401.blade.php ENDPATH**/ ?>
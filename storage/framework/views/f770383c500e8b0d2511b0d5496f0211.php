                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $riwayatData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $rw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr style="border-bottom:1px solid #e5e7eb; transition:background .12s;"
                            ...
                            <td style="padding:14px 12px; font-size:13px; color:var(--c-fg-muted); width:48px;"><?php echo e($i + 1); ?></td>
                            <td style="padding:14px 16px; min-width:200px;">
                                <p style="font-size:13px; font-weight:600; color:var(--c-fg); margin:0; overflow:hidden; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; line-height:1.5; max-width:260px;"><?php echo e($rw->nama_kegiatan_manual ?? 'Kegiatan tidak diketahui'); ?></p>
                            </td>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rw->buktiFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bukti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <a href="<?php echo e($bukti->public_url); ?>" target="_blank" title="<?php echo e($bukti->nama_file); ?>" style="text-decoration: none;">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bukti->isImage()): ?>
                                                    <img src="<?php echo e($bukti->public_url); ?>" style="width: 32px; height: 32px; border-radius: 6px; object-fit: cover; border: 1px solid var(--c-border);">
                                                <?php else: ?>
                                                    <span style="display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; border-radius: 6px; background: #eef2ff; border: 1px solid var(--c-border); font-size: 14px;"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--c-primary)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </a>
                            ...
                            <td style="padding:14px 16px;">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rw->verification_status === 'rejected' && $rw->verification_note): ?>
                                    <div class="verif-note rejected" title="<?php echo e($rw->verification_note); ?>">
                                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;margin-right:3px;"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>"<?php echo e(Str::limit($rw->verification_note, 60)); ?>"
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rw->verification_status === 'approved' && $rw->verification_note): ?>
                                    <div class="verif-note approved" title="<?php echo e($rw->verification_note); ?>">
                                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;margin-right:3px;"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>"<?php echo e(Str::limit($rw->verification_note, 60)); ?>"
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
...
<div style="background:#fff; border:1px solid #e5e7eb; border-radius:14px; overflow:hidden; box-shadow:0 1px 3px rgba(0,0,0,.04); display:flex; flex-direction:column; margin-bottom:18px;">
    ...
    <div style="padding:14px 16px; border-bottom:1px solid #e5e7eb;">
        <div class="kuota-info" style="margin-bottom:10px;">
            Kuota reward Anda (SK FT 774): umum <b><?php echo e($kuota['umum'] ?? 0); ?>/2</b> &nbsp;•&nbsp; invention/expo/fair <b><?php echo e($kuota['invention'] ?? 0); ?>/1</b>.
            Reward = peningkatan nilai mata kuliah; mata kuliah final ditetapkan departemen.
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rewardAturan->count()): ?>
            <div class="aturan-box" style="margin-bottom:0;">
                ...
                <?php echo $__env->make('manajemenmahasiswa::verifikasi._aturan_links', ['items' => $rewardAturan], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
                        ...
                        <tr style="border-bottom:1px solid #e5e7eb; transition:background .12s;"
                            ...
                            <td style="padding:14px 16px;">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->verification_status === 'rejected' && $p->verification_note): ?>
                                    <div class="verif-note rejected" title="<?php echo e($p->verification_note); ?>">
                                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;margin-right:3px;"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>"<?php echo e(Str::limit($p->verification_note, 60)); ?>"
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->verification_status === 'approved' && $p->verification_note): ?>
                                    <div class="verif-note approved" title="<?php echo e($p->verification_note); ?>">
                                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;margin-right:3px;"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>"<?php echo e(Str::limit($p->verification_note, 60)); ?>"
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td style="padding:14px 16px;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->verification_status === 'approved'): ?>
                                    ...
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->reward_status === \Modules\ManajemenMahasiswa\Models\Prestasi::CLAIM_DIAJUKAN): ?>
                                        <div class="reward-stack">
                                            <span class="claim-badge diajukan">Menunggu persetujuan</span>
                                            <div class="reward-actions">
                                                <button type="button" class="btn-tinjau" onclick="openRewardDetail(<?php echo \Illuminate\Support\Js::from($rdData)->toHtml() ?>)">Tinjau</button>
                                                <form method="POST" id="batalRewardForm<?php echo e($p->id); ?>" action="<?php echo e(route('manajemenmahasiswa.verifikasi.prestasi.reward.batal', $p->id)); ?>" style="margin:0;">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                                    <button type="button" class="btn-unclaim"
                                                            onclick="openBatalConfirm('batalRewardForm<?php echo e($p->id); ?>', <?php echo \Illuminate\Support\Js::from($p->nama_prestasi)->toHtml() ?>)">Batalkan</button>
                                                </form>
                                            </div>
                                        </div>
                                    <?php elseif($p->reward_status === \Modules\ManajemenMahasiswa\Models\Prestasi::CLAIM_DISETUJUI): ?>
                                        <div class="reward-stack">
                                    ...
                                    <?php elseif($p->reward_status === \Modules\ManajemenMahasiswa\Models\Prestasi::CLAIM_DITOLAK): ?>
                                        <div class="reward-stack">
                                            <span class="claim-badge ditolak">Reward ditolak</span>
                                            <div class="reward-actions">
                                                <button type="button" class="btn-tinjau" onclick="openRewardDetail(<?php echo \Illuminate\Support\Js::from($rdData)->toHtml() ?>)">Tinjau</button>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($isAlumni ?? false)): ?>
                                                    <button type="button" class="btn-claim"
                                                            onclick="openAjukanReward(<?php echo e($p->id); ?>, <?php echo \Illuminate\Support\Js::from($p->nama_prestasi)->toHtml() ?>)">Ajukan Ulang</button>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="reward-stack">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($isAlumni ?? false)): ?>
                                                <button type="button" class="btn-claim"
                                                        onclick="openAjukanReward(<?php echo e($p->id); ?>, <?php echo \Illuminate\Support\Js::from($p->nama_prestasi)->toHtml() ?>)">Ajukan Reward</button>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
...
<div class="modal fade" id="addRiwayatModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('manajemenmahasiswa.verifikasi.riwayat.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addPrestasiModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('manajemenmahasiswa.verifikasi.prestasi.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="reward_penyelenggara" id="arPenyelenggara" class="form-select form-select-custom" required>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \Modules\ManajemenMahasiswa\Models\Prestasi::PENYELENGGARA_LABELS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div class="mb-3 mt-3" id="arMkWrap" style="display:none;">
                        ...
                        <div class="d-flex gap-2">
                            <select id="arMkSelect" class="form-select form-select-custom" style="flex:1;">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \Modules\ManajemenMahasiswa\Models\Prestasi::MATA_KULIAH; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $smt => $mks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <optgroup label="<?php echo e($smt); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $namaMk => $sksMk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <option value="<?php echo e($namaMk); ?>"><?php echo e($namaMk); ?> (<?php echo e($sksMk); ?> SKS)</option>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    </optgroup>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
...
(function() {
    ...
    const LABELS       = <?php echo json_encode(\Modules\ManajemenMahasiswa\Models\Prestasi::CAPAIAN_LABELS, 15, 512) ?>;
    const CAP_BY_PENY  = <?php echo json_encode(\Modules\ManajemenMahasiswa\Models\Prestasi::CAPAIAN_BY_PENYELENGGARA, 15, 512) ?>;
    const JATAH        = <?php echo json_encode($rewardJatahMap, 15, 512) ?>;
    const JATAH_INV    = <?php echo json_encode($rewardJatahInvention, 15, 512) ?>;
    const PENY_LAINNYA = <?php echo json_encode(\Modules\ManajemenMahasiswa\Models\Prestasi::PENYELENGGARA_LAINNYA, 15, 512) ?>;
    const MK_SKS       = <?php echo json_encode(\Modules\ManajemenMahasiswa\Models\Prestasi::mataKuliahFlat(), 15, 512) ?>;
    const BASE_URL     = <?php echo json_encode(url('manajemen-mahasiswa/verifikasi'), 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\verifikasi\mahasiswa.blade.php ENDPATH**/ ?>
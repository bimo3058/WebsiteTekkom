                ...
                <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="card p-8 relative min-h-[400px]">
                        ...
                        <div x-show="step === 1 && !loading" x-transition.opacity.duration.300ms style="display: none;">
                            <?php echo $__env->make('profile.cv.steps.step-1', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Step 2: Pendidikan & Bahasa -->
                        <div x-show="step === 2 && !loading" x-transition.opacity.duration.300ms style="display: none;">
                            <?php echo $__env->make('profile.cv.steps.step-2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Step 3: Pengalaman & Organisasi -->
                        <div x-show="step === 3 && !loading" x-transition.opacity.duration.300ms style="display: none;">
                            <?php echo $__env->make('profile.cv.steps.step-3', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Step 4: Proyek & Sertifikasi & Prestasi -->
                        <div x-show="step === 4 && !loading" x-transition.opacity.duration.300ms style="display: none;">
                            <?php echo $__env->make('profile.cv.steps.step-4', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Step 5: Keahlian -->
                        <div x-show="step === 5 && !loading" x-transition.opacity.duration.300ms style="display: none;">
                            <?php echo $__env->make('profile.cv.steps.step-5', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Step 6: Preview -->
                        <div x-show="step === 6 && !loading" x-transition.opacity.duration.300ms style="display: none;">
                            <?php echo $__env->make('profile.cv.steps.step-6', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\profile\cv\index.blade.php ENDPATH**/ ?>
...
<form method="POST" action="<?php echo e(route('password.update')); ?>" id="form-password">
...
</script><?php /**PATH C:\WebsiteTekkom - Copy\resources\views/profile/partials/settings-panel-password.blade.php ENDPATH**/ ?>
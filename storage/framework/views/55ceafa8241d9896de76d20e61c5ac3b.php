...
<div style="display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap;">
    <div>
        ...
        <p style="font-size:12px; color:var(--c-fg-muted); margin-top:3px; margin-bottom:0;">
            Total
            <span style="color:var(--c-primary); font-weight:600;"><?php echo e(number_format($logs->total())); ?></span>
...
</div><?php /**PATH C:\WebsiteTekkom - Copy\resources\views/superadmin/audit-logs/_header.blade.php ENDPATH**/ ?>
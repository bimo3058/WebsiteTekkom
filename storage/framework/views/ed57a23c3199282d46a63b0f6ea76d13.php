...
<div x-data="capstoneGrades">
    ...
    <div class="space-y-10" x-show="!loading && !error" x-cloak>
        ...
        <div x-show="!sections.length" class="flex flex-col items-center justify-center rounded-xl border border-dashed px-6 py-20 text-center"><?php if (isset($component)) { $__componentOriginal0ebc33cc959e9b0fde2e3c32f43abd3a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0ebc33cc959e9b0fde2e3c32f43abd3a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'capstone::components.icon','data' => ['name' => 'GraduationCap','class' => 'mb-5 h-12 w-12 text-muted-foreground/40']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'GraduationCap','class' => 'mb-5 h-12 w-12 text-muted-foreground/40']); ?>
...
<?php endif; ?><h3 class="text-lg font-semibold">Belum ada nilai</h3><p class="mt-1.5 max-w-sm text-sm text-muted-foreground">Nilai akan muncul setelah pembimbing dan penguji mengirimkan evaluasi.</p></div>
        <template x-if="sections.length"><div class="space-y-10">
            ...
            <div>
                ...
                <div role="tabpanel" :id="'grade-panel-'+tab" :aria-labelledby="'grade-tab-'+tab" class="mt-5 space-y-4"><template x-for="detail in components" :key="tab+':'+detail.type"><div class="rounded-lg border px-4 py-3">
                    ...
                    <div x-show="detail.score!=null && detail.evaluators?.length" class="mt-3 space-y-1.5"><template x-for="(e,index) in (detail.evaluators || [])" :key="index"><div class="flex items-center justify-between rounded-md bg-muted/40 px-3 py-2"><div class="flex items-center gap-2 min-w-0"><?php if (isset($component)) { $__componentOriginal0ebc33cc959e9b0fde2e3c32f43abd3a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0ebc33cc959e9b0fde2e3c32f43abd3a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'capstone::components.icon','data' => ['name' => 'Users','class' => 'h-3.5 w-3.5 shrink-0 text-muted-foreground']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('capstone::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'Users','class' => 'h-3.5 w-3.5 shrink-0 text-muted-foreground']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = $__componentOriginal0ebc33cc959e9b0fde2e3c32f43abd3a; ?>
<?php unset($__componentOriginal0ebc33cc959e9b0fde2e3c32f43abd3a); ?>
<?php endif; ?><span class="truncate text-sm" x-text="e.name"></span><?php if (isset($component)) { $__componentOriginal22d7e929995a9d34325929f7d2857b6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal22d7e929995a9d34325929f7d2857b6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'capstone::components.badge','data' => ['variant' => 'outline','class' => 'text-[10px] h-5 px-1.5 shrink-0','xText' => 'roleLabel(e.role)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','class' => 'text-[10px] h-5 px-1.5 shrink-0','x-text' => 'roleLabel(e.role)']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?><span x-show="e.component" class="hidden sm:inline truncate text-[11px] text-muted-foreground" x-text="e.component"></span></div><span class="ml-2 text-sm font-semibold tabular-nums shrink-0" :class="e.score!=null?palette(e.score).text:'text-muted-foreground'" x-text="score(e.score)"></span></div></template></div>
...
<?php echo $__env->make('capstone::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\Capstone\tests/../resources/views/pages\mahasiswa\grades\index.blade.php ENDPATH**/ ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <section class="feature-card" id="section-mk-cpl">
        <div class="feature-head">
            ...
            <a href="<?php echo e(route('banksoal.admin.kontrol-umum.pemetaan.mk-cpl.create')); ?>" class="btn-add">
    ...
    <section class="feature-card" id="section-dosen-mk">
        <div class="feature-head">
            ...
            <a href="<?php echo e(route('banksoal.admin.kontrol-umum.pemetaan.mk-dosen.create')); ?>" class="btn-add">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                Tambah Pemetaan
    ...
    <script>
        ...
        const BASE_API = '<?php echo e(url("/bank-soal/admin/api/pemetaan")); ?>';
        ...
        const EDIT_URL = {
            ...
            mkCpl:   (id) => `<?php echo e(url('/bank-soal/admin/kontrol-umum/pemetaan/mk-cpl')); ?>/${id}/edit`,
            dosenMk: (id) => `<?php echo e(url('/bank-soal/admin/kontrol-umum/pemetaan/mk-dosen')); ?>/${id}/edit`,
        };
        // delete-all API URLs
        const DEL_ALL_URL = {
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\admin\kontrol-umum\pemetaan.blade.php ENDPATH**/ ?>
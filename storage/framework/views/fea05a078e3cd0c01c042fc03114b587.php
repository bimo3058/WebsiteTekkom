...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form action="<?php echo e(route('superadmin.users.update', $user)); ?>" method="POST" class="edit-wrap"
          x-data="{
              open: false,
              selected: <?php echo e(json_encode(old('roles', $currentRoleNames))); ?>,
        ...
        <div class="edit-box">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding:12px 24px;background:#F2F3F5;border-bottom:1px solid #D4D5D8;flex-shrink:0;">
                <a href="<?php echo e(route('superadmin.users.show', $user)); ?>"
            ...
            <div style="padding:24px;background:#fff;border-bottom:1px solid #D4D5D8;display:flex;gap:40px;">
                ...
                <div style="flex:1; display:grid; grid-template-columns: 1fr 1fr; gap:20px 30px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" required class="input-field">
                    </div>
                    ...
                    <div class="input-group" x-show="selected.includes('dosen') && !selected.includes('mahasiswa')" x-cloak>
                        ...
                        <input type="text" name="employee_number"
                               value="<?php echo e(old('employee_number', $user->lecturer->employee_number ?? '')); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <span style="font-size:11px;color:#EF4444;font-weight:600;"><?php echo e($message); ?></span>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="input-group" x-show="selected.includes('mahasiswa')" x-cloak>
                        ...
                        <input type="text" name="student_number"
                               value="<?php echo e(old('student_number', $user->student->student_number ?? '')); ?>"
                               class="input-field" placeholder="Contoh: 22552011001">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['student_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" value="<?php echo e(old('phone', $user->whatsapp)); ?>" placeholder="08123456789" class="input-field">
                    </div>
                    <div class="input-group" x-show="selected.includes('mahasiswa')" x-cloak>
                        <label>Tahun Angkatan <span style="color:#EF4444">*</span></label>
                        <input type="number" name="cohort_year"
                               value="<?php echo e(old('cohort_year', $user->student->cohort_year ?? date('Y'))); ?>"
                               class="input-field"
                               placeholder="<?php echo e(date('Y')); ?>"
                               min="2000" max="<?php echo e(date('Y') + 1); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['cohort_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div style="flex:1;overflow-y:auto;padding:24px;background:#fff;">
                    ...
                    <div style="margin-bottom:24px; max-width: 500px;">
                        ...
                        <div style="position:relative;" @click.outside="open = false">
                            ...
                            <div x-show="open" x-cloak
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $roleList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div x-show="!selected.includes('<?php echo e($slug); ?>')">
                                    <div @click="addRole('<?php echo e($slug); ?>')"
                                        ...
                                        <div style="flex-shrink:0; width:8px; height:8px; border-radius:50%; background:<?php echo e($r['color']); ?>;"></div>
                                        <span style="font-size:12px; font-weight:600; color:#475569;"><?php echo e($r['label']); ?></span>
                                    </div>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>

                                <div x-show="selected.length === <?php echo e(count($roleList)); ?>"
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:15px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dbModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            ?>
                            <div class="module-box" style="border:1px solid #D4D5D8;border-radius:10px;overflow:hidden;background:#fff;box-shadow:0 1px 2px rgba(0,0,0,.04); opacity: <?php echo e($mod->is_active ? '1' : '0.6'); ?>;">
                                <div style="display:flex;align-items:center;justify-content:space-between;padding:10px 15px;border-bottom:1px solid #E8E9EB;background:#fff;">
                                    <div style="display:flex;align-items:center;gap:10px;">
                                        <div style="width:28px;height:28px;border-radius:6px;display:flex;align-items:center;justify-content:center;border:1px solid <?php echo e($style['border']); ?>;background:<?php echo e($style['bg']); ?>;">
                                            <svg style="width:14px;height:14px;" fill="none" viewBox="0 0 24 24" stroke="<?php echo e($style['color']); ?>" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($style['icon']); ?>"/>
                                            </svg>
                                        </div>
                                        <span style="font-size:12px;font-weight:900;color:#1E293B;"><?php echo e(strtoupper($mod->name)); ?></span>
                                    </div>
                                    <label style="display:flex;align-items:center;gap:6px;cursor:pointer;">
                                        <input type="checkbox" onclick="toggleAllPerms('<?php echo e($pPrefix); ?>', this)" <?php echo e(!$mod->is_active ? 'disabled' : ''); ?>
                                ...
                                <div style="padding:15px;display:grid;grid-template-columns:1fr 1fr;gap:10px 15px;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $perms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <label style="display:flex;align-items:center;gap:8px;cursor:<?php echo e($mod->is_active ? 'pointer' : 'not-allowed'); ?>;">
                                            <input type="checkbox" name="permissions[]" value="<?php echo e($perm->name); ?>" 
                                                    <?php echo e($user->permissions->contains('name', $perm->name) ? 'checked' : ''); ?>

                                                <?php echo e(!$mod->is_active ? 'disabled' : ''); ?>

                                                style="width:15px; height:15px; border-radius:4px; border:1.5px solid #CBD5E1; cursor:inherit; accent-color:var(--c-primary);">
                                            <span style="font-size:12px;font-weight:600;color:#64748B;"><?php echo e($perm->display_name ?? \Illuminate\Support\Str::title(\Illuminate\Support\Str::after($perm->name, '.'))); ?></span>
                                        </label>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($perms->isEmpty()): ?>
...
<script>
    ...
    window.roleStyles = <?php echo json_encode($roleList, 15, 512) ?>;
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\users\edit.blade.php ENDPATH**/ ?>
...
<head>
    <meta charset="UTF-8">
    <title>Surat Pengantar KP - <?php echo e($data['instansi'] ?? 'Instansi'); ?></title>
    <style>
...
<body style="background: #f3f4f6; padding: 20px 0;">
    ...
    <div class="page-a4" style="<?php if(($data['format'] ?? 'pdf') !== 'word'): ?> box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); <?php endif; ?>">
        ...
        <table class="kop-table">
            <tr>
                <td class="logo-col">
                    <img class="logo-img" src="<?php echo e(($data['format'] ?? 'pdf') === 'pdf' ? public_path('images/logo-undip.png') : asset('images/logo-undip.png')); ?>" alt="Logo Universitas Diponegoro">
                </td>
                <td class="title-col">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $mhs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <table class="student-table">
            <tr>
                <td width="180">Nama</td>
                <td width="20">:</td>
                <td><strong><?php echo e($mhs['nama'] ?? '......................................................'); ?></strong></td>
            </tr>
            <tr>
                <td>NIM</td>
                <td>:</td>
            ...
            <tr>
                <td>Semester</td>
                <td>:</td>
                <td><?php echo e($mhs['semester'] ?? '4 (Empat)'); ?></td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>:</td>
        ...
        <p class="closing-text">
            Mohon izin bersama ini kami memohon kiranya berkenan memberikan Surat Pengantar kepada <strong><?php echo e($data['instansi'] ?? '......................................................'); ?></strong> guna keperluan pelaksanaan Kerja Praktik yang direncanakan berlangsung pada tanggal <strong><?php echo e($data['durasi'] ?? '......................................................'); ?></strong>.
        </p>
        ...
        <div class="signature-container">
            <div class="signature-box">
                <p>Semarang, <?php echo e($dateStr); ?></p>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\kp\mahasiswa\templates\surat_pengantar.blade.php ENDPATH**/ ?>
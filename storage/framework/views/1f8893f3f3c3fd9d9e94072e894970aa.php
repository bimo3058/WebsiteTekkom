...
<div class="grid grid-cols-[360px_1fr] gap-[14px] flex-1 min-h-0">
    <div class="flex flex-col gap-[14px]">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modul->praktikum?->is_active): ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum\koordinator\modul-detail.blade.php ENDPATH**/ ?>
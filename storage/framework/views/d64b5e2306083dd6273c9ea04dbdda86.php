...
<head>
    ...
    <title>419 — Sesi Telah Kedaluwarsa</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-wrap {
            ...
            margin: 0 auto 24px; position: relative; color: #ba7517;
        }
...
<body>
    <div class="container">
        <div class="label">419 Page Expired</div>
        <div class="icon-wrap">
            <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            <span class="icon-dot"></span>
        </div>
        <h1>Sesi Telah Kedaluwarsa</h1>
        <p><?php echo e($exception->getMessage() ?: 'Sesi Anda telah habis masa berlakunya. Silakan muat ulang halaman dan coba lagi.'); ?></p>
        <div class="actions">
    ...
    <footer>
        &copy; <?php echo e(date('Y')); ?> <a href="/">LuminHR</a>. All rights reserved.
    </footer>
...
<?php /**PATH C:\WebsiteTekkom - Copy\resources\views\errors\419.blade.php ENDPATH**/ ?>
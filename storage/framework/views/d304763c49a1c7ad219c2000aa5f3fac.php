...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'banksoal::components.ui.page-header','data' => ['title' => 'Tambah Arsip Soal','subtitle' => 'Pilih metode unggah yang sesuai: format PDF standar atau import massal via CSV/Excel.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Tambah Arsip Soal','subtitle' => 'Pilih metode unggah yang sesuai: format PDF standar atau import massal via CSV/Excel.']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
            ...
            <div class="p-6 flex-1">
                <form action="<?php echo e(route('banksoal.arsip.dosen.upload-csv')); ?>" method="POST" enctype="multipart/form-data" onsubmit="showLoader()">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\arsip\Dosen\create.blade.php ENDPATH**/ ?>
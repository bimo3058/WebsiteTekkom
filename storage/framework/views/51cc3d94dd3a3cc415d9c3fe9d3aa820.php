...
<div class="mp-page-header">
    <div>
        ...
        <p class="mp-page-sub">
            Selamat datang, <?php echo e($firstName); ?> · <?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?>
...
<div class="sec-head">
    ...
    <span class="mp-badge warning sm"><span class="dot"></span><?php echo e($asprakBelumModul); ?> asprak belum dapat modul</span>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
...
<div style="display:grid;grid-template-columns:1fr;gap:14px;flex-shrink:0;">
    ...
    <div class="mp-card" style="padding:20px;">
        ...
        <div class="flex items-end justify-between mb-3">
            <div style="font-size:13px;color:#666D80;"><?php echo e($asprakTerdistribusi ?? 0); ?> dari <?php echo e($totalAsprak ?? 0); ?> asprak sudah mendapat modul</div>
        ...
        <div style="margin-top:10px;display:flex;align-items:center;gap:6px;">
            ...
            <span style="font-size:11px;color:#956321;font-weight:500;"><?php echo e($asprakBelumModul); ?> asprak belum mendapat modul</span>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\koordinator\dashboard.blade.php ENDPATH**/ ?>
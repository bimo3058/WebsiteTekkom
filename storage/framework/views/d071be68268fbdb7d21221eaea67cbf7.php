    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-wrap {
            ...
            margin: 0 auto 24px; position: relative; color: #534ab7;
        }
        ...
        .icon-dot {
            ...
            width: 10px; height: 10px; background: #7c6bf8;
...
<?php /**PATH C:\WebsiteTekkom - Copy\resources\views\errors\404.blade.php ENDPATH**/ ?>
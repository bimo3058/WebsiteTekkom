...
<body>
    <div class="container">
        <div class="label">500 Server Error</div>
        <div class="icon-wrap">
            <svg viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>
            <span class="icon-dot"></span>
        </div>
        <h1>Kesalahan Server</h1>
        <p>Terjadi kesalahan pada server. Tim teknis sedang menangani masalah ini.</p>
        <div class="actions">
...
<?php /**PATH C:\WebsiteTekkom - Copy\resources\views\errors\500.blade.php ENDPATH**/ ?>
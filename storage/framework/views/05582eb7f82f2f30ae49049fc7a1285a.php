...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-ruangan.layout','data' => ['pageTitle' => 'Buku Tamu & Pengawasan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => 'Buku Tamu & Pengawasan']); ?>
        ...
        <div
            ...
            <div
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap; min-width:0;">
                    <form method="GET" action="<?php echo e(route('eoffice.peminjaman.admin.user.index')); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.user-avatar','data' => ['user' => $user,'size' => 'md','suspended' => $isSuspended]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user),'size' => 'md','suspended' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isSuspended)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                        <div style="min-width:0;">
                                            <div style="display:flex; align-items:center; gap:5px;">
                                                <p
                                                    style="font-size:13px; font-weight:600; color:<?php echo e($isSuspended ? '#DC2626' : 'var(--c-fg)'); ?>; <?php echo e($isSuspended ? 'text-decoration:line-through; text-decoration-color:#FCA5A5;' : ''); ?> white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:180px;">
                                            ...
                                            <p
                                                ...
                                                <?php echo e($user->nomor_induk ?? $user->email); ?>
                                ...
                                <td style="padding:14px 16px; text-align:center;">
                                    <div
                                        ...
                                        <?php echo e($bookingCounts[$user->id] ?? 0); ?>
                                ...
                                <td style="padding:12px 16px; text-align:center;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isSuspended): ?>
                                        <div style="display:inline-flex; align-items:center; padding:2px 8px; border-radius:999px; font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:0.05em; background:rgba(220, 38, 38, 0.1); color:#DC2626; border:1px solid rgba(220, 38, 38, 0.2);"
                                            title="<?php echo e($blacklists[$user->id]->alasan); ?>">
                                            <span
                                    ...
                                    <div style="position:relative; display:inline-block;" x-data="{ open: false }">
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                            ...
                                            <div style="padding:5px;">
                                                <button type="button"
                                                    @click="openHistory(<?php echo e($user->id); ?>, '<?php echo e(addslashes($user->name)); ?>'); open = false"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isSuspended): ?>
                                                    <form method="POST"
                                                        action="<?php echo e(route('eoffice.peminjaman.admin.user.toggleBlacklist', $user->id)); ?>"
                                                        style="display:block;">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit"
                                                ...
                                                <?php else: ?>
                                                    <button type="button"
                                                        @click="openSuspend(<?php echo e($user->id); ?>, '<?php echo e(addslashes($user->name)); ?>'); open = false"
            ...
            <?php else: ?>
                <div
                    ...
                    Menampilkan total <?php echo e($users->count()); ?> pengunjung
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('userManager', () => ({
                ...
                getSuspendUrl() {
                    ...
                    return "<?php echo e(route('eoffice.peminjaman.admin.user.toggleBlacklist', 'REPLACE_ID')); ?>".replace('REPLACE_ID', this.selectedId);
                }
            }))
        })
    </script>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-ruangan\admin\user\index.blade.php ENDPATH**/ ?>
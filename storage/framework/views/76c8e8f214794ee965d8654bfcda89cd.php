...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.dosen','data' => ['title' => 'Penilaian Seminar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Penilaian Seminar']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <?php $__env->stopSection(); ?>
                ...
                <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seminars->isEmpty()): ?>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-slate-200">
                                ...
                                <tbody class="bg-white divide-y divide-slate-100">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $seminars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <tr class="hover:bg-slate-50 transition-colors">
                                            <td class="px-5 py-4 whitespace-nowrap">
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        ...
                                                        <?php echo e(strtoupper(substr($sem->nama_mahasiswa ?? 'M', 0, 2))); ?>

                                                    </div>
                                                    <div>
                                                        <p class="text-sm font-medium text-slate-900">
                                                            <?php echo e($sem->nama_mahasiswa ?? 'Mahasiswa'); ?></p>
                                                        <p class="text-xs text-slate-500"><?php echo e($sem->nim); ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-5 py-4 whitespace-nowrap">
                                                <p class="text-sm font-semibold text-slate-900">
                                                    <?php echo e($sem->tanggal_seminar ? \Carbon\Carbon::parse($sem->tanggal_seminar)->format('d M Y') : '-'); ?>
                                                ...
                                                <p class="text-xs text-slate-500 mt-0.5">
                                                    ...
                                                    ?>
                                                    Jam:
                                                    <?php echo e($startTime ? \Carbon\Carbon::parse($startTime)->format('H:i') : '-'); ?> -
                                                    <?php echo e($endTime ? $endTime : '-'); ?>

                                                </p>
                                            </td>
                                            <td class="px-5 py-4 whitespace-nowrap">
                                                <span
                                                    class="text-sm text-slate-700"><?php echo e($sem->ruangan ?? 'Belum ditentukan'); ?></span>
                                            </td>
                                            <td class="px-5 py-4 whitespace-nowrap text-center">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sem->nilai_seminar_pembimbing !== null): ?>
                                                    <span
                                                        ...
                                                        @click="openDrawer(<?php echo e($sem->kp_id); ?>, '<?php echo e($sem->nama_mahasiswa); ?>', '<?php echo e($sem->nim); ?>', <?php echo e($sem->nilai_seminar_pembimbing); ?>)"
                                                        style="cursor: pointer;" title="Edit Nilai">
                                                        <?php echo e($sem->nilai_seminar_pembimbing); ?>

                                                    </span>
                                                <?php else: ?>
                                                    <button
                                                        @click="openDrawer(<?php echo e($sem->kp_id); ?>, '<?php echo e($sem->nama_mahasiswa); ?>', '<?php echo e($sem->nim); ?>', null)"
                                            ...
                                            <td class="px-5 py-4 whitespace-nowrap text-center">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sem->status_validasi_dosen == 'pending'): ?>
                                                    <div class="flex items-center justify-center gap-2">
                                                        <form
                                                            action="<?php echo e(route('eoffice.kp.dosen.penilaian_seminar.reject', $sem->kp_id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                        ...
                                                        <form
                                                            action="<?php echo e(route('eoffice.kp.dosen.penilaian_seminar.approve', $sem->kp_id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                ...
                                                <?php elseif($sem->status_validasi_dosen == 'approved'): ?>
                                                    <span
                                                ...
                                                <?php elseif($sem->status_validasi_dosen == 'rejected'): ?>
                                                    <span
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\dosen\penilaian_seminar.blade.php ENDPATH**/ ?>
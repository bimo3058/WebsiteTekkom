...
<aside data-mobile-sidebar :class="sidebarOpen ? 'w-[240px]' : 'w-[64px]'"
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden p-[6px_10px_10px] flex flex-col gap-[1px] scrollbar-thin scrollbar-thumb-[#DFE1E7] scrollbar-track-transparent">
        ...
        <?php $isDashboard = request()->routeIs('banksoal.dashboard') && auth()->user()->hasRole('dosen'); ?>
        ...
        <?php $isRps = request()->routeIs('banksoal.rps.dosen.*'); ?>
        <a href="<?php echo e(route('banksoal.rps.dosen.index')); ?>" class="relative flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] mt-[1px] transition-colors <?php echo e($isRps ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRps): ?>
                <span class="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-[20px] bg-[#0B266E] rounded-r-[3px]" x-show="sidebarOpen"></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <svg class="w-4 h-4 flex-shrink-0 <?php echo e($isRps ? 'text-[#0B266E]' : 'text-[#666D80]'); ?>" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconRps); ?>"/></svg>
            <span x-show="sidebarOpen" class="flex-1 whitespace-nowrap overflow-hidden text-ellipsis leading-tight">Manajemen RPS</span>
        </a>

        <?php $isSoal = request()->routeIs('banksoal.soal.dosen.*'); ?>
        <a href="<?php echo e(route('banksoal.soal.dosen.index')); ?>" class="relative flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] mt-[1px] transition-colors <?php echo e($isSoal ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isSoal): ?>
                <span class="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-[20px] bg-[#0B266E] rounded-r-[3px]" x-show="sidebarOpen"></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <svg class="w-4 h-4 flex-shrink-0 <?php echo e($isSoal ? 'text-[#0B266E]' : 'text-[#666D80]'); ?>" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconSoal); ?>"/></svg>
            <span x-show="sidebarOpen" class="flex-1 whitespace-nowrap overflow-hidden text-ellipsis leading-tight">Bank Soal</span>
        </a>

        <?php $isArsip = request()->routeIs('banksoal.arsip.dosen.*'); ?>
        <a href="<?php echo e(route('banksoal.arsip.dosen.index')); ?>" class="relative flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] mt-[1px] transition-colors <?php echo e($isArsip ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isArsip): ?>
                <span class="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-[20px] bg-[#0B266E] rounded-r-[3px]" x-show="sidebarOpen"></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <svg class="w-4 h-4 flex-shrink-0 <?php echo e($isArsip ? 'text-[#0B266E]' : 'text-[#666D80]'); ?>" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconArsip); ?>"/></svg>
            <span x-show="sidebarOpen" class="flex-1 whitespace-nowrap overflow-hidden text-ellipsis leading-tight">Arsip Soal</span>
        </a>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('gpm')): ?>
            ...
            <a href="<?php echo e(route('banksoal.switch-role', 'gpm')); ?>" class="relative flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] mt-[1px] transition-colors text-[#353849] font-medium hover:bg-[#F6F8FA]" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\components\ui\sidebar-dosen.blade.php ENDPATH**/ ?>
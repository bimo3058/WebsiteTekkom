...
<span <?php echo e($attributes->merge(['style' => "font-size:{$fontSize}; font-weight:{$fontWeight}; color:{$st['color']}; background:{$st['bg']}; border:1px solid {$st['border']}; padding:{$padding}; border-radius:9999px; white-space:nowrap; letter-spacing:0.02em; text-transform:uppercase; display:inline-block;"])); ?>>
    <?php echo e($label); ?>

</span>
<?php /**PATH C:\WebsiteTekkom - Copy\resources\views\components\ui\role-badge.blade.php ENDPATH**/ ?>
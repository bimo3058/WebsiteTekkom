...
<div style="margin-bottom:24px;">
    <a href="<?php echo e(route('manajemenmahasiswa.verifikasi.index', ['tab' => 'prestasi'])); ?>" class="back-link">
...
<div class="aturan-card">
    <div class="aturan-head">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canManageRewardAturan): ?>
    ...
    <div id="aturanUploadWrap" class="aturan-upload">
        <form method="POST" action="<?php echo e(route('manajemenmahasiswa.verifikasi.aturan.store')); ?>" enctype="multipart/form-data" class="aturan-form">
            <?php echo csrf_field(); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rewardAturan->count()): ?>
        <div class="aturan-list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rewardAturan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="aturan-row">
                    <span class="aturan-ico <?php echo e($a->isImage() ? 'img' : 'pdf'); ?>"><?php echo e($a->isImage() ? 'IMG' : 'PDF'); ?></span>
                    <div class="aturan-row-meta">
                        <span class="aturan-row-judul"><?php echo e($a->judul); ?></span>
                        <span class="aturan-row-file"><?php echo e($a->nama_file); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($a->uploadedBy): ?> • oleh <?php echo e($a->uploadedBy->name); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></span>
                    </div>
                    <a href="<?php echo e($a->public_url); ?>" target="_blank" rel="noopener" class="aturan-act lihat">Lihat ↗</a>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canManageRewardAturan): ?>
                        <form method="POST" action="<?php echo e(route('manajemenmahasiswa.verifikasi.aturan.destroy', $a->id)); ?>" onsubmit="return confirm('Hapus dokumen aturan ini?');" style="margin:0;">
...
<div class="admin-stats">
    <a href="<?php echo e(route('manajemenmahasiswa.verifikasi.reward.index', array_merge(request()->only(['search','angkatan']), ['reward' => 'menunggu']))); ?>"
       class="admin-stat-card pending <?php echo e($reward === 'menunggu' ? 'active' : ''); ?>">
        <div class="stat-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
        </div>
        <div>
            <div class="stat-num"><?php echo e($rewardStats['menunggu']); ?></div>
            <div class="stat-lbl">Menunggu</div>
        </div>
    </a>
    <a href="<?php echo e(route('manajemenmahasiswa.verifikasi.reward.index', array_merge(request()->only(['search','angkatan']), ['reward' => 'disetujui']))); ?>"
       class="admin-stat-card approved <?php echo e($reward === 'disetujui' ? 'active' : ''); ?>">
        <div class="stat-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
        </div>
        <div>
            <div class="stat-num"><?php echo e($rewardStats['disetujui']); ?></div>
            <div class="stat-lbl">Disetujui</div>
        </div>
    </a>
    <a href="<?php echo e(route('manajemenmahasiswa.verifikasi.reward.index', array_merge(request()->only(['search','angkatan']), ['reward' => 'ditolak']))); ?>"
       class="admin-stat-card rejected <?php echo e($reward === 'ditolak' ? 'active' : ''); ?>">
        <div class="stat-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
        </div>
        <div>
            <div class="stat-num"><?php echo e($rewardStats['ditolak']); ?></div>
...
<!-- Filter Area -->
<form method="GET" action="<?php echo e(route('manajemenmahasiswa.verifikasi.reward.index')); ?>" id="filterForm">
    <input type="hidden" name="reward" value="<?php echo e($reward); ?>">
    <div class="d-flex flex-column flex-md-row gap-3 justify-content-between align-items-center mb-3">
        <div class="search-wrapper w-100 me-0 me-md-2">
            ...
            <input type="text" name="search" class="form-control search-input w-100" placeholder="Cari nama / NIM mahasiswa..." value="<?php echo e(request('search')); ?>">
        </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rewardData->count() > 0): ?>
    <div class="form-card p-0" style="overflow-x: auto;">
        <table class="verif-table">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rewardData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    ?>
                    <tr>
                        <td style="color: #666D80;"><?php echo e(($rewardData->currentPage() - 1) * $rewardData->perPage() + $i + 1); ?></td>
                        <td style="font-weight: 600;"><?php echo e($p->kemahasiswaan->nama ?? '-'); ?></td>
                        <td style="font-family: monospace; font-size: 13px; color: #0B266E;"><?php echo e($p->kemahasiswaan->nim ?? '-'); ?></td>
                        <td style="font-weight: 600;"><?php echo e($p->nama_prestasi); ?></td>
                        <td><span class="tingkat-badge <?php echo e($p->tingkat); ?>"><?php echo e(ucfirst($p->tingkat)); ?></span></td>
                        <td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->reward_status === $P::CLAIM_DISETUJUI): ?>
                                <span class="claim-badge disetujui">Disetujui</span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->reward_reviewed_at): ?><div class="reward-mini"><?php echo e($p->reward_reviewed_at->translatedFormat('d M Y')); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php elseif($p->reward_status === $P::CLAIM_DIAJUKAN): ?>
                                <span class="claim-badge diajukan">Menunggu</span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->claimed_at): ?><div class="reward-mini"><?php echo e($p->claimed_at->translatedFormat('d M Y')); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->reward_status === $P::CLAIM_DIAJUKAN): ?>
                                <button type="button" class="btn-tinjau" onclick="openTinjauReward(<?php echo \Illuminate\Support\Js::from([
                                    "id"             => $p->id,
                            ...
                            <?php else: ?>
                                <div class="d-flex gap-1 flex-wrap">
                                    <button type="button" class="btn-detail" onclick="openDetailReward(<?php echo \Illuminate\Support\Js::from([
                                        "nama"           => $p->nama_prestasi,
                                        "mahasiswa"      => $p->kemahasiswaan->nama ?? "-",
                                        "nim"            => $p->kemahasiswaan->nim ?? "-",
                                        "penyelenggara"  => $p->reward_penyelenggara_label,
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->reward_status === $P::CLAIM_DISETUJUI): ?>
                                        <button type="button" class="btn-batal-reward"
                                                onclick="openBatalReward(<?php echo \Illuminate\Support\Js::from($p->id)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($p->nama_prestasi)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($p->kemahasiswaan->nama ?? '-')->toHtml() ?>)">Batalkan</button>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
    ...
    <div class="mt-3"><?php echo e($rewardData->appends(request()->query())->links()); ?></div>
<?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\verifikasi\reward.blade.php ENDPATH**/ ?>
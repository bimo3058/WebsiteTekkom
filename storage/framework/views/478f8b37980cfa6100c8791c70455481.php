...
<div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap; min-width:0;">
    <form method="GET" action="<?php echo e(route('banksoal.periode.jadwal')); ?>" id="searchForm" style="display:flex; align-items:center; gap:8px; margin:0;">
        ...
        <div class="relative inline-block" x-data="{ open: false }">
            <button type="button" @click="open = !open" @click.outside="open = false"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPeriodeId): ?>
            ...
            <div x-show="open" x-cloak
                ...
                <div class="p-1.5">
                    ...
                    <button type="button" @click="document.getElementById('hiddenPeriodeId').value = '<?php echo e($periode->id); ?>'; document.getElementById('searchForm').submit();"
                    class="block w-full text-left px-2.5 py-1.5 rounded-lg text-[11px] transition-colors"
                    style="font-weight:<?php echo e($selectedPeriodeId == $periode->id ? '700' : '500'); ?>; color:<?php echo e($selectedPeriodeId == $periode->id ? 'var(--c-primary)' : 'var(--c-fg-sec)'); ?>; text-decoration:none; background:<?php echo e($selectedPeriodeId == $periode->id ? 'rgba(94,83,244,0.06)' : 'transparent'); ?>;"
                    onmouseover="if('<?php echo e($selectedPeriodeId); ?>' != '<?php echo e($periode->id); ?>') this.style.background='var(--c-bg)'" onmouseout="if('<?php echo e($selectedPeriodeId); ?>' != '<?php echo e($periode->id); ?>') this.style.background='transparent'">
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\jadwal\_search_filter.blade.php ENDPATH**/ ?>
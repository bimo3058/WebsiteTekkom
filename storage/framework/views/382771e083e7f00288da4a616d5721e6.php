...
<?php endif; ?>
    ...
    <div class="method-cards">
        <div class="method-card <?php echo e($creationMethod === 'upload' ? 'active' : ''); ?>" data-method="upload">
            <input type="radio" name="creation_method_trigger" value="upload" <?php echo e($creationMethod === 'upload' ? 'checked' : ''); ?>>
        ...
        <div class="method-card <?php echo e($creationMethod === 'generator' ? 'active' : ''); ?>" data-method="generator">
            <input type="radio" name="creation_method_trigger" value="generator" <?php echo e($creationMethod === 'generator' ? 'checked' : ''); ?>>
    ...
    <!-- MAIN FORM -->
    <form action="<?php echo e(route('banksoal.rps.dosen.store')); ?>" method="POST" enctype="multipart/form-data" id="rpsSubmitForm"
                ...
                <div class="form-group">
                    ...
                    <select name="mata_kuliah_id" id="mkSelect" class="field-control" required>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mataKuliahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($mk->id); ?>" <?php echo e(old('mata_kuliah_id') == $mk->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="tahun_ajaran" value="<?php echo e($academicYear); ?>">
                </div>
            </div>
        </div>
                        ...
                        <div class="cpmk-row" data-cpmk-row data-row-index="0">
                            ...
                            <div>
                                <select name="cpmk_rows[0][kko]" class="field-control kko-select-input" style="font-size:13px;" required>
                                    ...
                                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'banksoal::components.ui.upload-zone','data' => ['name' => 'dokumen','inputId' => 'fileInput','accept' => '.pdf','maxLabel' => 'PDF (Maks. 5MB)','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'dokumen','inputId' => 'fileInput','accept' => '.pdf','maxLabel' => 'PDF (Maks. 5MB)','required' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function restoreCache(mkId) {
                return fetch("<?php echo e(route('banksoal.rps.dosen.get-wizard-cache', ['mkId' => 'PLACEHOLDER'])); ?>".replace('PLACEHOLDER', mkId))
                    .then(res => res.json())
                    .then(res => {
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\rps\Dosen\create.blade.php ENDPATH**/ ?>
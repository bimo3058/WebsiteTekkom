...
<div id="suspendedBulkBar"
    ...
    <div style="display:flex; align-items:center; gap:10px;">
        <button onclick="openBulkUnsuspendModal()"
            ...
            <img src="<?php echo e(asset('images/icons/unlocked-01.svg')); ?>" width="12" height="12"
...
<div class="audit-cards-grid" style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
    ...
    <div style="background:#fff; border:1px solid var(--c-border); border-radius:12px; overflow:hidden; box-shadow:0 1px 3px rgba(0,0,0,.04); display:flex; flex-direction:column;">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; padding:14px 16px; border-bottom:1px solid var(--c-border); background:#FAFAFA;">
            ...
            <a href="<?php echo e(route('superadmin.users.online')); ?>"
        ...
        <div style="overflow-x:auto;">
            <table style="width:100%; border-collapse:collapse; min-width:380px;">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $onlineUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $onlineUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    <tr style="border-bottom:1px solid #F3F4F6; transition:background .12s;"
                        ...
                        <td style="padding:14px 16px; width:44px;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isSA): ?>
                            <input type="checkbox"
                                   class="online-checkbox"
                                   value="<?php echo e($onlineUser->id); ?>"
                                   style="width:15px; height:15px; border-radius:4px; cursor:pointer; accent-color:var(--c-primary);">
                            <?php else: ?>
                        ...
                        <td style="padding:14px 12px; font-size:13px; font-weight:400; color:var(--c-fg-muted); width:40px;"><?php echo e($idx + 1); ?></td>

                        
                        <td style="padding:14px 16px;">
                            <div style="display:flex; align-items:center; gap:10px;">
                                <div style="position:relative; flex-shrink:0;">
                                    <div style="width:32px; height:32px; border-radius:50%; background:<?php echo e($isSA ? 'rgba(11,38,110,0.07)' : '#F3F4F6'); ?>; color:<?php echo e($isSA ? '#0B266E' : '#6B7280'); ?>; display:flex; align-items:center; justify-content:center; overflow:hidden; font-size:11px; font-weight:700; border:1.5px solid <?php echo e($isSA ? 'rgba(11,38,110,0.15)' : '#E5E7EB'); ?>;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($onlineUser->avatar_url): ?>
                                            <img src="<?php echo e($onlineUser->avatar_url); ?>" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
                                        <?php elseif($isSA): ?>
                                ...
                                <div style="min-width:0;">
                                    <p style="font-size:13px; font-weight:600; color:var(--c-fg); overflow:hidden; text-overflow:ellipsis; white-space:nowrap; max-width:130px; margin:0;"><?php echo e($onlineUser->name); ?></p>
                                    <p style="font-size:11px; color:var(--c-fg-muted); margin:1px 0 0 0;"><?php echo e(ucfirst($onlineUser->roles->first()->name ?? 'User')); ?></p>
                                </div>
                            </div>
                        </td>
                            ...
                            <div style="position:relative; display:inline-block;" x-data="{ open: false }">
                                ...
                                <div x-show="open"
                                    ...
                                    <div style="padding:5px;">
                                        ...
                                        <button type="button"
                                                onclick="openForceLogoutModal({ id: '<?php echo e($onlineUser->id); ?>', name: '<?php echo e(addslashes($onlineUser->name)); ?>' })"
                                        ...
                                        <button type="button"
                                                onclick="openSuspendModal({ id: '<?php echo e($onlineUser->id); ?>', name: '<?php echo e(addslashes($onlineUser->name)); ?>' })"
    ...
    <div style="background:#fff; border:1px solid var(--c-border); border-radius:12px; overflow:hidden; box-shadow:0 1px 3px rgba(0,0,0,.04); display:flex; flex-direction:column;">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; padding:14px 16px; border-bottom:1px solid var(--c-border); background:#FAFAFA;">
            ...
            <a href="<?php echo e(route('superadmin.users.suspended')); ?>"
        ...
        <div style="overflow-x:auto;">
            <table style="width:100%; border-collapse:collapse; min-width:380px;">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $suspendedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $su): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    <tr style="border-bottom:1px solid #F3F4F6; background:#FFF9F9; transition:background .12s;"
                            ...
                            <div style="display:flex; align-items:center; gap:10px;">
                                <div style="flex-shrink:0;">
                                    <div style="width:32px; height:32px; border-radius:50%; background:#FEF2F2; color:#DC2626; display:flex; align-items:center; justify-content:center; overflow:hidden; font-size:11px; font-weight:700; border:1.5px solid #FECACA; opacity:0.8;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($su->avatar_url): ?>
                                            <img src="<?php echo e($su->avatar_url); ?>" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
                                        <?php else: ?>
                                            <?php echo e($initials2); ?>

                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                                <div style="min-width:0;">
                                    <p style="font-size:13px; font-weight:600; color:#DC2626; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; max-width:130px; margin:0; text-decoration:line-through; text-decoration-color:#FECACA;"><?php echo e($su->name); ?></p>
                                    <p style="font-size:11px; color:var(--c-error); font-style:italic; margin:1px 0 0 0; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; max-width:130px;"><?php echo e($su->suspension_reason ?? 'Policy Violation'); ?></p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td style="padding:14px 16px; text-align:center;">
                            <form method="POST" action="<?php echo e(route('superadmin.users.unsuspend', $su)); ?>" style="margin:0; display:inline;">
                                <?php echo csrf_field(); ?>
                                <button type="submit" title="Unsuspend"
                                        ...
                                        onmouseout="this.style.background='#fff'; this.style.borderColor='var(--c-border)';">
                                    <img src="<?php echo e(asset('images/icons/unlocked-01.svg')); ?>" width="13" height="13"
                        ...
                        <td colspan="5" style="padding:32px 16px; text-align:center;">
                            <div style="display:flex; flex-direction:column; align-items:center; gap:8px;">
                                <div style="width:36px; height:36px; border-radius:50%; background:#FEF2F2; display:flex; align-items:center; justify-content:center;">
                                    <img src="<?php echo e(asset('images/icons/locked-01.svg')); ?>" width="16" height="16"
...
<div id="modalBulkForceLogout"
    ...
    <div style="background:#fff; border-radius:16px; padding:28px; width:100%; max-width:400px; box-shadow:0 20px 60px rgba(0,0,0,.2); margin:16px;">
        ...
        <form id="formBulkForceLogout" method="POST" action="<?php echo e(route('superadmin.users.bulk-force-logout')); ?>">
            <?php echo csrf_field(); ?>
    ...
    <div style="background:#fff; border-radius:16px; padding:28px; width:100%; max-width:400px; box-shadow:0 20px 60px rgba(0,0,0,.2); margin:16px;">
        <div style="display:flex; align-items:flex-start; gap:14px; margin-bottom:20px;">
            <div style="width:40px; height:40px; border-radius:10px; background:#ECFDF5; border:1px solid #A7F3D0; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                <img src="<?php echo e(asset('images/icons/unlocked-01.svg')); ?>" width="18" height="18"
        ...
        <form id="formBulkUnsuspend" method="POST" action="<?php echo e(route('superadmin.users.bulk-unsuspend')); ?>">
            <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\audit-logs\_cards.blade.php ENDPATH**/ ?>
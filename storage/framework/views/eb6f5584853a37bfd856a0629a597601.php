...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    ">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pendaftar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr style="border-bottom:1px solid #F1F1F3;" class="hover:bg-[#F8F5FF] transition-colors">
                            <td style="padding:8px 12px;">
                                <div class="flex flex-col">
                                    <span
                                        ...
                                        <?php echo e(optional(optional($kp->mahasiswa)->user)->name ?? 'Nama Tidak Ditemukan'); ?>

                                    </span>
                                    <span
                                        style="font-family:'Inter Tight',sans-serif; font-size:11px; color:#666D80; margin-top:2px;">
                                        NIM: <?php echo e($kp->nim ?? '-'); ?>
                            ...
                            <td
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kp->dosenPembimbing): ?>
                                    <div class="flex flex-col">
                                        <span style="font-weight:500; color:#0D0D12;">
                                            <?php echo e(optional($kp->dosenPembimbing->user)->name ?? '-'); ?>
                            ...
                            <td style="padding:8px 12px;">
                                <span style="
                                    ...
                                    <?php echo e($kp->status_kp ?? 'Terdaftar'); ?>

                                </span>
                            </td>
                            <td style="padding:8px 12px;">
                                <form action="<?php echo e(route('eoffice.kp.koordinator.pendaftar.destroy', $kp->id)); ?>"
                                    method="POST"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendaftar->hasPages()): ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\pendaftar\index.blade.php ENDPATH**/ ?>
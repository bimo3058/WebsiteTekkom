...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'banksoal::components.ui.page-header','data' => ['title' => 'Atur Periode Pengajuan','subtitle' => 'Konfigurasi jadwal pengajuan RPS dan template dokumen untuk dosen']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Atur Periode Pengajuan','subtitle' => 'Konfigurasi jadwal pengajuan RPS dan template dokumen untuk dosen']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

             <?php $__env->slot('actions', null, []); ?> 
                <a href="<?php echo e(route('banksoal.rps.gpm.validasi-rps')); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-600 hover:bg-slate-50 transition-colors">
                            ...
                            <div>
                                ...
                                <select name="tahun_ajaran" x-model="formData.tahun_ajaran" disabled required class="w-full rounded-2xl border border-slate-200 bg-slate-100 text-slate-500 cursor-not-allowed px-5 py-3.5 text-sm focus:border-navy focus:ring-4 focus:ring-navy/5 outline-none transition-all appearance-none bg-no-repeat bg-[right_1.25rem_center] bg-[length:1rem]" style="background-image: url('data:image/svg+xml;charset=utf-8,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 fill=%22none%22 viewBox=%220 0 20 20%22%3E%3Cpath stroke=%22%2394a3b8%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22 stroke-width=%221.5%22 d=%22m6 8 4 4 4-4%22/%3E%3C/svg%3E')">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tahunAjarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <option value="<?php echo e($ta); ?>"><?php echo e($ta); ?></option>
    ...
    <script>
        function periodeWizard() {
            return {
                ...
                formData: {
                    judul: '<?php echo e(old('judul')); ?>',
                    semester: '<?php echo e(old('semester', $currentSemester)); ?>',
                    tahun_ajaran: '<?php echo e(old('tahun_ajaran', $currentTahunAjaran)); ?>',
                    tanggal_mulai: '<?php echo e(old('tanggal_mulai')); ?>',
                    tanggal_selesai: '<?php echo e(old('tanggal_selesai')); ?>',
                    is_active: true
                },
                ...
                async submitStep1() {
                    this.loading = true;
                    try {
                        const response = await fetch("<?php echo e(route('banksoal.rps.gpm.periode-rps.store')); ?>", {
                            method: 'POST',
                            headers: {
                ...
                async submitStep2() {
                    ...
                    try {
                        const response = await fetch("<?php echo e(route('banksoal.rps.gpm.template.store')); ?>", {
                            method: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                                'Accept': 'application/json'
                        ...
                        const data = await response.json();
                        if (response.ok) {
                            window.location.href = "<?php echo e(route('banksoal.rps.gpm.validasi-rps')); ?>?success=Periode dan Template berhasil disimpan.";
                        } else {
                ...
                skipTemplate() {
                    window.location.href = "<?php echo e(route('banksoal.rps.gpm.validasi-rps')); ?>?success=Periode berhasil dibuat tanpa template baru.";
                }
            }
        }
    </script>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\gpm\periode-rps\create.blade.php ENDPATH**/ ?>
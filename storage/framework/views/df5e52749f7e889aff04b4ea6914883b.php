...
>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
        <div x-init="addToast({ type: 'success', message: '<?php echo e(addslashes(session('success'))); ?>' })"></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
        <div x-init="addToast({ type: 'error', message: '<?php echo e(addslashes(session('error'))); ?>' })"></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->getBag('default')->any() && !View::hasSection('hide_global_errors')): ?>
        <div x-init="addToast({ type: 'error', message: '<?php echo e(addslashes($errors->getBag('default')->first())); ?>' })"></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('warning')): ?>
        <div x-init="addToast({ type: 'warning', message: '<?php echo e(addslashes(session('warning'))); ?>' })"></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('info')): ?>
        <div x-init="addToast({ type: 'info', message: '<?php echo e(addslashes(session('info'))); ?>' })"></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('toast')): ?>
        <div x-init="addToast(<?php echo e(json_encode(session('toast'))); ?>)"></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <template x-for="toast in toasts" :key="toast.id">
        <div 
            ...
            :class="{
                'border-emerald-100 shadow-emerald-500/10 border-t-4 border-t-emerald-500': toast.type === 'success',
                'border-rose-100 shadow-rose-500/10 border-t-4 border-t-rose-500': toast.type === 'error',
                'border-amber-100 shadow-amber-500/10 border-t-4 border-t-amber-500': toast.type === 'warning',
                'border-primary/20 shadow-primary/10 border-t-4 border-t-blue-500': toast.type === 'info'
            }"
        >
            <!-- Progress Bar Atas -->
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\components\global-toast.blade.php ENDPATH**/ ?>
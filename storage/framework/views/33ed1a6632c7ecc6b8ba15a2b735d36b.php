    ...
    <div class="flex flex-col items-center w-full px-4 py-6 min-h-screen justify-between">
        ...
        <div class="w-full">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any()): ?>
                <div class="mb-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl flex items-start gap-2">
                    ...
                    <p class="text-xs text-red-600 dark:text-red-400 font-medium"><?php echo e($errors->first()); ?></p>
                </div>
            ...
            <div class="mb-4">
                ...
                <a href="<?php echo e(route('microsoft.redirect')); ?>"
        ...
        <div class="mt-6 text-center">
            <p class="text-[10px] text-slate-400 dark:text-slate-500 font-medium">
                © <?php echo e(date('Y')); ?> Teknik Komunikasi • Universitas Diponegoro
            </p>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\auth\login-mobile.blade.php ENDPATH**/ ?>
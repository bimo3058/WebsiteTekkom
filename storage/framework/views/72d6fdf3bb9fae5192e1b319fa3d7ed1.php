...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="stat-grid">
        ...
        <div class="stat-card">
            ...
            <div>
                <div class="stat-value"><?php echo e($totalAll); ?></div>
    ...
    <div class="rv-tabs">
        ...
        ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <a href="<?php echo e(route('manajemenmahasiswa.pengumuman.riwayat.verifikasi', ['status' => $value])); ?>"
               class="rv-tab <?php echo e($statusFilter === $value ? 'active' : ''); ?>">
                <?php echo e($tab['label']); ?>

                <span class="tab-badge"><?php echo e($tab['count']); ?></span>
            </a>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        ...
        ?>
        <div class="request-card <?php echo e($statusClass); ?>">
            <div class="request-header">
                <div style="min-width:0; flex:1;">
                    <div class="request-title">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentlyProcessed): ?>
                            <span style="display:inline-flex;align-items:center;padding:2px 8px;border-radius:50px;font-size:10px;font-weight:800;letter-spacing:.04em;margin-left:6px;vertical-align:middle;<?php echo e($req->status === 'approved' ? 'background:#dcfce7;color:#15803d;' : 'background:#fee2e2;color:#dc2626;'); ?>">
                                <?php echo e($req->status === 'approved' ? '✓ BARU DISETUJUI' : '✗ BARU DITOLAK'); ?>
                    ...
                    <div class="request-meta">
                        <span class="request-meta-item">
                            ...
                            Verifikator: <strong><?php echo e($req->verifier?->name ?? 'N/A'); ?></strong>
                        </span>
                        <span class="request-meta-item">
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>
                            </svg>
                            Diajukan <?php echo e($req->created_at->diffForHumans()); ?>

                        </span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->verified_at): ?>
                            <span class="request-meta-item">
                                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                                    <polyline points="22 4 12 14.01 9 11.01"/>
                                </svg>
                                Diproses <?php echo e($req->verified_at->diffForHumans()); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->catatan_verifikator): ?>
                <div class="info-box <?php echo e($req->status === 'approved' ? 'info-box-catatan-approved' : 'info-box-catatan-rejected'); ?>">
                    <div class="info-box-label">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->status === 'approved'): ?>
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>
                            </svg>
                            Catatan persetujuan dari <?php echo e($req->verifier?->name ?? 'verifikator'); ?>:
                        <?php else: ?>
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10"/>
                                <line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/>
                            </svg>
                            Alasan penolakan dari <?php echo e($req->verifier?->name ?? 'verifikator'); ?>

                            <span style="font-size:.72rem;font-weight:400;opacity:.7;">(pengajuan ini)</span>:
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <?php echo e($req->catatan_verifikator); ?>
            ...
            <div class="request-footer">
                <span class="footer-hint">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->status === 'pending'): ?>
                        Menunggu persetujuan dari <strong><?php echo e($req->verifier?->name ?? 'verifikator'); ?></strong>
                ...
                <div class="d-flex gap-2 align-items-center flex-wrap">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($req->status, ['rejected', 'cancelled']) && !$req->pengumuman): ?>
                        <span style="font-size:.82rem;color:#9ca3af;font-style:italic;">
                            Pengumuman telah dihapus — tidak dapat diajukan ulang
                        </span>
                    <?php elseif(in_array($req->status, ['rejected', 'cancelled']) && $req->pengumuman): ?>
                        
                        <a href="<?php echo e(route('manajemenmahasiswa.pengumuman.edit', $req->pengumuman_id)); ?>"
                        ...
                        <form action="<?php echo e(route('manajemenmahasiswa.pengumuman.publish', $req->pengumuman_id)); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->status === 'pending' && $req->pengumuman): ?>
                        <form action="<?php echo e(route('manajemenmahasiswa.pengumuman.verification.cancel', $req->pengumuman_id)); ?>"
                            method="POST"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        <div class="empty-state">
            ...
            <p>
                ...
                <?php elseif($statusFilter === 'pending'): ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\pengumuman\pengumuman-riwayat-verifikasi.blade.php ENDPATH**/ ?>
<div class="text-center py-8 animate-fade-in">
    ...
    <div class="flex items-center justify-center gap-4">
        <a href="<?php echo e(route('profile.cv.preview')); ?>" target="_blank" 
           class="btn-secondary text-sm">
            <span class="material-symbols-outlined text-[18px]">visibility</span>
            Preview CV
        </a>
        
        <a href="<?php echo e(route('profile.cv.generate')); ?>" target="_blank"
...
<?php /**PATH C:\WebsiteTekkom - Copy\resources\views\profile\cv\steps\step-6.blade.php ENDPATH**/ ?>
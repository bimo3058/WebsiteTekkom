...
<div class="mp-page-header">
    <div>
        ...
        <p class="mp-page-sub">Review dan seleksi calon asisten praktikum untuk praktikum yang Anda koordinatori · <?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?></p>
    </div>
</div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-praktikum.ui.select','data' => ['name' => 'status','options' => [
                ...
                ],'selected' => request('status', ''),'placeholder' => 'Semua Status','onChange' => '$event.target.form.submit()','minWidth' => '160px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['name' => 'status','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                    ...
                    ['value' => 'approved', 'label' => 'Disetujui'],
                    ['value' => 'rejected', 'label' => 'Ditolak']
                ]),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request('status', '')),'placeholder' => 'Semua Status','onChange' => '$event.target.form.submit()','minWidth' => '160px']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <tbody>
                ...
                <tr class="mp-tr" style="border-bottom:1px solid #DFE1E7;">
                    ...
                    <td style="padding:12px 16px;">
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$p->cv_path && !$p->transkrip_path && !$p->berkas_cerc_path): ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup_kode\koordinator\pendaftaran-asprak.blade.php ENDPATH**/ ?>
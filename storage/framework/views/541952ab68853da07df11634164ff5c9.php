...
<div id="daftar-praktikum" class="mp-card mt-2">
    ...
    <div class="p-4 border-b border-[#DFE1E7] bg-white flex gap-4 justify-between items-center flex-wrap">
        <form id="filter_praktikum_form" method="GET" action="<?php echo e(url()->current()); ?>#daftar-praktikum" class="flex flex-wrap gap-3 items-center flex-1 min-w-0">
            <div class="relative flex-1 min-w-[200px]">
                ...
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama praktikum..." class="w-full pl-9 pr-3 h-[38px] text-[13px] border border-[#DFE1E7] rounded-[8px] focus:outline-none focus:border-[#0B266E]" onchange="this.form.submit()">
            </div>
...
<?php endif; ?>
            ...
            <input type="text" name="tahun_ajaran" value="<?php echo e(request('tahun_ajaran')); ?>" placeholder="Tahun Ajaran (Contoh: 2025/2026)" class="w-56 h-[38px] px-3 text-[13px] border border-[#DFE1E7] rounded-[8px] focus:outline-none focus:border-[#0B266E]" onchange="this.form.submit()">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->anyFilled(['search', 'status', 'semester', 'tahun_ajaran'])): ?>
                <a href="<?php echo e(route('eoffice.manprak.admin.praktikum.index')); ?>" class="mp-btn secondary md px-4 h-[38px] flex items-center justify-center">Reset</a>
    ...
    <div class="mp-card-body p-0 overflow-x-auto">
        ...
        <div class="flex flex-col">
            ...
            <div class="grid gap-4 px-5 py-4 border-b border-[#F6F8FA] hover:bg-[#FAFAFA] transition-colors items-center cursor-pointer" style="grid-template-columns: minmax(220px, 1.5fr) minmax(320px, 2fr) minmax(250px, 1.5fr) 90px 100px 90px;" onclick="window.location='<?php echo e(route('eoffice.manprak.admin.praktikum.detail', $p->id)); ?>'">
                <div class="min-w-0">
                    <div class="text-[13px] font-semibold text-[#0D0D12] whitespace-nowrap"><?php echo e($p->nama); ?></div>
                    <div class="text-[11px] text-[#666D80] mt-1"><?php echo e($p->tahun_ajaran); ?> / Semester <?php echo e($p->semester); ?></div>
                </div>
                <div class="flex flex-col gap-1.5 w-full items-start">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $p->dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <div class="flex items-center justify-start gap-2 pr-3 w-full">
                            <div class="mp-av <?php echo e($avColor); ?> flex-shrink-0" style="min-width: 28px; min-height: 28px; max-width: 28px; max-height: 28px; font-size: 10px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                                ...
                                <img src="<?php echo e($dosen->avatar_url); ?>" alt="" style="width:100%; height:100%; object-fit:cover; border-radius:50%;">
                                <?php else: ?>
                                <?php echo e($ini); ?>

                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="text-[13px] font-medium text-[#353849] whitespace-nowrap" title="<?php echo e($dosen->name); ?>"><?php echo e($dosen->name); ?></div>
                        </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->koordinator): ?>
                        ...
                        <div class="flex items-center justify-start gap-2 pr-3 w-full">
                            <div class="mp-av <?php echo e($avColor); ?> flex-shrink-0" style="min-width: 28px; min-height: 28px; max-width: 28px; max-height: 28px; font-size: 10px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                                ...
                                <img src="<?php echo e($p->koordinator->avatar_url); ?>" alt="" style="width:100%; height:100%; object-fit:cover; border-radius:50%;">
                                <?php else: ?>
                                <?php echo e($ini); ?>

                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="text-[13px] font-medium text-[#353849] whitespace-nowrap" title="<?php echo e($p->koordinator->name); ?>"><?php echo e($p->koordinator->name); ?></div>
                        </div>
                    <?php else: ?>
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; padding:12px 20px; border-top:1px solid var(--c-border);">
        <div style="display:flex; align-items:center; gap:12px;">
            ...
            <div style="font-size:13px; color:var(--c-fg-sec);">Menampilkan <?php echo e($praktikums->firstItem() ?? 0); ?> sampai <?php echo e($praktikums->lastItem() ?? 0); ?> dari <?php echo e($praktikums->total()); ?> data</div>
        </div>
        ...
        <div style="display:flex; gap:4px;">
            ...
            <?php else: ?>
                <a href="<?php echo e($praktikums->previousPageUrl()); ?>#daftar-praktikum" style="width:32px; height:32px; border:1px solid var(--c-border); background:#fff; border-radius:6px; display:flex; align-items:center; justify-content:center; cursor:pointer; color:var(--c-fg); text-decoration:none;">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="15 18 9 12 15 6"/></svg>
                </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = $start; $i <= $end; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($praktikums->url($i)); ?>#daftar-praktikum" style="width:32px; height:32px; border:1px solid var(--c-border); background:#fff; border-radius:6px; display:flex; align-items:center; justify-content:center; cursor:pointer; font-size:13px; font-weight:600; color:var(--c-fg); text-decoration:none;"><?php echo e($i); ?></a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($praktikums->hasMorePages()): ?>
                <a href="<?php echo e($praktikums->nextPageUrl()); ?>#daftar-praktikum" style="width:32px; height:32px; border:1px solid var(--c-border); background:#fff; border-radius:6px; display:flex; align-items:center; justify-content:center; cursor:pointer; color:var(--c-fg); text-decoration:none;">
...
<div x-data="{ open: <?php echo e($errors->any() ? 'true' : 'false'); ?> }" 
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" name="tahun_ajaran" required placeholder="Contoh: 2025/2026" value="<?php echo e(old('tahun_ajaran')); ?>"
                ...
                <div>
                    ...
                    <div x-data="{ dropdownOpen: false, selected: '<?php echo e(old('status', 'aktif')); ?>', options: [{value:'aktif', label:'Aktif'}, {value:'nonaktif', label:'Non-Aktif'}] }" class="relative w-full text-left" @click.away="dropdownOpen = false">
...
<div x-data="{ open: false, selectAll: false, action: 'deactivate', toggleAll() { document.querySelectorAll('.bulk-checkbox').forEach(cb => cb.checked = this.selectAll); } }"
    ...
    <div class="bg-white rounded-[16px] shadow-2xl w-full max-w-lg mx-4 flex flex-col max-h-[90vh]" @click.away="open = false" x-show="open"
        ...
        <div class="overflow-y-auto flex-1">
            <form method="POST" action="<?php echo e(route('eoffice.manprak.admin.praktikum.bulk-toggle-active')); ?>" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex flex-col border border-[#DFE1E7] rounded-[8px] overflow-hidden">
                    ...
                    <label class="flex items-start gap-3 p-3 border-b border-[#F6F8FA] last:border-0 cursor-pointer hover:bg-[#F6F8FA] transition-colors">
                        <input type="checkbox" name="praktikum_ids[]" value="<?php echo e($p->id); ?>" class="bulk-checkbox w-4 h-4 mt-0.5 rounded text-[#0B266E] border-gray-300 focus:ring-[#0B266E]">
                        <div>
                            <div class="text-[13px] font-medium text-[#0D0D12] leading-tight mb-1"><?php echo e($p->nama); ?></div>
                            <div class="text-[11px] text-[#666D80]">
                                Sem. <?php echo e($p->semester); ?> <?php echo e($p->tahun_ajaran); ?> &bull; Status:
                                <span class="<?php echo e($p->is_active ? 'text-[#0D9488]' : 'text-[#DF1C41]'); ?> font-semibold"><?php echo e($p->is_active ? 'Aktif' : 'Non-Aktif'); ?></span>
                            </div>
                        </div>
                    </label>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>

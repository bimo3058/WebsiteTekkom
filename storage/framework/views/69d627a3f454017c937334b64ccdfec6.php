...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <?php $__env->startSection('breadcrumbs'); ?>
        <a href="<?php echo e(route('banksoal.rps.dosen.index')); ?>" class="text-slate-500 hover:text-primary transition-colors">Manajemen RPS</a>
    ...
    <div class="page-header">
        <div class="header-content">
            <h1>Revisi RPS</h1>
            <p>Perbarui Rencana Pembelajaran Semester. Status saat ini: <span class="badge <?php echo e(match($rps->status->value) {
            ...
            }); ?>" style="padding: 2px 8px; border-radius: 999px; font-size: 12px; font-weight: 600;"><?php echo e($rps->status->label()); ?></span></p>
        </div>
        <a href="<?php echo e(route('banksoal.rps.dosen.index')); ?>" class="btn btn-secondary">
...
<?php endif; ?>
    ...
    <!-- MAIN FORM -->
    <form action="<?php echo e(route('banksoal.rps.dosen.update', $rps->id)); ?>" method="POST" enctype="multipart/form-data" id="rpsSubmitForm"
        ...
        data-selected-cpl-ids='<?php echo e(json_encode($rps->cpls->pluck('id')->toArray())); ?>'
        data-generate-detail='<?php echo e(json_encode($generateDetail)); ?>'
        data-cpmk-row-builder="1"
        data-edit-mode="1"
        data-rps-id="<?php echo e($rps->id); ?>">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <input type="hidden" name="creation_method" id="creation_method_input" value="<?php echo e($creationMethod); ?>">
        ...
        <div class="form-card">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="mk-badge">
                        ...
                        <?php echo e($rps->mataKuliah->kode); ?> – <?php echo e($rps->mataKuliah->nama); ?> (<?php echo e($rps->mataKuliah->sks); ?> SKS)
                    </div>
                    <input type="hidden" id="mkSelect" name="mata_kuliah_id" value="<?php echo e($rps->mk_id); ?>">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="hidden" name="semester" value="<?php echo e($rps->semester); ?>">
                </div>
                <div class="form-group">
                    ...
                    <select id="tahun_ajaran" class="field-control bg-slate-100 border-slate-200 text-slate-500 cursor-not-allowed" disabled>
                        <option value="<?php echo e($rps->tahun_ajaran); ?>" selected><?php echo e($rps->tahun_ajaran); ?></option>
                    </select>
                    <input type="hidden" name="tahun_ajaran" value="<?php echo e($rps->tahun_ajaran); ?>">
                </div>
            </div>
        </div>
        ...
        <!-- ==================== METHOD A: UPLOAD PDF ==================== -->
        <div id="method_upload_panel" class="<?php echo e($creationMethod === 'upload' ? '' : 'hidden'); ?>">
            ...
            <div class="form-card">
                ...
                <div class="cpmk-section">
                    <div class="cpmk-header">
                        ...
                        <button type="button" class="btn btn-primary" id="addCpmkRowBtn" style="padding:8px 16px;font-size:13px;" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>>
                    ...
                    <div id="cpmkRows" class="cpmk-rows" data-cpmk-rows>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $existingCpmkRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="cpmk-row" data-cpmk-row data-row-index="<?php echo e($index); ?>">
                            <div>
                                <select name="cpmk_rows[<?php echo e($index); ?>][cpl_id]" class="field-control cpl-select-input" data-cpmk-cpl-select style="font-size:13px;" data-selected-value="<?php echo e($row['cpl_id'] ?? ''); ?>" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>>
                            ...
                            <div>
                                <div style="display:flex;align-items:center;gap:6px;">
                                    ...
                                    <input type="text" name="cpmk_rows[<?php echo e($index); ?>][kode]" value="<?php echo e($row['kode'] ?? ''); ?>" class="field-control" style="font-size:13px;" placeholder="1" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>>
                                </div>
                            </div>
                            <div>
                                <select name="cpmk_rows[<?php echo e($index); ?>][kko]" class="field-control kko-select-input" style="font-size:13px;" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>>
                                    <option value="">Pilih KKO</option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kkoOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <option value="<?php echo e($val); ?>" <?php echo e(($row['kko'] ?? '') === $val ? 'selected' : ''); ?>><?php echo e($val); ?> – <?php echo e($lbl); ?></option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </select>
                            </div>
                            <div>
                                <input type="text" name="cpmk_rows[<?php echo e($index); ?>][objek]" value="<?php echo e($row['objek'] ?? ''); ?>" class="field-control objek-input" style="font-size:13px;" placeholder="merancang sistem IoT" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>>
                            </div>
                            <div>
                                <input type="text" name="cpmk_rows[<?php echo e($index); ?>][konteks]" value="<?php echo e($row['konteks'] ?? ''); ?>" class="field-control" style="font-size:13px;" placeholder="sesuai kebutuhan" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>>
                            </div>
                            <div style="display:flex;align-items:flex-end;">
                                <button type="button" class="btn-danger-sm" data-remove-cpmk-row <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>><i class="fas fa-trash"></i></button>
                            </div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
            ...
            <div class="form-card">
                ...
                <div class="form-group">
                    <label class="field-label">Deskripsi Revisi <?php echo $rps->status->value === 'revisi' ? '<span class="req">*</span>' : ''; ?></label>
                    <textarea name="catatan" class="field-control" rows="3" placeholder="Jelaskan bagian RPS yang diubah..." <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?> <?php echo e($rps->status->value === 'revisi' ? 'required' : ''); ?>><?php echo e(old('catatan', $rps->catatan ?? '')); ?></textarea>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'banksoal::components.ui.upload-zone','data' => ['name' => 'dokumen','inputId' => 'fileInput','accept' => '.pdf','maxLabel' => 'PDF (Maks. 5MB)','disabled' => !$isUploadOpen,'required' => !$isUploadOpen || $rps->status->value === 'revisi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'dokumen','inputId' => 'fileInput','accept' => '.pdf','maxLabel' => 'PDF (Maks. 5MB)','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!$isUploadOpen),'required' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!$isUploadOpen || $rps->status->value === 'revisi')]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
$message = $__bag->first($__errorArgs[0]); ?><p class="field-error" style="margin-top:8px;"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="form-actions" style="display: flex; justify-content: flex-end; gap: 12px; margin-top: 24px;">
                <a href="<?php echo e(route('banksoal.rps.dosen.index')); ?>" class="btn btn-secondary">Batal</a>
                <button type="submit" class="btn btn-primary" id="btnSubmitManual" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>><i class="fas fa-paper-plane"></i> Simpan Perubahan</button>
            </div>
        </div>

        <!-- ==================== METHOD B: WIZARD GENERATOR ==================== -->
        <div id="method_generator_panel" class="<?php echo e($creationMethod === 'generator' ? '' : 'hidden'); ?>">
            <!-- Steps Indicators -->
            ...
            <div class="wizard-content-section" id="step_1_panel">
                ...
                <div class="form-card">
                    ...
                    <div class="cpmk-section">
                        <div class="cpmk-header">
                            ...
                            <button type="button" class="btn btn-primary" id="addCpmkRowBtnGenerator" style="padding:8px 16px;font-size:13px;" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>>
                                <i class="fas fa-plus"></i> Tambah Baris
                            </button>
                        </div>
                ...
                <div class="form-card">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi_mk" id="deskripsi_mk" class="field-control" rows="5" placeholder="Tuliskan deskripsi singkat mengenai materi, fokus kajian, dan tujuan pembelajaran mata kuliah ini..." <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>><?php echo e($generateDetail?->deskripsi_mk ?? ''); ?></textarea>
                    </div>
                </div>
                    ...
                    <table class="main-table" id="penilaian_data_table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><textarea name="penilaian_data[0][komponen]" class="field-control" rows="2" placeholder="Aktivitas Kelas / Diskusi" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>><?php echo e($penilaian[0]['komponen'] ?? ''); ?></textarea></td>
                                <td><input type="number" name="penilaian_data[0][bobot]" class="field-control text-center weight-input" min="0" max="100" value="<?php echo e($penilaian[0]['bobot'] ?? 0); ?>" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></td>
                                <td><select name="penilaian_data[0][cpmk][]" class="field-control cpmk-target-select" multiple required data-selected-values="<?php echo e(json_encode($penilaian[0]['cpmk'] ?? [])); ?>" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></select></td>
                            </tr>
                            <tr>
                                <td class="text-center">2</td>
                                <td class="font-bold">Hasil Proyek<input type="hidden" name="penilaian_data[1][poin]" value="Hasil Proyek"></td>
                                <td><textarea name="penilaian_data[1][komponen]" class="field-control" rows="2" placeholder="Hasil Proyek Desain" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>><?php echo e($penilaian[1]['komponen'] ?? ''); ?></textarea></td>
                                <td><input type="number" name="penilaian_data[1][bobot]" class="field-control text-center weight-input" min="0" max="100" value="<?php echo e($penilaian[1]['bobot'] ?? 0); ?>" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></td>
                                <td><select name="penilaian_data[1][cpmk][]" class="field-control cpmk-target-select" multiple required data-selected-values="<?php echo e(json_encode($penilaian[1]['cpmk'] ?? [])); ?>" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></select></td>
                            </tr>
                            <tr>
                                <td class="text-center">3</td>
                                <td class="font-bold">Tugas<input type="hidden" name="penilaian_data[2][poin]" value="Tugas"></td>
                                <td><textarea name="penilaian_data[2][komponen]" class="field-control" rows="2" placeholder="Tugas Kelompok" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>><?php echo e($penilaian[2]['komponen'] ?? ''); ?></textarea></td>
                                <td><input type="number" name="penilaian_data[2][bobot]" class="field-control text-center weight-input" min="0" max="100" value="<?php echo e($penilaian[2]['bobot'] ?? 0); ?>" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></td>
                                <td><select name="penilaian_data[2][cpmk][]" class="field-control cpmk-target-select" multiple required data-selected-values="<?php echo e(json_encode($penilaian[2]['cpmk'] ?? [])); ?>" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></select></td>
                            </tr>
                            <tr>
                                <td class="text-center">4</td>
                                <td class="font-bold">Quiz<input type="hidden" name="penilaian_data[3][poin]" value="Quiz"></td>
                                <td><textarea name="penilaian_data[3][komponen]" class="field-control" rows="2" placeholder="Tugas Individu / Kuis" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>><?php echo e($penilaian[3]['komponen'] ?? ''); ?></textarea></td>
                                <td><input type="number" name="penilaian_data[3][bobot]" class="field-control text-center weight-input" min="0" max="100" value="<?php echo e($penilaian[3]['bobot'] ?? 0); ?>" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></td>
                                <td><select name="penilaian_data[3][cpmk][]" class="field-control cpmk-target-select" multiple required data-selected-values="<?php echo e(json_encode($penilaian[3]['cpmk'] ?? [])); ?>" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></select></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="penilaian_data[4][sub_rows][0][bobot]" class="field-control text-center weight-input" min="0" max="100" value="<?php echo e($penilaian[4]['sub_rows'][0]['bobot'] ?? 0); ?>" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></td>
                                <td><select name="penilaian_data[4][sub_rows][0][cpmk][]" class="field-control cpmk-target-select" multiple required data-selected-values="<?php echo e(json_encode($penilaian[4]['sub_rows'][0]['cpmk'] ?? [])); ?>" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></select></td>
                            </tr>
                            <tr>
                                <td>UAS (Ujian Akhir Semester)<input type="hidden" name="penilaian_data[4][sub_rows][1][komponen]" value="UAS"></td>
                                <td><input type="number" name="penilaian_data[4][sub_rows][1][bobot]" class="field-control text-center weight-input" min="0" max="100" value="<?php echo e($penilaian[4]['sub_rows'][1]['bobot'] ?? 0); ?>" required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></td>
                                <td><select name="penilaian_data[4][sub_rows][1][cpmk][]" class="field-control cpmk-target-select" multiple required data-selected-values="<?php echo e(json_encode($penilaian[4]['sub_rows'][1]['cpmk'] ?? [])); ?>" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>></select></td>
                            </tr>
                ...
                <div class="sub-tab-panel hidden" id="sub_tab_referensi-catatan_panel">
                    <div class="form-card">
                        ...
                        <div id="references_container">
                            <div class="ref-row">
                                <input type="text" name="referensi_data[]" class="field-control" placeholder="Contoh: Pressman, R.S. (2015). Software Engineering: A Practitioner's Approach. McGraw-Hill." required <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>>
                                <button type="button" class="btn-danger-sm btn-remove-ref" style="flex-shrink: 0;" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>><i class="fas fa-trash"></i></button>
                            </div>
                        </div>
                        <button type="button" class="btn btn-secondary" id="btnAddReference" style="margin-top:12px; padding:8px 16px; font-size:13px;" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>>
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-group">
                            <textarea name="catatan" id="catatan_generator" class="field-control" rows="3" placeholder="Opsional. Tambahkan catatan revisi..." <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?> <?php echo e($rps->status->value === 'revisi' ? 'required' : ''); ?>><?php echo e(old('catatan', $rps->catatan ?? '')); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; justify-content: space-between; gap: 12px; margin-top: 16px;">
                        ...
                        <button type="submit" class="btn btn-primary" id="btnSubmitGenerator" <?php echo e(!$isUploadOpen ? 'disabled' : ''); ?>><i class="fas fa-paper-plane"></i> Simpan & Generate PDF</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cpmk-row" data-cpmk-row data-row-index="__INDEX__">
            ...
            <div>
                <select name="cpmk_rows[__INDEX__][kko]" class="field-control kko-select-input" style="font-size:13px;" required>
                    <option value="">Pilih KKO</option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kkoOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($val); ?>"><?php echo e($val); ?> – <?php echo e($lbl); ?></option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </select>
            </div>
            <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadCpls(mkId) {
                ...
                const cplPromise = fetch(`<?php echo e(route('banksoal.rps.dosen.cpl', '')); ?>/${mkId}`)
                    .then(res => res.json())
                    .then(data => {
            ...
            function saveCache(nextStepNum) {
                ...
                fetch("<?php echo e(route('banksoal.rps.dosen.wizard-cache')); ?>", {
                    method: 'POST',
    ...
    <script src="<?php echo e(asset('modules/banksoal/js/Banksoal/components/RpsCpmkRows.js')); ?>?v=<?php echo e(time()); ?>"></script>
    <?php $__env->stopPush(); ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\rps\Dosen\edit.blade.php ENDPATH**/ ?>
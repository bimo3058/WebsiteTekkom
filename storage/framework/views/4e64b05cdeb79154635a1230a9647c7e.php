            ...
            <div class="p-8">
                ...
                <div class="mb-6 bg-emerald-50 border-l-4 border-emerald-500 p-4 rounded-r-lg">
                    <div class="flex items-center">
                        ...
                        <p class="text-emerald-700 font-medium"><?php echo e(session('success')); ?></p>
                    </div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <form action="<?php echo e(route('eoffice.kp.store')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\kp\register.blade.php ENDPATH**/ ?>
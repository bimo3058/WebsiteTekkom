...
<div style="display:flex;align-items:flex-start;gap:20px;padding-bottom:20px;border-bottom:1px solid #f1f5f9;margin-bottom:20px;">
    ...
    <div style="position:relative;flex-shrink:0;">
        <div style="width:60px;height:60px;border-radius:50%;overflow:hidden;border:2px solid #e2e8f0;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:700;box-shadow:0 1px 3px rgba(0,0,0,.08);" class="<?php echo e($roleColor); ?>">
...
</script><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\profile\partials\settings-panel-general.blade.php ENDPATH**/ ?>
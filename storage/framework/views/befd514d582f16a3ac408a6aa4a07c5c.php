...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="dash-wrap">
        <div class="dash-box">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($finishedSession) && $finishedSession): ?>
                <?php
                ...
                <div
                    ...
                    <div class="p-8 sm:p-10 flex flex-col items-start h-full">
                        ...
                        <h3 class="text-3xl font-extrabold text-slate-900 tracking-tight mb-8">
                            <?php echo e($lulus ? 'Selamat! Anda Telah Lulus Ujian Komprehensif' : 'Mohon Maaf, Anda Belum Lulus Ujian Komprehensif'); ?>
                        ...
                        <div
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <span
                                    class="text-5xl font-black text-slate-900"><?php echo e((int)$skor); ?></span>
                            </div>
                            ...
                            <div>
                                ...
                                <span
                                    class="text-xl font-black <?php echo e($lulus ? 'text-emerald-700' : 'text-red-700'); ?>"><?php echo e($lulus ? 'LULUS' : 'TIDAK LULUS'); ?></span>
                            </div>
                        </div>

                        <a href="<?php echo e(route('komprehensif.mahasiswa.riwayat')); ?>"
            ...
            <?php elseif($pendaftar && $pendaftar->status_pendaftaran->value === 'approved'): ?>
                <?php
                ...
                <div class="flex flex-col w-full">
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 w-full items-start">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isUjianBerlangsung): ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasJadwal): ?>
                            ...
                            <div class="mb-5 bg-slate-50/70 border border-slate-200 rounded-lg p-4 inline-block min-w-[280px] sm:min-w-[400px]">
                                <ul class="text-[13px] text-slate-700 space-y-3">
                                    <li class="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-0">
                                        ...
                                        <span class="font-bold text-slate-900"><?php echo e($pendaftar->jadwal->nama_sesi); ?></span>
                                    </li>
                                    <li class="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-0">
                                        <span class="w-24 flex-shrink-0 font-bold text-slate-500 uppercase text-[10px] tracking-wider sm:mt-0.5">Waktu</span>
                                        <span class="font-medium text-slate-800">
                                            <?php echo e(\Carbon\Carbon::parse($pendaftar->jadwal->tanggal_ujian)->translatedFormat('l, d F Y')); ?><br>
                                            Pukul <?php echo e(\Carbon\Carbon::parse($pendaftar->jadwal->waktu_mulai)->format('H:i')); ?> - <?php echo e(\Carbon\Carbon::parse($pendaftar->jadwal->waktu_selesai)->format('H:i')); ?> WIB
                                        </span>
                                    </li>
                                    <li class="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-0">
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>                        <div x-data="{
                                confirmModal: false,
                                tokenError: '',
                                checking: false,
                                async checkAndConfirm() {
                                    ...
                                    try {
                                        const res = await fetch('<?php echo e(route('komprehensif.mahasiswa.engine.check-token')); ?>', {
                                            method: 'POST',
                                            headers: {
                            ...
                            class="lg:col-span-7 border-t border-slate-200 pt-5 mt-2 lg:mt-0 <?php echo e(!$isUjianBerlangsung ? 'opacity-50 pointer-events-none' : ''); ?>">
                            <form x-ref="examForm" action="<?php echo e(route('komprehensif.mahasiswa.engine.validate')); ?>" method="POST"
                                ...
                                <div class="flex-1 w-full sm:max-w-[280px]">
                                    ...
                                    <div class="flex flex-row items-center gap-3 mt-2 relative">
                                        <input type="text" id="token" name="token" required
                                            ...
                                            class="flex-1 h-12 px-4 text-xl tracking-[0.5em] font-mono font-bold text-slate-900 border-2 focus:ring-0 outline-none transition-colors uppercase placeholder:text-slate-300 <?php echo e($hasTokenError ? 'border-red-500 bg-red-50' : ''); ?>"
                                            placeholder="XXXXXX" maxlength="6" <?php echo e(!$isUjianBerlangsung ? 'disabled' : ''); ?> value="<?php echo e(old('token')); ?>"
                                            @input="tokenError = ''" />
                                        <button type="submit"
                                            :disabled="checking"
                                            class="h-12 px-6 <?php echo e(!$isUjianBerlangsung ? 'bg-slate-300 cursor-not-allowed text-slate-500' : 'bg-primary hover:bg-primary/90 text-white'); ?> font-bold text-sm tracking-widest uppercase transition-colors flex items-center justify-center whitespace-nowrap rounded-xl shadow-sm"
                                            <?php echo e(!$isUjianBerlangsung ? 'disabled' : ''); ?>>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasTokenError): ?>
                                        <div class="flex items-center gap-1.5 mt-1.5">
                                            ...
                                            <p class="text-xs font-bold text-red-600 tracking-wide"><?php echo e($tokenErrorMessage); ?></p>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="lg:col-span-5 w-full">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendaftar->jadwal): ?>
            ...
            <?php elseif($pendaftar && $pendaftar->status_pendaftaran->value === 'pending'): ?>
                <!-- STATE: PENDING -->
            ...
            <?php elseif($pendaftar && $pendaftar->status_pendaftaran->value === 'rejected'): ?>
                <!-- STATE: REJECTED -->
                <div class="flex flex-col border-2 border-red-500 bg-red-50 rounded-2xl shadow-sm overflow-hidden">
                    <div class="p-8 sm:p-10 flex flex-col items-start">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($pendaftar->catatan_admin)): ?>
                            <div class="p-4 bg-slate-50 border border-slate-200 rounded-md w-full max-w-xl">
                                ...
                                <p class="text-sm text-slate-600 italic">"<?php echo e($pendaftar->catatan_admin); ?>"</p>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            ...
            <?php elseif($activePeriode): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activePeriode->pendaftaran_ditutup_paksa): ?>
                    ...
                    <div class="flex flex-col border border-amber-300 bg-amber-50 rounded-2xl shadow-sm overflow-hidden">
                        <div class="p-8 sm:p-10 flex flex-col items-start h-full">
                            ...
                            <p class="text-base text-amber-800 leading-relaxed mb-10 max-w-xl">
                                Pendaftaran untuk <strong><?php echo e($activePeriode->nama_periode); ?></strong> telah ditutup lebih awal
                                oleh staf akademik. Silakan hubungi admin untuk informasi lebih lanjut.
                            </p>
                        </div>
                    </div>
                <?php elseif(now()->lt(\Carbon\Carbon::parse($activePeriode->tanggal_mulai)->startOfDay())): ?>
                    <!-- STATE: NOT YET OPEN -->
                    <div class="flex flex-col border border-slate-300 bg-white rounded-2xl shadow-sm overflow-hidden">
                        <div class="p-8 sm:p-10 flex flex-col items-start h-full">
                            ...
                            <p class="text-base text-slate-600 leading-relaxed mb-10 max-w-xl">
                                Registrasi ujian komprehensif <strong><?php echo e($activePeriode->nama_periode); ?></strong> baru dapat
                                diakses mulai tanggal <strong
                                    class="text-slate-900"><?php echo e(\Carbon\Carbon::parse($activePeriode->tanggal_mulai)->translatedFormat('d F Y')); ?></strong>.
                            </p>
                ...
                <?php elseif(now()->gt(\Carbon\Carbon::parse($activePeriode->tanggal_selesai)->endOfDay())): ?>
                    ...
                    <div class="flex flex-col border border-slate-300 bg-white rounded-2xl shadow-sm overflow-hidden">
                        <div class="p-8 sm:p-10 flex flex-col items-start h-full">
                            ...
                            <p class="text-base text-slate-600 leading-relaxed mb-10 max-w-xl">
                                Batas waktu pendaftaran Ujian Komprehensif untuk periode <strong><?php echo e($activePeriode->nama_periode); ?></strong>
                                telah berakhir pada <strong><?php echo e(\Carbon\Carbon::parse($activePeriode->tanggal_selesai)->translatedFormat('d F Y')); ?></strong>. 
                ...
                <?php else: ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kuotaPenuh): ?>
                        <!-- STATE: QUOTA FULL -->
                        <div class="flex flex-col border border-slate-300 bg-slate-50 rounded-2xl shadow-sm overflow-hidden">
                            <div class="p-8 sm:p-10 flex flex-col items-start h-full">
                                ...
                                <p class="text-base text-slate-600 leading-relaxed mb-10 max-w-xl">
                                    Mohon maaf, kuota pendaftaran ujian komprehensif periode <strong><?php echo e($activePeriode->nama_periode); ?></strong> saat ini telah terpenuhi sepenuhnya. Silakan hubungi bagian akademik atau pantau kembali halaman ini jika ada penambahan kuota.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col border-2 border-primary bg-white rounded-2xl shadow-sm overflow-hidden">
                            <div class="p-8 sm:p-10 flex flex-col h-full">
                                ...
                                <p class="text-base text-slate-600 leading-relaxed mb-10 max-w-xl">
                                    ...
                                    <strong><?php echo e($activePeriode->nama_periode); ?></strong>. Batas akhir pendaftaran adalah
                                    <strong><?php echo e(\Carbon\Carbon::parse($activePeriode->tanggal_selesai)->translatedFormat('d F Y')); ?>,
                                        23:59 WIB</strong>.
                                </p>

                                <div
                                    class="mt-auto flex flex-col sm:flex-row sm:items-center justify-between border-t border-slate-200 pt-6 gap-6">
                                    <a href="<?php echo e(route('komprehensif.mahasiswa.pendaftaran.form')); ?>"
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\mahasiswa\dashboard.blade.php ENDPATH**/ ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <?php $__env->startPush('styles'); ?>
        <style>
            ...
            .detail-image-wrapper {
                ...
                aspect-ratio: 42 / 59.4;
                /* Ukuran poster standar 42 x 59.4 cm */
    ...
    <div class="detail-card">
        ...
        <div class="detail-title">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pengumuman->is_pinned || $isPersonalPinned): ?>
                <div class="d-flex justify-content-center gap-2 mb-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pengumuman->is_pinned): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPersonalPinned): ?>
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <h5><?php echo e($pengumuman->judul); ?></h5>
        </div>
        ...
        <div class="meta-container">
            ...
            <div class="meta-item" title="Tanggal">
                ...
                <?php echo e(($pengumuman->published_at ?? $pengumuman->created_at)->translatedFormat('d F Y')); ?>
            ...
            <div class="meta-item" title="Waktu">
                ...
                <?php echo e(($pengumuman->published_at ?? $pengumuman->created_at)->format('H:i')); ?> WIB
            </div>
            <div class="meta-item" title="Pembuat">
                ...
                <?php echo e($pengumuman->author->name ?? 'Admin'); ?>

            </div>
        </div>

        <!-- Image Poster -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($posterUrl): ?>
            <div class="detail-image-wrapper zoomable-thumbnail" onclick="openLightbox('<?php echo e($posterUrl); ?>', '<?php echo e(addslashes($pengumuman->judul)); ?>')">
                <img src="<?php echo e($posterUrl); ?>" alt="<?php echo e($pengumuman->judul); ?>">
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <!-- Lampiran -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lampiran->count() > 0): ?>
            <div class="section-heading">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6B4FF4" stroke-width="2.5"
                    stroke-linecap="round" stroke-linejoin="round">
                    <path
            ...
            <div class="lampiran-list">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $lampiran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('manajemenmahasiswa.pengumuman.lampiran.download', $item->id)); ?>" class="lampiran-item"
                        download>
                        ...
                        <div class="lampiran-info">
                            <div class="lampiran-name"><?php echo e($item->judul_file ?? 'Lampiran'); ?></div>
        ...
        <div class="actions-container">
            <a href="<?php echo e(route('manajemenmahasiswa.pengumuman.index')); ?>" class="btn-action btn-back">
            ...
            <form action="<?php echo e(route('manajemenmahasiswa.pengumuman.personal_pin', $pengumuman->id)); ?>" method="POST" style="margin:0;">
                <?php echo csrf_field(); ?>
                <button type="submit" class="btn-action btn-pin-personal">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="<?php echo e($isPersonalPinned ? 'currentColor' : 'none'); ?>" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M17 3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V5c0-1.1-.9-2-2-2z"/>
                    </svg>
                    <?php echo e($isPersonalPinned ? 'Unpin Pribadi' : 'Pin Pribadi'); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canPinGlobal): ?>
                <form action="<?php echo e(route('manajemenmahasiswa.pengumuman.pin', $pengumuman->id)); ?>" method="POST" style="margin:0;">
                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                    <button type="submit" class="btn-action btn-pin-global">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="<?php echo e($pengumuman->is_pinned ? 'currentColor' : 'none'); ?>" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M16 12V4h1V2H7v2h1v8l-2 2v2h5v6h2v-6h5v-2l-2-2z"/>
                        </svg>
                        <?php echo e($pengumuman->is_pinned ? 'Unpin Global' : 'Pin Global'); ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\pengumuman\pengumuman-detail.blade.php ENDPATH**/ ?>
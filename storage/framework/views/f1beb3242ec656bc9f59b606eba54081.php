...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Layanan Pengaduan Konfidensial'); ?></title>
...
<?php endif; ?>
    ...
    <div class="anon-footer">
        &copy; <?php echo e(date('Y')); ?> Sistem Layanan Pengaduan. Tautan ini bersifat rahasia dan aman.
    </div>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\pengaduan\anon\layout.blade.php ENDPATH**/ ?>
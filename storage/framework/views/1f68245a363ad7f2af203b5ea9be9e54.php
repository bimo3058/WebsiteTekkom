...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-praktikum.layout','data' => ['pageTitle' => 'Pendaftaran Praktikan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => 'Pendaftaran Praktikan']); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($praktikumBuka->isEmpty()): ?>
...
<div class="mp-card flex-shrink-0">
    <div style="padding:18px;">
        <form method="GET" action="<?php echo e(route('eoffice.manprak.mahasiswa.pendaftaran-praktikan.index')); ?>">
            <?php
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-praktikum.ui.select','data' => ['name' => 'praktikum_id','options' => $praktikumOptions,'selected' => (string) request('praktikum_id', $praktikumBuka->first()?->id),'placeholder' => 'Pilih Mata Kuliah...','onChange' => '$event.target.form.submit()','minWidth' => '320px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'praktikum_id','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($praktikumOptions),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute((string) request('praktikum_id', $praktikumBuka->first()?->id)),'placeholder' => 'Pilih Mata Kuliah...','onChange' => '$event.target.form.submit()','minWidth' => '320px']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<div style="display:grid;grid-template-columns:minmax(0,1.1fr) minmax(300px,.9fr);gap:16px;margin-top:24px;">
        ...
        <div class="mp-card flex-shrink-0">
            <div style="padding:20px;">
                ...
                <div style="font-size:18px;font-weight:700;color:#0D0D12;margin-top:4px;">
                    <?php echo e($selectedPraktikum->matkul?->kode ?? $selectedPraktikum->kode ?? '—'); ?>

                </div>
                <div style="font-size:14px;color:#353849;margin-top:2px;"><?php echo e($selectedPraktikum->matkul?->nama ?? $selectedPraktikum->nama); ?></div>
                <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:14px;">
                    <span class="mp-badge neutral sm"><?php echo e($selectedPraktikum->semester); ?> · <?php echo e($selectedPraktikum->tahun_ajaran); ?></span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($periode?->ditutup_pada): ?>
                    <span class="mp-badge success sm">Ditutup <?php echo e($periode->ditutup_pada->locale('id')->isoFormat('D MMM YYYY, HH:mm')); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <div style="border-top:1px solid #DFE1E7;margin-top:18px;padding-top:14px;font-size:12px;color:#666D80;">
                    <div><strong style="color:#353849;">Praktikum:</strong> <?php echo e($selectedPraktikum->nama); ?></div>
                    <div style="margin-top:5px;"><strong style="color:#353849;">Dosen:</strong> <?php echo e($selectedPraktikum->dosens->pluck('name')->join(', ') ?: 'Belum ditentukan'); ?></div>
                    <div style="margin-top:5px;"><strong style="color:#353849;">Koordinator:</strong> <?php echo e($selectedPraktikum->koordinator?->name ?? 'Belum ditentukan'); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="mp-card flex-shrink-0">
            <div style="padding:20px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendaftaranTerakhir?->status === 'approved'): ?>
                ...
                <?php elseif($pendaftaranTerakhir?->status === 'pending'): ?>
                ...
                <?php elseif($pendaftaranTerakhir?->status === 'rejected'): ?>
                <span class="mp-badge error sm"><span class="dot"></span>Ditolak</span>
                <div style="font-size:12px;color:#666D80;margin-top:10px;"><?php echo e($pendaftaranTerakhir->alasan_penolakan ?: 'Berkas IRS belum memenuhi persyaratan.'); ?></div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$pendaftaranTerakhir || $pendaftaranTerakhir->status === 'rejected'): ?>
...
<div class="mp-card flex-shrink-0">
    ...
    <form method="POST" action="<?php echo e(route('eoffice.manprak.mahasiswa.pendaftaran-praktikan.store')); ?>" enctype="multipart/form-data" style="padding:20px;">
        <?php echo csrf_field(); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($riwayat->isNotEmpty()): ?>
<div class="sec-head" style="margin-top:24px;">
    <span class="sec-bar"></span>
...
<div class="mp-card flex-shrink-0">
    <div class="overflow-x-auto">
        <table class="mp-table">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $riwayat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr>
                    <td>
                        <div style="font-weight:600;"><?php echo e($item->praktikum?->matkul?->nama ?? $item->praktikum?->nama ?? '—'); ?></div>
                        <div style="font-size:11px;color:#808897;"><?php echo e($item->praktikum?->semester); ?> · <?php echo e($item->praktikum?->tahun_ajaran); ?></div>
                    </td>
                    <td style="font-size:12px;"><?php echo e($item->created_at?->locale('id')->isoFormat('D MMM YYYY, HH:mm')); ?></td>
                    <td>
                    ...
                    <td style="font-size:11px;color:#666D80;"><?php echo e($item->alasan_penolakan ?: ($item->status === 'approved' ? 'IRS terverifikasi.' : 'Sedang diperiksa koordinator.')); ?></td>
                </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </tbody>
        </table>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activePraktikum && $classmates->isNotEmpty()): ?>
<div class="sec-head" style="margin-top:24px;">
    <span class="sec-bar"></span>
...
<div class="mp-card flex-shrink-0">
    <div class="overflow-x-auto">
        <table class="mp-table">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $classmates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classmate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr>
                    <td style="font-weight:600;"><?php echo e($classmate->user?->name ?? '—'); ?></td>
                    <td><?php echo e($classmate->kelompok ?: 'Belum dibagi'); ?></td>
                    <td><?php echo e($classmate->shift ?: 'Belum dibagi'); ?></td>
                </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </tbody>
        </table>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum\mahasiswa\pendaftaran-praktikan.blade.php ENDPATH**/ ?>
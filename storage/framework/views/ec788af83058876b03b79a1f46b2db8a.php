<?php $__env->startSection('title','Ringkasan Evaluasi Jadwal'); ?>
<?php $__env->startSection('content'); ?>
<div x-data="adminReports('schedule')" class="space-y-6"><div class="flex flex-wrap items-center justify-between gap-4"><h1 class="text-3xl font-bold">Ringkasan Evaluasi Jadwal</h1><?php if (isset($component)) { $__componentOriginalb35a908784863ee4a31335a0ede028f1 = $component; } ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
<div class="px-6"><h2 class="font-semibold" x-text="data.group?.title || data.group?.code || 'Ringkasan Evaluasi'"></h2><p x-text="date(data.schedule?.date)+' - '+(data.schedule?.room || '-')"></p></div> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><template x-for="(student,index) in data.summary || []" :key="student.student_id || index"><?php if (isset($component)) { $__componentOriginal5ac34a7ad891af7fa808b2dbb0e60582 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5ac34a7ad891af7fa808b2dbb0e60582 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'capstone::components.card','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('capstone::card'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php echo $__env->make('capstone::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\Capstone\tests/../resources/views/pages\admin\evaluation-summary\_scheduleId_.blade.php ENDPATH**/ ?>
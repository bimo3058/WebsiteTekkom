...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="w-full">
        ...
        <div
            ...
            <div>
                ...
                <p style="font-size:12px; color:var(--c-fg-muted);">
                    <span style="color:var(--c-fg); font-weight:600;"><?php echo e($session->user->name); ?></span>
                    <span style="margin-left:4px; color:var(--c-fg-placeholder);">·</span>
                    <span style="margin-left:4px; color:var(--c-fg-muted);">NIM:
                        <?php echo e(optional($session->user->student)->student_number ?? '—'); ?></span>
                </p>
            </div>
        ...
        <div class="dash-stats" style="display:grid;grid-template-columns:repeat(5,1fr);gap:12px;margin-bottom:24px;">
            ...
            <div style="background:#fff;border:1px solid var(--c-border);border-radius:12px;padding:14px 16px;box-shadow:var(--shadow-card);transition:border-color .15s,box-shadow .15s;cursor:default;"
                ...
                <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                    <div
                        style="width:28px;height:28px;border-radius:8px;background:<?php echo e($lulus ? 'rgba(34,197,94,0.1)' : 'rgba(220,38,38,0.1)'); ?>;color:<?php echo e($lulus ? '#22C55E' : '#DC2626'); ?>;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                    ...
                    <p style="font-size:12px;font-weight:500;color:var(--c-fg-muted);">Skor Akhir
                        (<?php echo e($lulus ? 'Lulus' : 'Tidak Lulus'); ?>)</p>
                </div>
                <p
                    style="font-size:24px;font-weight:700;color:<?php echo e($lulus ? '#15803D' : '#B91C1C'); ?>;line-height:1;letter-spacing:-.02em;">
                    <?php echo e($skor); ?><span style="font-size:14px;color:var(--c-fg-muted);font-weight:500;">/100</span>
                </p>
            </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($cplStats) && $cplStats->isNotEmpty()): ?>
            <?php
                $cplLabels = [];
                $cplScores = [];
                $cplTotal = 0;
                ...
                <div class="w-full lg:w-1/2 flex flex-col"
                    ...
                    <div style="padding:0; overflow-y:auto; flex:1; max-height: 290px;">
                        <table style="width: 100%; text-align: left; border-collapse: collapse;">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cplStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr style="border-bottom: 1px solid var(--c-border);">
                                        <td
                                            style="padding: 12px 20px; font-size: 12px; font-weight: 600; color: var(--c-fg); vertical-align: top;">
                                            <?php echo e(preg_replace('/^CPL-0*/', 'CPL ', $stat['kode'])); ?></td>
                                        <td
                                            style="padding: 12px 20px; font-size: 12px; color: var(--c-fg-muted); line-height: 1.5; vertical-align: top;">
                                            <?php echo e($stat['deskripsi'] ?: '-'); ?></td>
                                    </tr>
        ...
        <div x-data="{ viewMode: 'default' }">
            ...
            <div x-show="viewMode === 'default'" x-transition:enter="transition ease-out duration-300"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($session->jawabans->isEmpty()): ?>
                ...
                <?php else: ?>
                    <div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $session->jawabans->sortBy('urutan_soal'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kompreJawaban): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php echo $__env->make('banksoal::admin.cbt.partials._jawaban-card', ['kompreJawaban' => $kompreJawaban], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div x-show="viewMode === 'cpl'" x-cloak style="display: none;"
                ...
                x-transition:enter-start="opacity-0 transform translate-y-2"
                x-transition:enter-end="opacity-100 transform translate-y-0">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($jawabansPerCpl)): ?>
                    <div class="space-y-8">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $jawabansPerCpl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kodeCpl => $jawabansGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div>
                                <div
                                    class="flex items-center gap-3 mb-4 sticky top-16 bg-white/95 backdrop-blur-sm py-2 z-10 border-b border-gray-100">
                                    <h3 class="text-[14px] font-bold text-gray-800"><?php echo e(preg_replace('/^CPL-0*/', 'CPL ', $kodeCpl)); ?></h3>
                                    <div class="h-px bg-gray-200 flex-1"></div>
                                </div>
                                <div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $jawabansGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kompreJawaban): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php echo $__env->make('banksoal::admin.cbt.partials._jawaban-card', ['kompreJawaban' => $kompreJawaban, 'hideCplBadge' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    function initChart() {
                        ...
                        const labels = <?php echo json_encode($cplLabels, 15, 512) ?>;
                        const cplScores = <?php echo json_encode($cplScores, 15, 512) ?>;
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\admin\cbt\detail-hasil.blade.php ENDPATH**/ ?>
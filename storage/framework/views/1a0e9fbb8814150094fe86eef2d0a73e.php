...
<div class="mp-alert info flex-shrink-0">
    <strong>Alur:</strong> Anda mereview data mahasiswa (IPK, motivasi) <?php if (isset($component)) { $__componentOriginal22b2b62d2a6bf157ddbb8ecb4421b995 = $component; } ?>
...
<?php endif; ?> Setujui/Tolak <?php if (isset($component)) { $__componentOriginal22b2b62d2a6bf157ddbb8ecb4421b995 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal22b2b62d2a6bf157ddbb8ecb4421b995 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-praktikum.ui.icon','data' => ['name' => 'arrow-right']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('eoffice::manajemen-praktikum.ui.icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $component = $__componentOriginal22b2b62d2a6bf157ddbb8ecb4421b995; ?>
<?php unset($__componentOriginal22b2b62d2a6bf157ddbb8ecb4421b995); ?>
<?php endif; ?> Jika disetujui, masuk ke antrian Admin untuk final approval.
</div>
            ...
            <tbody>
                ...
                <tr class="mp-tr" style="border-bottom:1px solid #DFE1E7;">
                    ...
                    <td style="padding:12px 16px;text-align:center;">
                        ...
                        <?php elseif($p->status_dosen === 'disetujui'): ?>
                        <div>
                    ...
                    <td style="padding:12px 16px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->status === 'pending' && $p->status_dosen === 'menunggu'): ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum\dosen\pendaftaran-koor.blade.php ENDPATH**/ ?>
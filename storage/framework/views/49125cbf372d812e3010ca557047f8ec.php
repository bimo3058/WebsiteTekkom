...
<div style="display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap;">
    ...
    <div style="display:flex; align-items:center; gap:14px; flex-wrap:wrap;">
        <div>
            ...
            <p style="font-size:12px; color:var(--c-fg-muted);">
                Selamat datang kembali, <span style="color:var(--c-fg); font-weight:600;"><?php echo e(auth()->user()->name); ?></span>
                <span style="margin-left:4px; color:var(--c-fg-placeholder);">·</span>
                <span style="margin-left:4px; color:var(--c-fg-muted);"><?php echo e(now()->translatedFormat('l, d F Y')); ?></span>
            </p>
        </div>
    </div>
    ...
    <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sesiOngoing > 0): ?>
            <a href="<?php echo e(route('banksoal.admin.cbt.live-proctoring')); ?>"
               ...
               onmouseout="this.style.background='var(--c-success)'; this.style.boxShadow='0 2px 6px rgba(16,185,129,0.3)'">
                ...
                <span>Live Sekarang (<?php echo e($sesiOngoing); ?>)</span>
            </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</div>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules/BankSoal\resources/views/dashboard/partials/_header.blade.php ENDPATH**/ ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => ['title' => 'Balancing Dosen']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Balancing Dosen']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div x-data="balancingApp()" x-cloak>
        ...
        <!-- Header & Actions -->
        <form action="<?php echo e(route('eoffice.kp.koordinator.balancing.store')); ?>" method="POST" id="balancingForm"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            function balancingApp() {
                return {
                    sidebarOpen: true,
                    unassignedStudents: <?php echo json_encode($unassignedStudents, 15, 512) ?>,
            ...
            <script>
                document.addEventListener('alpine:init', () => {
                    setTimeout(() => {
                        ...
                        app.showToast('success', 'Berhasil', '<?php echo e(session('success')); ?>');
                    }, 100);
                });
            </script>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\balancing.blade.php ENDPATH**/ ?>
...
<div x-data="{
    ...
    <div x-show="selected.length > 0" x-cloak x-transition:enter="transition ease-out duration-200"
        ...
        <div class="flex items-center gap-2">
            ...
            <button type="button" @click="openConfirm('<?php echo e(route('banksoal.pendaftaran.bulkReject')); ?>', 'POST', 'Tolak ' + countSelected + ' Peserta?', 'Data akan dihapus permanen dan tidak dapat dikembalikan.', 'bg-red-500 hover:bg-rose-600', 'text-red-500', 'bg-red-50', true, selected)"
            ...
            <button type="button" @click="openConfirm('<?php echo e(route('banksoal.pendaftaran.bulkApprove')); ?>', 'POST', 'Setujui ' + countSelected + ' Peserta?', 'Aksi ini tidak dapat dibatalkan.', 'bg-emerald-600 hover:bg-emerald-700', 'text-emerald-600', 'bg-emerald-50', true, selected)"
    ...
    <div
        ...
        <div class="overflow-x-auto w-full">
            <table class="w-full text-left text-[14px] text-gray-700 border-collapse">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pendaftars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php $isPending = $item->status_pendaftaran->value !== 'approved'; ?>
                        <tr class="hover:bg-gray-50 transition-colors border-b border-gray-200 last:border-b-0"
                            :class="selected.includes(<?php echo e($item->id); ?>) ? 'bg-[#2A3A7C]/5' : ''">
                            ...
                            <td class="px-6 py-4 text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPending): ?>
                                    <input type="checkbox"
                                        ...
                                        value="<?php echo e($item->id); ?>" x-model="selected">
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 text-center text-gray-400 text-xs whitespace-nowrap">
                                <?php echo e($pendaftars->firstItem() + $index); ?>
                            ...
                            <td class="px-6 py-4 text-gray-500 whitespace-nowrap">Semester <?php echo e($item->semester_aktif); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-gray-500 text-sm">
                                <?php $n = $item->sesi_selesai_count ?? 0; ?>
                                <?php echo e($n === 0 ? 'Belum pernah' : $n . '× ujian'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->status_pendaftaran->value === 'approved'): ?>
                                    <span
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button type="button" title="Lihat Detail" onclick="openDetailModal({
                                                            nim: '<?php echo e($item->nim); ?>',
                                                            nama: '<?php echo e(addslashes($item->nama_lengkap)); ?>',
                                                            semester: '<?php echo e($item->semester_aktif); ?>',
                                                            target_wisuda: '<?php echo e(addslashes($item->target_wisuda ?? '-')); ?>',
                                                            status: '<?php echo e($item->status_pendaftaran); ?>',
                                                            tanggal: '<?php echo e($item->created_at->translatedFormat('d F Y, H:i')); ?>',
                                                            dosen1: '<?php echo e(addslashes($item->dosenPembimbing1->name ?? '-')); ?>',
                                                            dosen2: '<?php echo e(addslashes($item->dosenPembimbing2->name ?? '-')); ?>',
                                                            ujian_count: <?php echo e($item->sesi_selesai_count ?? 0); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPending): ?>
                                        ...
                                        <button type="button" title="Setujui"
                                            @click="openConfirm('<?php echo e(route('banksoal.pendaftaran.updateStatus', $item->id)); ?>', 'PATCH', 'Setujui Pendaftaran?', 'Setujui pendaftaran <?php echo e(addslashes($item->nama_lengkap)); ?>? Aksi ini tidak dapat dibatalkan.', 'bg-emerald-600 hover:bg-emerald-700', 'text-emerald-500', 'bg-emerald-50', false, [], 'approved')"
                                        ...
                                        <button type="button" title="Tolak & Hapus"
                                            @click="openConfirm('<?php echo e(route('banksoal.pendaftaran.destroy', $item->id)); ?>', 'DELETE', 'Tolak & Hapus?', 'Tolak dan hapus pendaftar <?php echo e(addslashes($item->nama_lengkap)); ?>? Data akan dihapus dari daftar.', 'bg-red-500 hover:bg-rose-600', 'text-red-500', 'bg-red-50')"
        ...
        <div class="px-6 py-4 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4 bg-white">
            <div class="flex flex-col sm:flex-row sm:items-center gap-4 w-full">
                <div class="flex items-center gap-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendaftars instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
                    <span class="text-[13px] text-gray-600 font-medium ml-2">
                        Showing <?php echo e($pendaftars->firstItem() ?? 0); ?> to <?php echo e($pendaftars->lastItem() ?? 0); ?> of <?php echo e($pendaftars->total()); ?> results
                    </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendaftars instanceof \Illuminate\Pagination\LengthAwarePaginator && $pendaftars->hasPages()): ?>
                <div class="sm:ml-auto">
                    <?php echo e($pendaftars->links('pagination::tailwind')); ?>
...
</div><?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pendaftaran\partials\table.blade.php ENDPATH**/ ?>
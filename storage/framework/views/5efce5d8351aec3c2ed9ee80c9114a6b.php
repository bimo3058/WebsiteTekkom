...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Portal Mahasiswa'); ?> - <?php echo e(config('app.name', 'Portal Mahasiswa')); ?></title>
...
<body class="font-sans antialiased text-slate-800 bg-slate-50">
    <div class="flex h-screen overflow-hidden bg-slate-50">
        <!-- Sidebar -->
        <?php echo $__env->make('banksoal::partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <!-- Main Content Wrapper -->
        <div class="flex-1 flex flex-col relative overflow-hidden">
            <!-- Header -->
            <?php echo $__env->make('banksoal::partials.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\layouts\master.blade.php ENDPATH**/ ?>
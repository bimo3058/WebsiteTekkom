            ...
            <div class="<?php echo e($cardClass); ?>"
                ...
                <div class="pg-card-img">
                    ...
                    <form method="POST"
                        ...
                        <?php echo csrf_field(); ?>
                        <button type="submit"
                            class="pg-bookmark <?php echo e($isPinnedPersonal ? 'active' : ''); ?>"
                            title="<?php echo e($isPinnedPersonal ? 'Hapus pin' : 'Pin pengumuman ini'); ?>">
                ...
                <div class="pg-card-body">
                    ...
                    <div class="pg-category <?php echo e($catClass); ?>">
                    ...
                    <p class="pg-card-excerpt">
                        <?php echo e(Str::limit(html_entity_decode(strip_tags($item->konten)), 120)); ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\mahasiswa\pengumuman-mahasiswa.blade.php ENDPATH**/ ?>
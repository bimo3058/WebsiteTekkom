...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
    <div class="alert alert-success alert-dismissible fade show" role="alert"
        ...
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg> <?php echo e(session('success')); ?>
...
<div class="d-flex justify-content-between align-items-start">
    <div class="detail-header">
        <a href="<?php echo e(route('manajemenmahasiswa.kegiatan.index')); ?>" class="btn-back">
            &larr;
        </a>
        <div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?>
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('manajemenmahasiswa.kegiatan.edit', $kegiatan->id)); ?>"
...
<!-- Banner -->
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->banner): ?>
<div style="position:relative;width:100%;max-height:340px;border-radius:18px;overflow:hidden;margin-bottom:28px;box-shadow:0 10px 30px -10px rgba(0,0,0,0.15);cursor:pointer;transition:transform 0.2s;" 
    ...
    <img src="<?php echo e($kegiatan->banner_url); ?>" alt="<?php echo e($kegiatan->judul); ?>" style="width:100%;height:340px;object-fit:cover;display:block;">
...
<div class="detail-card">
    ...
    <div class="d-flex flex-wrap gap-2 mb-3">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->bidangs && $kegiatan->bidangs->count() > 0): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kegiatan->bidangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        ...
        <?php elseif($kegiatan->bidang): ?>
            <span class="badge-bidang"><?php echo e($kegiatan->bidang->nama_bidang); ?></span>
        <?php else: ?>
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->kategoris && $kegiatan->kategoris->count() > 0): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kegiatan->kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <span class="badge-kategori"><?php echo e($kat->nama_kategori); ?></span>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        <?php elseif($kegiatan->kategoriKegiatan): ?>
            <span class="badge-kategori"><?php echo e($kegiatan->kategoriKegiatan->nama_kategori); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>

    <!-- Title -->
    <h4 class="fw-bold mb-3" style="color:#0D0D12;"><?php echo e($kegiatan->judul); ?></h4>
    ...
    <div class="meta-grid">
        <div class="meta-item">
            ...
            <div class="meta-item-value">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"></rect><line x1="16" x2="16" y1="2" y2="6"></line><line x1="8" x2="8" y1="2" y2="6"></line><line x1="3" x2="21" y1="10" y2="10"></line></svg> <?php echo e($kegiatan->tanggal_mulai ? $kegiatan->tanggal_mulai->translatedFormat('d F Y') : 'Belum ditentukan'); ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->jam_mulai): ?>
                    pukul <?php echo e($kegiatan->jam_mulai_formatted); ?>

                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->tanggal_selesai): ?>
                    — <?php echo e($kegiatan->tanggal_selesai->translatedFormat('d F Y')); ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->jam_selesai): ?>
                        pukul <?php echo e($kegiatan->jam_selesai_formatted); ?>
        ...
        <div class="meta-item">
            ...
            <div class="meta-item-value"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> <?php echo e($kegiatan->lokasi); ?></div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->ketuaPelaksana): ?>
        <div class="meta-item">
            <div class="meta-item-label">Ketua Pelaksana</div>
            <div class="meta-item-value"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> <?php echo e($kegiatan->ketuaPelaksana->user->name ?? '-'); ?>

                <span style="font-size: 11px; color: #666D80; font-weight: 400;">(<?php echo e($kegiatan->ketuaPelaksana->student_number); ?>)</span>
            </div>
        </div>
        <?php elseif($kegiatan->penanggung_jawab): ?>
        <div class="meta-item">
            <div class="meta-item-label">Ketua Pelaksana</div>
            <div class="meta-item-value"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> <?php echo e($kegiatan->penanggung_jawab); ?></div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->dosenPendamping): ?>
        <div class="meta-item">
            <div class="meta-item-label">Dosen Pendamping</div>
            <div class="meta-item-value"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><path d="M22 10v6M2 10l10-5 10 5-10 5z"></path><path d="M6 12v5c3 3 9 3 12 0v-5"></path></svg> <?php echo e($kegiatan->dosenPendamping->user->name ?? '-'); ?>

                <span style="font-size: 11px; color: #666D80; font-weight: 400;">(<?php echo e($kegiatan->dosenPendamping->employee_number); ?>)</span>
            </div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->tahun): ?>
        <div class="meta-item">
            <div class="meta-item-label">Tahun</div>
            <div class="meta-item-value"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> <?php echo e($kegiatan->tahun); ?></div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->target_peserta): ?>
        <div class="meta-item">
            <div class="meta-item-label">Peserta</div>
            <div class="meta-item-value"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> <?php echo e($kegiatan->target_peserta); ?> orang</div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->anggaran && $canViewRestricted): ?>
        <div class="meta-item">
            <div class="meta-item-label">Anggaran</div>
            <div class="meta-item-value"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg> Rp <?php echo e(number_format($kegiatan->anggaran, 0, ',', '.')); ?></div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->panitia && $kegiatan->panitia->count() > 0): ?>
    <?php $panitiaList = $kegiatan->panitia; $panitiaCount = $panitiaList->count(); ?>
    <div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid #f3f4f6;">
        <div class="meta-item-label" style="margin-bottom: 10px;">
            ...
            PANITIA KEGIATAN
            <span style="font-size: 10px; font-weight: 600; background: #eef2ff; color: #0B266E; padding: 1px 7px; border-radius: 20px; margin-left: 4px;"><?php echo e($panitiaCount); ?> orang</span>
        </div>
        <div style="display: flex; flex-wrap: wrap; gap: 8px; align-items: center;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $panitiaList->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <span style="display: inline-flex; align-items: center; gap: 5px; padding: 5px 12px; background: #eef2ff; color: #091958; border-radius: 20px; font-size: 12px; font-weight: 600; border: 1px solid #5C78B8;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->pivot->peran): ?>
                        <span style="font-weight: 700; color: #091958; margin-left: 2px;">- <?php echo e($p->pivot->peran); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <span style="font-size: 10px; color: #0B266E; font-weight: 400;">(<?php echo e($p->student_number); ?>)</span>
                </span>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($panitiaCount > 2): ?>
                <button type="button" onclick="openPanitiaModal()" style="display:inline-flex;align-items:center;gap:5px;padding:5px 12px;background:#f3f4f6;color:#666D80;border-radius:20px;font-size:12px;font-weight:600;border:1px solid #DFE1E7;cursor:pointer;transition:all 0.2s;" onmouseover="this.style.background='#eef2ff';this.style.color='#091958';this.style.borderColor='#5C78B8'" onmouseout="this.style.background='#f3f4f6';this.style.color='#666D80';this.style.borderColor='#DFE1E7'">
                    ...
                    <?php echo e($panitiaCount - 2); ?> lainnya
                </button>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
        ...
        <div style="background:#fff;border-radius:20px;padding:0;max-width:480px;width:92%;max-height:80vh;display:flex;flex-direction:column;box-shadow:0 25px 60px rgba(0,0,0,0.18);animation:panitiaModalIn 0.25s cubic-bezier(0.34,1.56,0.64,1);">
            <div style="padding:22px 24px 16px;border-bottom:1px solid #f3f4f6;display:flex;align-items:center;justify-content:space-between;flex-shrink:0;">
                <div>
                    ...
                    <div style="font-size:12px;color:#666D80;margin-top:3px;font-weight:500;"><?php echo e($panitiaCount); ?> orang terdaftar</div>
                </div>
            ...
            <div style="overflow-y:auto;padding:16px 24px 24px;flex:1;">
                <div style="display:flex;flex-direction:column;gap:10px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $panitiaList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div style="display:flex;align-items:center;gap:12px;padding:12px 14px;background:#f9fafb;border:1px solid #f3f4f6;border-radius:12px;transition:all 0.2s;" onmouseover="this.style.background='#eef2ff';this.style.borderColor='#5C78B8'" onmouseout="this.style.background='#f9fafb';this.style.borderColor='#f3f4f6'">
                        <div style="width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,#0B266E,#0B266E);display:flex;align-items:center;justify-content:center;color:#fff;font-size:13px;font-weight:700;flex-shrink:0;"><?php echo e($idx + 1); ?></div>
                        <div style="flex:1;min-width:0;">
                            <div style="font-size:13px;font-weight:600;color:#0D0D12;"><?php echo e($p->user->name ?? '-'); ?></div>
                            <div style="font-size:11px;color:#666D80;font-weight:500;margin-top:1px;"><?php echo e($p->student_number ?? ''); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->pivot->peran): ?> &bull; <span style="color:#0B266E;font-weight:600;"><?php echo e($p->pivot->peran); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->pivot->peran): ?>
                        <span style="font-size:10px;font-weight:700;padding:3px 10px;background:#eef2ff;color:#091958;border-radius:20px;white-space:nowrap;border:1px solid #5C78B8;"><?php echo e($p->pivot->peran); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
...
<div class="detail-card">
    ...
    <div class="detail-description"><?php echo e($kegiatan->deskripsi); ?></div>
</div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalFiles > 0): ?>
    ...
    <div class="detail-card">
        <div class="gallery-header">
            ...
            <span class="gallery-count"><?php echo e($images->count()); ?> foto</span>
        </div>
        <div class="photo-gallery-grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $images->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="photo-gallery-item" onclick="openLightbox(<?php echo e($idx); ?>)">
                    <img src="<?php echo e($img->url); ?>" alt="<?php echo e($img->judul_file); ?>" loading="lazy">
                    <div class="photo-overlay">
                        ...
                        <span class="photo-name"><?php echo e($img->judul_file ?: $img->nama_file); ?></span>
                    </div>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
    ...
    <div class="detail-card">
        <div class="gallery-header">
            ...
            <span class="gallery-count"><?php echo e($videos->count()); ?> video</span>
        </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="video-card">
                    <video controls preload="metadata">
                        <source src="<?php echo e($vid->url); ?>" type="video/mp4">
                        Browser Anda tidak mendukung pemutar video.
                    </video>
                    <div class="video-info">
                        <div class="video-name"><?php echo e($vid->judul_file ?: $vid->nama_file); ?></div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($documents->count() > 0 && isset($canViewRestricted) && $canViewRestricted): ?>
    <div class="detail-card">
        <div class="gallery-header">
            <div class="detail-card-title" style="margin-bottom: 0;"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline></svg> Dokumen & Laporan</div>
            <span class="gallery-count"><?php echo e($documents->count()); ?> dokumen</span>
        </div>
        <div class="document-list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                ?>
                <a href="<?php echo e($doc->url); ?>" target="_blank" class="document-card" download>
                    <div class="doc-icon-wrapper <?php echo e($iconInfo[1]); ?>">
                        <?php echo e($iconInfo[0]); ?>

                    </div>
                    <div class="doc-details">
                        <div class="doc-title"><?php echo e($doc->judul_file ?: $doc->nama_file); ?></div>
                        <div class="doc-meta">
                            <span class="doc-ext-badge <?php echo e($iconInfo[2]); ?>"><?php echo e(strtoupper($ext)); ?></span>
...
<div id="deleteModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; align-items: center; justify-content: center;">
    <div style="background: #fff; border-radius: 16px; padding: 32px; max-width: 420px; width: 90%; text-align: center; box-shadow: 0 25px 60px rgba(0,0,0,0.15);">
        ...
        <p style="color: #666D80; font-size: 14px; margin-bottom: 24px;">
            Kegiatan <strong><?php echo e($kegiatan->judul); ?></strong> akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.
        </p>
        <div class="d-flex gap-3 justify-content-center">
            ...
            <form action="<?php echo e(route('manajemenmahasiswa.kegiatan.destroy', $kegiatan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="lightbox-modal" id="bannerLightboxModal">
    ...
    <div class="lightbox-content">
        <img src="<?php echo e($kegiatan->banner_url); ?>" alt="<?php echo e($kegiatan->judul); ?>">
    </div>
    <div class="lightbox-info">
        <div class="lightbox-title"><?php echo e($kegiatan->judul); ?></div>
    </div>
</div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
// Photo gallery data
const galleryImages = [
    <?php if(isset($images) && $images->count() > 0): ?>
        <?php $__currentLoopData = $images->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        {
            src: "<?php echo e($img->url); ?>",
            title: "<?php echo e(addslashes($img->judul_file ?: $img->nama_file)); ?>"
        },
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\kegiatan\show.blade.php ENDPATH**/ ?>
    ...
    <div class="dash-wrap">
        <div class="dash-box">
            ...
            <div class="dash-box-header">
                <?php echo $__env->make('superadmin.dashboard._header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>

            
            <div class="dash-box-body">
                <?php echo $__env->make('superadmin.dashboard._stats', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo $__env->make('superadmin.dashboard._chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo $__env->make('superadmin.dashboard._import', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo $__env->make('superadmin.dashboard._modules', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo $__env->make('superadmin.dashboard._activity', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
<?php echo $__env->make('superadmin.users._modal_import', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    try {
        ...
        if (res.ok) {
            ...
            setTimeout(async () => {
                ...
                await fetch('/superadmin/bust-stats-cache', { method: 'POST', headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' } });
                window.location.reload();
            }, 1500);
        }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    importForm.addEventListener('submit', async function (e) {
        ...
        try {
            const res  = await fetch(this.action, { method: 'POST', body: new FormData(this), headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' } });
            const data = await res.json();
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\dashboard\dashboard.blade.php ENDPATH**/ ?>
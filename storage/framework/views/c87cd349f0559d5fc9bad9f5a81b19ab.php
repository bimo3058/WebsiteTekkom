...
<div id="modal-tambah-manual" class="fixed inset-0 z-50 hidden flex items-center justify-center p-4 sm:p-6">
    ...
    <div class="relative w-full max-w-xl bg-white rounded-lg shadow-lg flex flex-col max-h-full z-10">
        ...
        <div class="px-6 py-4 overflow-y-auto">
            <!-- Form -->
            <form method="POST" action="<?php echo e(route('banksoal.pendaftaran.store')); ?>" id="form-tambah-manual"
                class="space-y-5">
                <?php echo csrf_field(); ?>

                
                <input type="hidden" name="periode_ujian_id" value="<?php echo e(request('periode_id')); ?>">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" name="nim" id="input-nim" value="<?php echo e(old('nim')); ?>" required placeholder="NIM"
                            class="flex-1 px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-gray-900 <?php $__errorArgs = ['nim'];
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['nim', 'pendaftar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="text-xs text-red-600 mt-1.5 font-medium"><?php echo e($message); ?></p>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="nama_lengkap" id="input-nama" value="<?php echo e(old('nama_lengkap')); ?>" required
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Semester<span
                            class="text-red-500">*</span></label>
                    <input type="text" name="semester_aktif" value="<?php echo e(old('semester_aktif')); ?>" required
    ...
    async function lookupNIM() {
        ...
        try {
            const response = await fetch(
                `<?php echo e(route('banksoal.pendaftaran.lookupNIM')); ?>?nim=${encodeURIComponent(nim)}`,
...
</script><?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pendaftaran\partials\modal-manual.blade.php ENDPATH**/ ?>
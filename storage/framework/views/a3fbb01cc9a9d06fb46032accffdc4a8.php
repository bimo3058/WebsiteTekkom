...
<div class="sk-login-root">
    ...
    <div class="sk-card">
        <div style="display:flex;flex-direction:column;align-items:center;gap:10px;">
            <img src="<?php echo e(asset('images/UNDIPOfficial.png')); ?>" alt="Logo UNDIP"
            ...
            <div class="sk-field-group">
                <div class="sk-field">
                    ...
                    <input id="email" class="sk-input" type="email" name="email"
                           value="<?php echo e(old('email')); ?>" placeholder="nama@undip.ac.id"
        ...
        <div class="sk-back-link">
            Kembali ke <a href="<?php echo e(route('login')); ?>">halaman login utama</a>
        </div>
    </div>

    <div class="sk-footer">
        <span>© <?php echo e(date('Y')); ?> Departemen Teknik Komunikasi &bull; Universitas Diponegoro</span>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\auth\dev-login.blade.php ENDPATH**/ ?>
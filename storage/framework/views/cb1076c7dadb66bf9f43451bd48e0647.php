...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => ['title' => 'Detail Mahasiswa']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Detail Mahasiswa']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

    <?php $__env->startSection('breadcrumbs'); ?>
        <a href="<?php echo e(route('eoffice.kp.koordinator.data_mahasiswa')); ?>"
            class="text-slate-400 hover:text-slate-800 transition-colors">Data Mahasiswa</a>
        <svg class="w-4 h-4 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        </svg>
        <span class="text-slate-800 font-semibold truncate max-w-[200px]"><?php echo e($m->nama); ?></span>
        ...
        <div
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('info')): ?>
                    <p class="text-[13px] mt-1"><?php echo e(session('info')); ?></p>
    ...
    <div class="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start mb-8">
        ...
        <div class="w-full lg:w-1/3 flex flex-col gap-6 shrink-0 lg:sticky lg:top-24">
            ...
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 flex flex-col items-center">
                <div
                    ...
                    <?php echo e(substr($m->nama, 0, 1)); ?>

                </div>
                <h2 class="text-lg font-extrabold text-slate-800 text-center leading-tight mb-1"><?php echo e($m->nama); ?></h2>
                <span
                    class="inline-flex items-center justify-center px-2 py-0.5 rounded text-xs font-bold bg-slate-100 text-slate-500 font-mono tracking-widest mb-4 border border-slate-200 shadow-sm"><?php echo e($m->nim); ?></span>
                ...
                <div class="w-full space-y-3">
                    <div class="flex justify-between items-start gap-4">
                        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider shrink-0">Status
                            KP</span>
                        <span
                            class="text-xs font-bold px-2 py-0.5 rounded-full whitespace-nowrap <?php echo e($m->status_kp === 'Pra KP' ? 'bg-amber-50 text-amber-600' : ($m->status_kp === 'Saat KP' ? 'bg-blue-50 text-blue-600' : (in_array($m->status_kp, ['Dibatalkan', 'Gagal']) ? 'bg-rose-50 text-rose-600' : 'bg-emerald-50 text-emerald-600'))); ?>">
                            <?php echo e($m->status_kp); ?>
                    ...
                    <div class="flex flex-col gap-1 text-left">
                        <span class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Dosen
                            Pembimbing</span>
                        <span
                            class="text-[13px] font-bold text-slate-800 leading-normal"><?php echo e($m->dosen_pembimbing); ?></span>
                    </div>
                    <div class="flex flex-col gap-1 text-left">
                        <span class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Tempat KP
                            (Perusahaan)</span>
                        <span class="text-[13px] font-bold text-slate-800 leading-normal"><?php echo e($m->tempat_kp); ?></span>
                    </div>
                    <div class="flex flex-col gap-1 text-left">
                        <span class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Judul
                            Laporan</span>
                        <span class="text-[13px] font-bold text-slate-800 leading-normal"><?php echo e($m->judul_kp); ?></span>
                    </div>
                    <div class="flex justify-between items-start gap-4 mt-2">
                        <div class="flex flex-col gap-1 text-left w-1/2">
                            <span class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Periode
                                KP</span>
                            <span
                                class="text-[13px] font-bold text-slate-800 leading-normal"><?php echo e($m->periode_name); ?></span>
                        </div>
                        <div class="flex flex-col gap-1 text-left w-1/2">
                            <span class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">IPK /
                                SKS</span>
                            <span class="text-[13px] font-bold text-slate-800 leading-normal"><?php echo e($m->ipk); ?> /
                                <?php echo e($m->sks_diambil); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="<?php echo e(route('eoffice.kp.koordinator.data_mahasiswa.update', $m->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden"
                    ...
                    <div x-show="expanded" x-collapse x-cloak
                        ...
                        <div>
                            ...
                            <select name="dosen_pembimbing_id"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($dosen->id); ?>" <?php echo e($m->dosen_pembimbing_id == $dosen->id ? 'selected' : ''); ?>>
                        ...
                        <div>
                            ...
                            <select name="kelas"
                                class="w-full text-xs font-semibold text-slate-600 border border-slate-200 rounded-lg px-2.5 py-2 shadow-sm focus:ring-1 focus:ring-indigo-500">
                                <option value="" <?php echo e($m->kelas === '-' ? 'selected' : ''); ?>>-- Belum Dialokasikan --
                                </option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($m->kelas_dibuka)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $m->kelas_dibuka; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <option value="<?php echo e($k); ?>" <?php echo e($m->kelas === $k ? 'selected' : ''); ?>><?php echo e($k); ?></option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <?php else: ?>
                        ...
                        <div>
                            ...
                            <select name="force_periode"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $periodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($p->id); ?>" <?php echo e($m->periode_id == $p->id ? 'selected' : ''); ?>>
                                        Sem. <?php echo e($p->semester); ?> <?php echo e($p->tahun_ajaran); ?> <?php echo e($p->is_active ? '(Aktif)' : ''); ?>
                        ...
                        <div x-data="{ forceStatus: '' }">
                            ...
                            <select name="force_status" x-model="forceStatus"
                                ...
                                <option value="" <?php echo e(!in_array($m->status_kp, ['Dibatalkan', 'Selesai']) ? 'selected' : ''); ?>>-- Ikuti Sistem (Otomatis) --</option>
                                <option value="Dibatalkan" <?php echo e($m->status_kp === 'Dibatalkan' ? 'selected' : ''); ?>>Batalkan
                                    Pelaksanaan KP (Gagal)</option>
                                <option value="Selesai" <?php echo e($m->status_kp === 'Selesai' ? 'selected' : ''); ?>>Luluskan /
                                    Selesai</option>
                            </select>

                            <div x-show="forceStatus === 'Dibatalkan' || '<?php echo e($m->status_kp); ?>' === 'Dibatalkan'"
                                ...
                                <textarea name="keterangan_status" rows="2"
                                    ...
                                    placeholder="Wajib diisi jika gagal/batal. Contoh: DO dari perusahaan."><?php echo e($m->keterangan_status ?? ''); ?></textarea>
                            </div>
                        </div>
        ...
        <div class="w-full lg:w-2/3 flex flex-col gap-6">
            ...
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="p-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dokumenKoor->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        <table class="w-full text-left border-collapse table-auto">
                            <tbody class="border-t-0 border-slate-200 divide-y divide-slate-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dokumenKoor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        <td class="px-6 py-4 w-1/2">
                                            <div class="flex items-start gap-3">
                                                ...
                                                ?>
                                                <div
                                                    class="mt-0.5 shrink-0 w-8 h-8 rounded-lg <?php echo e($isPdf ? 'bg-rose-50 text-rose-500' : 'bg-blue-50 text-blue-500'); ?> flex items-center justify-center shadow-sm border <?php echo e($isPdf ? 'border-rose-100' : 'border-blue-100'); ?>">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="inline-flex px-1.5 py-0.5 rounded text-[10px] font-bold tracking-widest uppercase shadow-sm border border-slate-200 <?php echo e($dok->approval_status === 'approved' || $dok->status_validasi === 'disetujui' ? 'bg-emerald-50 border-emerald-200 text-emerald-600' : ($dok->approval_status === 'rejected' || $dok->status_validasi === 'ditolak' ? 'bg-rose-50 border-rose-200 text-rose-600' : 'bg-slate-100 text-slate-500')); ?>">
                                                        <?php echo e($dok->approval_status === 'approved' || $dok->status_validasi === 'disetujui' ? 'Disetujui' : ($dok->approval_status === 'rejected' || $dok->status_validasi === 'ditolak' ? 'Revisi' : 'Menunggu')); ?>

                                                    </span>
                                                </div>
                                            </div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($dok->approval_status === 'rejected' || $dok->status_validasi === 'ditolak') && $dok->revision_note): ?>
                                                <div
                                                    class="mt-3 text-xs bg-rose-50/50 text-rose-700 py-1.5 px-3 rounded-md border border-rose-100 font-medium italic">
                                                    <span class="font-bold">📝 Catatan:</span> <?php echo e($dok->revision_note); ?>
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end gap-2 flex-wrap">
                                                ...
                                                <!-- Tombol Aksi Koor -->
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dok->approval_status !== 'approved' && $dok->status_validasi !== 'disetujui'): ?>
                                                    <!-- Reject Modal Alpine -->
                                                    <div x-data="{ openRejectModal: false, note: '' }" class="inline-block">
                                                        <form
                                                            action="<?php echo e(route('eoffice.kp.koordinator.data_mahasiswa.dokumen.reject', ['kp_id' => $kp->id, 'dokumen_id' => $dok->id])); ?>"
                                                                                ...
                                                                                <div class="sm:flex sm:items-start">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <h3
                                                                                            ...
                                                                                            Tolak Dokumen Koor
                                                                                            (<?php echo e($dok->jenis_dokumen); ?>)</h3>
                                                                                        <div>
                                                                                            <label for="catatan"
                                                    ...
                                                    <!-- Approve Buton -->
                                                    <form
                                                        action="<?php echo e(route('eoffice.kp.koordinator.data_mahasiswa.dokumen.approve', ['kp_id' => $kp->id, 'dokumen_id' => $dok->id])); ?>"
            ...
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden mt-2">
                ...
                <div class="p-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dokumenDosen->isEmpty()): ?>
                        <div class="py-12 flex flex-col items-center justify-center text-center">
                    ...
                    <?php else: ?>
                        <table class="w-full text-left border-collapse table-auto">
                            <tbody class="border-t-0 border-slate-200 divide-y divide-slate-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dokumenDosen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        <td class="px-6 py-4">
                                            <div class="flex items-start gap-3">
                                                <?php
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="inline-flex px-1.5 py-0.5 rounded text-[10px] font-bold tracking-widest uppercase shadow-sm border border-slate-200 <?php echo e($dok->approval_status === 'approved' || $dok->status_validasi === 'disetujui' ? 'bg-emerald-50 border-emerald-200 text-emerald-600' : ($dok->approval_status === 'rejected' || $dok->status_validasi === 'ditolak' ? 'bg-rose-50 border-rose-200 text-rose-600' : 'bg-slate-100 text-slate-500')); ?>">
                                                        <?php echo e($dok->approval_status === 'approved' || $dok->status_validasi === 'disetujui' ? 'Disetujui' : ($dok->approval_status === 'rejected' || $dok->status_validasi === 'ditolak' ? 'Revisi' : 'Menunggu Dosen')); ?>
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end gap-2 flex-wrap">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dok->approval_status === 'approved' || $dok->approval_status === 'rejected' || $dok->status_validasi === 'disetujui' || $dok->status_validasi === 'ditolak'): ?>
                                                    <form
                                                        action="<?php echo e(route('eoffice.kp.koordinator.data_mahasiswa.dokumen.reset', ['kp_id' => $kp->id, 'dokumen_id' => $dok->id])); ?>"
                                                        method="POST" class="inline">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit"
            ...
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden mt-2">
                ...
                <div class="p-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($komponenKoor->isEmpty()): ?>
                        <div class="py-12 flex flex-col items-center justify-center text-center">
                    ...
                    <?php else: ?>
                        <form action="<?php echo e(route('eoffice.kp.koordinator.data_mahasiswa.update', $m->id)); ?>" method="POST">
                            ...
                            <div class="space-y-4 max-w-lg">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $komponenKoor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $komp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div>
                                        <label
                                            class="block text-[13px] font-bold text-slate-700 mb-1.5"><?php echo e($komp->nama_komponen); ?>

                                            <span class="text-xs text-slate-400 font-normal italic ml-1">(Bobot:
                                                <?php echo e($komp->bobot); ?>%)</span></label>
                                        <div class="relative">
                                            <input type="number" step="0.01" min="0" max="100" name="nilai_<?php echo e($komp->id); ?>"
                                                value="<?php echo e($komp->nilai_angka ?? ''); ?>"
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($komp->nilai_angka)): ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\mahasiswa_detail.blade.php ENDPATH**/ ?>
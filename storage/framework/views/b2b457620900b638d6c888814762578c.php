...
<div class="detail-header">
    <a href="<?php echo e(route('manajemenmahasiswa.pelaksanaan.show', $proker->id)); ?>" class="btn-back">
        &larr;
    </a>
    <div>
        <h3 class="fw-bold mb-0" style="font-size:1.45rem;color:#0D0D12;letter-spacing:-.02em;">Edit Pelaksanaan Kegiatan</h3>
        <p class="mb-0" style="font-size:.82rem;color:#666D80;font-weight:500;">Perbarui informasi kegiatan <strong><?php echo e($proker->judul); ?></strong></p>
    </div>
</div>
...
<form action="<?php echo e(route('manajemenmahasiswa.pelaksanaan.update', $proker->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-card">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="judul" class="form-control form-control-custom"
                   value="<?php echo e(old('judul', $proker->judul)); ?>" required maxlength="255">
        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="checkbox-card-group" id="kategoriGroup">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kategoriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <label class="checkbox-card" id="kategoriCard<?php echo e($kategori->id); ?>">
                            <input type="checkbox" name="kategori_kegiatan_id[]"
                                   value="<?php echo e($kategori->id); ?>"
                                   data-is-prodi="<?php echo e(stripos($kategori->nama_kategori, 'prodi') !== false ? '1' : '0'); ?>"
                                   onchange="handleKategoriChange()"
                                   <?php echo e(in_array($kategori->id, $selectedKategoriIds) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6" id="bidangFieldWrapper">
                ...
                <div class="checkbox-card-group" id="bidangGroup">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bidangList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bidang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <label class="checkbox-card" id="bidangCard<?php echo e($bidang->id); ?>">
                            <input type="checkbox" name="bidang_id[]"
                                   value="<?php echo e($bidang->id); ?>"
                                   <?php echo e(in_array($bidang->id, $selectedBidangIds) ? 'checked' : ''); ?>>
        ...
        <div class="mb-3">
            ...
            <textarea name="deskripsi" class="form-control form-control-custom" required><?php echo e(old('deskripsi', $proker->deskripsi)); ?></textarea>
        </div>
    ...
    <div class="form-card">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-3">
                ...
                <input type="date" name="tanggal_mulai" class="form-control form-control-custom"
                       value="<?php echo e(old('tanggal_mulai', $proker->tanggal_mulai?->format('Y-m-d'))); ?>" required>
            </div>
            <div class="col-md-3">
                <label class="form-label-custom">Jam Mulai</label>
                <input type="time" name="jam_mulai" class="form-control form-control-custom"
                       value="<?php echo e(old('jam_mulai', $proker->jam_mulai_formatted)); ?>">
            </div>
            <div class="col-md-3">
                ...
                <input type="date" name="tanggal_selesai" class="form-control form-control-custom"
                       value="<?php echo e(old('tanggal_selesai', $proker->tanggal_selesai?->format('Y-m-d'))); ?>">
            </div>
            <div class="col-md-3">
                <label class="form-label-custom">Jam Selesai</label>
                <input type="time" name="jam_selesai" class="form-control form-control-custom"
                       value="<?php echo e(old('jam_selesai', $proker->jam_selesai_formatted)); ?>">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="lokasi" class="form-control form-control-custom"
                   value="<?php echo e(old('lokasi', $proker->lokasi)); ?>">
        </div>
    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="search-select-wrapper">
                    <input type="hidden" name="ketua_pelaksana_id" id="ketuaPelaksanaId"
                           value="<?php echo e(old('ketua_pelaksana_id', $proker->ketua_pelaksana_id)); ?>">
                    <input type="text" class="form-control form-control-custom" id="ketuaPelaksanaSearch"
                           placeholder="Cari nama mahasiswa..."
                           value="<?php echo e($ketuaNama); ?>"
                           autocomplete="off"
                    ...
                    <div class="search-select-dropdown" id="ketuaPelaksanaDropdown">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mahasiswaList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mhs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="search-select-option"
                                 onclick="selectOption('ketuaPelaksanaId', '<?php echo e($mhs->id); ?>', 'ketuaPelaksanaSearch', '<?php echo e($mhs->user->name ?? 'N/A'); ?>', 'ketuaPelaksanaDropdown')"
                                 data-name="<?php echo e(strtolower($mhs->user->name ?? '')); ?>"
                                 data-nim="<?php echo e($mhs->student_number); ?>">
                                <?php echo e($mhs->user->name ?? 'N/A'); ?>

                                <div class="sub-text">NIM: <?php echo e($mhs->student_number); ?> • Angkatan <?php echo e($mhs->cohort_year); ?></div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="search-select-wrapper">
                    <input type="hidden" name="dosen_pendamping_id" id="dosenPendampingId"
                           value="<?php echo e(old('dosen_pendamping_id', $proker->dosen_pendamping_id)); ?>">
                    <input type="text" class="form-control form-control-custom" id="dosenPendampingSearch"
                           placeholder="Cari nama dosen..."
                           value="<?php echo e($dosenNama); ?>"
                           autocomplete="off"
                    ...
                    <div class="search-select-dropdown" id="dosenPendampingDropdown">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dosenList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="search-select-option"
                                 onclick="selectOption('dosenPendampingId', '<?php echo e($dosen->id); ?>', 'dosenPendampingSearch', '<?php echo e($dosen->user->name ?? 'N/A'); ?>', 'dosenPendampingDropdown')"
                                 data-name="<?php echo e(strtolower($dosen->user->name ?? '')); ?>"
                                 data-nip="<?php echo e($dosen->employee_number); ?>">
                                <?php echo e($dosen->user->name ?? 'N/A'); ?>

                                <div class="sub-text">NIP: <?php echo e($dosen->employee_number); ?></div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="panitia-dropdown" id="panitiaDropdown">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mahasiswaList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mhs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="panitia-option"
                             ...
                             data-name="<?php echo e($mhs->user->name ?? 'N/A'); ?>"
                             data-name-lower="<?php echo e(strtolower($mhs->user->name ?? '')); ?>"
                             data-nim="<?php echo e($mhs->student_number); ?>"
                             data-angkatan="<?php echo e($mhs->cohort_year); ?>"
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="number" name="target_peserta" class="form-control form-control-custom"
                       value="<?php echo e(old('target_peserta', $proker->target_peserta)); ?>" min="1">
            </div>
            <div class="col-md-6">
                <label class="form-label-custom">Anggaran (Rp)</label>
                <input type="number" name="anggaran" class="form-control form-control-custom"
                       value="<?php echo e(old('anggaran', $proker->anggaran)); ?>" min="0" max="9999999999999" step="1000">
            </div>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proker->banner): ?>
            <div class="banner-current">
                ...
                <img src="<?php echo e($proker->banner_url); ?>" alt="Banner saat ini" class="banner-preview" style="display: block;" onclick="openLightbox(this.src)" title="Klik untuk memperbesar">
            </div>
        ...
        <div class="banner-upload-area" onclick="document.getElementById('bannerInput').click()">
            ...
            <p>Klik untuk upload banner <?php echo e($proker->banner ? 'baru' : 'kegiatan'); ?></p>
    ...
    <div class="form-card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingFoto->count() > 0): ?>
            <div class="existing-file-label">Foto yang sudah diupload</div>
            <div class="file-preview-grid" style="margin-bottom: 16px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $existingFoto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="file-preview-item" id="existingFile<?php echo e($foto->id); ?>">
                        <button type="button" class="btn-remove-file" onclick="markFileForDeletion(<?php echo e($foto->id); ?>)"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
                        <img src="<?php echo e($foto->url); ?>" alt="<?php echo e($foto->judul_file); ?>" style="cursor: pointer;" onclick="openLightbox(this.src)" title="Klik untuk memperbesar">
                        <div class="file-info"><?php echo e($foto->nama_file); ?></div>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="form-card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingDokumen->count() > 0): ?>
            <div class="existing-file-label">Dokumen yang sudah diupload</div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $existingDokumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                ...
                ?>
                <div class="doc-preview-item" id="existingFile<?php echo e($doc->id); ?>">
                    <span class="doc-icon"><?php echo e($icon); ?></span>
                    <div class="doc-info">
                        <div class="doc-name"><?php echo e($doc->nama_file); ?></div>
                        <div class="doc-size"><?php echo e(strtoupper($ext)); ?></div>
                    </div>
                    <a href="<?php echo e($doc->url); ?>" target="_blank" class="btn-remove-doc" style="background: #dbeafe; color: #2563eb;" title="Download"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg></a>
                    <button type="button" class="btn-remove-doc" onclick="markFileForDeletion(<?php echo e($doc->id); ?>)" title="Hapus"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    ...
    <div class="d-flex gap-3 justify-content-end mt-2">
        <a href="<?php echo e(route('manajemenmahasiswa.pelaksanaan.show', $proker->id)); ?>" class="btn-cancel">Batal</a>
...
<?php $__currentLoopData = $existingPanitia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
selectedPanitia['<?php echo e($pan->id); ?>'] = '<?php echo e(addslashes($pan->user->name ?? '')); ?>';
initialRoles['<?php echo e($pan->id); ?>'] = '<?php echo e(addslashes($pan->pivot->peran ?? '')); ?>';
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\pelaksanaan\edit.blade.php ENDPATH**/ ?>
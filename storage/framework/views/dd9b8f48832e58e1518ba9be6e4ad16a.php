...
<div class="flex h-screen w-full overflow-hidden">
    ...
    <aside data-mobile-sidebar :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex-1 overflow-y-auto py-6 px-4">
            ...
            <a href="<?php echo e(route('eoffice.admin.template_proposal')); ?>"
            ...
            <a href="<?php echo e(route('eoffice.admin.kelola_role')); ?>"
                class="flex items-center px-4 py-3 mb-1 text-slate-600 hover:text-indigo-700 hover:bg-indigo-50 rounded-xl transition-all text-sm font-medium">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('eoffice.admin.validasi_timeline')); ?>"
        ...
        <div class="p-4 border-t border-slate-100 shrink-0">
            <div class="flex items-center gap-3 px-4 py-3 bg-slate-50 rounded-xl border border-slate-100">
                <div class="w-9 h-9 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold text-sm shadow-sm border border-indigo-200"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'A', 0, 1))); ?></div>
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-bold text-slate-900 truncate"><?php echo e(auth()->user()->name ?? 'Admin SIKAPE'); ?></p>
                    <p class="text-[11px] text-slate-500 truncate"><?php echo e(auth()->user()->email ?? 'admin@sikape.undip.ac.id'); ?></p>
                </div>
            </div>
        </div>
    </aside>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\dashboard\admin\validasi_timeline.blade.php ENDPATH**/ ?>
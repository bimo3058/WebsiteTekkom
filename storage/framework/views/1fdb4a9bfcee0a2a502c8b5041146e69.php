...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-ruangan.layout','data' => ['pageTitle' => 'Edit User']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => 'Edit User']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mp-page-header">
        <div>
            ...
            <p class="mp-page-sub">Ubah profil, reset password, atau atur ulang role untuk akun <?php echo e($user->name); ?>.</p>
        </div>
        <div>
            <a href="<?php echo e(route('eoffice.peminjaman.admin.user.index')); ?>" class="mp-btn secondary">Kembali</a>
        </div>
    </div>

    <div class="mp-card" style="padding: 24px; max-width: 600px;">
        <form action="<?php echo e(route('eoffice.peminjaman.admin.user.update', $user->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <span style="color:#D92D20; font-size:12px;"><?php echo e($message); ?></span> <?php unset($message);
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span style="color:#D92D20; font-size:12px; display:block;"><?php echo e($message); ?></span>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div style="margin-bottom: 24px;">
                ...
                <select name="role" class="mp-input" style="width:100%;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($role->name); ?>" <?php echo e($user->roles->contains('name', $role->name) ? 'selected' : ''); ?>><?php echo e($role->name); ?></option>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-ruangan\admin\user\edit.blade.php ENDPATH**/ ?>
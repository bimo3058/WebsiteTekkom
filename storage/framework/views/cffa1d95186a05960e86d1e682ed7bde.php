    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <div class="flex-1 flex flex-col min-h-0 overflow-hidden">
            ...
            <div class="flex-1 flex flex-col min-h-0 overflow-hidden rounded-lg"
                ...
                <?php echo $__env->make('eoffice::kp.mahasiswa.partials.topbar', ['breadcrumb' => 'Seminar KP'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div x-data="{ show: true }" x-show="show" x-transition
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-rose-700"><?php echo e(session('error')); ?></p>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 gap-8">
                                    <div class="space-y-6">
                                        ...
                                        <div class="mt-8 pt-6">
                                            ...
                                            <div class="space-y-3">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($templatesDokumen && $templatesDokumen->isNotEmpty()): ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $templatesDokumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tmpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                        <?php
                                                            $jenis = $tmpl->title;
                                                            ...
                                                            <div class="flex items-center gap-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-[11px] text-slate-500 mt-0.5">
                                                                        <?php echo e($tmpl->description ?? 'Dokumen Pasca KP'); ?></p>
                                                                    ...
                                                                    <form action="<?php echo e(route('eoffice.kp.mahasiswa.dokumen.store')); ?>"
                                                                        ...
                                                                        <div class="relative w-full sm:w-auto">
                                                                            ...
                                                                            <label for="dokumen_<?php echo e($tmpl->id); ?>"
                                                                                ...
                                                                                <span
                                                                                    x-text="fileName ? fileName : '<?php echo e($latestDoc ? 'Unggah Ulang' : 'Upload File'); ?>'"
                                    ...
                                    <?php echo e($currentStep === 2 ? 'border-indigo-500 ring-4 ring-indigo-100 shadow-lg shadow-indigo-100/40' : ($step2Done ? 'border-emerald-200 shadow-sm' : 'border-slate-200 shadow-sm')); ?>">

                                            <div
                                                class="px-6 py-4 border-b border-slate-100 flex items-center justify-between <?php echo e($currentStep === 2 ? 'bg-indigo-50/40' : ''); ?>">
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        class="w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm
                                                <?php echo e($step2Done ? 'bg-indigo-600 text-white' : ($currentStep === 2 ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-400')); ?>">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step2Done): ?><svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
                                                                    d="M5 13l4 4L19 7" />
                                                            </svg>
                                                        <?php else: ?><svg class="w-4 h-4 text-current" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                    d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                                            </svg>
                                                ...
                                                <span
                                                    class="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider <?php echo e($semB['cls']); ?>"><?php echo e($semB['txt']); ?></span>
                                            </div>

                                            <div class="p-6">
                                                
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kp->seminar && $semStatus !== 'rejected'): ?>
                                                    <div class="grid grid-cols-3 gap-3 mb-5">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [
                                                            ...
                                                            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                            <div class="bg-slate-50 rounded-xl p-3 border border-slate-100">
                                                                <p
                                                                    class="text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">
                                                                    <?php echo e($inf['label']); ?></p>
                                                                <p class="text-sm font-bold text-slate-900"><?php echo e($inf['val']); ?></p>
                                                            </div>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                    </div>

                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($semStatus === 'approved'): ?>
                                                        <div
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($semStatus === 'rejected'): ?>
                                                                ...
                                                                <div class="flex-1 relative z-10">
                                                                    ...
                                                                    <div class="bg-white/60 p-3 rounded-lg border border-red-100/50">
                                                                        ...
                                                                        <p class="text-[13px] text-red-950 font-medium italic">
                                                                            "<?php echo e($kp->seminar->catatan_dosen ?? 'Tidak ada catatan tambahan.'); ?>"
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$kp->seminar || $semStatus === 'rejected'): ?>
                                                            <form action="<?php echo e(route('eoffice.kp.mahasiswa.seminar.store')); ?>" method="POST"
                                                                class="space-y-4">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                                    <div>
                                                                        <label
                                                                            ...
                                                                            Mahasiswa</label>
                                                                        <input type="text" value="<?php echo e($mahasiswa->nama_lengkap); ?>" readonly
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="text" value="<?php echo e($mahasiswa->nim); ?>" readonly
                                                                            class="w-full rounded-xl border-slate-200 text-sm py-2.5 px-4 border bg-slate-100 text-slate-500 cursor-not-allowed">
                                                                    </div>
                                        ...
                                        <div
                                            class="bg-white rounded-2xl border overflow-hidden transition-all duration-300
                                    <?php echo e($currentStep === 3 ? 'border-indigo-500 ring-4 ring-indigo-100 shadow-lg shadow-indigo-100/40' : ($step3Done ? 'border-emerald-200 shadow-sm' : 'border-slate-200 shadow-sm')); ?>">

                                            <div
                                                class="px-6 py-4 border-b border-slate-100 flex items-center justify-between <?php echo e($currentStep === 3 ? 'bg-indigo-50/40' : ''); ?>">
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        class="w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm
                                                <?php echo e($step3Done ? 'bg-indigo-600 text-white' : ($currentStep === 3 ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-400')); ?>">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step3Done): ?><svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
                                                                    d="M5 13l4 4L19 7" />
                                                            </svg>
                                            ...
                                            <?php echo e($step3Done ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-500'); ?>">
                                                    <?php echo e($step3Done ? 'Nilai Tersedia' : 'Menunggu Penilaian'); ?>
                                            ...
                                            <div class="p-6">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step3Done): ?>
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-1 gap-4 mb-5">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nilaiAkhir !== null): ?>
                                                            <div
                                                                ...
                                                                <div class="flex items-end gap-3">
                                                                    <span
                                                                        class="text-5xl font-black text-emerald-700 leading-none"><?php echo e($nilaiAkhir); ?></span>
                                                                </div>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\kp\mahasiswa\seminar.blade.php ENDPATH**/ ?>
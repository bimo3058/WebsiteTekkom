...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'banksoal::components.ui.page-header','data' => ['title' => 'Validasi RPS','subtitle' => 'Pantau riwayat dokumen RPS yang telah direview']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Validasi RPS','subtitle' => 'Pantau riwayat dokumen RPS yang telah direview']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('banksoal.rps.gpm.periode-rps.create')); ?>" class="gpm-rps-action-btn gpm-rps-action-btn-lg gpm-rps-btn-primary">
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activePeriode): ?>
        <div class="mb-6 rounded-2xl border border-slate-200 bg-slate-50 p-4 border-l-4 <?php echo e($isPeriodeRunning ? 'border-emerald-500' : 'border-slate-400'); ?>">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    <div class="flex h-10 w-10 items-center justify-center rounded-full <?php echo e($isPeriodeRunning ? 'bg-emerald-100 text-emerald-600' : 'bg-slate-200 text-slate-600'); ?>">
                        <i class="fas fa-calendar-check"></i>
                    </div>
                    <div>
                        <p class="text-sm font-semibold text-slate-900"><?php echo e($activePeriode->judul); ?></p>
                        <p class="text-xs text-slate-500">Tenggat: <?php echo e(\Carbon\Carbon::parse($activePeriode->tanggal_mulai)->locale('id')->translatedFormat('d M Y')); ?> s.d. <?php echo e(\Carbon\Carbon::parse($activePeriode->tanggal_selesai)->locale('id')->translatedFormat('d M Y')); ?></p>
                    </div>
                </div>
                <div class="flex items-center gap-3 flex-wrap">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPeriodeRunning): ?>
    ...
    <?php else: ?>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-amber-900">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inactivePeriodes->count() > 0): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inactivePeriodes->count() > 0): ?>
            <div class="mb-6">
                ...
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $inactivePeriodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="bg-white border border-slate-200 rounded-2xl p-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500"><?php echo e(\Carbon\Carbon::parse($periode->tanggal_mulai)->locale('id')->translatedFormat('d M Y H:i')); ?> s.d. <?php echo e(\Carbon\Carbon::parse($periode->tanggal_selesai)->locale('id')->translatedFormat('d M Y H:i')); ?></p>
                                </div>
                            </div>
                            <button type="button" class="inline-flex items-center gap-2 rounded-xl border border-primary/20 px-3 py-2 text-xs font-semibold text-primary hover:bg-primary/10" data-modal-open="modalOpenSession" data-periode-id="<?php echo e($periode->id); ?>" data-periode-judul="<?php echo e($periode->judul); ?>" onclick="setPeriodeData(this)">
    ...
    <div data-tabs>
        <div class="flex flex-col gap-4 border-b border-slate-200 pb-4 mb-6 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex flex-wrap gap-6 text-sm font-semibold">
                <button type="button" class="pb-2 border-b-2 border-primary text-primary" data-tab-target="menunggu" data-tab-active>
                    Menunggu Validasi
                    <span class="ml-2 inline-flex items-center rounded-full bg-primary/10 px-2 py-0.5 text-[11px] font-semibold text-primary border border-primary/20"><?php echo e($rpsDiajukan->total()); ?></span>
                </button>
                <button type="button" class="pb-2 border-b-2 border-transparent text-slate-500" data-tab-target="revisi">
                    Menunggu Revisi
                    <span class="ml-2 inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-[11px] font-semibold text-slate-600 border border-slate-200"><?php echo e($rpsRevisi->total()); ?></span>
                </button>
                <button type="button" class="pb-2 border-b-2 border-transparent text-slate-500" data-tab-target="disetujui">
                    Disetujui
                    <span class="ml-2 inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-[11px] font-semibold text-slate-600 border border-slate-200"><?php echo e($rpsDisetujui->total()); ?></span>
                </button>
            </div>
        </div>
        ...
        <div data-tab-panel="menunggu">
                        ...
                        <div class="pt-3 border-t border-slate-100">
                            ...
                            <div class="space-y-2">
                                <select x-model="selectedTahun" @change="applyFilters()" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20">
                                    ...
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $yearsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full" id="table-menunggu">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rpsDiajukan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="font-semibold text-slate-900"><?php echo e($rps->mataKuliah->nama); ?> (<?php echo e($rps->mataKuliah->kode); ?>)</div>
                                        <div class="text-xs text-slate-500">Semester <?php echo e($rps->semester); ?> <?php echo e($rps->tahun_ajaran); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col gap-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $rps->dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <?php
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <div class="flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 text-primary text-xs font-semibold"><?php echo e($initials); ?></div>
                                                    <span class="text-sm font-medium text-slate-700"><?php echo e($dosen->name); ?></span>
                                                </div>
                                    ...
                                    <td class="px-6 py-4 text-sm text-slate-600"><?php echo e($rps->created_at->format('d M Y')); ?></td>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="<?php echo e(route('banksoal.rps.gpm.validasi-rps.review', $rps->id)); ?>" class="gpm-rps-action-btn">
            ...
            <div class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <span class="text-xs text-slate-500">Menampilkan <?php echo e($rpsDiajukan->count()); ?> dari <?php echo e($rpsDiajukan->total()); ?> entri</span>
                <?php echo e($rpsDiajukan->links('banksoal::components.ui.laravel-pagination')); ?>
        ...
        <div class="hidden" data-tab-panel="revisi">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full" id="table-revisi">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rpsRevisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="font-semibold text-slate-900"><?php echo e($rps->mataKuliah->nama); ?> (<?php echo e($rps->mataKuliah->kode); ?>)</div>
                                        <div class="text-xs text-slate-500">Semester <?php echo e($rps->semester); ?> <?php echo e($rps->tahun_ajaran); ?></div>
                                    ...
                                    <td class="px-6 py-4 text-sm text-slate-600"><?php echo e($rps->updated_at->format('d M Y')); ?></td>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="<?php echo e(route('banksoal.rps.gpm.validasi-rps.revisi', $rps->id)); ?>" class="gpm-rps-action-btn">
            ...
            <div class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <span class="text-xs text-slate-500">Menampilkan <?php echo e($rpsRevisi->count()); ?> dari <?php echo e($rpsRevisi->total()); ?> entri</span>
                <?php echo e($rpsRevisi->links('banksoal::components.ui.laravel-pagination')); ?>
        ...
        <div class="hidden" data-tab-panel="disetujui">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full" id="table-disetujui">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rpsDisetujui; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="font-semibold text-slate-900"><?php echo e($rps->mataKuliah->nama); ?> (<?php echo e($rps->mataKuliah->kode); ?>)</div>
                                        <div class="text-xs text-slate-500">Semester <?php echo e($rps->semester); ?> <?php echo e($rps->tahun_ajaran); ?></div>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="<?php echo e(route('banksoal.rps.gpm.validasi-rps.setuju', $rps->id)); ?>" class="gpm-rps-action-btn">
            ...
            <div class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <span class="text-xs text-slate-500">Menampilkan <?php echo e($rpsDisetujui->count()); ?> dari <?php echo e($rpsDisetujui->total()); ?> entri</span>
                <?php echo e($rpsDisetujui->links('banksoal::components.ui.laravel-pagination')); ?>
    ...
    <div id="modalCloseSession" class="fixed inset-0 z-50 hidden" aria-hidden="true">
        ...
        <div class="relative mx-auto mt-24 w-full max-w-sm rounded-2xl bg-white shadow-xl animate-popup">
            <form action="<?php echo e(route('banksoal.rps.gpm.periode-rps.close-session')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="px-5 py-5 text-center">
                    ...
                    <p class="text-xs text-slate-500 mt-2">Sesi pengajuan <strong><?php echo e($activePeriode->judul ?? 'RPS'); ?></strong> akan ditutup. Dosen tidak akan bisa lagi mengajukan RPS sampai periode baru diaktifkan.</p>
    ...
    <div id="modalOpenSession" class="fixed inset-0 z-50 hidden" aria-hidden="true">
        ...
        <div class="relative mx-auto mt-24 w-full max-w-sm rounded-2xl bg-white shadow-xl animate-popup">
            <form action="<?php echo e(route('banksoal.rps.gpm.periode-rps.open-session')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\gpm\validasi-rps.blade.php ENDPATH**/ ?>
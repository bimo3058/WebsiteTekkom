...
<?php endif; ?>
    ...
    <div class="create-post-card">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($drafts) && $drafts->count() > 0): ?>
                <button type="button" class="btn btn-sm rounded-pill fw-bold px-4 text-white shadow-sm"
                    ...
                    <i class="bi bi-cloud-arrow-down-fill me-1"></i> Load Draft (<?php echo e($drafts->count()); ?>)
                </button>
        ...
        <form action="<?php echo e(route('manajemenmahasiswa.forum.store')); ?>" method="POST" id="createPostForm"
...
unset($__errorArgs, $__bag); ?>"
            ...
            <div class="mb-4">
                ...
                <div class="checkbox-card-group mt-2 <?php $__errorArgs = ['kategori'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="kategoriGroup">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <label class="checkbox-card <?php echo e(in_array($key, old('kategori', [])) ? 'checked' : ''); ?>"
                               id="kategoriCard_<?php echo e($key); ?>">
                            <input type="checkbox" name="kategori[]"
                                   id="kategori_<?php echo e($key); ?>" value="<?php echo e($key); ?>"
                                   <?php echo e(in_array($key, old('kategori', [])) ? 'checked' : ''); ?>>
                            <?php echo e($label); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="invalid-feedback d-block" style="font-size:12px;"><?php echo e($message); ?></div>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-4">
                ...
                <textarea name="konten" id="inputKonten" class="custom-textarea" rows="6"
                    placeholder="Bagikan apa yang ada di pikiranmu..."><?php echo e(old('konten')); ?></textarea>
            </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $drafts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $draft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="list-group-item list-group-item-action d-flex justify-content-between align-items-center p-3"
                                    ...
                                    <div class="flex-grow-1 pe-3"
                                        onclick="loadDraft(<?php echo e($draft->id); ?>, <?php echo e(json_encode($draft->judul)); ?>, <?php echo e(json_encode($draft->kategori)); ?>, <?php echo e(json_encode($draft->konten)); ?>)">
                                        <h6 class="mb-1 fw-bold text-dark" style="font-size: 15px;">
                                            <?php echo e($draft->judul ?: '(Tanpa Judul)'); ?>

                                        </h6>
                                        <p class="mb-1 text-muted"
                                            style="font-size: 13px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                            <?php echo e($draft->konten ?: '(Tidak ada konten teks)'); ?>
                                    ...
                                    <div class="ms-1">
                                        <form action="<?php echo e(route('manajemenmahasiswa.forum.drafts.destroy', $draft->id)); ?>"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            function saveDraftAJAX(isManual = false) {
                ...
                fetch('<?php echo e(route("manajemenmahasiswa.forum.drafts.store")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\forum\create.blade.php ENDPATH**/ ?>
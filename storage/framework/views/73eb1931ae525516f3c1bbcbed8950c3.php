...
<style>
    ...
    .banner-preview-box { display:<?php echo e($proker->banner ? 'block' : 'none'); ?>; border-radius:14px; overflow:hidden; position:relative; }
...
<div class="d-flex align-items-center gap-3 mb-4">
    <a href="<?php echo e(route('manajemenmahasiswa.proker.show', $proker->id)); ?>" class="btn-back">&larr;</a>
    <div>
        <h3 class="fw-bold mb-0" style="font-size:1.45rem;color:#0D0D12;letter-spacing:-.02em;">Edit Rencana Proker</h3>
        <p class="mb-0" style="font-size:.82rem;color:#666D80;font-weight:500;">Perbarui informasi program kerja</p>
    </div>
</div>
...
<form action="<?php echo e(route('manajemenmahasiswa.proker.update', $proker->id)); ?>" method="POST" enctype="multipart/form-data" id="prokerForm">
    ...
    <div class="form-card">
        ...
        <div class="mb-2">
            ...
            <textarea name="deskripsi" id="deskripsiInput" class="form-control form-control-custom"
                      ...
                      required oninput="updateCharCount('deskripsiInput','deskripsiCount',3000)"><?php echo e(old('deskripsi', $proker->deskripsi)); ?></textarea>
                ...
                <div style="display:flex;flex-wrap:wrap;gap:9px;" id="kategoriGroup">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kategoriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <label style="display:inline-flex;align-items:center;gap:7px;padding:9px 14px;border:1.5px solid #DFE1E7;border-radius:10px;background:#fff;cursor:pointer;transition:all 0.2s;font-size:13px;font-weight:500;color:#374151;user-select:none;"
                               id="kategoriCard<?php echo e($kategori->id); ?>">
                            <input type="checkbox" name="kategori_kegiatan_id[]" value="<?php echo e($kategori->id); ?>"
                                   style="width:15px;height:15px;accent-color:#0B266E;"
                                   onchange="handleKategoriChange()"
                                   <?php echo e($kat_checked ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6" id="bidangFieldWrapper">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:9px;" id="bidangGroup">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bidangList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bidang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        ?>
                        <label style="display:inline-flex;align-items:center;gap:7px;padding:9px 14px;border:1.5px solid #DFE1E7;border-radius:10px;background:#fff;cursor:pointer;transition:all 0.2s;font-size:13px;font-weight:500;color:#374151;user-select:none;"
                               id="bidangCard<?php echo e($bidang->id); ?>">
                            <input type="checkbox" name="bidang_id[]" value="<?php echo e($bidang->id); ?>"
                                   style="width:15px;height:15px;accent-color:#0B266E;"
                                   <?php echo e($bid_checked ? 'checked' : ''); ?>>
    ...
    <div class="form-card">
        ...
        <div class="banner-preview-box" id="bannerPreviewBox" style="cursor:pointer;" onclick="openLightbox()">
            <img id="bannerPreviewImg" src="<?php echo e($proker->banner_url); ?>" alt="Preview banner" class="banner-preview-img">
        ...
        <div class="banner-upload-area" id="bannerUploadArea" style="display:<?php echo e($proker->banner ? 'none' : 'block'); ?>"
    ...
    <div class="d-flex gap-3 justify-content-end mb-4">
        <a href="<?php echo e(route('manajemenmahasiswa.proker.show', $proker->id)); ?>" class="btn-cancel">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\proker\edit.blade.php ENDPATH**/ ?>
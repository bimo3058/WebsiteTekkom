...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-ruangan.layout','data' => ['pageTitle' => 'Dashboard Mahasiswa']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-5 mb-8">
        <div class="min-w-0">
            <h1 class="text-[22px] font-bold text-gray-900 tracking-tight flex items-center gap-2">
                Selamat datang, <span class="truncate block max-w-[200px] sm:max-w-xs"><?php echo e(array_pad(explode(' ', $user->name), 1, 'Mahasiswa')[0]); ?></span> 👋
            </h1>
            <p class="text-[13px] text-gray-500 mt-1.5">Kelola dan pantau pengajuan peminjaman ruangan Anda disini.</p>
        </div>
        <div class="flex-shrink-0">
            <a href="<?php echo e(route('eoffice.peminjaman.user.booking')); ?>" class="inline-flex items-center justify-center bg-[#0B266E] hover:bg-[#071946] text-white text-[13px] font-semibold px-4 py-[11px] rounded-xl transition-all shadow-sm hover:shadow-md w-full sm:w-auto">
                Pinjam Ruang
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
        <div class="bg-white rounded-[16px] border border-gray-200 p-5 flex items-center gap-5 shadow-sm hover:shadow-md transition-all">
            ...
            <div>
                ...
                <div class="text-3xl font-black text-gray-900 leading-none"><?php echo e($activeBookingsCount); ?></div>
            </div>
        </div>

        <div class="relative bg-gradient-to-br from-[#0B266E] to-[#1a3c94] rounded-[16px] border border-blue-900 p-5 flex items-center overflow-hidden shadow-sm hover:shadow-md transition-all group cursor-pointer" onclick="window.location.href='<?php echo e(route('eoffice.peminjaman.user.kalender')); ?>'">
        ...
        <div class="mp-card">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentBookings->count() > 0): ?>
                <table class="mp-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="mp-tr">
                                ...
                                <td>
                                    <div style="color: #111827; font-weight: 500;">
                                        <?php echo e($booking->tanggal_pinjam?->translatedFormat('d M Y')); ?></div>
                                    <div style="color: #6B7280; font-size: 12px;">
                                        <?php echo e(\Carbon\Carbon::parse($booking->jam_mulai)->format('H:i')); ?> -
                                        <?php echo e(\Carbon\Carbon::parse($booking->jam_selesai)->format('H:i')); ?></div>
                                </td>
                                <td style="color: #4B5563;"><?php echo e(Str::limit($booking->tujuan, 30)); ?></td>
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($booking->status == 'disetujui'): ?>
            ...
            <?php else: ?>
                <div style="padding: 40px; text-align: center;">
                    ...
                    <p style="font-size: 13px; color: #6B7280; margin-top: 4px;">Anda belum pernah mengajukan peminjaman
                        ruangan.</p>
                    <a href="<?php echo e(route('eoffice.peminjaman.user.booking')); ?>" class="mp-btn secondary"
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-ruangan\user\dashboard.blade.php ENDPATH**/ ?>
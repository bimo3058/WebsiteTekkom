...
<div style="display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap;">
    <div>
        ...
        <p style="font-size:12px; color:var(--c-fg-muted); margin-top:3px; margin-bottom:0;">
            Total <span style="color:var(--c-primary); font-weight:600;"><?php echo e(number_format($total)); ?></span> user terdaftar dalam sistem
        </p>
    </div>
...
</div><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\users\_header.blade.php ENDPATH**/ ?>
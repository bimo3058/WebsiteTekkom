...
<div class="sk-login-root">
    ...
    <div class="sk-card">
        ...
        <div style="display:flex;flex-direction:column;align-items:center;gap:2px;">
            <img
                src="<?php echo e(asset('images/UNDIPOfficial.png')); ?>"
                alt="Logo UNDIP"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('status')): ?>
            <div class="sk-alert sk-alert-warning"><?php echo e(session('status')); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any()): ?>
            <div class="sk-alert sk-alert-error"><?php echo e($errors->first()); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        
        <a href="<?php echo e(route('microsoft.redirect')); ?>" class="sk-btn-sso">
                ...
                <div class="sk-field-group">
                    ...
                    <div class="sk-field">
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px;">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" style="font-size:12px;font-weight:500;color:var(--c-primary);text-decoration:none;opacity:0.8;transition:opacity 0.15s;"
    ...
    <div class="sk-footer">
        <span>© <?php echo e(date('Y')); ?> Departemen Teknik Komputer &bull; Universitas Diponegoro</span>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views/auth/login.blade.php ENDPATH**/ ?>
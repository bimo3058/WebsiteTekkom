            ...
            <table class="w-full text-left text-[11pt] border-none">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-1.5 align-top pr-4"><?php echo e($request->hari_tanggal ? \Carbon\Carbon::parse($request->hari_tanggal)->locale('id')->translatedFormat('l, d F Y') : '............................'); ?></td>
                    ...
                    <tr>
                        ...
                        <td class="py-1.5 align-top">:</td>
                        <td class="py-1.5 align-top pr-4"><?php echo e($request->jam_mulai && $request->jam_selesai ? $request->jam_mulai . ' – ' . $request->jam_selesai : ($request->jam_mulai ?? '............................')); ?></td>
...
</html><?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\bank-soal\Dosen\print-ujian.blade.php ENDPATH**/ ?>
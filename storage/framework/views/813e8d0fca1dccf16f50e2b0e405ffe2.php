<div>
    ...
    <div class="flex flex-col gap-6 mb-8">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('alumni') || auth()->user()->hasRole('superadmin')): ?>
        <div class="w-full">
...
<?php /**PATH C:\WebsiteTekkom - Copy\resources\views\profile\cv\steps\step-3.blade.php ENDPATH**/ ?>
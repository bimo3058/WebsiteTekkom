...
<aside data-mobile-sidebar :class="sidebarOpen ? 'w-[240px]' : 'w-[64px]'"
    ...
    <div class="flex items-center gap-2 px-[14px] py-[14px] border-b border-[#DFE1E7] min-h-[60px] flex-shrink-0 relative" :class="sidebarOpen ? 'justify-start' : 'justify-center'">
        ...
        <div class="w-8 h-8 flex-shrink-0 flex items-center justify-center overflow-hidden">
            <img src="<?php echo e(asset('images/UNDIPOfficial.png')); ?>" alt="UNDIP" style="width:32px;height:32px;object-fit:contain;">
        </div>
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden p-[6px_10px_10px] flex flex-col gap-[1px] scrollbar-thin scrollbar-thumb-[#DFE1E7] scrollbar-track-transparent">
        ...
        <?php $isDashboard = request()->routeIs('banksoal.dashboard'); ?>
        <a href="<?php echo e(route('banksoal.dashboard')); ?>" class="relative flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] transition-colors <?php echo e($isDashboard ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
            ...
            <svg class="w-4 h-4 flex-shrink-0 <?php echo e($isDashboard ? 'text-[#0B266E]' : 'text-[#666D80]'); ?>" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconDashboard); ?>"/></svg>
        ...
        ?>
        <div x-data="{ openAcc: <?php echo e($isKontrolUmumActive ? 'true' : 'false'); ?> }" class="flex flex-col">
            <button @click="if(!sidebarOpen){ sidebarOpen=true; openAcc=true; } else { openAcc=!openAcc }" class="relative w-full flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] transition-colors <?php echo e($isKontrolUmumActive ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isKontrolUmumActive): ?>
                    <span class="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-[20px] bg-[#0B266E] rounded-r-[3px]" x-show="sidebarOpen"></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <svg class="w-4 h-4 flex-shrink-0 <?php echo e($isKontrolUmumActive ? 'text-[#0B266E]' : 'text-[#666D80]'); ?>" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconUmum); ?>"/></svg>
            ...
            <div x-show="openAcc && sidebarOpen" x-collapse x-cloak>
                <div class="flex flex-col gap-[2px] pl-[34px] pr-[10px] py-[2px] mt-[1px]">
                    <a href="<?php echo e(route('banksoal.admin.kontrol-umum.mata-kuliah')); ?>" class="block p-[7px_10px] rounded-lg text-[13px] transition-colors <?php echo e($isMataKuliah ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] hover:bg-[#F6F8FA]'); ?>">Manajemen Data</a>
                    <a href="<?php echo e(route('banksoal.admin.kontrol-umum.pemetaan')); ?>" class="block p-[7px_10px] rounded-lg text-[13px] transition-colors <?php echo e($isPemetaan ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] hover:bg-[#F6F8FA]'); ?>">Pemetaan</a>
                </div>
            </div>
        </div>
        ...
        ?>
        <div x-data="{ openAcc: <?php echo e($isKontrolBankSoalActive ? 'true' : 'false'); ?> }" class="flex flex-col mt-[1px]">
            <button @click="if(!sidebarOpen){ sidebarOpen=true; openAcc=true; } else { openAcc=!openAcc }" class="relative w-full flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] transition-colors <?php echo e($isKontrolBankSoalActive ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isKontrolBankSoalActive): ?>
                    <span class="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-[20px] bg-[#0B266E] rounded-r-[3px]" x-show="sidebarOpen"></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <svg class="w-4 h-4 flex-shrink-0 <?php echo e($isKontrolBankSoalActive ? 'text-[#0B266E]' : 'text-[#666D80]'); ?>" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconBankSoal); ?>"/></svg>
            ...
            <div x-show="openAcc && sidebarOpen" x-collapse x-cloak>
                <div class="flex flex-col gap-[2px] pl-[34px] pr-[10px] py-[2px] mt-[1px]">
                    <a href="<?php echo e(route('banksoal.admin.kontrol-banksoal.rps')); ?>" class="block p-[7px_10px] rounded-lg text-[13px] transition-colors <?php echo e($isRps ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] hover:bg-[#F6F8FA]'); ?>">Manajemen RPS</a>
                    <a href="<?php echo e(route('banksoal.admin.kontrol-banksoal.soal')); ?>" class="block p-[7px_10px] rounded-lg text-[13px] transition-colors <?php echo e($isSoal ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] hover:bg-[#F6F8FA]'); ?>">Manajemen Soal</a>
                </div>
                    </div>
                </div>
        ...
        ?>
        <div x-data="{ openAcc: <?php echo e($isPeriodeActive ? 'true' : 'false'); ?> }" class="flex flex-col">
            <button @click="if(!sidebarOpen){ sidebarOpen=true; openAcc=true; } else { openAcc=!openAcc }" class="relative w-full flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] transition-colors <?php echo e($isPeriodeActive ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPeriodeActive): ?>
                    <span class="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-[20px] bg-[#0B266E] rounded-r-[3px]" x-show="sidebarOpen"></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <svg class="w-4 h-4 flex-shrink-0 <?php echo e($isPeriodeActive ? 'text-[#0B266E]' : 'text-[#666D80]'); ?>" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconSetup); ?>"/></svg>
            ...
            <div x-show="openAcc && sidebarOpen" x-collapse x-cloak>
                <div class="flex flex-col gap-[2px] pl-[34px] pr-[10px] py-[2px] mt-[1px]">
                    <a href="<?php echo e(route('banksoal.periode.setup')); ?>" class="block p-[7px_10px] rounded-lg text-[13px] transition-colors <?php echo e($isSetup ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] hover:bg-[#F6F8FA]'); ?>">Periode Ujian</a>
                    <a href="<?php echo e(route('banksoal.pendaftaran.alokasi-sesi.index')); ?>" class="block p-[7px_10px] rounded-lg text-[13px] transition-colors <?php echo e($isSesi ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] hover:bg-[#F6F8FA]'); ?>">Jadwal & Sesi</a>
                    <a href="<?php echo e(route('banksoal.pendaftaran.index')); ?>" class="block p-[7px_10px] rounded-lg text-[13px] transition-colors <?php echo e($isDaftar ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] hover:bg-[#F6F8FA]'); ?>">Daftar Peserta</a>
                </div>
            </div>
        </div>
        ...
        ?>
        <div x-data="{ openAcc: <?php echo e($isMonitoringActive ? 'true' : 'false'); ?> }" class="flex flex-col mt-[1px]">
            <button @click="if(!sidebarOpen){ sidebarOpen=true; openAcc=true; } else { openAcc=!openAcc }" class="relative w-full flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] transition-colors <?php echo e($isMonitoringActive ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isMonitoringActive): ?>
                    <span class="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-[20px] bg-[#0B266E] rounded-r-[3px]" x-show="sidebarOpen"></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <svg class="w-4 h-4 flex-shrink-0 <?php echo e($isMonitoringActive ? 'text-[#0B266E]' : 'text-[#666D80]'); ?>" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconMonitor); ?>"/></svg>
            ...
            <div x-show="openAcc && sidebarOpen" x-collapse x-cloak>
                <div class="flex flex-col gap-[2px] pl-[34px] pr-[10px] py-[2px] mt-[1px]">
                    <a href="<?php echo e(route('banksoal.aktivasi.index')); ?>" class="block p-[7px_10px] rounded-lg text-[13px] transition-colors <?php echo e($isAktivasi ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] hover:bg-[#F6F8FA]'); ?>">Aktivasi Sesi</a>
                    <a href="<?php echo e(route('banksoal.admin.cbt.live-proctoring')); ?>" class="block p-[7px_10px] rounded-lg text-[13px] transition-colors <?php echo e($isLive ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] hover:bg-[#F6F8FA]'); ?>">Pantau Ujian</a>
                </div>
            </div>
        </div>

        
        <?php $isRiwayat = request()->routeIs('banksoal.admin.cbt.riwayat') || request()->routeIs('banksoal.admin.cbt.detail'); ?>
        <a href="<?php echo e(route('banksoal.admin.cbt.riwayat')); ?>" @click="if(!sidebarOpen) sidebarOpen=true" class="relative flex items-center gap-[9px] p-[7px_10px_7px_14px] rounded-lg text-[13px] mt-[1px] transition-colors <?php echo e($isRiwayat ? 'bg-[#F6F8FA] text-[#0D0D12] font-semibold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>" :class="!sidebarOpen ? 'justify-center p-[7px_0]' : ''">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRiwayat): ?>
                <span class="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-[20px] bg-[#0B266E] rounded-r-[3px]" x-show="sidebarOpen"></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <svg class="w-4 h-4 flex-shrink-0 <?php echo e($isRiwayat ? 'text-[#0B266E]' : 'text-[#666D80]'); ?>" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconRiwayat); ?>"/></svg>
    ...
    <div class="p-[8px_10px_12px] border-t border-[#DFE1E7] flex flex-col gap-[1px] flex-shrink-0">
        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-[10px] p-[8px_10px] rounded-lg text-[13px] font-medium text-[#353849] hover:bg-[#F6F8FA] transition-colors <?php echo e(request()->routeIs('profile.edit') ? 'bg-[#F6F8FA]' : ''); ?>" :class="!sidebarOpen ? 'justify-center p-[8px_0]' : ''">
            <svg class="w-4 h-4 flex-shrink-0 text-[#666D80]" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconSettings); ?>"/></svg>
        ...
        <a href="#" class="flex items-center gap-[10px] p-[8px_10px] rounded-lg text-[13px] font-medium text-[#353849] hover:bg-[#F6F8FA] transition-colors" :class="!sidebarOpen ? 'justify-center p-[8px_0]' : ''">
            <svg class="w-4 h-4 flex-shrink-0 text-[#666D80]" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconHelp); ?>"/></svg>
            <span x-show="sidebarOpen" class="whitespace-nowrap overflow-hidden text-ellipsis">Help &amp; Center</span>
        </a>
        <form method="POST" action="<?php echo e(route('logout')); ?>" class="m-0" data-no-loader>
            <?php echo csrf_field(); ?>
            <button type="submit" class="w-full flex items-center gap-[10px] p-[8px_10px] rounded-lg text-[13px] font-medium text-[#DF1C41] hover:bg-[#FEF1F4] transition-colors" :class="!sidebarOpen ? 'justify-center p-[8px_0]' : ''">
                <svg class="w-4 h-4 flex-shrink-0 text-[#DF1C41]" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="<?php echo e($iconLogout); ?>"/></svg>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules/BankSoal\resources/views/components/ui/sidebar-admin.blade.php ENDPATH**/ ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => ['title' => 'Dashboard']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div x-data="{
        selectedPeriode: '<?php echo e($defaultPeriodeId); ?>',
        allStats: <?php echo e(\Illuminate\Support\Js::from($periodeStats)); ?>,
        get stats() {
            ...
            <div style="min-width:220px;" class="mt-2 sm:mt-0 relative">
                ...
                ">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $periodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($p->id); ?>">Semester <?php echo e($p->semester); ?> <?php echo e($p->tahun_ajaran); ?></option>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            " onmouseover="this.style.borderColor='#D3C4FC'; this.style.boxShadow='0px 4px 12px rgba(11,38,110,0.1), 0px 1px 3px rgba(11,38,110,0.06)';"
                ...
                <a href="<?php echo e(route('eoffice.kp.koordinator.balancing')); ?>" style="
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules/EOffice\resources/views/koordinator/dashboard.blade.php ENDPATH**/ ?>
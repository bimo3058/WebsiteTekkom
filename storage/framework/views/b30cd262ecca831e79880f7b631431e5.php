...
<?php echo $__env->make('eoffice::manajemen-praktikum.partials._styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('eoffice::manajemen-praktikum.partials._shell-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="mp-shell" x-data="{ sidebarOpen: false, isMobile: window.innerWidth < 768 }"
    ...
    <?php echo $__env->make('eoffice::manajemen-praktikum.partials._sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="mp-main" :inert="isMobile &amp;&amp; sidebarOpen">
        ...
        <?php echo $__env->make('eoffice::manajemen-praktikum.partials._topbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="mp-wrap">
            <div class="mp-box">
                ...
                <div class="mp-box-body" role="region" aria-label="Konten <?php echo e($pageTitle ?? 'praktikum'); ?>" tabindex="0">
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules/EOffice\resources/views/components/manajemen-praktikum/layout.blade.php ENDPATH**/ ?>
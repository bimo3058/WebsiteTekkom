            ...
            <div class="flex-1 overflow-y-auto py-6 px-4">
                ...
                <div class="mb-1" x-data="{ expanded: false }">
                    <button @click="expanded = !expanded"
                        ...
                        <svg :class="expanded ? 'rotate-180' : ''" class="w-4 h-4 transition-transform text-slate-400"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div x-show="expanded" x-collapse class="pl-11 pr-4 py-2 space-y-1">
                        <a href="<?php echo e(route('eoffice.kp.koordinator.pengumuman')); ?>"
                        ...
                        <a href="<?php echo e(route('eoffice.kp.koordinator.faq')); ?>"
                            class="flex items-center px-3 py-2 text-sm font-medium text-slate-500 hover:text-indigo-600 hover:bg-slate-50 rounded-lg transition-colors relative before:absolute before:-left-5 before:top-1/2 before:w-3 before:h-px before:bg-slate-200">
                            FAQ & Dokumen
                        </a>
                    </div>
                ...
                <a href="<?php echo e(route('eoffice.kp.koordinator.balancing')); ?>"
                    class="flex items-center px-4 py-3 mb-1 text-slate-600 hover:text-indigo-700 hover:bg-indigo-50 rounded-xl transition-all text-sm font-medium">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden bg-slate-50/50">
            ...
            <main class="flex-1 overflow-y-auto p-6 lg:p-10">
                ...
                <div class="max-w-4xl mx-auto">
                    <!-- Page Header -->
                    <div class="mb-8">
                        <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight mb-2">Upload Berkas & Template
                        </h1>
                        <p class="text-sm text-slate-500 max-w-2xl leading-relaxed">Kelola template berkas resmi Kerja
                            Praktik mahasiswa untuk digunakan secara dinamis.</p>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
                        <div
                            class="mb-6 p-4 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-xl flex items-center gap-3">
                    ...
                    <div class="grid grid-cols-1 gap-8">
                        ...
                        <div
                            ...
                            <div class="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-slate-900 mb-1">Form Kehadiran & Nilai Lapangan
                                        (KP-A2)</h3>
                                    <p class="text-sm text-slate-500">Unggah berkas template Word (.docx) resmi. Sistem
                                        akan membaca file ini dan menyinkronkan data mahasiswa secara langsung.</p>
                                </div>
                            </div>

                            <div class="p-4 bg-slate-50 rounded-xl border border-slate-100 mb-6">
                                <h4 class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Petunjuk
                                    Format Template</h4>
                                <p class="text-xs text-slate-600 leading-relaxed">
                                    Pastikan dokumen Word (.docx) Anda memiliki tag-tag variabel berikut agar data
                                    mahasiswa otomatis masuk:
                                </p>
                            ...
                            <form action="<?php echo e(route('eoffice.kp.koordinator.upload_berkas.template_a2')); ?>" method="POST"
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\upload_berkas.blade.php ENDPATH**/ ?>
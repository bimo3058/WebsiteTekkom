...
<form action="<?php echo e(route('manajemenmahasiswa.proker.store')); ?>" method="POST" enctype="multipart/form-data" id="prokerForm">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-card">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="judul" id="judulInput" class="form-control form-control-custom"
                   ...
                   value="<?php echo e(old('judul')); ?>" required maxlength="255"
        ...
        <div class="mb-2">
            ...
            <textarea name="deskripsi" id="deskripsiInput" class="form-control form-control-custom"
                      ...
                      required oninput="updateCharCount('deskripsiInput','deskripsiCount',3000)"><?php echo e(old('deskripsi')); ?></textarea>
    ...
    <div class="d-flex gap-3 justify-content-end mb-4">
        <a href="<?php echo e(route('manajemenmahasiswa.proker.index')); ?>" class="btn-cancel">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\proker\create.blade.php ENDPATH**/ ?>
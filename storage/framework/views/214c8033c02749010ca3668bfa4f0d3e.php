...
document.getElementById('btnSaveCrop').addEventListener('click', function() {
    ...
    canvas.toBlob(function(blob) {
        ...
        fetch("<?php echo e(route('profile.avatar.update')); ?>", {method:'POST',body:fd,headers:{'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>','Accept':'application/json'}})
...
document.getElementById('btnConfirmDeleteAvatar')?.addEventListener('click', function() {
    ...
    fetch("<?php echo e(route('profile.avatar.destroy')); ?>", {method:'DELETE',headers:{'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>','Accept':'application/json'}})
...
</script><?php /**PATH C:\WebsiteTekkom - Copy\resources\views/profile/partials/settings-modals.blade.php ENDPATH**/ ?>
                ...
                <div style="display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap;">
                    <div>
                        ...
                        <p style="font-size:13px; color:var(--c-fg-muted);">
                            <?php echo e($session->jadwal->periode->nama_periode ?? 'Ujian Komprehensif'); ?> - Sesi
                            <?php echo e($session->jadwal->nama_sesi ?? '-'); ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\mahasiswa\detail-riwayat.blade.php ENDPATH**/ ?>
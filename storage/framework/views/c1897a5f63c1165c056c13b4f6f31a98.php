    ...
    <div class="flex flex-col flex-1 overflow-y-auto overflow-x-hidden" style="scrollbar-width: thin;">
        ...
        <nav class="flex-1 py-4 space-y-5">
            ...
            <div>
                ...
                <?php $isDashboard = request()->routeIs('eoffice.kp.dosen.dashboard'); ?>
                <div class="relative px-2">
                    ...
                    <a href="<?php echo e(route('eoffice.kp.dosen.dashboard')); ?>" class="flex items-center gap-3 py-2.5 px-3 rounded-[5px] transition-all group
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\components\ui\sidebar-dosen.blade.php ENDPATH**/ ?>
    ...
    <div style="background:#fff;border:1px solid var(--c-border);border-radius:12px;padding:20px;box-shadow:var(--shadow-card);">
        ...
        <div style="margin-bottom:20px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--c-border);padding-bottom:16px;">
            ...
            <div style="font-size:28px;font-weight:800;color:var(--c-primary);letter-spacing:-0.03em;">
                <?php echo e(number_format($soalDisetujui)); ?>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(220px, 1fr));gap:32px;">
            ...
            <div>
                ...
                <div style="display:flex;flex-direction:column;gap:12px;max-height:180px;overflow-y:auto;padding-right:8px;">
                    <?php $totalCpl = $distCpl->sum('total'); ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $distCpl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $pct = $totalCpl > 0 ? round(($cpl->total/$totalCpl)*100) : 0; ?>
                    <div>
                        <div style="display:flex;justify-content:space-between;font-size:12px;margin-bottom:4px;">
                            <span style="font-weight:500;color:var(--c-fg-muted);"><?php echo e($cpl->label); ?></span>
                            <span style="font-weight:600;color:var(--c-fg);"><?php echo e($cpl->total); ?></span>
                        </div>
                        <div style="width:100%;background:var(--c-bg-subtle);height:4px;border-radius:999px;overflow:hidden;">
                            <div style="height:100%;background:var(--c-primary);border-radius:999px;width:<?php echo e($pct); ?>%;"></div>
                        </div>
                    </div>
            ...
            <div>
                ...
                <div style="display:flex;flex-direction:column;gap:12px;max-height:180px;overflow-y:auto;padding-right:8px;">
                    <?php $totalMkDist = $distMk->sum('total'); ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $distMk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $pct = $totalMkDist > 0 ? round(($mk->total/$totalMkDist)*100) : 0; ?>
                    <div>
                        <div style="display:flex;justify-content:space-between;font-size:12px;margin-bottom:4px;">
                            <span style="font-weight:500;color:var(--c-fg-muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:140px;" title="<?php echo e($mk->label); ?>"><?php echo e($mk->label); ?></span>
                            <span style="font-weight:600;color:var(--c-fg);"><?php echo e($mk->total); ?></span>
                        </div>
                        <div style="width:100%;background:var(--c-bg-subtle);height:4px;border-radius:999px;overflow:hidden;">
                            <div style="height:100%;background:var(--c-primary);border-radius:999px;width:<?php echo e($pct); ?>%;"></div>
                        </div>
...
<div style="margin-bottom:24px;">
    ...
    <?php echo $__env->make('banksoal::dashboard.partials._activity', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="dash-stats" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;">
        ...
        <div style="background:#fff;border:1px solid var(--c-border);border-radius:12px;padding:14px 16px;box-shadow:var(--shadow-card);transition:border-color .15s,box-shadow .15s;cursor:default;"
            ...
            <p style="font-size:24px;font-weight:700;color:var(--c-fg);line-height:1;letter-spacing:-.02em;"><?php echo e($cbTotalPeserta); ?></p>
        </div>
        ...
        <div style="background:#fff;border:1px solid var(--c-border);border-radius:12px;padding:14px 16px;box-shadow:var(--shadow-card);transition:border-color .15s,box-shadow .15s;cursor:default;"
            ...
            <p style="font-size:24px;font-weight:700;color:var(--c-fg);line-height:1;letter-spacing:-.02em;"><?php echo e($cbtLulus); ?></p>
        </div>
        ...
        <div style="background:#fff;border:1px solid var(--c-border);border-radius:12px;padding:14px 16px;box-shadow:var(--shadow-card);transition:border-color .15s,box-shadow .15s;cursor:default;"
            ...
            <p style="font-size:24px;font-weight:700;color:var(--c-fg);line-height:1;letter-spacing:-.02em;"><?php echo e($cbtTidakLulus); ?></p>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const kesData = <?php echo json_encode(array_values($distKesulitan)); ?>;
        const kesLabels = <?php echo json_encode(array_keys($distKesulitan)); ?>;
...
<?php $__env->stopPush(); ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules/BankSoal\resources/views/dashboard/partials/_stats.blade.php ENDPATH**/ ?>
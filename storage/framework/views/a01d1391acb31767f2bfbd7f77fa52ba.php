    ...
    <header x-data="{ open: false }" class="sticky top-0 z-40 h-14 bg-white border-b border-[#DFE1E7] flex items-center px-6 justify-between">
        ...
        <div class="flex items-center gap-2.5">
            <div class="w-9 h-9 rounded-lg overflow-hidden flex-shrink-0">
                <img src="<?php echo e(asset('images/UNDIPOfficial.png')); ?>"
        ...
        <div class="relative">
            <button @click="open = !open"
                ...
                <div class="text-left hidden sm:block">
                    <p class="text-[12px] font-semibold text-[#0D0D12] leading-tight"><?php echo e(auth()->user()->name); ?></p>
                    <p class="text-[10px] text-[#A4ABB8] leading-tight">
                        <?php echo e(ucfirst(auth()->user()->roles->first()->name ?? 'User')); ?>
            ...
            <div x-show="open"
                ...
                <div class="px-3 py-2.5 border-b border-[#F0F1F4]">
                    <p class="text-[12px] font-semibold text-[#0D0D12] truncate"><?php echo e(auth()->user()->name); ?></p>
                    <p class="text-[11px] text-[#A4ABB8] truncate"><?php echo e(auth()->user()->email); ?></p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pb-24 sm:pb-8">
        ...
        <div class="mb-7">
            <h1 class="text-[20px] font-bold text-[#0D0D12] tracking-tight leading-tight">
                Selamat datang, <span class="text-[#0B266E]"><?php echo e(explode(' ', auth()->user()->name)[0]); ?></span>
            </h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <a href="<?php echo e(route($card['route'])); ?>"
               class="group bg-white border border-[#DFE1E7] rounded-2xl p-5 flex flex-col gap-3 transition-all duration-200 hover:shadow-[0_4px_12px_-2px_rgba(22,22,43,0.08)] hover:border-<?php echo e($card['color'] === 'blue' ? '[#8FA3D1]' : ($card['color'] === 'purple' ? '[#5C78B8]' : ($card['color'] === 'green' ? '[#40C4AA]' : '[#D39C3D]'))); ?> relative overflow-hidden min-h-[165px]">
                ...
                <div class="absolute -top-5 -right-5 w-20 h-20 rounded-full opacity-40 group-hover:opacity-80 transition-opacity pointer-events-none"
                     style="background:<?php echo e($mc['icon_bg']); ?>"></div>

                
                <div class="flex items-center justify-between relative z-10">
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                         style="background:<?php echo e($mc['icon_bg']); ?>">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                             stroke="<?php echo e($mc['icon_color']); ?>" stroke-width="1.8"
                             stroke-linecap="round" stroke-linejoin="round">
                            <?php echo $svg; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appText): ?>
        ...
        <div x-data="{ activeTab: 'all' }">
            ...
            <div class="flex items-end gap-0 border-b border-[#DFE1E7] overflow-x-auto" style="scrollbar-width:none;-ms-overflow-style:none;" onscroll="this.style.webkitScrollbarDisplay='none'">
                ...
                <button
                    @click="activeTab = '<?php echo e($tab['key']); ?>'"
                    :class="activeTab === '<?php echo e($tab['key']); ?>'
                    ...
                    <span :class="activeTab === '<?php echo e($tab['key']); ?>' ? 'bg-[#E8EDF7] text-[#0B266E]' : 'bg-[#F0F1F4] text-[#A4ABB8]'" 
                          class="px-1.5 py-0.5 text-[10px] font-bold rounded-full transition-colors">
                        <?php echo e($announcementCounts[$tab['key']] ?? 0); ?>
            ...
            <div class="bg-white border border-t-0 border-[#DFE1E7] rounded-b-2xl overflow-hidden max-h-[440px] overflow-y-auto custom-scrollbar flex flex-col">
                ...
                <div x-show="activeTab === 'all'"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $announcements['all'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $b = $badgeMap[$item['module']] ?? $badgeMap['bank_soal']; ?>
                    <div class="w-full flex items-start gap-4 px-5 py-4 border-b border-[#F0F1F4] last:border-b-0 hover:bg-[#F6F8FA] transition-colors group <?php echo e(!empty($item['url']) ? 'cursor-pointer' : ''); ?>"
                         style="border-left: 3px solid <?php echo e($b['border_l']); ?>"
                         <?php if(!empty($item['url'])): ?> onclick="window.location.href='<?php echo e(e($item['url'])); ?>'" <?php endif; ?>>
                        <div class="flex-1 min-w-0 w-full">
                            <div class="flex items-center gap-2 mb-1 flex-wrap">
                                <span class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-semibold flex-shrink-0"
                                      style="background:<?php echo e($b['bg']); ?>;color:<?php echo e($b['text']); ?>">
                                    <span class="w-1.5 h-1.5 rounded-full inline-block"
                                          style="background:<?php echo e($b['dot']); ?>"></span>
                                    <?php echo e($b['label']); ?>

                                </span>
                                <span class="text-[10px] text-[#C1C7CF] flex-shrink-0"><?php echo e($item['date']); ?></span>
                            </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['bank_soal', 'capstone', 'kemahasiswaan', 'eoffice']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moduleKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php $b = $badgeMap[$moduleKey]; ?>
                <div x-show="activeTab === '<?php echo e($moduleKey); ?>'"
                     x-transition:enter="transition ease-out duration-150"
                     x-transition:enter-start="opacity-0 translate-y-1"
                     x-transition:enter-end="opacity-100 translate-y-0"
                     class="w-full flex flex-col"
                     style="display:none">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $announcements[$moduleKey] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="w-full flex items-start gap-4 px-5 py-4 border-b border-[#F0F1F4] last:border-b-0 hover:bg-[#F6F8FA] transition-colors group <?php echo e(!empty($item['url']) ? 'cursor-pointer' : ''); ?>"
                         style="border-left: 3px solid <?php echo e($b['border_l']); ?>"
                         <?php if(!empty($item['url'])): ?> onclick="window.location.href='<?php echo e(e($item['url'])); ?>'" <?php endif; ?>>
                        <div class="flex-1 min-w-0 w-full">
                            <div class="flex items-center gap-2 mb-1 flex-wrap">
                                <span class="text-[10px] text-[#C1C7CF] flex-shrink-0"><?php echo e($item['date']); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item['pinned'])): ?>
                    ...
                    <div class="flex flex-col items-center justify-center py-12 w-full text-[#DFE1E7]">
                        ...
                        <p class="text-[12px] text-[#A4ABB8]">Belum ada pengumuman dari <?php echo e($b['label']); ?></p>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        ...
        <div class="mt-8 pt-5 border-t border-[#DFE1E7] flex items-center justify-between flex-wrap gap-2">
            <p class="text-[11px] text-[#A4ABB8]">
                &copy; <?php echo e(date('Y')); ?> <span class="font-semibold text-[#666D80]"><?php echo e(config('app.name')); ?></span>. All rights reserved.
            </p>
...
<div x-data="{ show: window.innerWidth < 768, openMenu: false }"
        ...
        <div x-show="openMenu" x-transition:enter="transition ease-out duration-300 transform"
            ...
            <div class="flex items-center gap-3 px-5 pb-4 border-b border-slate-100 shrink-0">
                <div class="w-10 h-10 rounded-full flex-shrink-0 flex items-center justify-center font-bold text-sm bg-gradient-to-br from-[#3C518B] to-[#0B266E] text-white overflow-hidden">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dashUser->avatar_url): ?>
                        <img src="<?php echo e($dashUser->avatar_url); ?>" alt="Avatar" class="w-full h-full object-cover">
                    <?php else: ?>
                        <?php echo e($dashInitials); ?>

                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <div class="min-w-0">
                    <p class="text-[14px] font-bold text-slate-800 truncate"><?php echo e($dashUser->name); ?></p>
                    <p class="text-[10px] text-slate-400 font-semibold uppercase tracking-wider"><?php echo e(ucfirst($dashUser->roles->first()->name ?? 'User')); ?></p>
                </div>
            </div>

            <div class="overflow-y-auto px-4 py-3 space-y-1">
                <a href="<?php echo e(route('profile.edit')); ?>" @click="openMenu = false"
    ...
    <div class="flex items-center justify-around px-2 py-1.5">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="flex flex-col items-center gap-1 px-4 py-1.5 rounded-xl text-[#0B266E]">
        ...
        <a href="<?php echo e(route('profile.edit')); ?>" class="flex flex-col items-center gap-1 px-4 py-1.5 rounded-xl text-[#ADB5BD]">
            <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
            </svg>
...
<?php endif; ?>
<?php /**PATH C:\Users\User\manajemen_praktikum_\resources\views/dashboard.blade.php ENDPATH**/ ?>
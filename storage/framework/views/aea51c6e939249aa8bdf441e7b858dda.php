                        ...
                        <div x-show="open" @click.away="open = false" style="display: none;" 
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($s = 1; $s <= 8; $s++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <label class="flex items-center gap-2.5 px-3 py-1.5 hover:bg-[#F6F8FA] cursor-pointer text-[13px] text-[#353849]">
                                    <input type="radio" value="<?php echo e($s); ?>" x-model="selected" @change="open = false" class="hidden">
                                    <div class="w-4 h-4 rounded-full border flex items-center justify-center transition-colors flex-shrink-0" :class="selected == '<?php echo e($s); ?>' ? 'border-[#0B266E]' : 'border-[#DFE1E7]'">
                                        <div class="w-2 h-2 rounded-full bg-[#0B266E]" x-show="selected == '<?php echo e($s); ?>'" style="display: none;"></div>
                                    </div>
                                    <span>Semester <?php echo e($s); ?></span>
                                </label>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\manajemen-praktikum\admin\matkul-praktikum.blade.php ENDPATH**/ ?>
...
<div style="max-width:100%; padding:24px 24px 56px;" class="online-page-body">

    
    <nav style="display:flex; align-items:center; gap:6px; font-size:11px; color:var(--c-fg-muted); margin-bottom:16px;">
        <a href="<?php echo e(route('superadmin.dashboard')); ?>" style="color:var(--c-fg-muted); text-decoration:none;"
        ...
        <a href="<?php echo e(route('superadmin.users.index')); ?>" style="color:var(--c-fg-muted); text-decoration:none;"
    ...
    <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:16px; margin-bottom:20px; flex-wrap:wrap;">
        <div>
            ...
            <p style="font-size:12px; color:var(--c-fg-muted); margin-top:3px;">
                <span style="color:var(--c-success); font-weight:600;"><?php echo e($users->total()); ?></span> user sedang aktif
            </p>
        </div>
        ...
        <form action="<?php echo e(url()->current()); ?>" method="GET" style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
            ...
            <div x-data="{ open:false, selected:'<?php echo e(request('per_page','10')); ?>', opts:['10','25','50','100'] }" style="position:relative; width:110px;">
            ...
            <div x-data="{
                ...
                roles:[{name:'all',label:'Semua Role'}, <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>{name:'<?php echo e($r->name); ?>',label:'<?php echo e(ucfirst($r->name)); ?>'}, <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>],
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.user-avatar','data' => ['user' => $user,'size' => 'sm','onlineDot' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user),'size' => 'sm','online-dot' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                            <div style="min-width:0;">
                                <div style="display:flex; align-items:center; gap:6px;">
                                    <p style="font-size:13px; font-weight:600; color:var(--c-fg); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:180px;"><?php echo e($user->name); ?></p>
                                ...
                                <p style="font-size:11px; color:var(--c-fg-muted); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:180px;"><?php echo e($user->email); ?></p>
                            </div>
                        </div>
                    </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.role-badge','data' => ['role' => $role->name,'size' => 'xs','style' => 'margin-right:3px;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['role' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($role->name),'size' => 'xs','style' => 'margin-right:3px;']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <td style="padding:12px 16px;">
                        ...
                        <p style="font-size:10px; color:var(--c-fg-muted);"><?php echo e($user->last_login?->diffForHumans() ?? 'Baru saja'); ?></p>
                    </td>

                    <td style="padding:12px 16px; text-align:center;">
                        <div style="display:flex; align-items:center; justify-content:center; gap:4px;">
                            <button onclick="openForceLogoutModal({ id: '<?php echo e($user->id); ?>', name: '<?php echo e(addslashes($user->name)); ?>' })"
                                    title="Force Logout"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isSuperadmin && !$isMe): ?>
                            <button onclick="openSuspendModal({ id: '<?php echo e($user->id); ?>', name: '<?php echo e(addslashes($user->name)); ?>' })"
                                    title="Suspend"
    ...
    <div style="margin-top:20px;"><?php echo e($users->appends(request()->query())->links()); ?></div>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\users\online.blade.php ENDPATH**/ ?>
        ...
        <nav class="hidden sm:flex items-center gap-1.5 text-[14px]">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($breadcrumbs) && count($breadcrumbs)): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($i === count($breadcrumbs) - 1): ?>
                    <span class="font-bold text-grey-800" style="color: var(--grey-800);"><?php echo e($crumb); ?></span>
                <?php else: ?>
                    <span class="text-grey-400"><?php echo e($crumb); ?></span>
            ...
            <?php elseif(isset($breadcrumb)): ?>
                <span class="text-grey-300 mx-1">/</span>
                <span class="font-bold text-grey-800" style="color: var(--grey-800);"><?php echo e($breadcrumb); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </nav>
        <!-- Mobile title -->
        <span class="sm:hidden text-[15px] font-semibold text-grey-800"><?php echo e($breadcrumb ?? 'SIKAPE'); ?></span>
    </div>
    ...
    <div class="flex items-center gap-2">
        ...
        <div class="flex items-center gap-2.5">
            ...
            <div class="hidden sm:block text-left">
                <p class="text-[13px] font-bold text-grey-900 leading-tight" style="color:var(--grey-900);"><?php echo e($user->name ?? 'Mahasiswa'); ?></p>
                <p class="text-[11px] text-grey-400 mt-0.5 leading-none">Mahasiswa</p>
            </div>
        </div>
    </div>
</header>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\kp\mahasiswa\partials\topbar.blade.php ENDPATH**/ ?>
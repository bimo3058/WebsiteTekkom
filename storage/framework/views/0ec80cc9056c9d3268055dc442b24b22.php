...
<div class="mp-page-header">
    <div>
        ...
        <p class="mp-page-sub"><?php echo e($praktikum?->nama ?? 'Belum terdaftar di praktikum manapun'); ?> · <?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?></p>
    </div>
</div>
...
<div class="mp-card flex-shrink-0" style="padding:20px;">
    <form method="POST" action="<?php echo e(route('eoffice.manprak.asprak.modul.store')); ?>"
        ...
        <div>
            ...
            <input name="nama" value="<?php echo e(old('nama')); ?>" required class="mp-input" style="width:100%;"
        ...
        <div>
            ...
            <input name="jadwal_minggu" value="<?php echo e(old('jadwal_minggu')); ?>" class="mp-input" style="width:100%;"
        ...
        <div>
            ...
            <input type="number" name="urutan" value="<?php echo e(old('urutan', $moduls->count() + 1)); ?>" min="1"
        ...
        <div style="grid-row:span 2;display:flex;flex-direction:column;">
            ...
            <textarea name="deskripsi" rows="4" class="mp-input" style="width:100%;flex:1;"
                      placeholder="Deskripsi singkat modul ini"><?php echo e(old('deskripsi')); ?></textarea>
        </div>
...
<div class="mp-card flex-1 min-h-0">
    <div class="mp-card-header">
        ...
        <div class="right">
            <span style="font-size:12px;color:#666D80;"><?php echo e($moduls->count()); ?> modul</span>
        </div>
    </div>
    ...
    <div class="mp-tr" style="display:flex;align-items:flex-start;gap:16px;padding:16px 20px;border-bottom:1px solid #DFE1E7;"
        ...
        <div style="width:36px;height:36px;border-radius:50%;font-size:13px;font-weight:700;
                    ...
                    background:<?php echo e($isMine ? '#F6F8FA' : '#F0F1F4'); ?>;
                    color:<?php echo e($isMine ? '#0B266E' : '#666D80'); ?>;">
            <?php echo e($modul->urutan); ?>

        </div>

        <div style="flex:1;min-width:0;">
            <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-bottom:4px;">
                <span style="font-size:14px;font-weight:600;color:#0D0D12;"><?php echo e($modul->nama); ?></span>
            ...
            <div style="font-size:12px;color:#666D80;margin-bottom:4px;"><?php echo e($modul->jadwal_minggu ?? '—'); ?></div>
            ...
            <div style="font-size:12px;color:#353849;margin-bottom:8px;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;"><?php echo e($modul->deskripsi); ?></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div style="display:flex;gap:12px;font-size:11px;color:#666D80;">
                <span><?php echo e($modul->materi->count()); ?> materi</span>
                <span><?php echo e($modul->tugas->count()); ?> tugas</span>
                <span><?php echo e($modul->modulAsprak->count()); ?> asisten praktikum</span>
            </div>
        </div>

        <div style="display:flex;align-items:center;gap:8px;flex-shrink:0;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isMine): ?>
                <a href="<?php echo e(route('eoffice.manprak.asprak.modul.show', $modul->id)); ?>" class="mp-btn primary sm" style="text-decoration:none;">Detail</a>
                <button onclick="openEdit(<?php echo e($modul->id); ?>, '<?php echo e(addslashes($modul->nama)); ?>', <?php echo e($modul->urutan); ?>, '<?php echo e(addslashes($modul->jadwal_minggu ?? '')); ?>', '<?php echo e(addslashes($modul->deskripsi ?? '')); ?>')"
                        class="mp-btn secondary sm">Edit</button>
                <form method="POST" action="<?php echo e(route('eoffice.manprak.asprak.modul.destroy', $modul->id)); ?>"
                      onsubmit="return confirm('Hapus modul <?php echo e(addslashes($modul->nama)); ?>? Materi dan tugas di dalamnya juga akan dihapus.')">
    ...
    <div style="background:#fff;border-radius:16px;box-shadow:0 20px 60px rgba(0,0,0,.18);width:100%;max-width:480px;margin:0 16px;padding:24px;">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
            ...
            <button onclick="document.getElementById('modal-edit').classList.add('hidden')"
                    style="color:#666D80;font-size:18px;line-height:1;border:none;background:transparent;cursor:pointer;" aria-label="Tutup dialog edit modul" title="Tutup"><?php if (isset($component)) { $__componentOriginal22b2b62d2a6bf157ddbb8ecb4421b995 = $component; } ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum\asprak\modul.blade.php ENDPATH**/ ?>
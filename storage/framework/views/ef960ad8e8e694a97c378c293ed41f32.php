...
<div style="display:flex;align-items:flex-start;gap:20px;padding-bottom:20px;border-bottom:1px solid #f1f5f9;margin-bottom:20px;">
    ...
    <div style="position:relative;flex-shrink:0;">
        <div style="width:60px;height:60px;border-radius:50%;overflow:hidden;border:2px solid #e2e8f0;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:700;box-shadow:0 1px 3px rgba(0,0,0,.08);" class="<?php echo e($isSuperadmin ? 'bg-[#F3F4F6] text-[#6B7280]' : $roleColor); ?>">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->avatar_url): ?>
                <img src="<?php echo e($user->avatar_url); ?>" id="currentAvatar" alt="Avatar" style="width:100%;height:100%;object-fit:cover;">
            <?php else: ?>
    ...
    <div style="flex:1;min-width:0;">
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-bottom:12px;">
            <p style="font-size:13px;font-weight:700;color:#0f172a;"><?php echo e($user->name); ?></p>
            <span style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.05em;padding:2px 8px;border-radius:6px;" class="<?php echo e($roleColor); ?>"><?php echo e($roleLabel); ?></span>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
            <div>
                ...
                <input type="text" value="<?php echo e($user->name); ?>" readonly class="field-input readonly">
            </div>
            <div>
                <label class="field-label" style="margin-bottom:4px;">Email Resmi (SSO)</label>
                <input type="email" value="<?php echo e($user->email); ?>" readonly class="field-input readonly">
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($idValue): ?>
            <div>
                <label class="field-label" style="margin-bottom:4px;"><?php echo e($idLabel); ?></label>
                <input type="text" value="<?php echo e($idValue); ?>" readonly class="field-input readonly">
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->hasRole('mahasiswa') && $user->student): ?>
            <div>
                <label class="field-label" style="margin-bottom:4px;">Angkatan</label>
                <input type="text" value="<?php echo e($user->student->cohort_year); ?>" readonly class="field-input readonly">
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
...
<form method="POST" action="<?php echo e(route('profile.update')); ?>" id="form-general">
    ...
    <div style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
            ...
            <div x-data="phoneCode('<?php echo e($savedCode); ?>')" style="position: relative;">
                ...
                <div style="display:flex;border:1px solid #e2e8f0;border-radius:8px;overflow:hidden;background:#fff;transition:border-color .15s,box-shadow .15s;"
                    ...
                    <input type="tel" name="whatsapp" value="<?php echo e(old('whatsapp', $savedLocalNum)); ?>" placeholder="8123456789"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['class' => 'mt-1','messages' => $errors->get('whatsapp')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-1','messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('whatsapp'))]); ?>
...
<?php endif; ?>
            ...
            <div>
                ...
                <input type="email" name="personal_email" value="<?php echo e(old('personal_email', $user->personal_email ?? '')); ?>" placeholder="email@pribadi.com" class="field-input">
                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['class' => 'mt-1','messages' => $errors->get('personal_email')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-1','messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('personal_email'))]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->hasAnyRole(['mahasiswa', 'alumni'])): ?>
<div style="margin-top:24px;padding-top:20px;border-top:1px solid #f1f5f9;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;">
        ...
        <div style="display:flex;flex-direction:row;gap:8px;flex-shrink:0;align-items:center;">
            <a href="<?php echo e($user->hasRole('mahasiswa') ? route('manajemenmahasiswa.direktori.mahasiswa.profil.cv') : route('manajemenmahasiswa.direktori.alumni.profil.cv')); ?>" target="_blank"
            ...
            <a href="<?php echo e(route('profile.cv.index')); ?>"
...
<?php /**PATH C:\WebsiteTekkom - Copy\resources\views/profile/partials/settings-panel-general.blade.php ENDPATH**/ ?>
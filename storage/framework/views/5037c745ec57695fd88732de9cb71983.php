...
<div class="d-flex justify-content-between align-items-start">
    <div class="detail-header">
        <a href="<?php echo e(route('manajemenmahasiswa.proker.index')); ?>" class="btn-back">&larr;</a>
        <div>
            <h3 class="fw-bold mb-0" style="font-size:1.45rem;color:#0D0D12;letter-spacing:-.02em;">Detail Rencana Proker</h3>
            <p class="mb-0" style="font-size:.82rem;color:#666D80;font-weight:500;"><?php echo e($proker->judul); ?></p>
        </div>
    </div>
    <div class="d-flex gap-2 flex-wrap align-items-start">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEdit && $proker->status === 'draft'): ?>
            <a href="<?php echo e(route('manajemenmahasiswa.proker.edit', $proker->id)); ?>"
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canDelete && $proker->status === 'draft'): ?>
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proker->status === 'draft'): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canAjukan): ?>
                <form action="<?php echo e(route('manajemenmahasiswa.proker.ajukan', $proker->id)); ?>" method="POST" style="margin:0;">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-4 mb-3">
        <div>
            <div class="d-flex flex-wrap gap-2 mb-3">
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ($proker->kategoris ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <span class="badge-bidang" style="background:#FFFBEB;color:#92400e;"><?php echo e($kat->nama_kategori); ?></span>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
            <h4 class="fw-bold mb-1" style="color:#0D0D12;"><?php echo e($proker->judul); ?></h4>
            <div style="font-size:13px;color:#666D80;font-weight:500;">
                Dibuat oleh: <span style="color:#374151;font-weight:600;"><?php echo e($proker->creator?->name ?? '-'); ?></span> &bull; 
                <?php echo e($proker->created_at->translatedFormat('d M Y')); ?>
...
<div class="detail-card">
    ...
    <div style="font-size:14px;color:#374151;line-height:1.75;white-space:pre-line;"><?php echo e($proker->deskripsi); ?></div>
</div>


<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proker->status === 'disetujui'): ?>
<div class="detail-card" style="background:rgba(11,38,110,0.05);border:1px solid rgba(11,38,110,0.18);">
    <div style="display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;">
        ...
        <a href="<?php echo e(route('manajemenmahasiswa.pelaksanaan.show', $proker->id)); ?>"
...
<div id="deleteModal" class="modal-overlay" style="display:none;">
    <div class="modal-box">
        ...
        <p style="color:#666D80;font-size:14px;">Data proker "<strong><?php echo e($proker->judul); ?></strong>" akan dihapus permanen.</p>
        <div class="d-flex gap-2 justify-content-center mt-3">
            ...
            <form action="<?php echo e(route('manajemenmahasiswa.proker.destroy', $proker->id)); ?>" method="POST">
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\proker\show.blade.php ENDPATH**/ ?>
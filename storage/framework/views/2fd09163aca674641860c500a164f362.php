...
<head>
    ...
    <title><?php echo e(config('app.name', 'Portal Mahasiswa')); ?></title>
...
<body class="font-sans antialiased text-slate-900 bg-slate-50 selection:bg-primary selection:text-white">
    <div x-data="{ sidebarOpen: true }" class="flex h-screen bg-slate-50 font-sans text-slate-900 overflow-hidden">
        ...
        <!-- Sidebar -->
        <?php if (isset($component)) { $__componentOriginal6054a76d4caf683b393e47e26d6c4078 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6054a76d4caf683b393e47e26d6c4078 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'banksoal::components.ui.sidebar-mahasiswa','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('banksoal::ui.sidebar-mahasiswa'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6054a76d4caf683b393e47e26d6c4078)): ?>
<?php $attributes = $__attributesOriginal6054a76d4caf683b393e47e26d6c4078; ?>
<?php unset($__attributesOriginal6054a76d4caf683b393e47e26d6c4078); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal6054a76d4caf683b393e47e26d6c4078)): ?>
<?php $component = $__componentOriginal6054a76d4caf683b393e47e26d6c4078; ?>
<?php unset($__componentOriginal6054a76d4caf683b393e47e26d6c4078); ?>
<?php endif; ?>
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden relative">
            ...
            <header class="bg-white border-b border-slate-200 h-16 flex-shrink-0 flex items-center justify-between px-6 z-10">
                <div class="flex items-center text-sm font-medium text-slate-600">
                    <span class="mr-2">Ujian Komprehensif</span> 
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 cursor-pointer group">
                        <div class="w-9 h-9 rounded-full bg-slate-200 flex items-center justify-center text-slate-600 overflow-hidden border border-slate-300 group-hover:border-primary transition-colors">
                            <span class="font-bold text-sm"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'M', 0, 1))); ?></span>
                        </div>
                        <div class="flex flex-col">
                            <span class="text-sm font-bold text-slate-800 leading-tight"><?php echo e(auth()->user()->name ?? 'Mahasiswa'); ?></span>
                            <span class="text-[11px] text-slate-500 font-medium">Mahasiswa</span>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main class="flex-1 overflow-y-auto bg-slate-50 relative">
                <div class="px-8 py-8 w-full max-w-screen-2xl mx-auto">
                    <?php echo e($slot); ?>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\components\layouts\mahasiswa.blade.php ENDPATH**/ ?>
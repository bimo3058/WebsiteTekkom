    ...
    <div class="simenma-topbar-right">
        ...
        <div class="simenma-notif-wrap" id="notifWrap">
            <button class="simenma-icon-btn" title="Notifikasi" onclick="toggleNotifDropdown()" id="notifBtn">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unreadNotifCount > 0): ?>
                    <span class="simenma-notif-badge" id="notifBadge"><?php echo e($unreadNotifCount > 9 ? '9+' : $unreadNotifCount); ?></span>
                <?php else: ?>
        ...
        <div class="simenma-topbar-user">
            ...
            <div class="simenma-topbar-meta">
                <div class="simenma-topbar-name"><?php echo e($user->name); ?></div>
                <div class="simenma-topbar-role"><?php echo e($roleDisplay); ?></div>
            </div>
        </div>
    </div>
</div>
...
<script>
const NOTIF_URL = '<?php echo e(route("manajemenmahasiswa.notifications.index")); ?>';
const NOTIF_READ_URL = '<?php echo e(route("manajemenmahasiswa.notifications.read", "__ID__")); ?>';
const NOTIF_READ_ALL_URL = '<?php echo e(route("manajemenmahasiswa.notifications.read_all")); ?>';
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules/ManajemenMahasiswa\resources/views/components/ui/topbar.blade.php ENDPATH**/ ?>
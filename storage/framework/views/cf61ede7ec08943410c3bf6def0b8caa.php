...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => ['title' => 'FAQ & Timeline KP']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'FAQ & Timeline KP']); ?>
    ...
    <div
        ...
        <div x-show="activeTab === 'dokumen'" x-transition.opacity.duration.300ms>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('eoffice.kp.koordinator.faq.dokumen.store')); ?>" method="POST"
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-slate-200">
                        ...
                        <tbody class="bg-white divide-y divide-slate-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dokumens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr class="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p
                                                    ...
                                                    <?php echo e($doc->judul); ?></p>
                                                <div class="flex items-center text-xs text-slate-500 mt-0.5 space-x-2">
                                                    <span><?php echo e($doc->file_name); ?></span>
                                                    <span class="w-1 h-1 rounded-full bg-slate-300"></span>
                                                    <span
                                                        class="font-medium bg-slate-100 px-1.5 rounded"><?php echo e($doc->version ?? 'v1.0'); ?></span>
                                                    <span class="w-1 h-1 rounded-full bg-slate-300"></span>
                                                    <span><?php echo e($doc->file_size ?? 'Unknown'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <p class="text-sm text-slate-900 font-medium">
                                            <?php echo e(\Carbon\Carbon::parse($doc->created_at)->format('d M Y')); ?></p>
                                        <p class="text-xs text-slate-500 mt-0.5">Oleh: <?php echo e($doc->pembuat->name); ?></p>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($doc->is_active): ?>
                                            <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <button title="Hapus"
                                                @click="deleteId = <?php echo e($doc->id); ?>; deleteDokumenOpen = true"
                        ...
                        <div class="flex items-start justify-between px-6 py-5 cursor-pointer hover:bg-slate-50 transition-colors"
                            ...
                            <div class="flex-1 pr-4">
                                <h3 class="text-[15px] font-bold text-slate-900 leading-snug"
                                    :class="expanded ? 'text-indigo-700' : ''"><?php echo e($faq->pertanyaan); ?></h3>
                            ...
                            <div class="flex items-center gap-3 shrink-0">
                                <div class="flex gap-1" @click.stop>
                                    ...
                                    <button @click="deleteId = <?php echo e($faq->id); ?>; deleteFaqOpen = true"
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div x-show="faqModalOpen" @click.away="faqModalOpen = false"
                        ...
                        <form action="<?php echo e(route('eoffice.kp.koordinator.faq.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\faq.blade.php ENDPATH**/ ?>
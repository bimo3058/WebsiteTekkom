...
<form action="<?php echo e(route('manajemenmahasiswa.kegiatan.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-card">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="judul" class="form-control form-control-custom"
                   placeholder="Contoh: Seminar Nasional IT 2026" value="<?php echo e(old('judul')); ?>" required maxlength="255">
        </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kategoriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <label class="checkbox-card" id="kategoriCard<?php echo e($kategori->id); ?>">
                            <input type="checkbox" name="kategori_kegiatan_id[]"
                                   ...
                                   <?php echo e(is_array(old('kategori_kegiatan_id')) && in_array($kategori->id, old('kategori_kegiatan_id')) ? 'checked' : ''); ?>>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bidangList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bidang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <label class="checkbox-card" id="bidangCard<?php echo e($bidang->id); ?>">
                            <input type="checkbox" name="bidang_id[]"
                                   ...
                                   <?php echo e(is_array(old('bidang_id')) && in_array($bidang->id, old('bidang_id')) ? 'checked' : ''); ?>>
        ...
        <div class="mb-3">
            ...
            <textarea name="deskripsi" class="form-control form-control-custom"
                      placeholder="Jelaskan tujuan, sasaran, dan detail kegiatan secara lengkap..." required><?php echo e(old('deskripsi')); ?></textarea>
        </div>
    ...
    <div class="form-card">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="lokasi" class="form-control form-control-custom"
                   placeholder="Contoh: Gedung A Lantai 3, Undip Tembalang" value="<?php echo e(old('lokasi')); ?>">
        </div>
    </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <div class="search-select-wrapper">
                    <input type="hidden" name="ketua_pelaksana_id" id="ketuaPelaksanaId" value="<?php echo e(old('ketua_pelaksana_id')); ?>">
            ...
            <div class="col-md-6">
                ...
                <div class="search-select-wrapper">
                    <input type="hidden" name="dosen_pendamping_id" id="dosenPendampingId" value="<?php echo e(old('dosen_pendamping_id')); ?>">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="number" name="target_peserta" class="form-control form-control-custom"
                       placeholder="Jumlah peserta" value="<?php echo e(old('target_peserta')); ?>" min="1">
            </div>
            <div class="col-md-6">
                <label class="form-label-custom">Anggaran (Rp)</label>
                <input type="number" name="anggaran" class="form-control form-control-custom"
                       placeholder="Contoh: 5000000" value="<?php echo e(old('anggaran')); ?>" min="0" max="9999999999999" step="1000">
            </div>
        </div>
    </div>
    ...
    <div class="d-flex gap-3 justify-content-end mt-2">
        <a href="<?php echo e(route('manajemenmahasiswa.kegiatan.index')); ?>" class="btn-cancel">Batal</a>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\kegiatan\create.blade.php ENDPATH**/ ?>
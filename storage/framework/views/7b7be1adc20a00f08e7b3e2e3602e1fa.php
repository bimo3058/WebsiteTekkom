...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => ['title' => 'Pengumuman & Informasi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Pengumuman & Informasi']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

    <?php $__env->startSection('breadcrumbs'); ?>
        <a href="<?php echo e(route('eoffice.kp.koordinator.dashboard')); ?>"
    ...
    <div x-data="{
        ...
        deleteId: null,
        tabState: {
            pengumuman: { isEditing: false, formAction: '<?php echo e(route('eoffice.kp.koordinator.pengumuman.store')); ?>', formData: { judul: '', konten: '', is_active: true, fileName: '' } },
            faq: { isEditing: false, formAction: '<?php echo e(route('eoffice.kp.koordinator.pengumuman.store')); ?>', formData: { judul: '', konten: '', is_active: true, fileName: '' } },
            timeline: { isEditing: false, formAction: '<?php echo e(route('eoffice.kp.koordinator.pengumuman.store')); ?>', formData: { judul: '', konten: '', is_active: true, fileName: '' } }
        }
    }">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
            <div x-data="{ show: true }" x-show="show" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <div class="flex-1">
                    ...
                    <p class="text-[13px] text-slate-500 leading-relaxed"><?php echo e(session('success')); ?></p>
                </div>
                        ...
                        <div class="w-full flex flex-col justify-between h-full space-y-4"
                            ...
                            <div class="flex gap-1.5 w-full">
                                <button type="button" x-show="tabState[activeTab].isEditing"
                                    @click="tabState[activeTab].isEditing = false; tabState[activeTab].formAction = '<?php echo e(route('eoffice.kp.koordinator.pengumuman.store')); ?>'; tabState[activeTab].formData = { judul: '', konten: '', is_active: true, fileName: '' }"
        ...
        <div x-show="activeTab === 'pengumuman'" x-transition.opacity.duration.300ms x-data="{
                ...
                perPage: 5,
                currentPage: 1,
                allItems: <?php echo e($pengumumen->map(function ($i) {
        return [
            'id' => $i->id,
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm mb-6 overflow-hidden">
                ...
                <div class="divide-y divide-slate-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pengumumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="group hover:bg-slate-50 transition-colors p-5 flex flex-col md:flex-row gap-5"
                            x-show="filteredItems.includes(<?php echo e($item->id); ?>) && (() => { const i = filteredItems.indexOf(<?php echo e($item->id); ?>); return i >= (currentPage - 1) * perPage && i < currentPage * perPage; })()"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-slate-600 line-clamp-2 leading-relaxed mb-4"><?php echo e($item->konten); ?></p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->lampiran): ?>
                                    <a href="<?php echo e(Storage::url($item->lampiran)); ?>" target="_blank"
                                        ...
                                        <?php echo e(basename($item->lampiran)); ?>
                            ...
                            <div
                                ...
                                <button type="button"
                                    @click='tabState[activeTab].formData = { judul: <?php echo json_encode($item->judul, 15, 512) ?>, konten: <?php echo json_encode($item->konten, 15, 512) ?>, is_active: <?php echo e($item->is_published ? "true" : "false"); ?>, fileName: <?php echo json_encode($item->lampiran ? basename($item->lampiran) : "", 15, 512) ?> }; tabState[activeTab].formAction = `/eoffice/kp/koordinator/pengumuman/<?php echo e($item->id); ?>`; tabState[activeTab].isEditing = true; document.getElementById("form-section").scrollIntoView({ behavior: "smooth" });'
                                ...
                                <button type="button" @click="deleteId = <?php echo e($item->id); ?>; deleteModalOpen = true;"
                            ...
                            <div class="flex items-start justify-between px-6 py-5 cursor-pointer hover:bg-slate-50 transition-colors"
                                ...
                                <div class="flex-1 pr-4">
                                    <h3 class="text-[15px] font-bold text-slate-900 leading-snug"
                                        :class="expanded ? 'text-indigo-700' : ''"><?php echo e($faq->judul); ?></h3>
                                    <p class="text-xs text-slate-400 mt-1.5 font-medium flex items-center">
                                        <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                        Update terakhir: <?php echo e(\Carbon\Carbon::parse($faq->updated_at)->diffForHumans()); ?>
                                ...
                                <div class="flex items-center gap-3 shrink-0">
                                    <div class="flex gap-1" @click.stop>
                                        <button type="button"
                                            @click='tabState[activeTab].formData = { judul: <?php echo json_encode($faq->judul, 15, 512) ?>, konten: <?php echo json_encode($faq->konten, 15, 512) ?>, is_active: <?php echo e($faq->is_published ? "true" : "false"); ?> }; tabState[activeTab].formAction = `/eoffice/kp/koordinator/pengumuman/<?php echo e($faq->id); ?>`; tabState[activeTab].isEditing = true; document.getElementById("form-section").scrollIntoView({ behavior: "smooth" });'
                                        ...
                                        <button @click="deleteId = <?php echo e($faq->id); ?>; deleteModalOpen = true;"
        ...
        <div x-show="activeTab === 'timeline'" style="display: none;" x-transition.opacity.duration.300ms>
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-6">
                <div class="divide-y divide-slate-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $timelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="group hover:bg-slate-50 transition-colors p-5 flex flex-col md:flex-row gap-5">
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-3 mb-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($timeline->is_published): ?>
                                        <span
                                ...
                                <h3
                                    class="text-sm font-bold text-slate-900 mb-2 truncate group-hover:text-indigo-700 transition-colors">
                                    <?php echo e($timeline->judul); ?>

                                </h3>
                                <p class="text-xs text-slate-600 line-clamp-2 leading-relaxed mb-4"><?php echo e($timeline->konten); ?>

                                </p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($timeline->lampiran): ?>
                                    <a href="<?php echo e(Storage::url($timeline->lampiran)); ?>" target="_blank"
                                        class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-50 border border-slate-200 rounded-lg text-[11px] font-medium text-slate-600 hover:bg-slate-100 hover:text-indigo-600 cursor-pointer transition-colors w-fit mt-2">
                                        ...
                                        <?php echo e(basename($timeline->lampiran)); ?>
                            ...
                            <div
                                class="flex flex-row md:flex-col items-center justify-end gap-1.5 shrink-0 border-t md:border-t-0 md:border-l border-slate-100 pt-4 md:pt-0 md:pl-5">
                                <button type="button"
                                    @click='tabState[activeTab].formData = { judul: <?php echo json_encode($timeline->judul, 15, 512) ?>, konten: <?php echo json_encode($timeline->konten, 15, 512) ?>, is_active: <?php echo e($timeline->is_published ? "true" : "false"); ?>, fileName: <?php echo json_encode($timeline->lampiran ? basename($timeline->lampiran) : "", 15, 512) ?> }; tabState[activeTab].formAction = `/eoffice/kp/koordinator/pengumuman/<?php echo e($timeline->id); ?>`; tabState[activeTab].isEditing = true; document.getElementById("form-section").scrollIntoView({ behavior: "smooth" });'
                                    class="flex-1 md:flex-none inline-flex items-center justify-center px-4 md:px-3 py-2 bg-white border border-slate-200 text-slate-600 text-sm font-medium rounded-lg hover:bg-slate-50 hover:text-indigo-600 transition-colors shadow-sm">
                                    <svg class="w-4 h-4 mr-2 md:mr-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                ...
                                <button type="button" @click="deleteId = <?php echo e($timeline->id); ?>; deleteModalOpen = true;"
                                    class="flex-1 md:flex-none inline-flex items-center justify-center px-4 md:px-3 py-2 bg-white border border-slate-200 text-red-500 text-sm font-medium rounded-lg hover:bg-red-50 hover:border-red-100 transition-colors shadow-sm">
                                    <svg class="w-4 h-4 mr-2 md:mr-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\pengumuman.blade.php ENDPATH**/ ?>
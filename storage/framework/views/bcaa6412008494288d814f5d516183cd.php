...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'capstone::components.dialog','data' => ['id' => 'confirm-delete','title' => $deleteTitle ?? 'Hapus Data']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'confirm-delete','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($deleteTitle ?? 'Hapus Data')]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

    <p class="text-muted-foreground text-sm py-4"><?php echo e($deleteDescription ?? 'Apakah Anda yakin ingin menghapus data ini? Tindakan ini tidak dapat dibatalkan.'); ?> <strong x-text="deleting?.name || deleting?.code || ''"></strong></p>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules/Capstone\resources/views/partials/delete-dialog.blade.php ENDPATH**/ ?>
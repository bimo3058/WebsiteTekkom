...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="flex flex-col items-center w-full max-w-md px-4">
            ...
            <div class="px-8 py-7">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any()): ?>
                    <div class="mb-5 flex items-start gap-3 p-3.5 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 rounded-xl">
                        ...
                        <p class="text-sm text-red-600 dark:text-red-400"><?php echo e($errors->first()); ?></p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($remaining < 5): ?>
                    <div class="mb-5 flex items-center gap-2 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 rounded-xl">
                        ...
                        <p class="text-xs font-semibold text-amber-700 dark:text-amber-400">
                            Sisa percobaan: <span class="font-bold"><?php echo e($remaining); ?>x</span> sebelum akun dikunci.
                        </p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <form method="POST" action="<?php echo e(route('sso.verify')); ?>" class="space-y-5">
                    <?php echo csrf_field(); ?>
                ...
                <div class="mt-5 pt-5 border-t border-slate-200 dark:border-slate-700 text-center">
                    ...
                    <form method="POST" action="<?php echo e(route('logout.switch')); ?>" class="inline">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
        ...
        <div class="mt-6 text-center text-xs text-slate-500 dark:text-slate-400 font-medium">
            <p>© <?php echo e(date('Y')); ?> Departemen Teknik Komunikasi • Universitas Diponegoro</p>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\auth\sso-password.blade.php ENDPATH**/ ?>
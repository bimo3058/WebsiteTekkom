...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="page-header">
        ...
        <div style="display: flex; gap: 8px;">
            ...
            <a href="<?php echo e(route('banksoal.admin.kontrol-umum.mata-kuliah.create')); ?>" class="btn-add" style="text-decoration: none;">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="page-header" style="margin-top: 48px;">
        ...
        <div style="display: flex; gap: 8px;">
            <a href="<?php echo e(route('banksoal.admin.kontrol-umum.cpl.create')); ?>" class="btn-add" style="text-decoration: none;">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                Tambah CPL
    ...
    <script>
        const API_URL = '<?php echo e(url("/bank-soal/admin/api/mata-kuliah")); ?>';
        const EDIT_MK_URL = '<?php echo e(url("/bank-soal/admin/kontrol-umum/mata-kuliah")); ?>';
        const EDIT_CPL_URL = '<?php echo e(url("/bank-soal/admin/kontrol-umum/cpl")); ?>';
        ...
        const API_URL_CPL = '<?php echo e(url("/bank-soal/admin/api/cpl")); ?>';
        let allCpl = [];
        let filteredCpl = [];
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules/BankSoal\resources/views/pages/admin/kontrol-umum/mata-kuliah.blade.php ENDPATH**/ ?>
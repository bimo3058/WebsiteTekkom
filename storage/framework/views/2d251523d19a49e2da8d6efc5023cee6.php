...
<!-- Back Button -->
<div class="mb-3">
    <a href="<?php echo e(route('manajemenmahasiswa.direktori.mahasiswa.show', $mhs->id)); ?>" class="btn-outline-custom" style="font-size: 12px; padding: 6px 14px;">
...
<div class="form-card">
    ...
    <div class="form-subtitle">Perbarui informasi biodata mahasiswa: <?php echo e($mhs->nama); ?></div>

    <form method="POST" action="<?php echo e(route('manajemenmahasiswa.direktori.mahasiswa.update', $mhs->id)); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <input type="text" name="nama" class="form-control form-control-custom"
                       value="<?php echo e(old('nama', $mhs->nama)); ?>" required readonly style="background-color: #f3f4f6; cursor: not-allowed; opacity: 0.7;">
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="nim" class="form-control form-control-custom"
                       value="<?php echo e(old('nim', $mhs->nim)); ?>" required readonly style="background-color: #f3f4f6; cursor: not-allowed; opacity: 0.7;">
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="angkatan" class="form-control form-control-custom"
                       value="<?php echo e(old('angkatan', $mhs->angkatan)); ?>" min="2000" max="2099" required readonly style="background-color: #f3f4f6; cursor: not-allowed; opacity: 0.7;">
            </div>
            ...
            <div class="col-md-6">
                ...
                <select name="status" class="form-select form-select-custom" required>
                    <option value="aktif" <?php echo e(old('status', $mhs->status) == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                    <option value="cuti" <?php echo e(old('status', $mhs->status) == 'cuti' ? 'selected' : ''); ?>>Cuti</option>
                    <option value="drop_out" <?php echo e(old('status', $mhs->status) == 'drop_out' ? 'selected' : ''); ?>>Drop Out</option>
                    <option value="pindah_studi" <?php echo e(old('status', $mhs->status) == 'pindah_studi' ? 'selected' : ''); ?>>Pindah Studi</option>
                    <option value="wafat" <?php echo e(old('status', $mhs->status) == 'wafat' ? 'selected' : ''); ?>>Wafat</option>
                    <option value="mangkir" <?php echo e(old('status', $mhs->status) == 'mangkir' ? 'selected' : ''); ?>>Mangkir</option>
                </select>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="ipk" class="form-control form-control-custom"
                       value="<?php echo e(old('ipk', $mhs->ipk)); ?>" min="0" max="4" step="0.01"
            ...
            <div class="col-md-6">
                ...
                <input type="email" name="email_pribadi" class="form-control form-control-custom"
                       value="<?php echo e(old('email_pribadi', $mhs->user?->personal_email)); ?>"
            ...
            <!-- Kontak -->
            <div class="col-md-6" x-data="mhsPhoneCode('<?php echo e($savedCode); ?>')">
        ...
        <div class="d-flex gap-3 mt-4 pt-3" style="border-top: 1px solid #f3f4f6;">
            ...
            <a href="<?php echo e(route('manajemenmahasiswa.direktori.mahasiswa.show', $mhs->id)); ?>" class="btn-outline-custom">
                Batal
            </a>
        </div>
    </form>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\direktori\mahasiswa-edit.blade.php ENDPATH**/ ?>
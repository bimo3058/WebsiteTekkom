...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'banksoal::components.ui.page-header','data' => ['title' => 'Manajemen Bank Soal','subtitle' => 'Kelola dan organisir repositori pertanyaan Anda']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Manajemen Bank Soal','subtitle' => 'Kelola dan organisir repositori pertanyaan Anda']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('banksoal.edit')): ?>
            <div class="relative" id="uploadDropdownContainer">
                ...
                <div id="uploadDropdownMenu" class="absolute right-0 top-[110%] w-56 bg-white border border-slate-100 rounded-xl shadow-lg transition-all duration-200 ease-out origin-top-right z-50 overflow-hidden transform opacity-0 scale-95 pointer-events-none">
                    <a href="<?php echo e(route('banksoal.soal.dosen.export-csv')); ?>" class="flex items-center px-4 py-3 text-sm text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition-colors border-b border-slate-50">
            ...
            <a href="<?php echo e(route('banksoal.soal.dosen.create')); ?>" class="inline-flex items-center gap-2 bg-slate-800 hover:bg-slate-900 text-white rounded-lg px-4 py-2.5 font-medium transition-colors shadow-sm">
...
<div
    ...
    data-mk-json="<?php echo e(base64_encode($mataKuliahDosen->toJson())); ?>"
    hidden
></div>
...
<div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-8">
    ...
    <form action="<?php echo e(route('banksoal.soal.dosen.index')); ?>" method="GET" class="p-6 border-b border-slate-200 flex flex-col md:flex-row gap-3 flex-wrap items-center" id="filterForm" onsubmit="window.showLoader();">
        <div class="relative flex-1 min-w-[250px] w-full">
            ...
            <input type="text" data-search-tab="soal" name="searchSoal" list="search-suggestions" value="<?php echo e(request('searchSoal')); ?>" placeholder="Cari soal, kursus, atau topik..." class="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all outline-none" autocomplete="off" id="searchSoal">
            <datalist id="search-suggestions">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mataKuliahDosen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <option value="<?php echo e($mk->nama); ?>"></option>
        ...
        <select name="sort" id="sortBy" onchange="this.form.submit()" class="px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none cursor-pointer min-w-[140px] flex-shrink-0 focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all outline-none">
            ...
            <option value="nama-asc" <?php echo e(request('sort') == 'nama-asc' ? 'selected' : ''); ?>>Nama A-Z</option>
            <option value="nama-desc" <?php echo e(request('sort') == 'nama-desc' ? 'selected' : ''); ?>>Nama Z-A</option>
        </select>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['formId' => 'filterForm','hasActiveFilter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request('status') ? true : false),'resetRoute' => ''.e(route('banksoal.soal.dosen.index')).'','applyLabel' => 'Terapkan']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 cursor-pointer group">
                            <input type="radio" name="status" value="<?php echo e($val); ?>" <?php if(request('status') == $val): echo 'checked'; endif; ?> class="w-4 h-4 rounded-full border-slate-300 text-primary focus:ring-primary transition-all">
...
<?php endif; ?>
    ...
    <div class="overflow-x-auto" data-tab-panel="soal">
        <table class="w-full" id="tableSoal">
            ...
            <tbody class="divide-y divide-slate-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = ($soals ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $soal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        <td class="px-6 py-4 font-medium text-slate-900">
                            <div class="flex flex-col items-start gap-1">
                                <span><?php echo e($soal->kode_soal); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strtolower($soal->tipe_soal) === 'essay'): ?>
                        ...
                        <td class="px-2 py-4 text-slate-600"><?php echo e($soal->mataKuliah->nama ?? '-'); ?></td>
                        <td class="px-2 py-4 text-slate-600"><?php echo \Illuminate\Support\Str::limit(strip_tags($soal->soal), 80, '...'); ?></td>
                        <td class="px-3 py-4">
                            <?php $diff = strtolower($soal->kesulitan ?? ''); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($diff === 'easy'): ?>
                                <span class="inline-flex px-2.5 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-700"><?php echo e(ucfirst($soal->kesulitan)); ?></span>
                            <?php elseif($diff === 'advanced'): ?>
                                <span class="inline-flex px-2.5 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-700"><?php echo e(ucfirst($soal->kesulitan)); ?></span>
                            <?php else: ?>
                                <span class="inline-flex px-2.5 py-1 rounded-full text-xs font-semibold bg-yellow-100 text-yellow-700"><?php echo e(ucfirst($soal->kesulitan)); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="px-3 py-4">
                            <?php $status = strtolower($soal->status ?? 'draft'); ?>
                            ...
                            <?php elseif($status === 'revisi' || $status === 'ditolak'): ?>
                        ...
                        <td class="px-6 py-4">
                            <?php echo $__env->make('banksoal::partials.dosen.soal-actions', ['soal' => $soal], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </td>
                    </tr>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($soals) && $soals->count() > 0): ?>
        <div class="px-6 py-4 border-t border-slate-200 bg-slate-50 flex items-center justify-between">
            <span class="text-sm text-slate-600">
                Showing <?php echo e($soals->firstItem()); ?> to <?php echo e($soals->lastItem()); ?> of <?php echo e($soals->total()); ?> questions
            </span>
            <div class="pagination-list">
                ...
                ?>
                <a href="<?php echo e($soals->appends(request()->query())->previousPageUrl() ?? '#'); ?>"
                   class="pagination-btn <?php echo e($currentPage === 1 ? 'opacity-45 pointer-events-none' : ''); ?>">&lsaquo;</a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($soals->appends(request()->query())->url($page)); ?>"
                           class="pagination-btn <?php echo e((int)$page === $currentPage ? 'active' : ''); ?>"><?php echo e($page); ?></a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <a href="<?php echo e($soals->appends(request()->query())->nextPageUrl() ?? '#'); ?>"
                   class="pagination-btn <?php echo e($currentPage === $totalPages ? 'opacity-45 pointer-events-none' : ''); ?>">&rsaquo;</a>
            </div>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('banksoal.edit')): ?>
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <form action="<?php echo e(route('banksoal.soal.dosen.index')); ?>" method="GET" class="p-6 border-b border-slate-200 flex flex-col sm:flex-row gap-3" onsubmit="window.showLoader();">
            <div class="relative flex-1 max-w-md">
                ...
                <input type="text" data-search-tab="paket" list="packageSuggestions" autocomplete="off" name="searchPackages" value="<?php echo e(request('searchPackages')); ?>" class="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none" placeholder="Cari paket soal, kode mata kuliah, atau nama..." id="searchPackages">
                <datalist id="packageSuggestions">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ($mataKuliahDosen ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($mk->nama); ?>"></option>
                        <option value="<?php echo e($mk->kode); ?>"></option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </datalist>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('searchPackages')): ?>
                <a href="<?php echo e(route('banksoal.soal.dosen.index')); ?>" class="inline-flex items-center gap-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-xl px-4 py-2.5 font-medium transition-colors border border-red-200">
        ...
        <div class="overflow-x-auto" data-tab-panel="paket">
            <table class="w-full" id="tablePackages">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = ($packages ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-6 py-4 font-medium text-slate-900"><?php echo e($pkg->kode); ?></td>
                            <td class="px-6 py-4 text-slate-600"><?php echo e($pkg->nama); ?></td>
                            <td class="px-6 py-4 text-slate-600">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pkg->str_cpls !== '-'): ?>
                                    <span class="inline-flex px-2 py-1 rounded text-xs font-medium bg-primary/10 text-primary whitespace-normal break-words max-w-[150px] leading-relaxed"><?php echo e($pkg->str_cpls); ?></span>
                                <?php else: ?>
                                    <span class="text-slate-400 italic">Belum Dipetakan</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="px-6 py-4 text-slate-600">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pkg->str_cpmks !== '-'): ?>
                                    <span class="inline-flex px-2 py-1 rounded text-xs font-medium bg-emerald-50 text-emerald-700 whitespace-normal break-words max-w-[150px] leading-relaxed"><?php echo e($pkg->str_cpmks); ?></span>
                                <?php else: ?>
                                    <span class="text-slate-400 italic">Belum Dipetakan</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="px-6 py-4">
                                <span class="font-semibold text-slate-900"><?php echo e($pkg->jumlah_soal); ?></span> Set
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <button type="button" data-package-action="lihat" data-mk-id="<?php echo e($pkg->id); ?>" data-mk-nama="<?php echo e(e($pkg->nama)); ?>" class="inline-flex items-center justify-center w-8 h-8 text-slate-600 hover:bg-slate-100 hover:text-primary rounded-lg transition-colors" title="Lihat Daftar Soal"><i class="fas fa-eye text-sm"></i></button>
                                    <button type="button" data-package-action="tarik" data-mk-id="<?php echo e($pkg->id); ?>" class="inline-flex items-center justify-center w-8 h-8 text-slate-600 hover:bg-slate-100 hover:text-emerald-600 rounded-lg transition-colors" title="Tarik Paket Soal"><i class="fas fa-download text-sm"></i></button>
                                </div>
                            </td>
                        </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($packages) && $packages->count() > 0): ?>
            <div class="px-6 py-4 border-t border-slate-200 bg-slate-50 flex items-center justify-between">
                <span class="text-sm text-slate-600">
                    Showing <?php echo e($packages->firstItem()); ?> to <?php echo e($packages->lastItem()); ?> of <?php echo e($packages->total()); ?> packages
                </span>
                <div class="pagination-list">
                    <?php
                    ...
                    ?>
                    <a href="<?php echo e($packages->appends(request()->query())->previousPageUrl() ?? '#'); ?>"
                       class="pagination-btn <?php echo e($pkgPage === 1 ? 'opacity-45 pointer-events-none' : ''); ?>">&lsaquo;</a>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pkgPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p === '...'): ?>
                            <span class="pagination-ellipsis">...</span>
                        <?php else: ?>
                            <a href="<?php echo e($packages->appends(request()->query())->url($p)); ?>"
                               class="pagination-btn <?php echo e((int)$p === $pkgPage ? 'active' : ''); ?>"><?php echo e($p); ?></a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <a href="<?php echo e($packages->appends(request()->query())->nextPageUrl() ?? '#'); ?>"
                       class="pagination-btn <?php echo e($pkgPage === $pkgTotal ? 'opacity-45 pointer-events-none' : ''); ?>">&rsaquo;</a>
                </div>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
...
<div id="tarikSoalModal" class="fixed inset-0 z-[100] hidden items-center justify-center overflow-y-auto overflow-x-hidden bg-slate-900/50 backdrop-blur-sm p-4 transition-opacity duration-300 opacity-0">
    <div id="tarikSoalModalContent" class="relative w-full max-w-lg bg-white rounded-2xl shadow-xl border border-slate-200 transform transition-all duration-300 ease-out opacity-0 scale-95 translate-y-4 flex flex-col max-h-[90vh]">
        ...
        <div class="px-6 py-5 overflow-y-auto w-full">
            <form action="<?php echo e(route('banksoal.soal.dosen.ekstrak')); ?>" method="POST" id="formTarikSoal">
                <?php echo csrf_field(); ?>
...
<div id="importModal" class="fixed inset-0 z-[100] hidden items-center justify-center bg-slate-900/60 backdrop-blur-sm transition-opacity duration-300 opacity-0" onclick="if(event.target === this) closeImportModal()">
    <div id="importModalContent" class="relative w-full max-w-lg transform rounded-2xl bg-white shadow-2xl transition-all duration-300 scale-95 opacity-0 translate-y-4">
        ...
        <form action="<?php echo e(route('banksoal.soal.dosen.import-csv')); ?>" method="POST" enctype="multipart/form-data" onsubmit="if(this.checkValidity()){ window.showLoader(); return true; }">
            <?php echo csrf_field(); ?>
...
<div id="ajukanModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-[100] justify-center items-center bg-slate-900/60 backdrop-blur-sm transition-opacity duration-300 opacity-0">
    <div id="ajukanModalContent" class="relative p-4 w-full max-w-lg max-h-full transform transition-all duration-300 scale-95 opacity-0 translate-y-4">
        <form action="<?php echo e(route('banksoal.soal.dosen.ajukan-semua')); ?>" method="POST" class="relative bg-white rounded-2xl shadow-xl border border-slate-100 flex flex-col max-h-[90vh]" onsubmit="if(this.checkValidity()){ window.showLoader(); return true; }">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('banksoal::pages.bank-soal.Dosen.review-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\bank-soal\Dosen\index.blade.php ENDPATH**/ ?>
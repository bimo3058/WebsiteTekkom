...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="user-wrap">
        <div class="user-box">
            ...
            <div class="user-box-header">
                <?php echo $__env->make('superadmin.users._header', ['total' => $users->total()], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>

            
            <div class="user-box-body">
                
                <?php echo $__env->make('superadmin.users._alerts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                
                <?php echo $__env->make('superadmin.users._table', ['users' => $users, 'roles' => $roles], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
    ...
    <?php echo $__env->make('superadmin.users._modal_add', ['roles' => $roles], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script>
        const DOSEN_ID     = <?php echo e($roles->first(fn($r) => strtolower($r->name) === 'dosen')?->id ?? 'null'); ?>;
        const MAHASISWA_ID = <?php echo e($roles->first(fn($r) => strtolower($r->name) === 'mahasiswa')?->id ?? 'null'); ?>;
        ...
        function openBulkDeleteHybrid() {
            ...
            form.action = '<?php echo e(route("superadmin.users.bulk-destroy")); ?>';
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views/superadmin/users/index.blade.php ENDPATH**/ ?>
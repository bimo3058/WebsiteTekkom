...
<div id="importProgressContainer"
     data-import-id="<?php echo e($displayId ?? ''); ?>"
     style="<?php echo e($displayId ? '' : 'display:none;'); ?> background:#fff; border:1px solid var(--c-border); border-radius:12px; overflow:hidden; margin-bottom:16px; box-shadow:0px 1px 2px rgba(228,229,231,0.24);">
    <div style="display:flex; align-items:center; justify-content:space-between; padding:10px 16px; background:var(--c-bg); border-bottom:1px solid var(--c-border);">
        ...
        <div style="display:flex; align-items:center; gap:12px;">
            ...
            <button type="button" id="btnCancelImport" onclick="confirmCancelProgressModal('<?php echo e($displayId); ?>')"
...
<div style="background:#fff; border:1px solid var(--c-error-subtle); border-left:3px solid var(--c-error); border-radius:10px; margin-bottom:16px; overflow:hidden;">
    ...
    <ul style="padding:10px 14px 10px 28px; list-style:disc; margin:0;">
        ...
        <li style="font-size:11px; color:var(--c-error); font-weight:500; margin-bottom:2px;"><?php echo e($error); ?></li>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success') && !$displayId): ?>
<div style="display:flex; align-items:center; justify-content:space-between; background:#fff; border:1px solid #9DE0D3; border-left:3px solid var(--c-success); border-radius:10px; padding:10px 14px; margin-bottom:16px;">
    <div style="display:flex; align-items:center; gap:10px;">
        ...
        <span style="font-size:11px; font-weight:600; color:#287F6E;"><?php echo e(session('success')); ?></span>
    </div>
...
</script><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\users\_alerts.blade.php ENDPATH**/ ?>
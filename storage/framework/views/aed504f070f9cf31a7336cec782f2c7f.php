...
<aside data-mobile-sidebar x-data="{ sidebarCollapsed: false }"
    ...
    <div class="flex items-center gap-3 px-6 h-16 flex-shrink-0 sikape-logo-container">
        <img src="<?php echo e(asset('images/UNDIPOfficial.png')); ?>" alt="Logo UNDIP" class="w-8 h-8 object-contain flex-shrink-0">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5" :class="sidebarCollapsed ? 'lg:px-2' : ''">
        ...
        <a href="<?php echo e(route('eoffice.kp.mahasiswa.dashboard')); ?>"
           class="sikape-nav-item <?php echo e(isActive('mahasiswa.dashboard', $route) ? 'active' : ''); ?>">
        ...
        <div x-data="{ 
                open: localStorage.getItem('sidebar_info_open') === 'true' || <?php echo e(isActive('mahasiswa.proposal', $route) || isActive('mahasiswa.surat', $route) || isActive('mahasiswa.pengumuman', $route) || isActive('mahasiswa.faq', $route) ? 'true' : 'false'); ?>,
                toggle() {
                    this.open = !this.open;
            ...
            <button @click="toggle()"
                    class="sikape-nav-item w-full <?php echo e(isActive('mahasiswa.proposal', $route) || isActive('mahasiswa.surat', $route) || isActive('mahasiswa.pengumuman', $route) || isActive('mahasiswa.faq', $route) ? 'active' : ''); ?>">
                <span class="sikape-nav-icon">
            ...
            <div x-show="open && !sidebarCollapsed" x-collapse class="mt-0.5 ml-3 pl-3 border-l border-grey-100 space-y-0.5">
                <a href="<?php echo e(route('eoffice.kp.mahasiswa.pengumuman')); ?>"
                   class="sikape-sub-item <?php echo e(isActive('mahasiswa.pengumuman', $route) ? 'active' : ''); ?>">
                    Pengumuman
                </a>
                <a href="<?php echo e(route('eoffice.kp.mahasiswa.faq')); ?>"
                   class="sikape-sub-item <?php echo e(isActive('mahasiswa.faq', $route) ? 'active' : ''); ?>">
                    Pertanyaan Umum
                </a>
                <a href="<?php echo e(route('eoffice.kp.mahasiswa.proposal')); ?>"
                   class="sikape-sub-item <?php echo e(isActive('mahasiswa.proposal', $route) ? 'active' : ''); ?>">
                    Proposal KP
                </a>
                <a href="<?php echo e(route('eoffice.kp.mahasiswa.surat')); ?>"
                   class="sikape-sub-item <?php echo e(isActive('mahasiswa.surat', $route) ? 'active' : ''); ?>">
                    Surat Pengantar
                </a>
            </div>
        </div>
        ...
        <a href="<?php echo e(route('eoffice.kp.mahasiswa.pendaftaran')); ?>"
           class="sikape-nav-item <?php echo e(isActive('mahasiswa.pendaftaran', $route) ? 'active' : ''); ?>">
            <span class="sikape-nav-icon">
        ...
        <a href="<?php echo e(route('eoffice.kp.mahasiswa.dokumen')); ?>"
           class="sikape-nav-item <?php echo e(isActive('mahasiswa.dokumen', $route) ? 'active' : ''); ?>">
            <span class="sikape-nav-icon">
        ...
        <a href="<?php echo e(route('eoffice.kp.mahasiswa.seminar')); ?>"
           class="sikape-nav-item <?php echo e(isActive('mahasiswa.seminar', $route) ? 'active' : ''); ?>">
            <span class="sikape-nav-icon">
    ...
    <div class="px-3 py-3 flex-shrink-0 sikape-user-container">
        <div class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-grey-50 transition-colors cursor-pointer group sikape-user-wrapper">
            <div class="w-8 h-8 rounded-full bg-primary-100 flex items-center justify-center text-primary-500 font-semibold text-sm flex-shrink-0">
                <?php echo e(strtoupper(substr($user->name ?? 'M', 0, 2))); ?>

            </div>
            <div x-show="!sidebarCollapsed" class="flex-1 min-w-0">
                <p class="text-[13px] font-semibold text-grey-800 truncate leading-tight"><?php echo e($user->name ?? 'Mahasiswa'); ?></p>
                <p class="text-[11px] text-grey-400 truncate">Mahasiswa</p>
            </div>
            <form x-show="!sidebarCollapsed" method="POST" action="<?php echo e(route('logout')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\kp\mahasiswa\partials\sidebar.blade.php ENDPATH**/ ?>
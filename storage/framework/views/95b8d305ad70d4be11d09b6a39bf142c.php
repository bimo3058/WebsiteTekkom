...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <a href="<?php echo e(route('banksoal.admin.kontrol-umum.pemetaan')); ?>" class="text-slate-500 hover:text-primary transition-colors">Kontrol Umum</a>
    <span class="mx-2 text-slate-300">/</span>
    <a href="<?php echo e(route('banksoal.admin.kontrol-umum.pemetaan')); ?>" class="text-slate-500 hover:text-primary transition-colors">Pemetaan</a>
    <span class="mx-2 text-slate-300">/</span>
    ...
    <style>
        .pm-page{--pm:rgb(11,38,110);--pm-hover:rgb(8,28,82);--pm-light:rgba(11,38,110,.08);--s50:#f8fafc;--s100:#f1f5f9;--s200:#e2e8f0;--s300:#cbd5e1;--s400:#94a3b8;--s500:#64748b;--s600:#475569;--s700:#334155;--s800:#1e293b}
        ...
        .pm-page .tab-btn{padding:9px 22px;border-radius:8px;border:none;font-size:14px;font-weight:600;cursor:pointer;color:var(--s600);background:transparent;transition:all .2s}
        ...
        .pm-page .srch input{width:100%;padding:8px 10px 8px 30px;border:1px solid var(--s300);border-radius:8px;font-size:13px;color:var(--s800);background:#fff;transition:border-color .2s}
    ...
    <div class="page-header">
        ...
        <a href="<?php echo e(route('banksoal.admin.kontrol-umum.pemetaan')); ?>" class="btn btn-secondary">
    ...
    <div class="tab-content active" id="tab0">
        <div class="mapping-grid">
            ...
            <div class="panel">
                <div class="panel-header"><h2>Pilih CPL</h2><p>Centang satu atau lebih CPL</p></div>
                <div class="panel-search"><div class="srch"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg><input type="text" placeholder="Cari CPL..." oninput="T[0].rq=this.value;T[0].rp=1;renderRight(0)"></div></div>
        ...
        <div class="form-actions">
            <a href="<?php echo e(route('banksoal.admin.kontrol-umum.pemetaan')); ?>" class="btn btn-secondary">Batal</a>
    ...
    <div class="tab-content" id="tab1">
        <div class="mapping-grid">
            <div class="panel">
                <div class="panel-header"><h2>CPL Terpilih</h2><p>Pilih satu CPL</p></div>
                <div class="panel-search"><div class="srch"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg><input type="text" placeholder="Cari CPL..." oninput="T[1].lq=this.value;T[1].lp=1;renderLeft(1)"></div></div>
    ...
    <script>
    const CSRF='<?php echo e(csrf_token()); ?>',BASE='<?php echo e(url("/bank-soal/admin/api")); ?>',BACK='<?php echo e(route("banksoal.admin.kontrol-umum.pemetaan")); ?>';
    const LS=8,RS=10;
    // T[i] = state per tab
    const T=[
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\admin\kontrol-umum\pemetaan-mk-cpl-create.blade.php ENDPATH**/ ?>
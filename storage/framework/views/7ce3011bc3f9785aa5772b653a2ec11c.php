...
<head>
    ...
    <title><?php echo e($pageTitle ?? 'Manajemen Ruangan'); ?> — SIPERKOM</title>
                        ...
                        <div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $section['groups']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupLabel => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <?php $active = str_contains($currentRoute, $item['match']); ?>
                                    <a href="<?php echo e($item['href']); ?>"
                                        class="group relative flex items-center gap-[10px] px-[12px] py-[9px] rounded-lg mb-[1px] no-underline transition-colors duration-[120ms] overflow-hidden whitespace-nowrap <?php echo e($active ? 'bg-[#F1F5F9] text-[#0B266E] font-bold' : 'text-[#353849] font-medium hover:bg-[#F6F8FA]'); ?>"
                                        ...
                                        <svg class="w-[18px] h-[18px] flex-shrink-0 transition-colors <?php echo e($active ? 'text-[#0B266E]' : 'text-[#808897]'); ?>"
            ...
            <div class="px-3 py-[10px] border-t border-[#DFE1E7] flex-shrink-0">
                <div
                    ...
                    <div class="flex items-center justify-center w-[30px] h-[30px] rounded-full flex-shrink-0 text-white text-[11px] font-bold"
                        style="background:linear-gradient(135deg,#1F2937,#111827);"><?php echo e($initials); ?></div>
                    <div class="flex-1 min-w-0 overflow-hidden transition-[opacity,width] duration-200"
                        :class="sidebarOpen ? 'opacity-100' : 'opacity-0 w-0'">
                        <div
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="flex items-center justify-between px-6 bg-white border-b border-[#DFE1E7] flex-shrink-0"
                ...
                <div class="flex items-center gap-3 min-w-0">
                    <div>
                        <div class="font-bold text-[15px] text-[#0D0D12] leading-[1.2]"><?php echo e($pageTitle ?? 'Dashboard'); ?>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\components\manajemen-ruangan\layout.blade.php ENDPATH**/ ?>
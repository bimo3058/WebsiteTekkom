    ...
    <div class="vr-card">
        ...
        <div class="summary-grid">
            <div class="summary-item summary-title">
                <label>Judul</label>
                <span><?php echo e($pengumuman->judul); ?></span>
            </div>
            <div class="summary-item">
                <label>Kategori</label>
                <span><?php echo e(ucfirst(str_replace('_', ' ', $pengumuman->kategori ?? '-'))); ?></span>
            </div>
            <div class="summary-item">
                <label>Target Audiens</label>
                <span><?php echo e($pengumuman->target_audience === 'all' ? 'Semua' : ucfirst($pengumuman->target_audience)); ?></span>
            </div>
        </div>
    </div>

    <!-- Verification Form -->
    <form action="<?php echo e(route('manajemenmahasiswa.pengumuman.verification.submit', $pengumuman->id)); ?>" method="POST" id="verificationForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="vr-card">
            ...
            <div class="form-group">
                ...
                <select name="verifier_id" class="form-select-custom" required id="verifierSelect">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $verifiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $verifier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $roleLabel = $verifier->roles->pluck('name')->map(function($r) {
                                return ucwords(str_replace('_', ' ', $r));
                            })->implode(', ');
                        ?>
                        <option value="<?php echo e($verifier->id); ?>" <?php echo e(old('verifier_id') == $verifier->id ? 'selected' : ''); ?>>
                            <?php echo e($verifier->name); ?> — <?php echo e($roleLabel); ?>

                        </option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </select>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['verifier_id'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <textarea name="pesan_pengaju" class="form-textarea" placeholder="Contoh: Mohon diverifikasi untuk pengumuman kegiatan besok pagi..."><?php echo e(old('pesan_pengaju')); ?></textarea>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['pesan_pengaju'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="form-error"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="form-actions">
                <a href="<?php echo e(route('manajemenmahasiswa.pengumuman.index')); ?>" class="btn-cancel-draft">
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\pengumuman\pengumuman-verification-request.blade.php ENDPATH**/ ?>
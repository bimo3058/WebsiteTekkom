...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.dosen','data' => ['title' => 'Ruang Bimbingan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Ruang Bimbingan']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <?php $__env->startSection('breadcrumbs'); ?>
            <div class="flex items-center gap-2 text-sm text-slate-500">
                <a href="<?php echo e(route('eoffice.kp.dosen.bimbingan.index')); ?>"
            ...
            <div
                ...
                <div class="flex items-center gap-5">
                    <div
                        ...
                        <?php echo e(substr($kp->nama_mahasiswa ?? 'M', 0, 1)); ?>

                    </div>
                    <div>
                        <h1 class="text-2xl font-bold mb-1"><?php echo e($kp->nama_mahasiswa ?? 'Nama Mahasiswa'); ?></h1>
                        <p class="text-indigo-200 text-sm font-medium"><?php echo e($kp->nim ?? '-'); ?></p>
                    </div>
                </div>
                <div class="flex flex-col gap-3 md:items-end">
                    <div class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-sm font-bold shadow-sm uppercase tracking-wider
                        <?php if($kp->status_kp === 'completed'): ?> bg-emerald-500/20 text-emerald-300 border-emerald-500/30
                        <?php elseif($kp->status_kp === 'active'): ?> bg-blue-500/20 text-blue-300 border-blue-500/30
                        <?php else: ?> bg-slate-500/20 text-slate-300 border-slate-500/30 <?php endif; ?>">
                        <span
                            class="w-2 h-2 rounded-full <?php if($kp->status_kp === 'completed'): ?> bg-emerald-400 <?php elseif($kp->status_kp === 'active'): ?> bg-blue-400 <?php else: ?> bg-slate-400 <?php endif; ?>"></span>
                        <?php echo e(strtoupper($kp->status_kp)); ?>

                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kp->status_kp === 'pending'): ?>
                        <form action="<?php echo e(route('eoffice.kp.dosen.bimbingan.approve_pra_kp', $kp->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seminar): ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-8">
                <div class="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                    ...
                    <span
                        class="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider <?php echo e($seminar->status_validasi_dosen === 'approved' ? 'bg-emerald-100 text-emerald-800' : ($seminar->status_validasi_dosen === 'rejected' ? 'bg-red-100 text-red-800' : 'bg-amber-100 text-amber-800')); ?>">
                        <?php echo e($seminar->status_validasi_dosen === 'pending' ? 'Menunggu Persetujuan' : ($seminar->status_validasi_dosen === 'approved' ? 'Disetujui' : 'Ditolak')); ?>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-black text-slate-800">
                                <?php echo e(\Carbon\Carbon::parse($seminar->tanggal_seminar)->translatedFormat('l, d M Y')); ?>

                                <span
                                    class="text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-lg text-lg ml-2"><?php echo e($seminar->waktu_seminar); ?></span>
                            </p>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seminar->status_validasi_dosen === 'pending'): ?>
                            <div class="flex gap-2">
                                <form action="<?php echo e(route('eoffice.kp.dosen.penilaian_seminar.reject', $kp->id)); ?>" method="POST"
                                ...
                                <form action="<?php echo e(route('eoffice.kp.dosen.penilaian_seminar.approve', $kp->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $kp->dokumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dokumen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <tr class="hover:bg-slate-50 transition-colors">
                                                <td class="px-6 py-4">
                                                    <p class="text-sm font-bold text-slate-800"><?php echo e($dokumen->jenis_dokumen); ?></p>
                                                    <p class="text-xs text-slate-500 mt-0.5">Upload:
                                                        <?php echo e(\Carbon\Carbon::parse($dokumen->tanggal_upload)->format('d M Y')); ?>
                                                ...
                                                <td class="px-6 py-4">
                                                    <span
                                                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold border
                                                                                                                                                                                                                                                                <?php echo e($dokumen->approval_status === 'approved' ? 'bg-emerald-50 text-emerald-700 border-emerald-200' :
                            ($dokumen->approval_status === 'rejected' ? 'bg-red-50 text-red-700 border-red-200' : 'bg-amber-50 text-amber-700 border-amber-200')); ?>">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dokumen->approval_status === 'approved'): ?>
                                                            ...
                                                            Disetujui
                                                        <?php elseif($dokumen->approval_status === 'rejected'): ?>
                                                            <svg class="w-3.5 h-3.5" viewBox="0 0 20 20" fill="currentColor">
                                                                <path fill-rule="evenodd"
                                                ...
                                                <td class="px-6 py-4">
                                                    <a href="<?php echo e($dokumen->file_url); ?>" target="_blank"
                                                ...
                                                <td class="px-6 py-4 text-right">
                                                    <div class="flex items-center justify-end gap-2">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dokumen->approval_status === 'pending' && $dokumen->status_validasi === 'menunggu'): ?>
                                                            <div x-data="{ openRejectModal: false, note: '' }">
                                                                <form
                                                                    action="<?php echo e(route('eoffice.kp.dosen.bimbingan.dokumen.reject', [$kp->id, $dokumen->id])); ?>"
                                                                                                ...
                                                                                                <div class="mt-2">
                                                                                                    <p class="text-sm text-slate-500">
                                                                                                        ...
                                                                                                        untuk merevisi dokumen <span
                                                                                                            class="font-bold text-slate-700"><?php echo e($dokumen->jenis_dokumen); ?></span>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dokumen->approval_status === 'pending' && $dokumen->status_validasi === 'menunggu'): ?>
                                                            <form
                                                                action="<?php echo e(route('eoffice.kp.dosen.bimbingan.dokumen.approve', [$kp->id, $dokumen->id])); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rubrikLocked): ?>
            ...
            <form action="<?php echo e(route('eoffice.kp.dosen.bimbingan.penilaian.store', $kp->id)); ?>" method="POST"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rubrikItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr
                                    class="hover:bg-indigo-50/30 transition-colors <?php echo e($item->nilai_angka !== null ? 'bg-indigo-50/10' : ''); ?>">
                                    <td class="px-6 py-4 text-center font-bold text-slate-500"><?php echo e($index + 1); ?></td>
                                    <td class="px-6 py-4">
                                        <p class="font-bold text-slate-800"><?php echo e($item->deskripsi); ?></p>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <span
                                            ...
                                            <?php echo e($item->bobot); ?>%
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end">
                                            <input type="number" step="0.01" min="0" max="100" name="nilai_<?php echo e($item->id); ?>"
                                                value="<?php echo e(old('nilai_' . $item->id, $item->nilai_angka)); ?>" required
                                                placeholder="0" <?php echo e($rubrikLocked ? 'disabled' : ''); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['nilai_' . $item->id];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            <p class="mt-1 text-xs text-red-600 font-medium w-full text-right"><?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$rubrikLocked && !empty($rubrikItems)): ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\dosen\bimbingan_detail.blade.php ENDPATH**/ ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mp-page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
        <div>
            <h1>Kategori: <span class="mp-highlight"><?php echo e($category); ?></span></h1>
            <p>Menampilkan semua pengguna dalam grup ini</p>
        </div>
        <a href="<?php echo e(route('manajemenmahasiswa.pengguna.index')); ?>" class="mp-btn-back">
    ...
    <form action="<?php echo e(url()->current()); ?>" method="GET" class="mp-filter-bar">

        
        <div x-data="{
                open: false,
                selected: '<?php echo e($perPage); ?>',
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category === 'Pengurus Himpunan'): ?>
        <div x-data="{
                open: false,
                selected: '<?php echo e($roleFilter); ?>',
                roles: [
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($users->hasPages()): ?>
        <div class="mt-4 d-flex flex-column align-items-center gap-2">
            <div class="d-flex align-items-center gap-1">
                ...
                <?php else: ?>
                    <a href="<?php echo e($users->withQueryString()->previousPageUrl()); ?>" class="page-btn page-btn-nav">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
                    </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $users->withQueryString()->links()->offsetGet('elements'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($users->hasMorePages()): ?>
                    <a href="<?php echo e($users->withQueryString()->nextPageUrl()); ?>" class="page-btn page-btn-nav">
            ...
            <div style="font-size: 12px; color: #9ca3af; font-weight: 500;">
                Showing <?php echo e($users->firstItem()); ?>–<?php echo e($users->lastItem()); ?> of <?php echo e($users->total()); ?> results
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\permissions\category.blade.php ENDPATH**/ ?>
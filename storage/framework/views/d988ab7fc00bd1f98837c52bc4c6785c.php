...
<div class="flex h-screen w-full overflow-hidden">
    ...
    <div class="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8" x-data="suratManager({
            defaultPerusahaan: '<?php echo e($kp ? ($kp->instansi_kp ?? "") : ""); ?>'
        })">
                    ...
                    <div class="sikape-card overflow-hidden">
                        ...
                        <div class="border-b border-grey-200 bg-grey-50 px-4 flex flex-wrap gap-2">
                            ...
                            <button type="button" @click="activeSuratTab = 'template_lain'" 
                                ...
                                Template Lainnya 
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($templatesKeperluan->count() > 0): ?>
                                    <span class="bg-indigo-100 text-indigo-600 text-[10px] px-1.5 py-0.5 rounded-full font-bold">
                                        <?php echo e($templatesKeperluan->count()); ?>
                        ...
                        <div class="p-6 bg-white">
                            ...
                            <div x-show="activeSuratTab === 'pengantar'">
                                <div class="mb-6 pb-6 border-b border-grey-100 flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                                    ...
                                    <a href="<?php echo e(route('eoffice.kp.mahasiswa.dokumen.template', 'surat_pengantar')); ?>" class="sikape-btn-outline text-xs flex-shrink-0 flex items-center gap-1">
                                ...
                                <!-- Formulir Pembuatan -->
                                <form action="<?php echo e(route('eoffice.kp.mahasiswa.surat_pengantar.export')); ?>" method="POST" target="_blank">
                                    <?php echo csrf_field(); ?>
                            ...
                            <div x-show="activeSuratTab === 'template_lain'" style="display: none;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($templatesKeperluan->count() > 0): ?>
                                    <div class="grid grid-cols-1 gap-4">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $templatesKeperluan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <div class="p-4 border border-grey-200 rounded-xl bg-white hover:shadow-sm transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                                <div>
                                                    <h4 class="text-sm font-bold text-grey-900 mb-1"><?php echo e($loop->iteration); ?>. <?php echo e($template->judul); ?></h4>
                                                    <p class="text-xs text-grey-500 leading-relaxed"><?php echo e($template->konten); ?></p>
                                                </div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($template->lampiran): ?>
                                                    <a href="<?php echo e(url('storage/' . $template->lampiran)); ?>" target="_blank" download class="sikape-btn-primary bg-indigo-600 hover:bg-indigo-700 text-xs py-2 px-4 flex-shrink-0">
...
function suratManager(params = {}) {
    return {
        ...
        suratForm: {
            ...
            anggota: [
                {
                    nama: '<?php echo e($mahasiswa->nama_lengkap ?? $user->name); ?>',
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\kp\mahasiswa\surat.blade.php ENDPATH**/ ?>
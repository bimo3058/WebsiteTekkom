...
<div style="display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap;">
    <div>
        <div style="display:flex; align-items:center; gap:8px; margin-bottom:3px;">
            ...
            <span style="font-size:10px; font-weight:600; color:var(--c-primary); background:var(--c-primary-subtle); border:1px solid var(--c-primary-border); padding:2px 8px; border-radius:9999px; letter-spacing:0.03em;"><?php echo e(auth()->user()->hasRole('superadmin') ? 'Superadmin' : 'Admin E-Office'); ?></span>
        </div>
...
<div class="mp-content-grid">
    ...
    <div style="background:#fff; border:1px solid var(--c-border); border-radius:14px; overflow:hidden; box-shadow:0 1px 3px rgba(0,0,0,.04);">
        ...
        <div class="mp-registration-record" style="display:grid; grid-template-columns:1.5fr 1fr auto; gap:16px; padding:14px 20px; border-bottom:1px solid var(--c-border); align-items:center;">
            <div data-label="Praktikum" style="font-size:13px; font-weight:600; color:var(--c-fg);"><?php echo e($pend['nama']); ?></div>
            <div data-label="Masa pendaftaran" style="font-size:13px; color:var(--c-fg-muted);"><?php echo e($pend['masa']); ?></div>
    ...
    <div class="mp-dashboard-panel-heading" style="display:flex; align-items:center; justify-content:space-between; padding:16px 20px; border-bottom:1px solid var(--c-border);">
        ...
        <form id="dosen_filter_form" method="GET" action="<?php echo e(url()->current()); ?>#daftar-dosen" style="display:flex; gap:10px; margin:0;">
            <div class="relative flex items-center">
                ...
                <input type="text" name="search_dosen" value="<?php echo e(request('search_dosen')); ?>" placeholder="Cari dosen" onchange="this.form.submit()" style="padding:6px 12px 6px 32px; border:1px solid var(--c-border); border-radius:8px; font-size:13px; outline:none; min-width:200px;">
            </div>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum\admin\dashboard.blade.php ENDPATH**/ ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-praktikum.layout','data' => ['pageTitle' => 'Edit Praktikum — '.e($praktikum->nama).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => 'Edit Praktikum — '.e($praktikum->nama).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mp-page-header" style="flex-shrink:0;">
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
            <a href="<?php echo e(route('eoffice.manprak.admin.praktikum.detail', $praktikum->id)); ?>"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
        <div class="mp-alert success flex-shrink-0"><?php echo e(session('success')); ?></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any()): ?>
        <div class="mp-alert warning flex-shrink-0">
            <strong>Ada kesalahan:</strong>
            <ul style="margin:4px 0 0 16px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?><li style="font-size:12px;"><?php echo e($e); ?></li><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </ul>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div
        ...
        <div
            ...
            <div>
                <div style="font-size:14px;font-weight:700;color:#0D0D12;"><?php echo e($praktikum->nama); ?></div>
                <div style="font-size:11px;color:#A4ABB8;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($praktikum->kode): ?><span
                    style="font-family:monospace;color:#0B266E;"><?php echo e($praktikum->kode); ?></span> · <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php echo e($praktikum->semester); ?> <?php echo e($praktikum->tahun_ajaran); ?>
        ...
        <form method="POST" action="<?php echo e(route('eoffice.manprak.admin.praktikum.update', $praktikum->id)); ?>"
            id="editForm">
            <?php echo csrf_field(); ?>
            ...
            <div style="padding:24px 20px;display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                ...
                <div style="grid-column:1/-1;">
                    ...
                    <input type="text" name="nama" required value="<?php echo e(old('nama', $praktikum->nama)); ?>"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ($matkulList ?? collect())->groupBy('semester'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sem => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <optgroup label="Semester <?php echo e($sem); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($mk->id); ?>" <?php echo e(old('matkul_id', $praktikum->matkul_id) == $mk->id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <input type="text" name="tahun_ajaran" required
                        value="<?php echo e(old('tahun_ajaran', $praktikum->tahun_ajaran)); ?>" placeholder="2025/2026"
                ...
                <div>
                    ...
                    <select name="semester" required class="mp-input mp-select" style="width:100%;">
                        <option value="Ganjil" <?php echo e(old('semester', $praktikum->semester) === 'Ganjil' ? 'selected' : ''); ?>>
                            Ganjil</option>
                        <option value="Genap" <?php echo e(old('semester', $praktikum->semester) === 'Genap' ? 'selected' : ''); ?>>
                            Genap</option>
                    </select>
                </div>
                ...
                <?php
                    ...
                    if (empty($dosenIds))
                        $dosenIds = [''];
                ?>
                <div style="grid-column:1/-1;" x-data="{ dosens: <?php echo e(json_encode($dosenIds)); ?> }">
                    <label style="display:block;font-size:12px;font-weight:600;color:#353849;margin-bottom:5px;">
                ...
                <div>
                    ...
                    <select name="status" required class="mp-input mp-select" style="width:100%;">
                        <option value="aktif" <?php echo e(old('status', $praktikum->status) === 'aktif' ? 'selected' : ''); ?>>Aktif
                        </option>
                        <option value="nonaktif" <?php echo e(old('status', $praktikum->status) === 'nonaktif' ? 'selected' : ''); ?>>
                            Nonaktif</option>
                    </select>
                </div>
    ...
    <div
        ...
        <div style="padding:16px 20px;display:flex;align-items:center;justify-content:space-between;gap:16px;">
            ...
            <form method="POST" action="<?php echo e(route('eoffice.manprak.admin.praktikum.destroy', $praktikum->id)); ?>"
                onsubmit="return confirm('Hapus praktikum \'<?php echo e(addslashes($praktikum->nama)); ?>\'? (Data akan diarsipkan)')"
                style="flex-shrink:0;">
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\manajemen-praktikum\admin\praktikum-edit.blade.php ENDPATH**/ ?>
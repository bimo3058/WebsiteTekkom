    ...
    <div
        ...
        <div class="mp-page-header">
            ...
            <div class="mp-page-actions">
                <!-- Filter Dropdown -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewMode !== 'akademik'): ?>
                    <form action="<?php echo e(route('eoffice.peminjaman.admin.jadwal-internal.index')); ?>" method="GET"
                        class="flex gap-2">
                        <select name="tipe" onchange="this.form.submit()" class="mp-input !py-2 !text-xs !bg-white">
                            <option value="semua" <?php echo e($tipe === 'semua' ? 'selected' : ''); ?>>Semua Tipe Jadwal</option>
                            <option value="rutin" <?php echo e($tipe === 'rutin' ? 'selected' : ''); ?>>Rutin (Mingguan)</option>
                            <option value="spesifik" <?php echo e($tipe === 'spesifik' ? 'selected' : ''); ?>>Spesifik (Acara)</option>
                        </select>
                    </form>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewMode === 'akademik'): ?>
                    <form action="<?php echo e(route('eoffice.peminjaman.admin.jadwal-akademik.reset')); ?>" method="POST"
                        class="inline-block"
            ...
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showImportModal" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div>
                        ...
                        <form action="<?php echo e(route('eoffice.peminjaman.admin.jadwal-akademik.import-preview')); ?>"
        ...
        <div class="mp-card" style="margin-top: 15px;">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between px-5 py-4 border-b border-gray-100 gap-4 relative z-10 w-full"
                ...
                <h2 class="text-[16px] font-bold text-gray-800 tracking-tight">
                    <?php echo e($viewMode === 'akademik' ? 'Jadwal Akademik Table' : 'Event & Maintenance Table'); ?></h2>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewMode === 'akademik'): ?>
                    <div class="flex items-center gap-2" x-data="{ openFilter: false, openSort: false }">
                        <form action="<?php echo e(route('eoffice.peminjaman.admin.jadwal-akademik.index')); ?>" method="GET"
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="search" value="<?php echo e(request('search')); ?>" onblur="this.form.submit()"
                                    placeholder="Search"
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <select name="hari"
                                                ...
                                                <option value="1" <?php echo e(request('hari') == '1' ? 'selected' : ''); ?>>Senin
                                                </option>
                                                <option value="2" <?php echo e(request('hari') == '2' ? 'selected' : ''); ?>>Selasa
                                                </option>
                                                <option value="3" <?php echo e(request('hari') == '3' ? 'selected' : ''); ?>>Rabu</option>
                                                <option value="4" <?php echo e(request('hari') == '4' ? 'selected' : ''); ?>>Kamis
                                                </option>
                                                <option value="5" <?php echo e(request('hari') == '5' ? 'selected' : ''); ?>>Jumat
                                                </option>
                                                <option value="6" <?php echo e(request('hari') == '6' ? 'selected' : ''); ?>>Sabtu
                                                </option>
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select name="ruangan_id"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ruangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <option value="<?php echo e($r->id); ?>" <?php echo e(request('ruangan_id') == $r->id ? 'selected' : ''); ?>>
                                                        <?php echo e($r->nama); ?>
                                        ...
                                        <div class="flex gap-2 pt-3 border-t border-gray-100 mt-2">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search') || request('hari') || request('ruangan_id')): ?>
                                                <a href="<?php echo e(route('eoffice.peminjaman.admin.jadwal-akademik.index')); ?>"
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            <select name="sort" onchange="this.form.submit()"
                                                ...
                                                <option value="waktu" <?php echo e(request('sort', 'waktu') === 'waktu' ? 'selected' : ''); ?>>Hari & Waktu Terawal</option>
                                                <option value="matkul_asc" <?php echo e(request('sort') === 'matkul_asc' ? 'selected' : ''); ?>>Mata Kuliah (A-Z)</option>
                                                <option value="matkul_desc" <?php echo e(request('sort') === 'matkul_desc' ? 'selected' : ''); ?>>Mata Kuliah (Z-A)</option>
                                                <option value="ruangan" <?php echo e(request('sort') === 'ruangan' ? 'selected' : ''); ?>>Ruangan (A-Z)</option>
                                                <option value="terbaru" <?php echo e(request('sort') === 'terbaru' ? 'selected' : ''); ?>>Waktu Ditambahkan</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <tr class="mp-tr">
                                    ...
                                    <td>
                                        <div style="font-size: 12px; font-weight: 600; color: #4B5563;">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($j->tgl_mulai_efektif && $j->tgl_selesai_efektif): ?>
                                                <?php echo e(\Carbon\Carbon::parse($j->tgl_mulai_efektif)->format('d/m/Y')); ?><br>
                                                <span style="color: #9CA3AF;">s.d</span> <?php echo e(\Carbon\Carbon::parse($j->tgl_selesai_efektif)->format('d/m/Y')); ?>
                                                        ...
                                                        <div class="space-y-4">
                                                            <div>
                                                                ...
                                                                <select name="ruangan_id" required
                                                                    class="mp-input text-[14px]">
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ruangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                                        <option value="<?php echo e($r->id); ?>" <?php echo e($r->id == $j->ruangan_id ? 'selected' : ''); ?>><?php echo e($r->nama); ?> - Lt.
                                                                            <?php echo e($r->lantai); ?>
                                                            ...
                                                            <input type="hidden" name="keterangan"
                                                                value="<?php echo e($j->keterangan ?: 'Matkul Akademik'); ?>">
                                                                ...
                                                                <div class="grid grid-cols-2 gap-4">
                                                                    <div>
                                                                        ...
                                                                        <input type="text" name="mata_kuliah"
                                                                            value="<?php echo e($j->mata_kuliah); ?>" required
                                                                            class="mp-input text-[14px]"
                                                                            placeholder="Nama Lengkap Matkul">
                                                                    </div>
                                                                    <div>
                                                                        ...
                                                                        <input type="text" name="kelas"
                                                                            value="<?php echo e($j->kelas); ?>" required
                                                                            class="mp-input text-[14px]"
                                                                            placeholder="A/B/C/D">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="grid grid-cols-2 gap-4">
                                                                <div>
                                                                    ...
                                                                    <select name="hari" required
                                                                        class="mp-input text-[14px]">
                                                                        <option value="1" <?php echo e($j->hari == 1 ? 'selected' : ''); ?>>Senin</option>
                                                                        <option value="2" <?php echo e($j->hari == 2 ? 'selected' : ''); ?>>Selasa</option>
                                                                        <option value="3" <?php echo e($j->hari == 3 ? 'selected' : ''); ?>>Rabu</option>
                                                                        <option value="4" <?php echo e($j->hari == 4 ? 'selected' : ''); ?>>Kamis</option>
                                                                        <option value="5" <?php echo e($j->hari == 5 ? 'selected' : ''); ?>>Jumat</option>
                                                                        <option value="6" <?php echo e($j->hari == 6 ? 'selected' : ''); ?>>Sabtu</option>
                                                                        <option value="7" <?php echo e($j->hari == 7 ? 'selected' : ''); ?>>Minggu</option>
                                                                    </select>
                                                                </div>
                                                                <div class="grid grid-cols-2 gap-2">
                                                                    <div>
                                                            ...
                                                            <div class="grid grid-cols-2 gap-4"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="date" name="tgl_mulai_efektif"
                                                                        value="<?php echo e($j->tgl_mulai_efektif); ?>" required
                                                                        class="mp-input text-[14px]">
                                                                </div>
                                                                <div>
                                                                    <label
                                                                    ...
                                                                    <input type="date" name="tgl_selesai_efektif"
                                                                        value="<?php echo e($j->tgl_selesai_efektif); ?>" required
                                                                        class="mp-input text-[14px]">
                                                                </div>
                                                            </div>
                                                        </div>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-ruangan\admin\jadwal\index.blade.php ENDPATH**/ ?>
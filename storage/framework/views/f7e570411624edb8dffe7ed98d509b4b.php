...
<div id="modal-<?php echo e($module->slug); ?>"
    ...
    <div style="position:fixed; inset:0;" onclick="closeModal('modal-<?php echo e($module->slug); ?>')"></div>
    ...
    <div style="position:relative; width:100%; max-width:480px; background:#fff; border-radius:16px; border:1px solid var(--c-border); box-shadow:0 20px 40px rgba(13,13,18,0.15); overflow:hidden;">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; padding:18px 22px 0;">
            <div style="display:flex; align-items:center; gap:12px;">
                ...
                <div>
                    ...
                    <p style="font-size:10px; font-weight:600; text-transform:uppercase; letter-spacing:.06em; color:var(--c-fg-muted); margin-top:2px;"><?php echo e($module->name); ?></p>
                </div>
            </div>
            <button onclick="closeModal('modal-<?php echo e($module->slug); ?>')"
        ...
        <form action="<?php echo e(route('superadmin.modules.update-config', $module->slug)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div style="padding:20px 22px; display:flex; flex-direction:column; gap:18px;">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e($module->name); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($module->slug); ?>" disabled
                ...
                <div>
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
                        <div>
                            ...
                            <input type="number" name="settings[max_upload]" value="<?php echo e($module->setting('max_upload', 10)); ?>" min="1" max="100"
                        ...
                        <div>
                            ...
                            <input type="number" name="settings[quota]" value="<?php echo e($module->setting('quota', 5)); ?>" min="1" max="500"
                                   style="width:100%; padding:8px 12px; background:#fff; border:1px solid #D0D5DD; border-radius:8px; font-size:12px; color:var(--c-fg); font-family:inherit; outline:none; transition:border-color .15s, box-shadow .15s;"
                                   onfocus="this.style.borderColor='var(--c-primary)'; this.style.boxShadow='0 0 0 3px var(--c-primary-subtle)'"
                                   onblur="this.style.borderColor='#D0D5DD'; this.style.boxShadow='none'">
                        </div>
                ...
                <div>
                    ...
                    <label style="display:flex; align-items:center; gap:10px; padding:10px 12px; background:var(--c-bg); border:1px solid var(--c-border); border-radius:10px; cursor:pointer; margin-bottom:8px; transition:border-color .15s;"
                        ...
                        <input type="checkbox" name="settings[debug_mode]" value="1"
                               <?php echo e($module->setting('debug_mode', false) ? 'checked' : ''); ?>
                    ...
                    <div style="display:flex; align-items:center; gap:10px; padding:10px 12px; background:var(--c-bg); border:1px solid var(--c-border); border-radius:10px;">
                        <svg width="16" height="16" fill="none" stroke="<?php echo e($module->is_active ? 'var(--c-success)' : 'var(--c-warning)'); ?>" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <span style="font-size:9px; font-weight:700; text-transform:uppercase; letter-spacing:.05em; padding:3px 8px; border-radius:9999px; background:<?php echo e($module->is_active ? 'var(--c-success-subtle)' : 'var(--c-warning-subtle)'); ?>; color:<?php echo e($module->is_active ? '#287F6E' : 'var(--c-warning)'); ?>;">
            ...
            <div style="display:flex; align-items:center; justify-content:space-between; padding:14px 22px; border-top:1px solid var(--c-border); background:var(--c-bg);">
                ...
                <button type="button"
                        onclick="if(confirm('Bersihkan cache modul <?php echo e($module->name); ?>?')) document.getElementById('purge-<?php echo e($module->slug); ?>').submit();"
                        title="Purge Cache"
        ...
        <form id="purge-<?php echo e($module->slug); ?>" action="<?php echo e(route('superadmin.modules.purge-cache', $module->slug)); ?>" method="POST" style="display:none;"><?php echo csrf_field(); ?></form>
    </div>
</div><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\modules\_modal_manage.blade.php ENDPATH**/ ?>
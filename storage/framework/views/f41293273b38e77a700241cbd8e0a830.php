...
<div id="daftar-praktikum" class="mp-card mt-2">
    ...
    <div class="p-4 border-b border-[#DFE1E7] bg-white flex flex-col xl:flex-row gap-4 justify-between items-start xl:items-center">
        <form id="filter_praktikum_form" method="GET" action="<?php echo e(url()->current()); ?>#daftar-praktikum" class="flex flex-wrap gap-3 w-full xl:w-auto items-center flex-1">
            <div class="relative flex-1 min-w-[200px]">
                ...
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama praktikum..." class="w-full pl-9 pr-3 py-2 text-[13px] border border-[#DFE1E7] rounded-[8px] focus:outline-none focus:border-[#0B266E]" onchange="this.form.submit()">
            </div>
            
            
            <div x-data="{ open: false, selected: '<?php echo e(request('status', '')); ?>' }" class="relative min-w-[170px]">
            ...
            <div x-data="{ open: false, selected: '<?php echo e(request('semester', '')); ?>' }" class="relative min-w-[160px]">
                <button type="button" @click="open = !open" 
                        class="w-full py-2 pl-3 pr-3 text-left text-[13px] border rounded-[8px] focus:outline-none font-medium flex items-center justify-between transition-colors"
                        :class="open ? 'border-[#0B266E] bg-[#F6F8FA]' : 'border-[#DFE1E7] bg-white'">
                    <span x-text="selected === 'Ganjil' ? 'Ganjil' : (selected === 'Genap' ? 'Genap' : 'Pilih Semester')"></span>
                    <svg class="w-4 h-4 text-[#666D80] transition-transform duration-200" :class="{'rotate-180': open}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
                </button>
                <div x-show="open" @click.away="open = false" style="display: none;" 
                     class="absolute z-10 w-full mt-1.5 bg-white border border-[#DFE1E7] rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.08)] py-1.5">
                    ...
                    <label class="flex items-center gap-2.5 px-3 py-1.5 hover:bg-[#F6F8FA] cursor-pointer text-[13px] text-[#353849]">
                        <input type="radio" name="semester" value="" x-model="selected" @change="$event.target.form.submit()" class="hidden">
                        <div class="w-4 h-4 rounded-full border flex items-center justify-center transition-colors" :class="selected === '' ? 'border-[#0B266E]' : 'border-[#DFE1E7]'">
                            <div class="w-2 h-2 rounded-full bg-[#0B266E]" x-show="selected === ''" style="display: none;"></div>
                        </div>
                        Semua Semester
                    ...
                    <label class="flex items-center gap-2.5 px-3 py-1.5 hover:bg-[#F6F8FA] cursor-pointer text-[13px] text-[#353849]">
                        <input type="radio" name="semester" value="Ganjil" x-model="selected" @change="$event.target.form.submit()" class="hidden">
                        <div class="w-4 h-4 rounded-full border flex items-center justify-center transition-colors" :class="selected === 'Ganjil' ? 'border-[#0B266E]' : 'border-[#DFE1E7]'">
                            <div class="w-2 h-2 rounded-full bg-[#0B266E]" x-show="selected === 'Ganjil'" style="display: none;"></div>
                        </div>
                        Ganjil
                    </label>
                    
                    <label class="flex items-center gap-2.5 px-3 py-1.5 hover:bg-[#F6F8FA] cursor-pointer text-[13px] text-[#353849]">
                        <input type="radio" name="semester" value="Genap" x-model="selected" @change="$event.target.form.submit()" class="hidden">
                        <div class="w-4 h-4 rounded-full border flex items-center justify-center transition-colors" :class="selected === 'Genap' ? 'border-[#0B266E]' : 'border-[#DFE1E7]'">
                            <div class="w-2 h-2 rounded-full bg-[#0B266E]" x-show="selected === 'Genap'" style="display: none;"></div>
                        </div>
                        Genap
                    </label>
                </div>
            ...
            <input type="text" name="tahun_ajaran" value="<?php echo e(request('tahun_ajaran')); ?>" placeholder="Tahun Ajaran (Contoh: 2025/2026)" class="w-56 py-2 px-3 text-[13px] border border-[#DFE1E7] rounded-[8px] focus:outline-none focus:border-[#0B266E]" onchange="this.form.submit()">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->anyFilled(['search', 'status', 'semester', 'tahun_ajaran'])): ?>
                <a href="<?php echo e(route('eoffice.manprak.admin.praktikum.index')); ?>" class="mp-btn secondary md px-4" style="height:35px;">Reset</a>
    ...
    <div class="mp-card-body p-0">
        ...
        <div class="flex flex-col">
            ...
            <div class="grid grid-cols-[2fr_1.5fr_1.5fr_90px_100px_90px] gap-4 px-5 py-4 border-b border-[#F6F8FA] hover:bg-[#FAFAFA] transition-colors items-center cursor-pointer" onclick="window.location='<?php echo e(route('eoffice.manprak.admin.praktikum.detail', $p->id)); ?>'">
                <div class="min-w-0">
                    <div class="text-[13px] font-semibold text-[#0B266E] truncate"><?php echo e($p->nama); ?></div>
                ...
                <div class="min-w-0 flex flex-col gap-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $p->dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="text-[13px] text-[#353849] truncate"><?php echo e($dosen->name); ?></div>
                ...
                <div class="min-w-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->koordinator): ?>
                        <div class="text-[13px] text-[#353849] truncate"><?php echo e($p->koordinator->name); ?></div>
                    <?php else: ?>
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <div x-data="{ open: false, selected: '<?php echo e(old('semester', 'Ganjil')); ?>', options: [{value:'Ganjil', label:'Ganjil'}, {value:'Genap', label:'Genap'}] }" class="relative w-full">
                            <input type="hidden" name="semester" x-model="selected" required>
                            <button type="button" @click="open = !open" 
                                    class="mp-input w-full flex items-center justify-between bg-white text-left text-[13px] h-[38px] px-3 border rounded-[8px] focus:outline-none transition-colors"
                                    :class="open ? 'border-[#0B266E] shadow-[0_0_0_3px_rgba(11,38,110,0.1)]' : 'border-[#DFE1E7]'">
                                <span x-text="selected ? options.find(o => o.value == selected)?.label : '— Pilih Semester —'" :class="selected ? 'text-[#0D0D12]' : 'text-[#666D80]'"></span>
                                <svg class="w-4 h-4 text-[#666D80] transition-transform duration-200" :class="{'rotate-180': open}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
                            </button>
                            <div x-show="open" @click.away="open = false" style="display: none;" 
                ...
                <div>
                    ...
                    <div x-data="{ open: false, selected: '<?php echo e(old('status', 'aktif')); ?>', options: [{value:'aktif', label:'Aktif'}, {value:'nonaktif', label:'Nonaktif'}] }" class="relative w-full">
        ...
        <form method="POST" :action="updateActionUrl" class="p-6">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <label class="block text-[12px] font-semibold text-[#353849] mb-1">Semester <span class="text-red-500">*</span></label>
                        <div x-data="{ dropdownOpen: false, options: [{value:'Ganjil', label:'Ganjil'}, {value:'Genap', label:'Genap'}] }" class="relative w-full">
                            <input type="hidden" name="semester" x-model="editData.semester" required>
                            <button type="button" @click="dropdownOpen = !dropdownOpen" 
                                    class="mp-input w-full flex items-center justify-between bg-white text-left text-[13px] h-[38px] px-3 border rounded-[8px] focus:outline-none transition-colors"
                                    :class="dropdownOpen ? 'border-[#0B266E] shadow-[0_0_0_3px_rgba(11,38,110,0.1)]' : 'border-[#DFE1E7]'">
                                <span x-text="editData.semester ? options.find(o => o.value == editData.semester)?.label : '— Pilih Semester —'" :class="editData.semester ? 'text-[#0D0D12]' : 'text-[#666D80]'"></span>
                                <svg class="w-4 h-4 text-[#666D80] transition-transform duration-200" :class="{'rotate-180': dropdownOpen}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
                            </button>
                            <div x-show="dropdownOpen" @click.away="dropdownOpen = false" style="display: none;" 
                                 class="absolute z-10 w-full mt-1.5 bg-white border border-[#DFE1E7] rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.08)] py-1.5 max-h-48 overflow-y-auto">
                                <template x-for="option in options" :key="option.value">
                                    <label class="flex items-center gap-2.5 px-3 py-1.5 hover:bg-[#F6F8FA] cursor-pointer text-[13px] text-[#353849]">
                                        ...
                                        <div class="w-4 h-4 rounded-full border flex items-center justify-center transition-colors flex-shrink-0" :class="editData.semester == option.value ? 'border-[#0B266E]' : 'border-[#DFE1E7]'">
                                            <div class="w-2 h-2 rounded-full bg-[#0B266E]" x-show="editData.semester == option.value" style="display: none;"></div>
                                        </div>
                                        <span x-text="option.label"></span>
                                    </label>
                                </template>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\manajemen-praktikum\admin\praktikum.blade.php ENDPATH**/ ?>
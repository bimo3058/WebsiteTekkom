...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="form-section">
        ...
        <form id="cplEditForm" onsubmit="handleFormSubmit(event)">
            ...
            <div class="form-group">
                ...
                <input type="text" id="kode" name="kode" value="<?php echo e($cpl->kode); ?>" required maxlength="50">
            </div>

            <div class="form-group">
                <label for="deskripsi">Deskripsi CPL <span style="color: var(--danger-red)">*</span></label>
                <textarea id="deskripsi" name="deskripsi" required><?php echo e($cpl->deskripsi); ?></textarea>
            </div>
    ...
    <script>
        const UPDATE_URL = '<?php echo e(route("banksoal.api.v1.admin.cpl.update", $cpl->id)); ?>';
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\admin\kontrol-umum\cpl-edit.blade.php ENDPATH**/ ?>
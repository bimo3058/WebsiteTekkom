    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <div class="flex-1 flex flex-col min-h-0 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
                ...
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pengumumanItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div x-show="('<?php echo e(addslashes($item->judul)); ?>'.toLowerCase().includes(search.toLowerCase()) || '<?php echo e(addslashes($item->konten)); ?>'.toLowerCase().includes(search.toLowerCase()) || search === '')"
                            ...
                            <button @click="openItem = openItem === <?php echo e($i); ?> ? null : <?php echo e($i); ?>"
                                ...
                                <div class="flex items-start sm:items-center gap-3 flex-1 min-w-0">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->tipe === 'timeline'): ?>
                                    ...
                                    <div class="flex-1 min-w-0 mt-1 sm:mt-0">
                                        ...
                                        <div class="flex items-center flex-wrap gap-2 mt-0.5">
                                            <p class="text-xs" style="color:var(--grey-400);">
                                                <?php echo e(\Carbon\Carbon::parse($item->updated_at)->translatedFormat('d F Y, H:i')); ?>

                                                WIB
                                            </p>
                                            <span class="text-[10px]" style="color:var(--grey-300);">•</span>
                                            <p class="text-xs" style="color:var(--grey-400);">
                                                <?php echo e($item->pembuat->name ?? 'Admin'); ?>

                                            </p>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->updated_at->ne($item->created_at)): ?>
                                ...
                                <div class="flex items-center self-end sm:self-auto gap-2">
                                    <span class="text-xs" style="color:var(--grey-400);"
                                        x-text="openItem === <?php echo e($i); ?> ? 'Tutup' : 'Lihat Detail'"></span>
                                    <svg class="w-5 h-5 flex-shrink-0 transition-transform duration-200"
                                        :class="openItem === <?php echo e($i); ?> ? 'rotate-180' : ''" style="color:var(--grey-400);"
                            ...
                            <div x-show="openItem === <?php echo e($i); ?>" x-collapse x-cloak>
                                <div class="px-5 pb-5 border-t" style="border-color:var(--grey-100);">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->lampiran): ?>
                                        <div class="mt-5 p-3 rounded-xl border flex items-center justify-between gap-4 max-w-md hover:shadow-sm transition-all"
                                            ...
                                            <a href="<?php echo e(route('eoffice.kp.mahasiswa.pengumuman.lampiran', $item->id)); ?>"
                                                target="_blank"
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\kp\mahasiswa\pengumuman.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title><?php echo e(config('app.name', 'SIBASO')); ?></title>
...
<body class="font-sans antialiased text-slate-900 bg-slate-50 selection:bg-primary selection:text-white">
    <div x-data="{ sidebarOpen: true }" class="flex h-screen bg-slate-50 font-sans text-slate-900 overflow-hidden">
        ...
        <!-- Sidebar Component -->
        <?php if (isset($component)) { $__componentOriginalcf6a90a91e0590713d2fca637bf86266 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf6a90a91e0590713d2fca637bf86266 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'banksoal::components.ui.sidebar-dosen','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('banksoal::ui.sidebar-dosen'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf6a90a91e0590713d2fca637bf86266)): ?>
<?php $attributes = $__attributesOriginalcf6a90a91e0590713d2fca637bf86266; ?>
<?php unset($__attributesOriginalcf6a90a91e0590713d2fca637bf86266); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcf6a90a91e0590713d2fca637bf86266)): ?>
<?php $component = $__componentOriginalcf6a90a91e0590713d2fca637bf86266; ?>
<?php unset($__componentOriginalcf6a90a91e0590713d2fca637bf86266); ?>
<?php endif; ?>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 cursor-pointer group">
                        <div class="w-9 h-9 rounded-full bg-slate-200 flex items-center justify-center text-slate-600 overflow-hidden border border-slate-300 group-hover:border-primary transition-colors">
                            <span class="font-bold text-sm"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'D', 0, 1))); ?></span>
                        </div>
                        <div class="flex flex-col">
                            <span class="text-sm font-bold text-slate-800 leading-tight"><?php echo e(auth()->user()->name ?? 'Dosen'); ?></span>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\components\layouts\dosen-admin.blade.php ENDPATH**/ ?>
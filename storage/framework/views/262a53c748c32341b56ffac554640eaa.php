...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <!-- Form -->
    <form action="<?php echo e(route('manajemenmahasiswa.pengumuman.update', $pengumuman->id)); ?>" method="POST"
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul" class="form-input" placeholder="Masukkan judul pengumuman"
                    value="<?php echo e(old('judul', $pengumuman->judul)); ?>" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-select-custom">
                        ...
                        <option value="akademik" <?php echo e(old('kategori', $pengumuman->kategori) === 'akademik' ? 'selected' : ''); ?>>Akademik</option>
                        <option value="himpunan" <?php echo e(old('kategori', $pengumuman->kategori) === 'himpunan' ? 'selected' : ''); ?>>Himpunan</option>
                        <option value="lowongan" <?php echo e(old('kategori', $pengumuman->kategori) === 'lowongan' ? 'selected' : ''); ?>>Lowongan</option>
                        <option value="event_prodi" <?php echo e(old('kategori', $pengumuman->kategori) === 'event_prodi' ? 'selected' : ''); ?>>Event Prodi</option>
                    </select>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <select name="target_audience" class="form-select-custom" required>
                        <option value="all" <?php echo e(old('target_audience', $pengumuman->target_audience) === 'all' ? 'selected' : ''); ?>>Semua</option>
                        <option value="mahasiswa" <?php echo e(old('target_audience', $pengumuman->target_audience) === 'mahasiswa' ? 'selected' : ''); ?>>Mahasiswa</option>
                        <option value="alumni" <?php echo e(old('target_audience', $pengumuman->target_audience) === 'alumni' ? 'selected' : ''); ?>>Alumni</option>
                    </select>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['target_audience'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="form-error"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="form-group">
                ...
                <textarea name="konten" id="kontenHidden"
                    style="display:none;"><?php echo e(old('konten', $pengumuman->konten)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="form-group">
                    ...
                    <div style="margin-bottom: 12px;">
                        <div class="file-item" style="max-width: 380px;">
                            <span class="file-name">
                                ...
                                <?php echo e($existingPoster->nama_file); ?>

                            </span>
                            <button type="button" class="file-remove"
                                onclick="deleteLampiran('<?php echo e(route('manajemenmahasiswa.pengumuman.lampiran.remove', [$pengumuman->id, $existingPoster->id])); ?>', this, 'Hapus poster ini?')">
                                Hapus
                            </button>
                        </div>
                        <div class="poster-preview" style="margin-top: 8px;">
                            <img src="<?php echo e($posterUrl); ?>" alt="Poster saat ini">
                        </div>
                ...
                <div class="file-upload-zone" id="posterZone">
                    ...
                    <h6><?php echo e($posterUrl ? 'Klik untuk mengganti poster' : 'Klik atau seret gambar ke sini'); ?></h6>
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingDokumen->isNotEmpty()): ?>
                <div class="form-group">
                    <label>Lampiran Saat Ini</label>
                    <div class="file-list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $existingDokumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="file-item">
                                <span class="file-name">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6b7280"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    <?php echo e($dok->judul_file ?? $dok->nama_file); ?>

                                </span>
                                <button type="button" class="file-remove"
                                    onclick="deleteLampiran('<?php echo e(route('manajemenmahasiswa.pengumuman.lampiran.remove', [$pengumuman->id, $dok->id])); ?>', this, 'Hapus lampiran ini?')">
                                    Hapus
                                </button>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <input type="hidden" name="status_publish" value="<?php echo e($pengumuman->status_publish); ?>">

            <!-- Actions -->
            <div class="form-actions">
                <a href="<?php echo e(route('manajemenmahasiswa.pengumuman.show', $pengumuman->id)); ?>"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            document.getElementById('inlineImageInput').addEventListener('change', async function (e) {
                ...
                try {
                    const res = await fetch('<?php echo e(route("manajemenmahasiswa.pengumuman.inline.image")); ?>', {
                        method: 'POST',
                        body: formData,
                    });
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\pengumuman\pengumuman-edit.blade.php ENDPATH**/ ?>
...
<div id="modalAddUser" class="fixed inset-0 hidden z-[50] flex items-center justify-center p-4 bg-slate-900/40">
    ...
    <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <form method="POST" action="<?php echo e(route('superadmin.users.store')); ?>" id="addUserForm">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <label class="relative cursor-pointer">
                                ...
                                <div class="px-3 py-1.5 rounded-xl border text-[10px] font-bold uppercase transition-all <?php echo e($roleColors); ?>">
...
</div><?php /**PATH C:\WebsiteTekkom - Copy\resources\views/superadmin/users/_modal_add.blade.php ENDPATH**/ ?>
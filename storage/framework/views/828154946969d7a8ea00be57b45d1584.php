...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => ['title' => 'Data Mahasiswa']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Data Mahasiswa']); ?>
    ...
    <div x-data="pageData()"
        ...
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-5 mb-8">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('eoffice.kp.koordinator.data_mahasiswa.export')); ?>"
                    ...
                    <div x-show="openPeriode"
                        ...
                        <div style="padding:4px; max-height: 250px; overflow-y: auto;">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $periodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <label style="display:flex; align-items:center; padding:8px 12px; gap:8px; cursor:pointer;"
                                    class="hover:bg-gray-50 rounded-md text-left">
                                    <input type="radio" x-model="filterPeriode" value="<?php echo e($p->id); ?>" name="filter_periode"
                                        class="text-indigo-600 focus:ring-indigo-500">
                                    <span style="font-family:'Inter Tight',sans-serif; font-size:13px; color:#4B5563;">
                                        Semester <?php echo e($p->semester); ?> <?php echo e($p->tahun_ajaran); ?>
                                ...
                                <td class="py-3 px-4 align-middle text-center relative" x-data="{ menuOpen: false }"
                                    ...
                                    <div class="flex items-center justify-center pointer-events-auto" @click.stop>
                                        ...
                                        <div x-show="menuOpen" style="display:none;"
                                            ...
                                            <a :href="`<?php echo e(route('eoffice.kp.koordinator.data_mahasiswa.show', 'DUMMY_ID')); ?>`.replace('DUMMY_ID', m.id)"
                                            ...
                                            <form
                                                :action="`<?php echo e(route('eoffice.kp.koordinator.pendaftar.destroy', 'DUMMY_ID')); ?>`.replace('DUMMY_ID', m.id)"
        ...
        <script>
            document.addEventListener('alpine:init', () => {
                Alpine.data('pageData', () => ({
                    ...
                    dosens: <?php echo json_encode($dosens, 15, 512) ?>,
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\data_mahasiswa.blade.php ENDPATH**/ ?>
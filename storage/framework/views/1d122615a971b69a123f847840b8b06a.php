...
<div class="bg-white border rounded-xl px-4 py-3 mb-4 relative z-40" 
     ...
     x-data="{ 
         filterRole: '<?php echo e($selectedRole); ?>',
         filterLimit: '<?php echo e($selectedLimit); ?>',
         rolesList: <?php echo \Illuminate\Support\Js::from($roleItems)->toHtml() ?>,
         getRoleLabel(val) {
             return this.rolesList.find(r => r.name === val)?.label || 'Semua Role';
         }
     }">
     
    <form method="GET" action="<?php echo e(route('superadmin.users.index')); ?>">
...
</div><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\users\_search_filter.blade.php ENDPATH**/ ?>
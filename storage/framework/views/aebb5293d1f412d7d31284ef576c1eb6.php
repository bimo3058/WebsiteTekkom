...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-ruangan.layout','data' => ['pageTitle' => 'Pratinjau Impor Jadwal Kuliah']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => 'Pratinjau Impor Jadwal Kuliah']); ?>
    ...
    <div x-data="sandboxEditor()">
        <div class="mp-page-header">
            ...
            <div class="mp-page-actions">
                ...
                ?>
                <form action="<?php echo e(route('eoffice.peminjaman.admin.jadwal-akademik.import-execute')); ?>" method="POST"
                    id="executeImportForm"
                    class="flex items-center gap-3 bg-white p-2 rounded-xl border border-gray-200 shadow-sm">
                    <?php echo csrf_field(); ?>
                    <textarea name="validated_payload" class="hidden"><?php echo e(json_encode($payloadArray)); ?></textarea>
                    ...
                    <button type="submit" id="simpan-btn" class="mp-btn primary md !py-2.5" <?php echo e(count($payloadArray) === 0 ? 'disabled' : ''); ?>>
                        ...
                        Simpan <span id="simpan-btn-counter" class="mx-1"><?php echo e(count($payloadArray)); ?></span> Kelas Rutin
                    </button>
                </form>
            </div>
        </div>
        ...
        <div
            ...
            <?php echo e(count($csvData)); ?> baris data valid berhasil dibaca dari SIAP. Tinjau dan simpan ke database.
        </div>
        ...
        <div class="mp-card" style="margin-top: 15px;">
            ...
            <div class="mp-card-body">
                <div class="mp-table-wrap"
                    ...
                    <table class="mp-table preview-table" style="position: relative; width: 100%; min-width: 900px;">
                        ...
                        <tbody style="background: white;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $csvData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                    $hari = (int) $row[0];
                                    $ruangId = (int) $row[1];
                                    $jamMulai = $row[2];
                                    ...
                                    $conflictMsg = $row[10] ?? '';
                                ?>
                                <tr class="mp-tr" id="preview-row-<?php echo e($loop->index); ?>"
                                    style="<?php echo e($conflictMsg ? 'background-color: #FEF2F2;' : ''); ?>">
                                    <td style="text-align:center;" id="icon-container-<?php echo e($loop->index); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($ruangId)): ?>
                                            <div
                                    ...
                                    <td>
                                        <div style="font-weight:600; color:#3730A3;">
                                            <?php echo e($namaHariArray[$hari] ?? '-'); ?>

                                        </div>
                                    </td>
                                    <td>
                                        <div style="font-weight:700; color:#0D0D12;">
                                            <?php echo e($jamMulai); ?> - <?php echo e($jamSelesai); ?>
                                    ...
                                    <td>
                                        ...
                                        <div id="msg-container-<?php echo e($loop->index); ?>"
                                            style="font-size:11px; font-weight:600; color:#DC2626; margin-top:2px; display: <?php echo e($conflictMsg ? 'block' : 'none'); ?>;">
                                            <span
                                                class="inline-block w-1.5 h-1.5 rounded-full bg-red-600 mr-1 align-middle"></span><span
                                                id="msg-text-<?php echo e($loop->index); ?>"><?php echo e($conflictMsg); ?></span>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ruanganObj): ?>
                                            <div style="font-weight:700; color:#0D0D12;">
                                                <?php echo e($ruanganObj->nama); ?>

                                                <span
                                                    style="font-size:12px; color:#666D80; margin-left:4px; font-weight:500;">(Lt.
                                                    <?php echo e($ruanganObj->lantai ?? '-'); ?>)</span>
                                            </div>
                                        <?php else: ?>
                                            <div style="font-weight:700; color:#B45309; margin-bottom: 4px; font-size: 11px;">
                                                Tidak Dikenal: <span
                                                    class="bg-orange-100 px-1 rounded"><?php echo e($row[11] ?? '?'); ?></span>
                                            </div>
                                            <select
                                                class="mp-input !py-1 !px-2 !text-xs !bg-orange-50 hover:bg-orange-100 border-orange-200 text-orange-900 cursor-pointer"
                                                onchange="updateRuangan(<?php echo e($loop->index); ?>, this.value)"
                                    ...
                                    <td style="text-align:center; min-width: 90px;">
                                        <div style="display: flex; justify-content: center; align-items: center; gap: 4px;">
                                            <button type="button" @click="openEditModal(<?php echo e($loop->index); ?>)"
                                            ...
                                            <button type="button" onclick="removeTableRow(<?php echo e($loop->index); ?>)"
                ...
                <script>
                    let rawPayload = <?php echo json_encode($payloadArray); ?>;
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($csvData) === 0): ?>
            ...
            Alpine.data('sandboxEditor', () => ({
                ...
                ruanganMap: {
                    <?php $__currentLoopData = $ruangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           "<?php echo e($r->id); ?>": '<?php echo e(addslashes($r->nama)); ?>',
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-ruangan\admin\jadwal\import-preview.blade.php ENDPATH**/ ?>
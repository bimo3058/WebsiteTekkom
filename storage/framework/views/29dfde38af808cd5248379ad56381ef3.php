            ...
            <tbody>
                <tr class="mp-tr">
                    ...
                    <td style="padding:14px 16px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusAbsen === 'hadir'): ?>
                            <span class="mp-badge success sm" style="background:#ECFDF5;color:#10B981;"><?php if (isset($component)) { $__componentOriginal22b2b62d2a6bf157ddbb8ecb4421b995 = $component; } ?>
...
<?php endif; ?> Hadir</span>
                        <?php elseif($statusAbsen === 'izin'): ?>
                            <span class="mp-badge sky sm" style="background:#EFF6FF;color:#3B82F6;">Izin</span>
                        <?php elseif($statusAbsen === 'tidak_hadir'): ?>
                            <span class="mp-badge danger sm" style="background:#FEF2F2;color:#EF4444;"><?php if (isset($component)) { $__componentOriginal22b2b62d2a6bf157ddbb8ecb4421b995 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal22b2b62d2a6bf157ddbb8ecb4421b995 = $attributes; } ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum\mahasiswa\nilai.blade.php ENDPATH**/ ?>
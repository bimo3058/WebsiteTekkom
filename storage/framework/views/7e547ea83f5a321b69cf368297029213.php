...
<?php
    ...
    if ($roleUser && $roleUser->relationLoaded('roles') && $roleUser->roles->isNotEmpty()) {
        ...
        $roleStyles = [
            ...
            'admin_capstone'       => 'background: #b45309; color: #fff;',
            'admin_eoffice'        => 'background: #b45309; color: #fff;',
            'dosen'                => 'background: #1d4ed8; color: #fff;',
            'gpm'                  => 'background: #6d28d9; color: #fff;',
            'ketua_departemen'     => 'background: #6d28d9; color: #fff;',
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($roleName): ?>
    <span class="role-badge d-inline-flex align-items-center" style="<?php echo e($roleStyle); ?> font-size: <?php echo e($badgeSize ?? '10px'); ?>; font-weight: 700; padding: 2px 8px; border-radius: 6px; white-space: nowrap; line-height: 1; text-transform: uppercase; letter-spacing: 0.02em;">
        <?php echo $icon; ?>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\forum\partials\role-badge.blade.php ENDPATH**/ ?>
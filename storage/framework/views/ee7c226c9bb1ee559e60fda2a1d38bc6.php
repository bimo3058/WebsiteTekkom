...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mp-page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
        ...
        <div class="d-flex align-items-center gap-2 flex-wrap">
            ...
            <form action="<?php echo e(route('manajemenmahasiswa.pengguna.index')); ?>" method="GET" class="d-flex align-items-center gap-2">
                <div class="mp-search-bar">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Cari nama, NIM, email...">
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search): ?>
                    <a href="<?php echo e(route('manajemenmahasiswa.pengguna.index')); ?>" style="font-size:12px;color:#6b7280;text-decoration:none;font-weight:600;">
                        Reset
                    </a>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasAnyRole(['admin_kemahasiswaan','admin','superadmin'])): ?>
    ...
    <div class="mp-stat-row">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $sectionUsers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <a href="<?php echo e($categoryRoutes[$title]); ?>" class="mp-stat-card">
                <div class="mp-stat-icon <?php echo e($categoryIcons[$title]); ?>">
                    <?php echo $categorySvg[$title]; ?>

                </div>
                <div class="mp-stat-info">
                    <div class="mp-stat-count"><?php echo e(count($sectionUsers)); ?></div>
                    <div class="mp-stat-label"><?php echo e($title); ?></div>
                </div>
            </a>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $sectionUsers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <section>
                ...
                <div class="mp-section-header">
                    ...
                    <a href="<?php echo e($categoryRoutes[$title]); ?>" class="mp-view-all">
                        Lihat Semua
                ...
                <div class="mp-card-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $sectionUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php echo $__env->make('manajemenmahasiswa::permissions._user_card', [
                            'user'            => $user,
        ...
        <div style="background:#fff;border-radius:16px;padding:28px;width:460px;max-width:90vw;box-shadow:0 20px 60px rgba(0,0,0,.15);">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:20px;">
                ...
                <div>
                    ...
                    <p style="font-size:12px;color:#6b7280;margin:0;">Mahasiswa angkatan ≤ <?php echo e(now()->year - 5); ?> akan dijadikan alumni</p>
                </div>
            </div>
    ...
    <?php echo $__env->make('manajemenmahasiswa::permissions._scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    function previewResetPengurus() {
        ...
        fetch('<?php echo e(route('manajemenmahasiswa.pengguna.reset-pengurus')); ?>', {
            method: 'POST',
            headers: {
    ...
    function previewAlumni() {
        ...
        fetch('<?php echo e(route('manajemenmahasiswa.pengguna.check-alumni')); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json',
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\permissions\index.blade.php ENDPATH**/ ?>
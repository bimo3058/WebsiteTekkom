                    ...
                    <template x-for="(dosen, index) in dosens" :key="index">
                        <div style="display:flex;gap:8px;margin-bottom:8px;">
                            ...
                            <button type="button" x-show="dosens.length > 1" @click="dosens.splice(index, 1)"
                                class="mp-btn destructive sm" style="padding:0 12px;flex-shrink:0;" aria-label="Hapus dosen dari pilihan" title="Hapus dosen dari pilihan"><?php if (isset($component)) { $__componentOriginal22b2b62d2a6bf157ddbb8ecb4421b995 = $component; } ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum\admin\praktikum-edit.blade.php ENDPATH**/ ?>
...
<div class="da-header">
    <div>
        ...
        <div class="da-header-meta">
            <span style="font-size:.82rem;color:#9ca3af;">Diperbarui: <?php echo e($genAt->format('d M Y, H:i')); ?> WIB</span>
        </div>
    </div>
    <a href="<?php echo e(route('manajemenmahasiswa.dashboard')); ?>" class="da-refresh-btn">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('dpm_himpunan')): ?>
...
<div class="kpi-row">
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dpmHimpunanKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="kpi-mini">
            <div class="kpi-mini-icon" style="background:<?php echo e($k['bg']); ?>;color:<?php echo e($k['color']); ?>;">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            </div>
            <div>
                <div class="kpi-mini-val" style="color:<?php echo e($k['color']); ?>;"><?php echo e($k['val']); ?></div>
                <div class="kpi-mini-label"><?php echo e($k['label']); ?></div>
            </div>
        </div>
...
<div class="chart-grid-2">
    <div class="chart-card">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/bar-chart-11.svg'))); ?></span>
            <?php echo e($dpmHimpunan['composition_label'] ?? 'Komposisi Pengurus per Divisi'); ?>

            <span class="chart-title-right">Periode <?php echo e($dpmHimpunan['periode_aktif'] ?? '-'); ?></span>
        </div>
        <?php $maxDivisiDpm = max(1, (int) (collect($dpmHimpunan['per_divisi'] ?? [])->max() ?? 0)); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($dpmHimpunan['per_divisi'])): ?>
            <div style="display:flex;flex-direction:column;gap:8px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dpmHimpunan['per_divisi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divisi => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div style="display:flex;align-items:center;gap:12px;">
                        <span style="font-size:.82rem;font-weight:600;color:#374151;width:150px;flex-shrink:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo e($divisi); ?></span>
                        <div style="flex:1;height:22px;background:#f3f4f6;border-radius:6px;overflow:hidden;">
                            <div style="height:100%;width:<?php echo e(round($total / $maxDivisiDpm * 100)); ?>%;background:linear-gradient(90deg,#293C79,#415086);border-radius:6px;min-width:24px;"></div>
                        </div>
                        <span style="font-size:.82rem;font-weight:700;color:#1e1b4b;width:32px;text-align:right;flex-shrink:0;"><?php echo e($total); ?></span>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        <?php else: ?>
    ...
    <div class="chart-card" style="overflow-x:auto;">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/users-01.svg'))); ?></span>
            Pengurus Inti
        </div>
        <table class="da-table">
            <thead><tr><th>Nama</th><th>NIM</th><th>Jabatan</th><th>Status</th></tr></thead>
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dpmHimpunan['pengurus_inti'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengurus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    ?>
                    <tr>
                        <td><div style="display:flex;align-items:center;gap:9px;"><div class="avatar-sm"><?php echo e(strtoupper(substr($namaPengurus,0,2))); ?></div><span style="font-weight:600;color:#1e1b4b;"><?php echo e($namaPengurus); ?></span></div></td>
                        <td style="font-family:monospace;color:#9ca3af;font-size:.82rem;"><?php echo e($pengurus['nim'] ?? '-'); ?></td>
                        <td><?php echo e($pengurus['jabatan'] ?? '-'); ?></td>
                        <td><span class="badge <?php echo e($statusPengurusKey === 'aktif' ? 'badge-bekerja' : 'badge-belum'); ?>"><?php echo e(ucfirst($statusPengurus)); ?></span></td>
                    </tr>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('dpm_proker')): ?>
...
<div class="kpi-row">
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dpmProkerKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="kpi-mini">
            <div class="kpi-mini-icon" style="background:<?php echo e($k['bg']); ?>;color:<?php echo e($k['color']); ?>;">
...
<div class="chart-grid-2">
    <div class="chart-card">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/bar-chart-12.svg'))); ?></span>
            Sebaran Proker per Bidang
            <span class="chart-title-right"><?php echo e(number_format($dpmProker['tahun_ini'] ?? 0)); ?> tahun ini</span>
        </div>
        <?php $maxBidangDpm = max(1, (int) (collect($dpmProker['per_bidang'] ?? [])->max() ?? 0)); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($dpmProker['per_bidang'])): ?>
            <div class="progress-card">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dpmProker['per_bidang']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bidang => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $pctBidangDpm = round($total / $maxBidangDpm * 100); ?>
                    <div class="progress-item">
                        <div class="progress-row">
                            <span class="progress-label"><?php echo e($bidang); ?></span>
                            <span class="progress-count" style="color:#293C79;"><?php echo e($total); ?></span>
                        </div>
                        <div class="progress-bar-bg">
                            <div class="progress-bar-fill" style="width:<?php echo e($pctBidangDpm); ?>%;background:#293C79;"></div>
                        </div>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
    ...
    <div class="chart-card" style="overflow-x:auto;">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/file-01.svg'))); ?></span>
            Draft Proker Terbaru
        </div>
        <table class="da-table">
            <thead><tr><th>Kegiatan</th><th>Ketua</th><th>Kategori</th><th>Dibuat</th></tr></thead>
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dpmProker['proker_terbaru'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    ?>
                    <tr>
                        <td style="font-weight:600;color:#1e1b4b;"><?php echo e($proker->nama_kegiatan ?? '-'); ?></td>
                        <td><?php echo e($ketuaProker); ?></td>
                        <td><?php echo e($kategoriProker ?: '-'); ?></td>
                        <td style="color:#9ca3af;"><?php echo e(optional($proker->created_at)->format('d M Y') ?? '-'); ?></td>
                    </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('dpm_pelaksanaan')): ?>
...
<div class="kpi-row">
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dpmPelaksanaanKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="kpi-mini">
            <div class="kpi-mini-icon" style="background:<?php echo e($k['bg']); ?>;color:<?php echo e($k['color']); ?>;">
...
<div class="chart-grid-2">
        ...
        <div class="progress-card">
            <div class="progress-item">
                <div class="progress-row">
                    ...
                    <span class="progress-count" style="color:#2563eb;"><?php echo e(number_format($dpmPelaksanaan['realisasi_peserta'] ?? 0)); ?> / <?php echo e(number_format($dpmPelaksanaan['target_peserta'] ?? 0)); ?> (<?php echo e($dpmPelaksanaan['rate_peserta'] ?? 0); ?>%)</span>
                </div>
                <div class="progress-bar-bg">
                    <div class="progress-bar-fill" style="width:<?php echo e(min(100, (int) ($dpmPelaksanaan['rate_peserta'] ?? 0))); ?>%;background:#2563eb;"></div>
                </div>
            </div>
            <div class="progress-item">
                <div class="progress-row">
                    <span class="progress-label">Anggaran</span>
                    <span class="progress-count" style="color:#059669;">Rp <?php echo e(number_format($dpmPelaksanaan['anggaran_realisasi'] ?? 0, 0, ',', '.')); ?> / Rp <?php echo e(number_format($dpmPelaksanaan['anggaran_rencana'] ?? 0, 0, ',', '.')); ?></span>
                </div>
                <div class="progress-bar-bg">
                    <div class="progress-bar-fill" style="width:<?php echo e(min(100, (int) ($dpmPelaksanaan['rate_anggaran'] ?? 0))); ?>%;background:#059669;"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="chart-card" style="overflow-x:auto;">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/calendar.svg'))); ?></span>
            Jadwal Pelaksanaan Mendatang
        </div>
        <table class="da-table">
            <thead><tr><th>Kegiatan</th><th>Tanggal</th><th>Dosen Pendamping</th></tr></thead>
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dpmPelaksanaan['pelaksanaan_mendatang'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    ?>
                    <tr>
                        <td style="font-weight:600;color:#1e1b4b;"><?php echo e($kegiatan->nama_kegiatan ?? '-'); ?></td>
                        <td style="color:#9ca3af;"><?php echo e($tanggalMulaiDpm); ?></td>
                        <td><?php echo e($dosenDpm); ?></td>
                    </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('dpm_partisipasi')): ?>
...
<div class="kpi-row">
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dpmPartisipasiKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="kpi-mini">
            <div class="kpi-mini-icon" style="background:<?php echo e($k['bg']); ?>;color:<?php echo e($k['color']); ?>;">
...
<div class="chart-grid-2">
    <div class="chart-card">
        <div class="chart-title">
            ...
            <span class="chart-title-right"><?php echo e(number_format($dpmPartisipasi['total_panitia'] ?? 0)); ?> panitia</span>
        </div>
        <?php $maxAngkatanDpm = max(1, (int) (collect($dpmPartisipasi['per_angkatan'] ?? [])->max() ?? 0)); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($dpmPartisipasi['per_angkatan'])): ?>
            <div style="display:flex;flex-direction:column;gap:8px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dpmPartisipasi['per_angkatan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $angkatan => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div style="display:flex;align-items:center;gap:10px;">
                        <span style="font-size:.8rem;font-weight:700;color:#374151;width:48px;flex-shrink:0;"><?php echo e($angkatan); ?></span>
                        <div style="flex:1;height:22px;background:#f3f4f6;border-radius:6px;overflow:hidden;">
                            <div style="height:100%;width:<?php echo e(round($total / $maxAngkatanDpm * 100)); ?>%;background:linear-gradient(90deg,#293C79,#415086);border-radius:6px;min-width:24px;"></div>
                        </div>
                        <span style="font-size:.82rem;font-weight:700;color:#1e1b4b;width:36px;text-align:right;flex-shrink:0;"><?php echo e($total); ?></span>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        <?php else: ?>
    ...
    <div class="chart-card" style="overflow-x:auto;">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/star.svg'))); ?></span>
            Mahasiswa Paling Aktif
        </div>
        <table class="da-table">
            <thead><tr><th>Mahasiswa</th><th>NIM</th><th>Riwayat</th></tr></thead>
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dpmPartisipasi['top_mahasiswa'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                        $student = $row->student;
                        $namaAktif = $student?->user?->name ?? $student?->name ?? 'Mahasiswa';
                    ?>
                    <tr>
                        <td><div style="display:flex;align-items:center;gap:9px;"><div class="avatar-sm"><?php echo e(strtoupper(substr($namaAktif,0,2))); ?></div><span style="font-weight:600;color:#1e1b4b;"><?php echo e($namaAktif); ?></span></div></td>
                        <td style="font-family:monospace;color:#9ca3af;font-size:.82rem;"><?php echo e($student?->student_number ?? '-'); ?></td>
                        <td style="font-weight:700;color:#293C79;"><?php echo e(number_format($row->total ?? 0)); ?></td>
                    </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('dpm_prestasi_reward')): ?>
...
<div class="kpi-row">
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dpmRewardKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="kpi-mini">
            <div class="kpi-mini-icon" style="background:<?php echo e($k['bg']); ?>;color:<?php echo e($k['color']); ?>;">
...
<div class="chart-grid-2">
    <div class="chart-card">
        ...
        <div class="kpi-row" style="grid-template-columns:repeat(2,minmax(0,1fr));margin-bottom:0;">
            <div class="kpi-mini">
                ...
                <div>
                    <div class="kpi-mini-val" style="color:#2563eb;"><?php echo e(number_format($dpmReward['reward_mk_diajukan'] ?? 0)); ?></div>
            ...
            <div class="kpi-mini">
                ...
                <div>
                    <div class="kpi-mini-val" style="color:#059669;"><?php echo e(number_format($dpmReward['reward_sks_diajukan'] ?? 0)); ?></div>
    ...
    <div class="chart-card" style="overflow-x:auto;">
        ...
        <table class="da-table">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dpmReward['reward_terbaru'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prestasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $namaPrestasi = $prestasi->kemahasiswaan?->user?->name ?? $prestasi->kemahasiswaan?->nama ?? 'Mahasiswa'; ?>
                    <tr>
                        <td><div style="display:flex;align-items:center;gap:9px;"><div class="avatar-sm"><?php echo e(strtoupper(substr($namaPrestasi,0,2))); ?></div><span style="font-weight:600;color:#1e1b4b;"><?php echo e($namaPrestasi); ?></span></div></td>
                        <td><?php echo e($prestasi->nama_prestasi ?? '-'); ?></td>
                        <td style="color:#293C79;font-weight:700;"><?php echo e((int) ($prestasi->reward_jml_mk_max ?? 0)); ?> MK / <?php echo e((int) ($prestasi->reward_sks_max ?? 0)); ?> SKS</td>
                    </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('action_items')): ?>
...
<div class="action-grid">
    ...
    <a href="<?php echo e(route('manajemenmahasiswa.pengaduan.index')); ?>"
       class="action-card action-card-red <?php echo e($act['pengaduan_baru'] === 0 ? 'zero-state' : ''); ?>">
        <div class="action-card-top">
            <div class="action-icon action-icon-red">
                <span style="display:inline-flex;width:18px;height:18px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/headphone-01.svg'))); ?></span>
            </div>
        </div>
        <div class="action-num action-num-red"><?php echo e($act['pengaduan_baru']); ?></div>
        <div>
    ...
    <a href="<?php echo e(route('manajemenmahasiswa.verifikasi.index')); ?>"
       class="action-card action-card-orange <?php echo e($act['verif_kegiatan'] === 0 ? 'zero-state' : ''); ?>">
        <div class="action-card-top">
            <div class="action-icon action-icon-orange">
                <span style="display:inline-flex;width:18px;height:18px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/check-square.svg'))); ?></span>
            </div>
        </div>
        <div class="action-num action-num-orange"><?php echo e($act['verif_kegiatan']); ?></div>
        <div>
    ...
    <a href="<?php echo e(route('manajemenmahasiswa.verifikasi.index')); ?>"
       class="action-card action-card-amber <?php echo e($act['verif_prestasi'] === 0 ? 'zero-state' : ''); ?>">
        <div class="action-card-top">
            <div class="action-icon action-icon-amber">
                <span style="display:inline-flex;width:18px;height:18px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/star.svg'))); ?></span>
            </div>
        </div>
        <div class="action-num action-num-amber"><?php echo e($act['verif_prestasi']); ?></div>
        <div>
    ...
    <a href="<?php echo e(route('manajemenmahasiswa.forum.index')); ?>"
       class="action-card action-card-purple <?php echo e($act['laporan_forum'] === 0 ? 'zero-state' : ''); ?>">
        <div class="action-card-top">
            <div class="action-icon action-icon-purple">
                <span style="display:inline-flex;width:18px;height:18px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/alert-circle.svg'))); ?></span>
            </div>
        </div>
        <div class="action-num action-num-purple"><?php echo e($act['laporan_forum']); ?></div>
        <div>
    ...
    <a href="<?php echo e(route('manajemenmahasiswa.pengumuman.verifikasi.index')); ?>"
       class="action-card action-card-blue <?php echo e($act['pengumuman_pending'] === 0 ? 'zero-state' : ''); ?>">
        <div class="action-card-top">
            <div class="action-icon action-icon-blue">
                <span style="display:inline-flex;width:18px;height:18px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/announcement-01.svg'))); ?></span>
            </div>
        </div>
        <div class="action-num action-num-blue"><?php echo e($act['pengumuman_pending']); ?></div>
        <div>
    ...
    <a href="<?php echo e(route('manajemenmahasiswa.verifikasi.reward.index')); ?>"
       class="action-card action-card-green <?php echo e(($act['reward_pending'] ?? 0) === 0 ? 'zero-state' : ''); ?>">
        <div class="action-card-top">
            <div class="action-icon action-icon-green">
                <span style="display:inline-flex;width:18px;height:18px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/star.svg'))); ?></span>
            </div>
        </div>
        <div class="action-num action-num-green"><?php echo e($act['reward_pending'] ?? 0); ?></div>
        <div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('admin_operasional')): ?>
<div class="da-section" style="order:2;">
<div class="section-header section-gap">
...
<div class="kpi-row">
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $adminKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
    <div class="kpi-mini">
        <div class="kpi-mini-icon" style="background:<?php echo e($k['bg']); ?>;color:<?php echo e($k['color']); ?>;">
            <span style="display:inline-flex;width:18px;height:18px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/check-square.svg'))); ?></span>
        </div>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:18px;margin-top:18px;">
    <div class="chart-card">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/headphone-01.svg'))); ?></span>
            Layanan Pengaduan
        </div>
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(110px,1fr));gap:10px;margin-bottom:16px;">
            ...
            <div style="padding:12px;border:1px solid #eef2f7;border-radius:12px;background:#fff;">
                <div style="font-size:1.25rem;font-weight:800;color:<?php echo e($row['color']); ?>;"><?php echo e(number_format($row['val'])); ?></div>
                <div style="font-size:.75rem;color:#6b7280;font-weight:600;"><?php echo e($row['label']); ?></div>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;font-size:.82rem;">
            ...
            <span style="font-weight:800;color:#059669;"><?php echo e($ops['responsivitas_pengaduan'] ?? 0); ?>%</span>
        </div>
        <div style="height:7px;background:#f3f4f6;border-radius:999px;overflow:hidden;">
            <div style="width:<?php echo e(min(100, $ops['responsivitas_pengaduan'] ?? 0)); ?>%;height:100%;background:#059669;border-radius:999px;"></div>
        </div>
        <div style="margin-top:10px;font-size:.72rem;color:#9ca3af;">
            SLA <?php echo e($ops['sla_hari'] ?? 7); ?> hari, <?php echo e(number_format($ops['pengaduan_belum_dibaca'] ?? 0)); ?> pengaduan belum dibaca.
        </div>
    </div>

    <div class="chart-card">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/check-square.svg'))); ?></span>
            Verifikasi & Approval
        </div>
        <table class="da-table">
            ...
            <tbody>
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr>
                    <td style="font-weight:600;color:#1e1b4b;"><?php echo e($label); ?></td>
                    <td style="text-align:right;font-weight:800;color:<?php echo e($val > 0 ? '#dc2626' : '#059669'); ?>;"><?php echo e(number_format($val)); ?></td>
                </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </tbody>
        </table>
        <div style="margin-top:10px;font-size:.72rem;color:#9ca3af;">
            Potensi reward pending: <?php echo e(number_format($ops['reward_mk_pending'] ?? 0)); ?> MK / <?php echo e(number_format($ops['reward_sks_pending'] ?? 0)); ?> SKS.
        </div>
    </div>
</div>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:18px;margin-top:18px;">
    <div class="chart-card">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(100px,1fr));gap:10px;margin-bottom:16px;">
            ...
            <div style="padding:12px;border:1px solid #eef2f7;border-radius:12px;background:#fff;">
                <div style="font-size:1.25rem;font-weight:800;color:#293C79;"><?php echo e(number_format($row['val'])); ?></div>
                <div style="font-size:.75rem;color:#6b7280;font-weight:600;"><?php echo e($row['label']); ?></div>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
        <div style="display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap;font-size:.82rem;margin-bottom:6px;"><strong>Peserta</strong><span><?php echo e(number_format($ops['realisasi_peserta'] ?? 0)); ?> / <?php echo e(number_format($ops['target_peserta'] ?? 0)); ?> (<?php echo e($ops['persen_realisasi_peserta'] ?? 0); ?>%)</span></div>
        <div style="height:7px;background:#f3f4f6;border-radius:999px;overflow:hidden;margin-bottom:12px;"><div style="width:<?php echo e($pesertaPct); ?>%;height:100%;background:#2563eb;border-radius:999px;"></div></div>
        <div style="display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap;font-size:.82rem;margin-bottom:6px;"><strong>Anggaran</strong><span>Rp <?php echo e(number_format($ops['anggaran_realisasi'] ?? 0, 0, ',', '.')); ?> / Rp <?php echo e(number_format($ops['anggaran_rencana'] ?? 0, 0, ',', '.')); ?></span></div>
        <div style="height:7px;background:#f3f4f6;border-radius:999px;overflow:hidden;"><div style="width:<?php echo e($anggaranPct); ?>%;height:100%;background:#059669;border-radius:999px;"></div></div>
        <div style="margin-top:10px;font-size:.72rem;color:#9ca3af;">
            <?php echo e(number_format($ops['kegiatan_selesai_belum_realisasi'] ?? 0)); ?> kegiatan selesai belum lengkap realisasinya.
        </div>
    </div>
    ...
    <div class="chart-card">
        ...
        <table class="da-table">
            ...
            <tbody>
                ...
                <tr>
                    <td style="font-weight:600;color:#1e1b4b;"><?php echo e($label); ?></td>
                    <td style="text-align:right;font-weight:800;color:<?php echo e($val > 0 ? '#d97706' : '#059669'); ?>;"><?php echo e(number_format($val)); ?></td>
                </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </tbody>
        </table>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('activity')): ?>
<div class="da-section" style="order:<?php echo e($isGpm ? 6 : ($hasSection('admin_operasional') ? 3 : 2)); ?>;">
<div class="section-header section-gap">
...
<div class="activity-grid">
    ...
    <div class="stat-card card-clickable" onclick="openDashModal('kegiatan',{},'Kegiatan Bulan Ini')">
        <div class="stat-icon stat-icon-green">
            <span style="display:inline-flex;width:20px;height:20px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/calendar.svg'))); ?></span>
        </div>
        <div>
            <div class="stat-value"><?php echo e(number_format($acty['kegiatan_bulan_ini'])); ?></div>
            <div class="stat-label">Kegiatan Bulan Ini</div>
            <div class="stat-sub">Ditambahkan <?php echo e(now()->translatedFormat('F Y')); ?></div>
        </div>
    </div>
    ...
    <div class="stat-card card-clickable" onclick="openDashModal('pengumuman',{},'Pengumuman Bulan Ini')">
        <div class="stat-icon stat-icon-purple">
            <span style="display:inline-flex;width:20px;height:20px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/announcement-01.svg'))); ?></span>
        </div>
        <div>
            <div class="stat-value"><?php echo e(number_format($acty['pengumuman_bulan_ini'])); ?></div>
            <div class="stat-label">Pengumuman Bulan Ini</div>
            <div class="stat-sub">Dipublish <?php echo e(now()->translatedFormat('F Y')); ?></div>
        </div>
    </div>

    
    <div class="stat-card <?php echo e($acty['kegiatan_berlangsung'] > 0 ? 'card-clickable' : ''); ?>"
         <?php if($acty['kegiatan_berlangsung'] > 0): ?>
             onclick="window.location.href='<?php echo e(route('manajemenmahasiswa.kegiatan.index')); ?>'"
         <?php endif; ?>>
        <div class="stat-icon stat-icon-amber">
            <span style="display:inline-flex;width:20px;height:20px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/clock-02.svg'))); ?></span>
        </div>
        <div>
            <div class="stat-value" style="<?php echo e($acty['kegiatan_berlangsung'] > 0 ? 'color:#d97706;' : ''); ?>">
                <?php echo e(number_format($acty['kegiatan_berlangsung'])); ?>
...
<div class="chart-card section-gap">
    <div class="chart-title">
        <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/bar-chart-11.svg'))); ?></span>
        <?php echo e($isGpm ? 'Tren Pelaksanaan Kegiatan (6 Bulan Terakhir)' : 'Tren Kegiatan Ditambahkan (6 Bulan Terakhir)'); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('evaluasi_mutu') && !empty($eval)): ?>
<div class="da-section" style="order:1;">
<div class="section-header section-gap">
...
<div class="kpi-row" style="grid-template-columns:repeat(3,1fr);margin-bottom:18px;">
    ...
    <div class="kpi-mini">
        ...
        <div>
            <div class="kpi-mini-val" style="color:#2563eb;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nMasaStudi < $minSampel): ?><?php echo $dataKurang; ?><?php else: ?><?php echo e($eval['rata_masa_studi']); ?> <span style="font-size:.8rem;font-weight:600;">thn</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="kpi-mini-label">Rata-rata Masa Studi</div>
            <div style="font-size:.68rem;color:#9ca3af;margin-top:2px;">dari <?php echo e($nMasaStudi); ?> lulusan</div>
            <?php echo $targetBadge('masa_studi'); ?>
    ...
    <div class="kpi-mini">
        ...
        <div>
            <div class="kpi-mini-val" style="color:#d97706;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nWaktuTunggu < $minSampel): ?><?php echo $dataKurang; ?><?php else: ?><?php echo e($eval['rata_waktu_tunggu']); ?> <span style="font-size:.8rem;font-weight:600;">thn</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="kpi-mini-label">Waktu Tunggu Kerja</div>
            <div style="font-size:.68rem;color:#9ca3af;margin-top:2px;"><?php echo e($nWaktuTunggu); ?> dari <?php echo e($almTotal); ?> alumni terdata</div>
            <?php echo $targetBadge('waktu_tunggu_kerja'); ?>
    ...
    <div class="kpi-mini">
        ...
        <div>
            <div class="kpi-mini-val" style="color:#059669;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($almTerdata < $minSampel): ?><?php echo $dataKurang; ?><?php else: ?><?php echo e($eval['serapan_kerja']); ?>%<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="kpi-mini-label">Serapan Kerja Alumni</div>
            <div style="font-size:.68rem;color:#9ca3af;margin-top:2px;"><?php echo e($almTerdata); ?> dari <?php echo e($almTotal); ?> alumni terdata</div>
            <?php echo $targetBadge('serapan_kerja'); ?>
    ...
    <div class="kpi-mini">
        ...
        <div>
            <div class="kpi-mini-val" style="color:#ea580c;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nMasaStudi < $minSampel): ?><?php echo $dataKurang; ?><?php else: ?><?php echo e($eval['kelulusan_tepat_waktu'] ?? 0); ?>%<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="kpi-mini-label">Kelulusan Tepat Waktu</div>
            <div style="font-size:.68rem;color:#9ca3af;margin-top:2px;">lulus ≤ 4 thn · dari <?php echo e($nMasaStudi); ?> lulusan</div>
            <?php echo $targetBadge('kelulusan_tepat_waktu'); ?>
    ...
    <div class="kpi-mini">
        ...
        <div>
            <div class="kpi-mini-val" style="color:#4f46e5;"><?php echo e($eval['kelengkapan_data_alumni'] ?? 0); ?>%</div>
            <div class="kpi-mini-label">Kelengkapan Data Alumni</div>
            <div style="font-size:.68rem;color:#9ca3af;margin-top:2px;"><?php echo e($almTerdata); ?> dari <?php echo e($almTotal); ?> mengisi data karir</div>
        </div>
    </div>
    ...
    <div class="kpi-mini">
        ...
        <div>
            <div class="kpi-mini-val" style="color:#a855f7;"><?php echo e($eval['responsivitas']); ?>%</div>
            <div class="kpi-mini-label" title="Persentase pengaduan (non-draft) yang dijawab dalam ≤ <?php echo e($eval['sla_hari'] ?? 7); ?> hari sejak dibuat.">Responsivitas Pengaduan (SLA)</div>
            <div style="font-size:.68rem;color:#9ca3af;margin-top:2px;"><?php echo e($eval['pengaduan_sla_terpenuhi'] ?? 0); ?> dari <?php echo e($eval['pengaduan_total'] ?? 0); ?> dijawab ≤ <?php echo e($eval['sla_hari'] ?? 7); ?> hari</div>
        </div>
    </div>
</div>
...
<div class="chart-card section-gap">
    ...
    <div style="overflow-x:auto;">
        <table class="da-table" style="width:100%;border-collapse:collapse;">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $eval['kelulusan_per_angkatan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $angkatan => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr style="border-bottom:1px solid #f9fafb;">
                        <td style="padding:9px 12px;font-size:.85rem;font-weight:700;color:#1e1b4b;"><?php echo e($angkatan); ?></td>
                        <td style="padding:9px 12px;text-align:center;font-size:.85rem;color:#374151;"><?php echo e($row['total']); ?></td>
                        <td style="padding:9px 12px;text-align:center;font-size:.85rem;color:#059669;font-weight:600;"><?php echo e($row['lulus']); ?></td>
                        <td style="padding:9px 12px;text-align:center;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($row['jatuh_tempo'])): ?>
                            ...
                            <?php else: ?>
                                <span style="display:inline-block;min-width:46px;padding:2px 8px;border-radius:50px;font-size:.78rem;font-weight:700;background:#ecfdf5;color:#059669;"><?php echo e($row['rate_lulus']); ?>%</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td style="padding:9px 12px;text-align:center;font-size:.85rem;color:#dc2626;font-weight:600;"><?php echo e($row['do']); ?></td>
                        <td style="padding:9px 12px;text-align:center;">
                            <span style="display:inline-block;min-width:46px;padding:2px 8px;border-radius:50px;font-size:.78rem;font-weight:700;background:<?php echo e($row['rate_do'] > 0 ? '#fef2f2' : '#f3f4f6'); ?>;color:<?php echo e($row['rate_do'] > 0 ? '#dc2626' : '#9ca3af'); ?>;"><?php echo e($row['rate_do']); ?>%</span>
                        </td>
                    </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<div class="kpi-row" style="grid-template-columns:repeat(4,1fr);margin-bottom:18px;">
    <div class="kpi-mini">
        <div class="kpi-mini-icon" style="background:#eff6ff;color:#2563eb;">
            <span style="display:inline-flex;width:18px;height:18px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/calendar.svg'))); ?></span>
        </div>
        <div>
            <div class="kpi-mini-val" style="color:#2563eb;"><?php echo e(number_format($eval['kegiatan_total'] ?? 0)); ?></div>
    ...
    <div class="kpi-mini">
        ...
        <div>
            <div class="kpi-mini-val" style="color:#059669;"><?php echo e(number_format($eval['kegiatan_selesai'] ?? 0)); ?></div>
    ...
    <div class="kpi-mini">
        ...
        <div>
            <div class="kpi-mini-val" style="color:#d97706;"><?php echo e(number_format($eval['kegiatan_berjalan'] ?? 0)); ?></div>
            <div class="kpi-mini-label">Berjalan / Disetujui</div>
        </div>
    </div>
    <div class="kpi-mini">
        <div class="kpi-mini-icon" style="background:#f5f3ff;color:#7c3aed;">
            <span style="display:inline-flex;width:18px;height:18px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/bar-chart-11.svg'))); ?></span>
        </div>
        <div>
            <div class="kpi-mini-val" style="color:#7c3aed;"><?php echo e($eval['rate_realisasi_kegiatan'] ?? 0); ?>%</div>
...
<div class="chart-card section-gap">
    <div class="chart-title">
        ...
        <span class="chart-title-right">Total: <?php echo e(number_format($eval['kegiatan_total'] ?? 0)); ?></span>
    </div>
    <?php
        $statusLabelMap = [
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sumStatus > 0): ?>
        <div style="display:flex;flex-wrap:wrap;gap:10px;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $perStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st => $cnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php $cfg = $statusLabelMap[$st] ?? [ucfirst(str_replace('_',' ',$st)), '#6b7280', '#f3f4f6']; ?>
                <div style="display:flex;align-items:center;gap:8px;padding:8px 14px;border-radius:10px;background:<?php echo e($cfg[2]); ?>;">
                    <span style="font-size:1.2rem;font-weight:800;color:<?php echo e($cfg[1]); ?>;line-height:1;"><?php echo e(number_format($cnt)); ?></span>
                    <span style="font-size:.78rem;font-weight:600;color:<?php echo e($cfg[1]); ?>;"><?php echo e($cfg[0]); ?></span>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
    <?php else: ?>
...
<div class="chart-card section-gap">
    <div class="chart-title">
        ...
        <span class="chart-title-right">Total kategori: <?php echo e(count($eval['kegiatan_per_kategori'] ?? [])); ?></span>
    </div>
    <?php $maxKat = max(1, (int) (collect($eval['kegiatan_per_kategori'] ?? [])->max() ?? 0)); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($eval['kegiatan_per_kategori'])): ?>
        <div style="display:flex;flex-direction:column;gap:8px;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $eval['kegiatan_per_kategori']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori => $jml): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div style="display:flex;align-items:center;gap:12px;">
                    <span style="font-size:.82rem;font-weight:600;color:#374151;width:160px;flex-shrink:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo e($kategori); ?></span>
                    <div style="flex:1;height:22px;background:#f3f4f6;border-radius:6px;overflow:hidden;">
                        <div style="height:100%;width:<?php echo e(round($jml / $maxKat * 100)); ?>%;background:linear-gradient(90deg,#293C79,#415086);border-radius:6px;min-width:24px;"></div>
                    </div>
                    <span style="font-size:.82rem;font-weight:700;color:#1e1b4b;width:32px;text-align:right;flex-shrink:0;"><?php echo e($jml); ?></span>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
    <?php else: ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('mahasiswa')): ?>
<div class="da-section" style="order:<?php echo e($isGpm ? 4 : ($isDpm ? 7 : ($hasSection('admin_operasional') ? 4 : 3))); ?>;">
<div class="section-header section-gap">
...
<div class="kpi-row">
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mhsKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="kpi-mini card-clickable"
             onclick="openDashModal('mahasiswa',{status:'<?php echo e($k['status']); ?>'},'Mahasiswa — <?php echo e($k['label']); ?>')">
            <div class="kpi-mini-icon" style="background:<?php echo e($k['bg']); ?>;color:<?php echo e($k['color']); ?>;">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
            </div>
            <div>
                <div class="kpi-mini-val" style="color:<?php echo e($k['color']); ?>;"><?php echo e(number_format($k['val'])); ?></div>
                <div class="kpi-mini-label"><?php echo e($k['label']); ?></div>
            </div>
        </div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<div class="chart-grid-2">
    ...
    <div class="chart-card">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/pie-chart-01.svg'))); ?></span>
            Status Seluruh Mahasiswa
            <span class="chart-title-right">Total: <?php echo e(number_format($totalSemuaMhs)); ?></span>
        </div>
        <div class="donut-row">
            ...
            <div class="donut-legend">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mhsStatusItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="legend-item">
                        <div class="legend-dot" style="background:<?php echo e($si['color']); ?>;"></div>
                        <span><?php echo e($si['label']); ?></span>
                        <span class="legend-val"><?php echo e(number_format($si['val'])); ?></span>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        </div>
    ...
    <div class="chart-card">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/line-chart-up-01.svg'))); ?></span>
        ...
        <div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:14px;" id="angkatanFilters">
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $lineStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cfg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <button
                    class="angkatan-filter-btn active"
                    data-status="<?php echo e($key); ?>"
                    onclick="toggleAngkatanLine('<?php echo e($key); ?>', this)"
                    style="display:inline-flex;align-items:center;gap:6px;padding:5px 12px;border-radius:50px;border:1.5px solid <?php echo e($cfg['border']); ?>;background:<?php echo e($cfg['bg']); ?>;color:<?php echo e($cfg['color']); ?>;font-size:.78rem;font-weight:700;cursor:pointer;transition:all .2s;">
                    <span style="width:8px;height:8px;border-radius:50%;background:<?php echo e($cfg['color']); ?>;display:inline-block;flex-shrink:0;"></span>
...
<div class="chart-grid-2">
    ...
    <div class="chart-card" style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div class="chart-title" style="margin-bottom:0;">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/star.svg'))); ?></span>
            Prestasi Mahasiswa
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canAccessVerifikasi): ?>
            <a href="<?php echo e(route('manajemenmahasiswa.verifikasi.index')); ?>" class="table-link" style="margin-left:auto;">Verifikasi →</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;">
            <div style="background:#E7E8F0;border-radius:10px;padding:10px 12px;text-align:center;">
                <div style="font-size:1.4rem;font-weight:800;color:#293C79;line-height:1;"><?php echo e($mhs['total_prestasi']); ?></div>
                <div style="font-size:.72rem;color:#9ca3af;font-weight:500;margin-top:2px;">Terverifikasi</div>
            </div>
            <div style="background:<?php echo e($pendingPrestasi > 0 ? '#fff7ed' : '#f9fafb'); ?>;border-radius:10px;padding:10px 12px;text-align:center;">
                <div style="font-size:1.4rem;font-weight:800;color:<?php echo e($pendingPrestasi > 0 ? '#ea580c' : '#d1d5db'); ?>;line-height:1;"><?php echo e($pendingPrestasi); ?></div>
            ...
            <div style="background:#f0fdf4;border-radius:10px;padding:10px 12px;text-align:center;">
                <div style="font-size:.9rem;font-weight:700;color:#059669;line-height:1.3;"><?php echo e($tingkatTertinggi ? ucfirst($tingkatTertinggi) : '—'); ?></div>
                <div style="font-size:.72rem;color:#9ca3af;font-weight:500;margin-top:2px;">Tingkat Tertinggi</div>
            </div>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mhs['total_prestasi'] > 0): ?>
            ...
            <div class="donut-row" style="gap:14px;">
                ...
                <div class="donut-legend" style="flex:1;gap:5px;">
                    <?php $pi=0; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tingkatOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php $cnt = $mhs['prestasi_per_tingkat'][$tk] ?? 0; ?>
                        <div class="legend-item" style="<?php echo e($cnt === 0 ? 'opacity:.35;' : ''); ?>">
                            <div class="legend-dot" style="background:<?php echo e($pColors[$pi % 5]); ?>;"></div>
                            <span style="font-size:.8rem;"><?php echo e($tingkatLabels[$tk] ?? ucfirst($tk)); ?></span>
                            <span class="legend-val" style="font-size:.82rem;"><?php echo e($cnt); ?></span>
                        </div>
                        <?php $pi++; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            ...
            <div>
                ...
                ?>
                <div style="display:flex;flex-direction:column;gap:8px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $mhs['prestasi_terbaru']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                        ...
                        <div style="display:flex;align-items:center;gap:9px;padding:7px 10px;background:#fafafa;border-radius:10px;border:1px solid #f3f4f6;">
                            <div class="avatar-sm" style="width:28px;height:28px;font-size:10px;flex-shrink:0;"><?php echo e($initials); ?></div>
                            <div style="flex:1;min-width:0;">
                                <div style="font-size:.82rem;font-weight:600;color:#1e1b4b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo e($pr->nama_prestasi); ?></div>
                                <div style="font-size:.75rem;color:#9ca3af;"><?php echo e($studentName); ?></div>
                            </div>
                            <span style="display:inline-flex;align-items:center;padding:2px 8px;border-radius:50px;font-size:.7rem;font-weight:700;background:<?php echo e($bc['bg']); ?>;color:<?php echo e($bc['color']); ?>;border:1px solid <?php echo e($bc['border']); ?>;white-space:nowrap;flex-shrink:0;">
                                <?php echo e(ucfirst($pr->tingkat)); ?>
        ...
        <?php else: ?>
            ...
            <div style="display:flex;flex-direction:column;align-items:center;padding:24px 16px;gap:10px;">
                <div style="width:56px;height:56px;border-radius:50%;background:#E7E8F0;display:flex;align-items:center;justify-content:center;">
                    <span style="display:inline-flex;width:26px;height:26px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/star.svg'))); ?></span>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingPrestasi > 0 && $canAccessVerifikasi): ?>
                    <a href="<?php echo e(route('manajemenmahasiswa.verifikasi.index')); ?>"
                        ...
                        <span style="display:inline-flex;width:13px;height:13px;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/check.svg'))); ?></span>
                        Review <?php echo e($pendingPrestasi); ?> Pengajuan Pending
                    </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="chart-card" style="overflow-x:auto;padding:22px 20px;">
        <div class="table-header">
            ...
            <a href="<?php echo e(route('manajemenmahasiswa.direktori.mahasiswa.index')); ?>" class="table-link">Lihat Semua →</a>
        </div>
        <table class="da-table">
            <thead><tr><th>Mahasiswa</th><th>NIM</th><th>Angkatan</th></tr></thead>
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $mhs['mahasiswa_terbaru']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $nm = $m->nama ?? $m->user?->name ?? '-'; ?>
                    <tr>
                        <td><div style="display:flex;align-items:center;gap:9px;"><div class="avatar-sm"><?php echo e(strtoupper(substr($nm,0,2))); ?></div><span style="font-weight:600;color:#1e1b4b;"><?php echo e($nm); ?></span></div></td>
                        <td style="font-family:monospace;color:#9ca3af;font-size:.82rem;"><?php echo e($m->nim ?? '-'); ?></td>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('calon_do') || $hasSection('lulusan')): ?>
<div class="da-section" style="order:<?php echo e($isGpm ? 2 : ($isDpm ? 1 : ($hasSection('admin_operasional') ? 5 : 4))); ?>;">
<div class="section-header section-gap">
...
<div class="chart-grid-2" style="margin-bottom:18px;">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('calon_do') && !empty($cdo)): ?>
    <?php $cdoTotal = $cdo['total_count'] ?? 0; ?>
    <div class="chart-card" style="<?php echo e($cdoTotal > 0 ? 'border:1px solid #fde68a;' : ''); ?>">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#d97706;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/alert-triangle.svg'))); ?></span>
            Deteksi Dini Drop Out
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cdoTotal > 0): ?>
        ...
        <div style="display:flex;gap:10px;margin-bottom:12px;">
            <div style="flex:1;text-align:center;padding:12px;border-radius:14px;background:#fef2f2;border:1px solid #fecaca;">
                <div style="font-size:2rem;font-weight:900;line-height:1;color:#dc2626;"><?php echo e($cdo['kritis_count'] ?? 0); ?></div>
            ...
            <div style="flex:1;text-align:center;padding:12px;border-radius:14px;background:#fffbeb;border:1px solid #fde68a;">
                <div style="font-size:2rem;font-weight:900;line-height:1;color:#d97706;"><?php echo e($cdo['pantau_count'] ?? 0); ?></div>
        ...
        <div style="font-size:.78rem;color:#9ca3af;line-height:1.5;margin-bottom:12px;">
            Mahasiswa <strong>aktif</strong> pada semester lanjut (angkatan ≤ <?php echo e($cdo['threshold_pantau'] ?? '-'); ?>). Perlu evaluasi &amp; pendampingan akademik bertingkat.
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($cdo['list']) && count($cdo['list']) > 0): ?>
        <div style="border-top:1px solid #f3f4f6;padding-top:10px;">
            ...
            <div style="display:flex;flex-direction:column;gap:6px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cdo['list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $isKritis = ($m['tier'] ?? '') === 'kritis'; ?>
                    <div style="display:flex;align-items:center;gap:9px;padding:6px 10px;background:#fafafa;border-radius:8px;">
                        <div class="avatar-sm" style="width:26px;height:26px;font-size:9px;flex-shrink:0;"><?php echo e(strtoupper(substr($m['nama'],0,2))); ?></div>
                        <div style="flex:1;min-width:0;">
                            <div style="font-size:.8rem;font-weight:600;color:#1e1b4b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo e($m['nama']); ?></div>
                            <div style="font-size:.72rem;color:#9ca3af;"><?php echo e($m['nim']); ?> · Angkatan <?php echo e($m['angkatan']); ?></div>
                        </div>
                        <span style="font-size:.72rem;font-weight:700;color:<?php echo e($isKritis ? '#dc2626' : '#d97706'); ?>;background:<?php echo e($isKritis ? '#fef2f2' : '#fffbeb'); ?>;padding:2px 8px;border-radius:50px;white-space:nowrap;flex-shrink:0;">Smt <?php echo e($m['semester']); ?></span>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('lulusan') && !empty($lulus)): ?>
    <div class="chart-card">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/bank-02.svg'))); ?></span>
            Lulusan per Periode
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($lulus['belum_sinkron'] ?? 0) > 0): ?>
        <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;background:#fffbeb;border:1px solid #fde68a;border-radius:10px;margin-bottom:14px;">
            <span style="display:inline-flex;width:18px;height:18px;color:#d97706;flex-shrink:0;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/alert-circle.svg'))); ?></span>
            <div style="flex:1;font-size:.8rem;color:#92400e;line-height:1.5;">
                <strong><?php echo e($lulus['belum_sinkron']); ?></strong> mahasiswa berstatus lulus belum tersinkron ke direktori alumni.
            </div>
        </div>
        <?php else: ?>
        ...
        <?php $maxLulus = max(1, (int) (collect($lulus['per_tahun'] ?? [])->max() ?? 0)); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($lulus['per_tahun'])): ?>
            <div style="display:flex;flex-direction:column;gap:8px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $lulus['per_tahun']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahun => $jml): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div style="display:flex;align-items:center;gap:10px;">
                        <span style="font-size:.8rem;font-weight:700;color:#374151;width:46px;flex-shrink:0;"><?php echo e($tahun); ?></span>
                        <div style="flex:1;height:22px;background:#f3f4f6;border-radius:6px;overflow:hidden;position:relative;">
                            <div style="height:100%;width:<?php echo e(round($jml / $maxLulus * 100)); ?>%;background:linear-gradient(90deg,#293C79,#415086);border-radius:6px;min-width:24px;"></div>
                        </div>
                        <span style="font-size:.82rem;font-weight:700;color:#1e1b4b;width:32px;text-align:right;flex-shrink:0;"><?php echo e($jml); ?></span>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSection('alumni') && !empty($alm)): ?>
<div class="da-section" style="order:<?php echo e($hasSection('admin_operasional') ? 6 : 5); ?>;">
<div class="section-header section-gap">
...
<div class="kpi-row">
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $almKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="kpi-mini card-clickable"
             onclick="openDashModal('alumni',{filter:'<?php echo e($k['filter']); ?>'},'Alumni — <?php echo e($k['label']); ?>')">
            <div class="kpi-mini-icon" style="background:<?php echo e($k['bg']); ?>;color:<?php echo e($k['color']); ?>;">
...
<div class="chart-grid-2">
    ...
    <div class="chart-card">
        ...
        <div class="donut-row">
            ...
            <div class="donut-legend">
                <?php $karirCM=['bekerja'=>'#10b981','wirausaha'=>'#3b82f6','studi_lanjut'=>'#6F7DA4','belum_bekerja'=>'#f59e0b','belum_terdata'=>'#9ca3af']; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $alm['per_status_karir']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s => $cnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="legend-item">
                        <div class="legend-dot" style="background:<?php echo e($karirCM[$s] ?? '#9ca3af'); ?>;"></div>
                        <span><?php echo e($karirLabels[$s] ?? ucfirst($s)); ?></span>
                        <span class="legend-val"><?php echo e(number_format($cnt)); ?></span>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        </div>
...
<div class="chart-grid-2">
    ...
    <div class="chart-card">
        <div class="chart-title">
            <span style="display:inline-flex;width:15px;height:15px;color:#293C79;"><?php echo str_replace(['#0D0D12','black','width="24"','height="24"'], ['currentColor','currentColor','width="100%"','height="100%"'], file_get_contents(public_path('images/icons/briefcase-01.svg'))); ?></span>
            Distribusi Bidang Industri
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($alm['distribusi_industri']) > 0): ?>
            <div class="donut-row">
                <div class="donut-canvas"><canvas id="chartIndustri"></canvas></div>
                <div class="donut-legend" style="max-height:170px;overflow-y:auto;">
                    <?php $iC=['#293C79','#3b82f6','#10b981','#f59e0b','#ef4444','#6F7DA4','#06b6d4','#84cc16']; $ii=0; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $alm['distribusi_industri']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b => $cnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="legend-item">
                            <div class="legend-dot" style="background:<?php echo e($iC[$ii%8]); ?>;"></div>
                            <span><?php echo e($industryLabels[$b] ?? ucfirst(str_replace('_',' ',$b))); ?></span>
                            <span class="legend-val"><?php echo e($cnt); ?></span>
                        </div>
                        <?php $ii++; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
    ...
    <div class="chart-card">
        ...
        <div class="progress-card">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $alm['per_status_karir']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s => $cnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php $cfg=$karirProg[$s]??['label'=>ucfirst($s),'color'=>'#9ca3af']; $pct=round($cnt/$totalK*100,1); ?>
                <div class="progress-item">
                    <div class="progress-row">
                        <span class="progress-label"><?php echo e($cfg['label']); ?></span>
                        <span class="progress-count" style="color:<?php echo e($cfg['color']); ?>;"><?php echo e(number_format($cnt)); ?> <span style="color:#9ca3af;font-weight:500;font-size:.78rem;">(<?php echo e($pct); ?>%)</span></span>
                    </div>
                    <div class="progress-bar-bg">
                        <div class="progress-bar-fill" style="width:<?php echo e($pct); ?>%;background:<?php echo e($cfg['color']); ?>;"></div>
                    </div>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
...
<div class="table-card">
    <div class="table-header">
        ...
        <a href="<?php echo e(route('manajemenmahasiswa.direktori.alumni.index')); ?>" class="table-link">Lihat Semua →</a>
    </div>
    <table class="da-table">
        ...
        <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $alm['alumni_terbaru']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $al): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                    $nm = $al->user?->name ?? '-';
                ...
                ?>
                <tr>
                    <td style="color:#d1d5db;font-size:.8rem;"><?php echo e($i+1); ?></td>
                    <td><div style="display:flex;align-items:center;gap:9px;"><div class="avatar-sm"><?php echo e(strtoupper(substr($nm,0,2))); ?></div><span style="font-weight:600;color:#1e1b4b;"><?php echo e($nm); ?></span></div></td>
                    <td style="font-family:monospace;color:#9ca3af;font-size:.82rem;"><?php echo e($al->nim ?? '-'); ?></td>
                    <td><?php echo e($al->angkatan ?? '-'); ?></td>
                    <td><?php echo e($al->tahun_lulus ?? '-'); ?></td>
                    <td><?php echo e($al->perusahaan ?? '-'); ?></td>
                    <td><span class="badge <?php echo e($badge); ?>"><?php echo e($karirLabels[$al->status_karir ?? 'belum_terdata'] ?? 'Belum Terdata'); ?></span></td>
                </tr>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    <?php if($hasSection('activity')): ?>
    <?php $trendKey = $isGpm ? 'kegiatan_trend_pelaksanaan' : 'kegiatan_trend'; ?>
    mkBar('chartKegiatanTrend',
        <?php echo json_encode(array_keys($acty[$trendKey] ?? [])); ?>,
        <?php echo json_encode(array_values($acty[$trendKey] ?? [])); ?>,
        '#293C79'
    );
    <?php endif; ?>

    // Tier 3 — Mahasiswa
    <?php if($hasSection('mahasiswa')): ?>
    mkDonut('chartStatusMhs',
        ['Aktif','Alumni','Cuti','Drop Out','Pindah','Mangkir','Wafat'],
        [<?php echo e($mhs['total_aktif']); ?>,<?php echo e($mhs['total_alumni_status']); ?>,<?php echo e($mhs['total_cuti']); ?>,<?php echo e($mhs['total_do']); ?>,<?php echo e($mhs['total_pindah']); ?>,<?php echo e($mhs['total_mangkir'] ?? 0); ?>,<?php echo e($mhs['total_wafat'] ?? 0); ?>],
    ...
    const angkatanChartData = {
        ...
        datasets: [
            <?php $__currentLoopData = $lineDatasets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
                label: '<?php echo e($ds['label']); ?>',
                data: <?php echo json_encode($angkatanByStatus[$ds['status']] ?? array_fill(0, count($angkatanLabels), 0)); ?>,
                borderColor: 'rgb(<?php echo e($ds['color']); ?>)',
                backgroundColor: '<?php echo e($useBarDistribusiMahasiswa ? "rgb(".$ds["color"].")" : "rgba(".$ds["color"].", 0.08)"); ?>',
                fill: true,
                tension: 0.35,
                borderWidth: <?php echo e($useBarDistribusiMahasiswa ? '1' : '2.5'); ?>,
                stack: 'mhs',
                pointRadius: 4,
                pointHoverRadius: 6,
                pointBackgroundColor: 'rgb(<?php echo e($ds['color']); ?>)',
                pointBorderColor: '#fff',
                pointBorderWidth: 2,
                _statusKey: '<?php echo e($ds['status']); ?>',
            },
    ...
    _angkatanChart = new Chart(document.getElementById('chartAngkatan'), {
        type: '<?php echo e($useBarDistribusiMahasiswa ? "bar" : "line"); ?>',
        ...
        options: {
            ...
            scales: {
                x: { stacked: <?php echo e($useBarDistribusiMahasiswa ? 'true' : 'false'); ?>, grid: { display: false }, ticks: { font: { size: 11 } } },
                y: {
                    stacked: <?php echo e($useBarDistribusiMahasiswa ? 'true' : 'false'); ?>,
                    grid: { color: '#f3f4f6' },
    ...
    <?php if(($mhs['total_prestasi'] ?? 0) > 0): ?>
    mkDonut('chartPrestasi',
        <?php echo json_encode(array_map(fn($k) => $tingkatLabels[$k] ?? ucfirst($k), array_keys($mhs['prestasi_per_tingkat'] ?? []))); ?>,
        <?php echo json_encode(array_values($mhs['prestasi_per_tingkat'] ?? [])); ?>,
    ...
    // Tier 4 — Alumni
    <?php if($hasSection('alumni') && !empty($alm)): ?>
    <?php
    ...
    mkDonut('chartStatusKarir',
        <?php echo json_encode($kChartL); ?>,
        <?php echo json_encode($kChartD); ?>,
        <?php echo json_encode($kChartC); ?>

    );
    mkBar('chartSerapan',
        <?php echo json_encode(array_keys($alm['serapan_per_angkatan'] ?? [])); ?>,
        <?php echo json_encode(array_values($alm['serapan_per_angkatan'] ?? [])); ?>,
        '#10b981', '%'
    );
    <?php if(count($alm['distribusi_industri'] ?? []) > 0): ?>
    <?php
    ...
    mkDonut('chartIndustri',
        <?php echo json_encode($iL); ?>,
        <?php echo json_encode($iD); ?>,
        <?php echo json_encode($iC); ?>
...
const MODAL_URL = '<?php echo e(route('manajemenmahasiswa.dashboard.modal')); ?>';
...
const PRESTASI_MODAL_URL = '<?php echo e(route('manajemenmahasiswa.dashboard.modal')); ?>';
        ...
        <div class="dm-toolbar" style="flex-direction:column;gap:10px;align-items:stretch;">
            ...
            <div>
                ...
                <div class="dm-filter-chips" id="prestasiTingkatChips">
                    <?php $tingkatList = ['semua'=>'Semua','internasional'=>'Internasional','nasional'=>'Nasional','regional'=>'Regional','universitas'=>'Universitas','prodi'=>'Prodi']; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tingkatList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <button class="dm-chip <?php echo e($val === 'semua' ? 'active' : ''); ?>"
                            data-val="<?php echo e($val); ?>"
                            onclick="setPrestasiTingkat('<?php echo e($val); ?>')"><?php echo e($lbl); ?></button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\dashboard\dashboard-analitik.blade.php ENDPATH**/ ?>
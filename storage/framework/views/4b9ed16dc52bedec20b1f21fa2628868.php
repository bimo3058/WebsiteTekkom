...
<div class="detail-header">
    <a href="<?php echo e(route('manajemenmahasiswa.kegiatan.show', $kegiatan->id)); ?>" class="btn-back">
        &larr;
    </a>
    <div>
        <h3 class="fw-bold mb-0" style="font-size:1.45rem;color:#0D0D12;letter-spacing:-.02em;">Edit Kegiatan</h3>
        <p class="mb-0" style="font-size:.82rem;color:#666D80;font-weight:500;">Perbarui informasi kegiatan <strong><?php echo e($kegiatan->judul); ?></strong></p>
    </div>
</div>
...
<form action="<?php echo e(route('manajemenmahasiswa.kegiatan.update', $kegiatan->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-card">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="judul" class="form-control form-control-custom"
                   value="<?php echo e(old('judul', $kegiatan->judul)); ?>" required maxlength="255">
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="deskripsi" class="form-control form-control-custom" required><?php echo e(old('deskripsi', $kegiatan->deskripsi)); ?></textarea>
        </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-3">
                ...
                <input type="date" name="tanggal_mulai" class="form-control form-control-custom"
                       value="<?php echo e(old('tanggal_mulai', $kegiatan->tanggal_mulai?->format('Y-m-d'))); ?>" required>
            </div>
            <div class="col-md-3">
                <label class="form-label-custom">Jam Mulai</label>
                <input type="time" name="jam_mulai" class="form-control form-control-custom"
                       value="<?php echo e(old('jam_mulai', $kegiatan->jam_mulai_formatted)); ?>">
            </div>
            <div class="col-md-3">
                ...
                <input type="date" name="tanggal_selesai" class="form-control form-control-custom"
                       value="<?php echo e(old('tanggal_selesai', $kegiatan->tanggal_selesai?->format('Y-m-d'))); ?>">
            </div>
            <div class="col-md-3">
                <label class="form-label-custom">Jam Selesai</label>
                <input type="time" name="jam_selesai" class="form-control form-control-custom"
                       value="<?php echo e(old('jam_selesai', $kegiatan->jam_selesai_formatted)); ?>">
            </div>
        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="search-select-wrapper">
                    <input type="hidden" name="ketua_pelaksana_id" id="ketuaPelaksanaId"
                           value="<?php echo e(old('ketua_pelaksana_id', $kegiatan->ketua_pelaksana_id)); ?>">
            ...
            <div class="col-md-6">
                ...
                <div class="search-select-wrapper">
                    <input type="hidden" name="dosen_pendamping_id" id="dosenPendampingId"
                           value="<?php echo e(old('dosen_pendamping_id', $kegiatan->dosen_pendamping_id)); ?>">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="number" name="target_peserta" class="form-control form-control-custom"
                       value="<?php echo e(old('target_peserta', $kegiatan->target_peserta)); ?>" min="1">
            </div>
            <div class="col-md-6">
                <label class="form-label-custom">Anggaran (Rp)</label>
                <input type="number" name="anggaran" class="form-control form-control-custom"
                       value="<?php echo e(old('anggaran', $kegiatan->anggaran)); ?>" min="0" max="9999999999999" step="1000">
            </div>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kegiatan->banner): ?>
            <div class="banner-current">
                ...
                <img src="<?php echo e($kegiatan->banner_url); ?>" alt="Banner saat ini" class="banner-preview" style="display: block;" onclick="openLightbox(this.src)" title="Klik untuk memperbesar">
            </div>
        ...
        <div class="banner-upload-area" onclick="document.getElementById('bannerInput').click()">
            ...
            <p>Klik untuk upload banner <?php echo e($kegiatan->banner ? 'baru' : 'kegiatan'); ?></p>
    ...
    <div class="d-flex gap-3 justify-content-end mt-2">
        <a href="<?php echo e(route('manajemenmahasiswa.kegiatan.show', $kegiatan->id)); ?>" class="btn-cancel">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\kegiatan\edit.blade.php ENDPATH**/ ?>
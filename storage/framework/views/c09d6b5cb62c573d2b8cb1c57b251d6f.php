    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:24px;">
        ...
        <div style="flex:1;min-width:0;">
            ...
            <div style="font-size:13px;color:#666D80;margin-bottom:10px;">
                ...
                <br>⏰ Deadline AC: <span style="font-weight:600;color:<?php echo e($lewat ? '#999' : '#353849'); ?>;"><?php echo e($dl->locale('id')->format('d M Y, H:i')); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <br>⏰ Deadline ACC: <span style="font-weight:600;color:<?php echo e(now()->gt($tugas->deadline_acc) ? '#DF1C41' : '#353849'); ?>;"><?php echo e(\Carbon\Carbon::parse($tugas->deadline_acc)->locale('id')->format('d M Y, H:i')); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
                                ...
                                <td style="padding:12px 16px;vertical-align:middle;">
                                    <div style="display:flex;align-items:center;gap:10px;min-width:0;">
                                        ...
                                        <div style="min-width:0;">
                                            ...
                                            <div style="font-size:11px;color:#666D80;margin-top:2px;font-style:italic;" title="<?php echo e($peng->catatan); ?>">💬 Mhs: <?php echo e(Str::limit($peng->catatan, 20)); ?></div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div style="display:flex;flex-direction:column;gap:6px;align-items:flex-start;">
                                        ...
                                        <div style="padding:6px 8px;background:#FEF2F2;border:1px solid #FEE2E2;border-radius:6px;font-size:11px;width:100%;box-sizing:border-box;">
                                            ...
                                            <a href="<?php echo e(app(\App\Services\SupabaseStorage::class)->publicUrl($peng->file_revisi_asprak, 'eoffice')); ?>" target="_blank" style="font-weight:600;color:#95122B;text-decoration:none;display:block;word-break:break-all;" title="<?php echo e(basename($peng->file_revisi_asprak)); ?>">
                                                📄 <?php echo e(Str::limit(basename($peng->file_revisi_asprak), 12)); ?>
                                            ...
                                            <div style="color:#7C1028;font-style:italic;margin-top:2px;word-break:break-word;" title="<?php echo e($peng->catatan_revisi); ?>">💬: <?php echo e(Str::limit($peng->catatan_revisi, 25)); ?></div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\manajemen-praktikum\asprak\tugas.blade.php ENDPATH**/ ?>
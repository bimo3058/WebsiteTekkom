<?php $__env->startSection('title','Laporan PDC 2'); ?>
<?php $__env->startSection('content'); ?>
<div x-data="adminReports('pdc2')" class="space-y-6"><div class="flex flex-wrap items-center justify-between gap-4"><h1 class="text-3xl font-bold">Laporan PDC 2</h1><?php if (isset($component)) { $__componentOriginalb35a908784863ee4a31335a0ede028f1 = $component; } ?>
...
<?php echo $__env->make('capstone::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\Capstone\tests/../resources/views/pages\admin\reports\pdc2.blade.php ENDPATH**/ ?>
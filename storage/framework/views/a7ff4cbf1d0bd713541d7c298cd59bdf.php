...
<div style="max-width:100%; padding:24px 24px 56px;">
    ...
    <nav style="display:flex; align-items:center; gap:6px; font-size:11px; color:var(--c-fg-muted); margin-bottom:16px;">
        ...
        <a href="<?php echo e(route('superadmin.users.index')); ?>" style="color:var(--c-fg-muted); text-decoration:none;" onmouseover="this.style.color='var(--c-fg)'" onmouseout="this.style.color='var(--c-fg-muted)'">User Management</a>
        <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
    ...
    <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:16px; margin-bottom:20px; flex-wrap:wrap;">
        <div>
            ...
            <p style="font-size:12px; color:var(--c-fg-muted); margin-top:3px;">
                Total <span style="color:var(--c-error); font-weight:600;"><?php echo e($users->total()); ?></span> user disuspend
            </p>
        </div>
        ...
        <form action="<?php echo e(url()->current()); ?>" method="GET" style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
            ...
            <div x-data="{
                open:false, selected:'<?php echo e(request('role','all')); ?>',
        ...
        <div style="overflow-x:auto;">
            <table style="width:100%; border-collapse:collapse;">
                ...
                <tbody>
                    ...
                    <?php $isSA = $user->roles->pluck('name')->contains('superadmin'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.user-avatar','data' => ['user' => $user,'size' => 'sm','suspended' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user),'size' => 'sm','suspended' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                <div style="min-width:0;">
                                    <div style="display:flex; align-items:center; gap:6px; margin-bottom:2px;">
                                        <p style="font-size:13px; font-weight:600; color:var(--c-error); text-decoration:line-through; text-decoration-color:var(--c-error-subtle); overflow:hidden; text-overflow:ellipsis; white-space:nowrap; max-width:160px;"><?php echo e($user->name); ?></p>
                                    ...
                                    <p style="font-size:11px; color:var(--c-fg-muted);"><?php echo e($user->email); ?></p>
                                </div>
                            </div>
                        </td>
...
<?php endif; ?>
                        ...
                        <td style="padding:12px 16px;">
                            <p style="font-size:12px; font-weight:600; color:var(--c-error); max-width:200px; overflow:hidden; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; line-height:1.5;">
                                <?php echo e($user->suspension_reason ?? 'No specific reason provided'); ?>
                        ...
                        <td style="padding:12px 16px;">
                            ...
                            <p style="font-size:10px; color:var(--c-fg-muted); font-style:italic;"><?php echo e($user->suspended_at?->diffForHumans() ?? '-'); ?></p>
                        </td>

                        <td style="padding:12px 16px; text-align:center;">
                            <form method="POST" action="<?php echo e(route('superadmin.users.unsuspend', $user)); ?>" style="margin:0; display:inline;">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\users\suspended.blade.php ENDPATH**/ ?>
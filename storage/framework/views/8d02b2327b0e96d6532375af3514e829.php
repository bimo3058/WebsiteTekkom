<aside data-mobile-sidebar class="h-full bg-white flex flex-col justify-between overflow-hidden"
    ...
    <div class="flex flex-col flex-1 overflow-y-auto overflow-x-hidden" style="scrollbar-width: thin;">
        ...
        <div class="flex items-center justify-between px-4 py-[18px] border-b border-[#DFE1E6]">
            <div class="flex items-center gap-3 min-w-0">
                <div class="w-9 h-9 flex items-center justify-center flex-shrink-0">
                    <img src="<?php echo e(asset('images/UNDIPOfficial.png')); ?>" alt="Logo" class="w-full h-full object-contain">
                </div>
        ...
        <nav class="flex-1 py-4 space-y-5">
            ...
            <div>
                ...
                <?php $isDashboard = request()->routeIs('eoffice.kp.koordinator.dashboard'); ?>
                <div class="relative px-2">
                    ...
                    <a href="<?php echo e(route('eoffice.kp.koordinator.dashboard')); ?>" class="flex items-center gap-3 py-2.5 px-3 rounded-[5px] transition-all group
                            <?php echo e($isDashboard ? 'bg-[#F0F2FA]' : 'hover:bg-[#F8F9FB]'); ?>">
                        ...
                        <span x-show="sidebarOpen"
                            class="text-[13px] whitespace-nowrap <?php echo e($isDashboard ? 'font-semibold text-[#272835]' : 'text-[#666D80] group-hover:text-[#353849]'); ?>"
                    ...
                    <div class="relative px-2">
                        ...
                        <a href="<?php echo e(route($item['route'])); ?>"
                            class="flex items-center gap-3 py-2.5 px-3 rounded-[5px] transition-all group
                                                                                    <?php echo e($item['active'] ? 'bg-[#F0F2FA]' : 'hover:bg-[#F8F9FB]'); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['active']): ?>
                                <span class="w-7 h-7 bg-[#353849] rounded-lg flex items-center justify-center flex-shrink-0">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['icon'] === 'periode'): ?>
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <span x-show="sidebarOpen"
                                class="text-[13px] whitespace-nowrap <?php echo e($item['active'] ? 'font-semibold text-[#272835]' : 'text-[#666D80] group-hover:text-[#353849]'); ?>"
                                x-transition.opacity.duration.200ms><?php echo e($item['label']); ?></span>
                        </a>
                    </div>
            ...
            <div>
                ...
                <div class="relative px-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRubrik): ?>
                        <span class="absolute left-0 top-2 bottom-2 w-[3.5px] bg-[#0065FF] rounded-r-full z-10"></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <a href="<?php echo e(route('eoffice.kp.koordinator.master-rubrik.index')); ?>" class="flex items-center gap-3 py-2.5 px-3 rounded-[5px] transition-all group
                                <?php echo e($isRubrik ? 'bg-[#F0F2FA]' : 'hover:bg-[#F8F9FB]'); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRubrik): ?>
                            <span class="w-7 h-7 bg-[#353849] rounded-lg flex items-center justify-center flex-shrink-0">
                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <span x-show="sidebarOpen"
                            class="text-[13px] whitespace-nowrap <?php echo e($isRubrik ? 'font-semibold text-[#272835]' : 'text-[#666D80] group-hover:text-[#353849]'); ?>"
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $infoItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="relative px-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['active']): ?>
                            <span class="absolute left-0 top-2 bottom-2 w-[3.5px] bg-[#0065FF] rounded-r-full z-10"></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <a href="<?php echo e(route($item['route'])); ?>"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['active']): ?>
                                <span class="w-7 h-7 bg-[#353849] rounded-lg flex items-center justify-center flex-shrink-0">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['icon'] === 'annc'): ?>
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
                                        </svg>
                                    <?php elseif($item['icon'] === 'faq'): ?>
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    <?php elseif($item['icon'] === 'tpl'): ?>
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="border-t border-[#DFE1E6] pt-2 pb-3">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user() && auth()->user()->hasRole('koor_kp')): ?>
            <div class="px-2">
                <a href="<?php echo e(route('eoffice.kp.dosen.dashboard')); ?>"
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules/EOffice\resources/views/components/ui/sidebar-koordinator.blade.php ENDPATH**/ ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-praktikum.layout','data' => ['pageTitle' => 'Buat Tugas']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => 'Buat Tugas']); ?>
...
<div class="mp-page-header">
    <div>
        ...
        <p class="mp-page-sub">Pilih modul yang Anda ampu lalu isi detail tugas · <?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?></p>
    </div>
...
<div class="mp-card" style="padding:28px;flex-shrink:0;">
    <form method="POST"
          action="<?php echo e(route('eoffice.manprak.asprak.tugas.store')); ?>"
        ...
        <div>
            ...
            <select name="modul_id" required class="mp-input mp-select" style="min-height:44px;">
                ...
                <option value="<?php echo e($m->id); ?>" <?php if(old('modul_id') == $m->id): echo 'selected'; endif; ?>>
                    <?php echo e($m->nama); ?> — <?php echo e($m->praktikum?->nama); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:10px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['tugas_pendahuluan' => 'Tugas Pendahuluan', 'praktikum' => 'Praktikum', 'laporan' => 'Laporan', 'responsi' => 'Responsi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <label style="display:flex;align-items:center;gap:10px;padding:12px 14px;border:2px solid <?php echo e(old('jenis_tugas') === $val ? '#6366F1' : '#DFE1E7'); ?>;border-radius:10px;cursor:pointer;background:<?php echo e(old('jenis_tugas') === $val ? '#F0F1FE' : '#FAFBFC'); ?>;transition:border-color .15s,background .15s;"
                       x-data
                       :style="$refs.jenis_<?php echo e($val); ?>.checked ? 'border-color:#6366F1;background:#F0F1FE;' : 'border-color:#DFE1E7;background:#FAFBFC;'">
                    <input type="radio" name="jenis_tugas" value="<?php echo e($val); ?>"
                           id="jenis_<?php echo e($val); ?>" x-ref="jenis_<?php echo e($val); ?>"
                           ...
                           <?php if(old('jenis_tugas') === $val): ?> checked <?php endif; ?>
                           style="accent-color:#6366F1;width:16px;height:16px;cursor:pointer;">
                    <span style="font-size:13px;font-weight:600;color:#353849;"><?php echo e($label); ?></span>
                </label>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['jenis_tugas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            <div style="font-size:11px;color:#DF1C41;margin-top:6px;"><?php echo e($message); ?></div>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            ...
            <textarea name="deskripsi" rows="5" class="mp-input" style="resize:vertical;"
                      placeholder="Jelaskan detail tugas, instruksi pengerjaan, kriteria penilaian, atau catatan penting lainnya..."><?php echo e(old('deskripsi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(240px, 1fr));gap:16px;">
            <div>
                ...
                <input type="datetime-local" name="deadline" class="mp-input" style="min-height:44px;" value="<?php echo e(old('deadline')); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <input type="datetime-local" name="deadline_acc" class="mp-input" style="min-height:44px;" value="<?php echo e(old('deadline_acc')); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['deadline_acc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
        ...
        <div>
            <label style="display:flex;align-items:center;gap:10px;cursor:pointer;user-select:none;margin-top:4px;">
                ...
                <input type="checkbox" name="is_published" value="1" id="chk-published"
                       ...
                       <?php if(old('is_published', true)): ?> checked <?php endif; ?>>
                <div>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\manajemen-praktikum\asprak\tugas-create.blade.php ENDPATH**/ ?>
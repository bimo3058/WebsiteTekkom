...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-praktikum.layout','data' => ['pageTitle' => 'Rekap Nilai — '.e($praktikum ? $praktikum->nama : 'Belum Ada Praktikum').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => 'Rekap Nilai — '.e($praktikum ? $praktikum->nama : 'Belum Ada Praktikum').'']); ?>
...
<div class="mp-page-header">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($praktikum && $daftarPraktikan->isNotEmpty()): ?>
    <div class="mp-page-actions" style="display:flex;gap:10px;align-items:center;">
        <a href="<?php echo e(route('eoffice.manprak.koor.nilai.export-csv', ['modul_id' => $modulFilter])); ?>" class="mp-btn neutral md" style="background:#fff;border:1px solid #DFE1E7;box-shadow:0 1px 2px rgba(0,0,0,0.05);">
    ...
    <div class="mp-card-header" style="background:#F9FAFB; border-bottom:1px solid #EDF0F4; border-radius: 12px 12px 0 0; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
        ...
        <div style="display:flex; gap:10px; align-items:center; flex-wrap:wrap;">
            ...
            <div x-data="{
                    open: false,
                    searchStr: '',
                    options: <?php echo e(json_encode($kelompoks)); ?>,
                    get filtered() {
            ...
            <div x-data="{
                    open: false,
                    searchStr: '',
                    options: <?php echo e(json_encode($shifts)); ?>,
                    get filtered() {
                        return this.searchStr === '' 
                            ? this.options 
                            : this.options.filter(o => o.toLowerCase().includes(this.searchStr.toLowerCase()))
        ...
        <table class="mp-table" style="min-width: 900px;">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $daftarPraktikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $dp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <tr class="mp-tr" style="border-bottom:1px solid #DFE1E7;"
                    x-data="{ name: '<?php echo e(addslashes(strtolower($dp->user?->name ?? ''))); ?>', nim: '<?php echo e(addslashes(strtolower($dp->user?->student?->student_number ?? $dp->user?->email ?? ''))); ?>', kel: '<?php echo e(addslashes($dp->kelompok ?? '')); ?>', shf: '<?php echo e(addslashes($dp->shift ?? '')); ?>' }"
...
<div class="mp-card flex-shrink-0" style="margin-bottom: 48px;">
    <div style="padding:20px; display:flex; flex-wrap:wrap; gap:20px; align-items:center; justify-content:space-between;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$allKoorApproved): ?>
        <div style="flex-shrink:0;">
            <form method="POST" action="<?php echo e(route('eoffice.manprak.koor.nilai.approve')); ?>">
                <?php echo csrf_field(); ?>
                <button type="submit" class="mp-btn primary md" style="background:#6366F1;box-shadow:0 2px 6px rgba(99,102,241,.3);" onmouseover="this.style.background='#4F46E5'" onmouseout="this.style.background='#6366F1'">
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\manajemen-praktikum\koordinator\nilai.blade.php ENDPATH**/ ?>
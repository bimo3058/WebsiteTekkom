...
<?php endif; ?>
    ...
    <div class="mp-card-body p-0">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pendaftarans ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <?php
        ...
        <div class="grid gap-3 px-5 py-4 border-b border-[#F6F8FA] hover:bg-[#FAFAFA] transition-colors items-center"
            ...
            <div class="text-[12px] font-semibold text-[#666D80]">
                <?php echo e($loop->iteration + ($pendaftarans->firstItem() ?? 1) - 1); ?>
            ...
            <div class="flex items-center gap-[10px] min-w-0 pr-3">
                ...
                <div class="min-w-0">
                    <div class="text-[13px] font-semibold text-[#0D0D12] truncate"><?php echo e($pend->user?->name ?? '—'); ?></div>
                </div>
            </div>

            
            <div class="text-[12px] text-[#666D80] truncate"><?php echo e($pend->user?->student_number ?? '—'); ?></div>

            
            <div class="text-[13px] text-[#0D0D12] truncate"><?php echo e($pend->praktikum?->nama ?? '—'); ?></div>
            ...
            <div class="text-center flex justify-center gap-2">
                ...
                <div class="flex gap-2 justify-center">
                    ...
                    <form method="POST" action="<?php echo e(route('eoffice.manprak.admin.pendaftaran-asprak.reject', $pend->id)); ?>" onsubmit="return confirm('Tolak pendaftaran ini?')">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pendaftarans) && method_exists($pendaftarans, 'hasPages') && ($pendaftarans->hasPages() || $pendaftarans->total() > 0)): ?>
    <div style="display:flex; align-items:center; justify-content:space-between; padding:12px 20px; border-top:1px solid var(--c-border);">
        <div style="display:flex; align-items:center; gap:12px;">
            ...
            <div style="font-size:13px; color:var(--c-fg-sec);">Menampilkan <?php echo e($pendaftarans->firstItem() ?? 0); ?> sampai <?php echo e($pendaftarans->lastItem() ?? 0); ?> dari <?php echo e($pendaftarans->total()); ?> data</div>
        </div>
        
        <div style="display:flex; gap:4px;">
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendaftarans->onFirstPage()): ?>
            ...
            <?php else: ?>
                <a href="<?php echo e($pendaftarans->previousPageUrl()); ?>#daftar-pendaftaran" style="width:32px; height:32px; border:1px solid var(--c-border); background:#fff; border-radius:6px; display:flex; align-items:center; justify-content:center; cursor:pointer; color:var(--c-fg); text-decoration:none;">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="15 18 9 12 15 6"/></svg>
                </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = $start; $i <= $end; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($pendaftarans->url($i)); ?>#daftar-pendaftaran" style="width:32px; height:32px; border:1px solid var(--c-border); background:#fff; color:var(--c-fg-sec); font-size:13px; font-weight:600; border-radius:6px; display:flex; align-items:center; justify-content:center; text-decoration:none;">
                        <?php echo e($i); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendaftarans->hasMorePages()): ?>
                <a href="<?php echo e($pendaftarans->nextPageUrl()); ?>#daftar-pendaftaran" style="width:32px; height:32px; border:1px solid var(--c-border); background:#fff; border-radius:6px; display:flex; align-items:center; justify-content:center; cursor:pointer; color:var(--c-fg); text-decoration:none;">
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\manajemen-praktikum\admin\pendaftaran-asprak.blade.php ENDPATH**/ ?>
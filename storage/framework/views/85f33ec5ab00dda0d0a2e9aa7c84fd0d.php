...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.manajemen-praktikum.layout','data' => ['pageTitle' => 'Pendaftaran Koordinator Praktikum']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => 'Pendaftaran Koordinator Praktikum']); ?>
...
<div class="flex flex-col gap-5 mb-2">
    ...
    <?php echo $__env->make('eoffice::manajemen-praktikum.admin.partials.registration-tabs', ['activeRegistrationTab' => 'koor'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->anyFilled(['search','status','praktikum_id'])): ?>
    ...
    <div class="mp-card-body p-0 overflow-x-auto">
        ...
        <div class="grid gap-3 px-5 py-3 bg-[#FAFAFA] border-b border-[#DFE1E7]"
             style="grid-template-columns: 40px minmax(200px, auto) minmax(220px, auto) 130px minmax(250px, auto) 50px 160px 100px 190px;">
        ...
        <div class="grid gap-3 px-5 py-4 border-b border-[#F6F8FA] hover:bg-[#FAFAFA] transition-colors items-center"
            ...
            <div class="flex items-center gap-[10px] pr-3">
                ...
                <div>
                    <div class="text-[13px] font-semibold text-[#0D0D12] whitespace-nowrap"><?php echo e($p->user?->name ?? '—'); ?></div>
                </div>
            </div>

            
            <div class="text-[12px] text-[#666D80] whitespace-nowrap"><?php echo e($p->user?->email ?? '—'); ?></div>
            
            
            <div class="text-[13px] text-[#0D0D12] whitespace-nowrap" style="font-family: 'Inter', sans-serif;">
                <?php echo e($p->user?->student?->student_number ?? $p->user?->external_id ?? '—'); ?>

            </div>
            
            
            <div class="text-[13px] text-[#0D0D12] whitespace-nowrap"><?php echo e($p->praktikum?->nama ?? '—'); ?></div>
            ...
            <div class="text-center flex flex-col items-center justify-center gap-2">
                <a class="mp-btn secondary sm" href="<?php echo e(route('eoffice.manprak.admin.pendaftaran.show', ['type' => 'koor', 'id' => $p->id])); ?>">
...
<?php endif; ?> Detail &amp; Dokumen
                ...
                <span class="text-[11px] text-[#666D80]">Override tersedia di detail</span>
                <?php elseif($p->status === 'rejected' && $p->status_dosen === 'ditolak'): ?>
                <span class="text-[11px] text-[#666D80]">Override tersedia di detail</span>
                <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum\admin\pendaftaran-koor.blade.php ENDPATH**/ ?>
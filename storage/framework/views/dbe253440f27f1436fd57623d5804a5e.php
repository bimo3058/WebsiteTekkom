...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('level_up')): ?>
        ...
        <div class="level-up-toast" id="levelUpToast">
            <span class="level-icon"><?php echo $levelUp['tier_icon']; ?></span>
            <div class="level-text">LEVEL UP!</div>
            <div class="level-tier">Level <?php echo e($levelUp['new_level']); ?> — <?php echo e($levelUp['tier_name']); ?></div>
            <div class="level-sub">Selamat! Anda naik dari Level <?php echo e($levelUp['old_level']); ?></div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\components\layouts\forum-layout.blade.php ENDPATH**/ ?>
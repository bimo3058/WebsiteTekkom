    ...
    <div class="mp-tr" style="display:flex;align-items:flex-start;gap:16px;padding:16px 20px;border-bottom:1px solid #DFE1E7;"
        ...
        <div style="flex:1;min-width:0;">
            ...
            <div style="display:flex;gap:12px;font-size:11px;color:#666D80;">
                ...
                <span><?php echo e($modul->modulAsprak->count()); ?> asprak</span>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\asprak\modul.blade.php ENDPATH**/ ?>
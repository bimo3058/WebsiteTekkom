...
<div id="modalImportUser" class="fixed inset-0 hidden z-50 flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <form id="formImportUser" action="<?php echo e(route('superadmin.users.bulkImport')); ?>" method="POST" enctype="multipart/form-data" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-amber-50 rounded-xl p-4 mb-6 border border-amber-100">
                <div class="flex gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <a href="<?php echo e(route('superadmin.users.downloadImportTemplate')); ?>"
...
</script><?php /**PATH C:\WebsiteTekkom - Copy\resources\views\superadmin\users\_modal_import.blade.php ENDPATH**/ ?>
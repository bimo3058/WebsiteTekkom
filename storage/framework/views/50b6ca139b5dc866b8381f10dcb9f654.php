...
<div id="modalBulkDeleteAudit"
    ...
    <div style="position:relative; width:100%; max-width:420px; background:#fff; border-radius:16px; border:1px solid var(--c-border); box-shadow:0 20px 40px rgba(13,13,18,0.15); overflow:hidden;">
        ...
        <form id="formBulkDeleteAudit" action="<?php echo e(route('superadmin.audit-logs.bulk-destroy')); ?>" method="POST" style="padding:20px 24px 24px;">
            <?php echo csrf_field(); ?>
            ...
            <div style="display:flex; flex-direction:column; gap:8px; margin-bottom:16px;">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$val, $label, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <label style="display:flex; align-items:center; gap:12px; padding:10px 14px; border:1px solid var(--c-border); border-radius:10px; cursor:pointer; transition:border-color .15s, background .15s;"
                       onmouseover="this.style.background='var(--c-bg)'" onmouseout="this.style.background='#fff'">
                    <input type="radio" name="delete_type" value="<?php echo e($val); ?>"
                           style="width:14px; height:14px; accent-color:var(--c-error); cursor:pointer; flex-shrink:0;">
                    <div>
                        <span style="font-size:13px; font-weight:600; color:var(--c-fg); display:block;"><?php echo e($label); ?></span>
                        <span style="font-size:10px; color:var(--c-fg-muted);"><?php echo e($desc); ?></span>
                    </div>
                </label>
...
</style><?php /**PATH C:\WebsiteTekkom - Copy\resources\views/superadmin/audit-logs/_modal_bulk_delete.blade.php ENDPATH**/ ?>
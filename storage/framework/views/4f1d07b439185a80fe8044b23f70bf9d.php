...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="settings-wrap" id="settings-root"
            x-data="{ tab: '<?php echo e(session('status') === 'password-updated' ? 'password' : ((session('status') === 'notifications-updated' || request('tab') === 'notifikasi' || old('_settings_tab') === 'notifikasi') ? 'notifikasi' : 'general')); ?>' }">
                ...
                <div class="settings-box-header">
                    <div style="display:flex;align-items:center;justify-content:space-between;">
                        ...
                        <button type="button" onclick="submitActiveForm()"
                            x-show="tab !== 'notifikasi' || <?php echo e($user->hasRole('superadmin') ? 'true' : 'false'); ?>"
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\resources\views/profile/edit.blade.php ENDPATH**/ ?>
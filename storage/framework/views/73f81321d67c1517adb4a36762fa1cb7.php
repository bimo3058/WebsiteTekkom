...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <!-- Form -->
    <form action="<?php echo e(route('manajemenmahasiswa.pengumuman.store')); ?>" method="POST" enctype="multipart/form-data"
        id="createForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-card">
            <div class="d-flex justify-content-between align-items-center form-section-title">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($drafts) && $drafts->count() > 0): ?>
                    <button type="button" class="btn btn-sm rounded-pill fw-bold px-4 text-white shadow-sm"
                        ...
                        Load Draft (<?php echo e($drafts->count()); ?>)
                    </button>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-select-custom">
                        ...
                        <option value="akademik" <?php echo e(old('kategori') === 'akademik' ? 'selected' : ''); ?>>Akademik</option>
                        <option value="himpunan" <?php echo e(old('kategori') === 'himpunan' ? 'selected' : ''); ?>>Himpunan</option>
                        <option value="lowongan" <?php echo e(old('kategori') === 'lowongan' ? 'selected' : ''); ?>>Lowongan</option>
                        <option value="event_prodi" <?php echo e(old('kategori') === 'event_prodi' ? 'selected' : ''); ?>>Event Prodi
                        </option>
                    </select>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <select name="target_audience" class="form-select-custom" required>
                        <option value="all" <?php echo e(old('target_audience') === 'all' ? 'selected' : ''); ?>>Semua</option>
                        <option value="mahasiswa" <?php echo e(old('target_audience') === 'mahasiswa' ? 'selected' : ''); ?>>Mahasiswa
                        </option>
                        <option value="alumni" <?php echo e(old('target_audience') === 'alumni' ? 'selected' : ''); ?>>Alumni</option>
                    </select>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="form-group">
                ...
                <div class="rich-editor-wrapper" id="editorWrapper">
                    ...
                    <!-- Editor Area -->
                    <div class="editor-content" id="editorContent" contenteditable="true"><?php echo old('konten'); ?></div>
                </div>
                <!-- Hidden textarea untuk form submission -->
                <textarea name="konten" id="kontenHidden" style="display:none;"><?php echo e(old('konten')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo e(route('manajemenmahasiswa.pengumuman.index')); ?>" class="btn-cancel">Batal</a>
                ...
                <div class="modal-content border-0 shadow" style="border-radius: 16px;">
                    ...
                    <div class="modal-body">
                        <div class="list-group list-group-flush">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $drafts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $draft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="list-group-item list-group-item-action d-flex justify-content-between align-items-center p-3"
                                    style="border-radius: 12px; margin-bottom: 8px; border: 1px solid #e5e7eb; cursor: pointer;">
                                    <div class="flex-grow-1 pe-3"
                                        onclick="loadDraft(<?php echo e($draft->id); ?>, <?php echo e(json_encode($draft->judul)); ?>, <?php echo e(json_encode($draft->kategori)); ?>, <?php echo e(json_encode($draft->target_audience)); ?>, <?php echo e(json_encode($draft->konten)); ?>)">
                                        <h6 class="mb-1 fw-bold text-dark" style="font-size: 15px;">
                                            <?php echo e($draft->judul ?: '(Tanpa Judul)'); ?></h6>
                                        <p class="mb-1 text-muted"
                                            style="font-size: 13px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                            <?php echo e(strip_tags($draft->konten) ?: '(Tidak ada konten teks)'); ?>

                                        </p>
                                        <small class="text-muted" style="font-size: 11px;">
                                            Diperbarui: <?php echo e($draft->updated_at->diffForHumans()); ?>

                                        </small>
                                    </div>
                                    <div class="ms-1">
                                        <form action="<?php echo e(route('manajemenmahasiswa.pengumuman.drafts.destroy', $draft->id)); ?>"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            function saveDraftAJAX(isManual = false) {
                ...
                fetch('<?php echo e(route("manajemenmahasiswa.pengumuman.drafts.store")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\pengumuman\pengumuman-create.blade.php ENDPATH**/ ?>
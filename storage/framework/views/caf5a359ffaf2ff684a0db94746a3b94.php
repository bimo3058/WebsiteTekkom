<div style="background:#fff; border:1px solid var(--c-border); border-radius:14px; overflow:hidden; box-shadow:0 1px 3px rgba(0,0,0,.04); display:flex; flex-direction:column;">
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; padding:14px 16px; border-bottom:1px solid var(--c-border); gap:10px; flex-wrap:wrap;">
        ...
        <?php echo $__env->make('banksoal::periode._search_filter', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $periodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $periode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <tr style="border-bottom:1px solid #F3F4F6; transition:background .12s;" onmouseover="this.style.background='#FAFAFA'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding:14px 16px; min-width:200px;">
                            <p style="font-size:13px; font-weight:600; color:var(--c-fg); margin:0;"><?php echo e($periode->nama_periode); ?></p>
                        </td>

                        <td style="padding:14px 16px;">
                            <p style="font-size:13px; font-weight:500; color:var(--c-fg); margin:0;">
                                <?php echo e(\Carbon\Carbon::parse($periode->tanggal_mulai)->translatedFormat('d F Y')); ?> - <?php echo e(\Carbon\Carbon::parse($periode->tanggal_selesai)->translatedFormat('d F Y')); ?>

                            </p>
                        </td>

                        <td style="padding:14px 16px;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($periode->tanggal_mulai_ujian && $periode->tanggal_selesai_ujian): ?>
                            <p style="font-size:13px; font-weight:500; color:var(--c-fg); margin:0;">
                                <?php echo e(\Carbon\Carbon::parse($periode->tanggal_mulai_ujian)->translatedFormat('d F Y')); ?> - <?php echo e(\Carbon\Carbon::parse($periode->tanggal_selesai_ujian)->translatedFormat('d F Y')); ?>
                        ...
                        <td style="padding:12px 16px;">
                            <span style="display:inline-flex; align-items:center; gap:5px; padding:3px 8px 3px 6px; border-radius:9999px; font-size:10px; font-weight:600; text-transform:uppercase; letter-spacing:0.04em; background:<?php echo e($badgeBg); ?>; color:<?php echo e($badgeColor); ?>; margin-bottom: 2px;">
                                <span style="width:6px; height:6px; border-radius:50%; background:<?php echo e($badgeColor); ?>;"></span>
                                <?php echo e($badgeLabel); ?>

                            </span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($daftarDitutup): ?>
                                <br/>
                            ...
                            <div style="position:relative; display:inline-block; text-align:left;" x-data="{ actionOpen: false }">
                                ...
                                <div x-show="actionOpen"
                                    ...
                                    <div style="padding:5px;">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($periode->status === 'selesai'): ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($periode->pendaftaran_ditutup_paksa && $now->lte(\Carbon\Carbon::parse($periode->tanggal_selesai)->endOfDay())): ?>
                                            <div style="height:1px; background:var(--c-border); margin:4px 6px;"></div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasPendaftar): ?>
    ...
    <?php echo $__env->make('banksoal::periode._pagination', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\periode\_table.blade.php ENDPATH**/ ?>
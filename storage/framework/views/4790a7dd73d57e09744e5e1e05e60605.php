...
<div class="mp-page-header">
    <div>
        ...
        <p class="mp-page-sub">
            Halo, <?php echo e($firstName); ?> · <?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?>
...
<div class="flex gap-[14px] flex-1 min-h-0 mb-1">
    ...
    <div class="mp-card min-w-0" style="flex:2;">
        <div class="mp-card-header" style="flex-shrink:0;">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div class="right">
                <a href="<?php echo e(route('eoffice.manprak.asprak.tugas.index')); ?>" class="mp-btn secondary sm" style="text-decoration:none;">Lihat Semua →</a>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\manajemen-praktikum_backup\asprak\dashboard.blade.php ENDPATH**/ ?>
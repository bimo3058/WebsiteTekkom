...
Minggu 7-8 : Penyusunan laporan akhir KP"
                        ...
                        <div x-show="proposalStep === 3" class="p-6 md:p-8" style="display:none;">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 items-center justify-center">
                                <form action="<?php echo e(route('eoffice.kp.mahasiswa.proposal.export')); ?>" method="POST" target="_blank" class="w-full sm:w-auto">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\WebsiteTekkom - Copy\Modules/EOffice\resources/views/kp/mahasiswa/proposal.blade.php ENDPATH**/ ?>
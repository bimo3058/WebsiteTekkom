        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                ...
                <div class="flex items-baseline gap-2">
                    <h3 class="text-3xl font-bold text-slate-900"><?php echo e($totalPeserta); ?></h3>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                ...
                <div class="flex items-baseline gap-2">
                    <h3 class="text-3xl font-bold text-slate-900"><?php echo e($rataRata); ?></h3>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                ...
                <div class="flex items-baseline gap-2">
                    <h3 class="text-3xl font-bold text-emerald-600"><?php echo e($tertinggi); ?></h3>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                ...
                <div class="flex items-baseline gap-2">
                    <h3 class="text-3xl font-bold text-rose-600"><?php echo e($terendah); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                ...
                <div class="p-6 flex-1 flex flex-col justify-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalPeserta > 0): ?>
                        <?php
                        ...
                        <div class="flex flex-col items-center justify-center mb-8 border-b border-slate-100 pb-8">
                            ...
                            <div class="flex justify-center gap-6 mb-6">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs font-bold text-slate-600">Lulus (<?php echo e($persenLulus); ?>%)</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-2.5 bg-rose-500 rounded-sm"></div>
                                    <span class="text-xs font-bold text-slate-600">Tidak Lulus (<?php echo e($persenTidak); ?>%)</span>
                                </div>
                            </div>

                            <!-- Pie Chart -->
                            <div class="w-44 h-44 rounded-full shadow-sm" 
                                 style="background: conic-gradient(#10b981 0% <?php echo e($persenLulus); ?>%, #f43f5e <?php echo e($persenLulus); ?>% 100%);">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 text-center">
                            <div class="p-3 bg-emerald-50 rounded-lg">
                                ...
                                <p class="text-2xl font-black text-emerald-600"><?php echo e($lulus); ?> <span class="text-xs font-medium text-emerald-700/70">Mhs</span></p>
                            </div>
                            <div class="p-3 bg-rose-50 rounded-lg">
                                ...
                                <p class="text-2xl font-black text-rose-600"><?php echo e($tidakLulus); ?> <span class="text-xs font-medium text-rose-700/70">Mhs</span></p>
                            </div>
                        </div>
                    <?php else: ?>
            ...
            <div class="lg:col-span-2 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cplStats && count($cplStats) > 0): ?>
                        <div class="space-y-5">
                                ...
                                <div>
                                    <div class="flex justify-between items-start text-sm mb-2 gap-4">
                                        <span class="font-medium text-slate-700 leading-snug">
                                            <?php echo e($stat['cpl_kode']); ?> 
                                            <span class="text-slate-500 font-normal ml-1"><?php echo e($stat['deskripsi']); ?></span>
                                        </span>
                                        <span class="font-bold text-slate-900 shrink-0"><?php echo e($stat['persentase']); ?>%</span>
                                    </div>
                                    <div class="w-full bg-slate-100 rounded-full h-2.5 overflow-hidden">
                                        ...
                                        ?>
                                        <div class="<?php echo e($color); ?> h-2.5 rounded-full transition-all duration-500" style="width: <?php echo e($stat['persentase']); ?>%"></div>
                                    </div>
                                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kesalahanPerSoal && count($kesalahanPerSoal) > 0): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kesalahanPerSoal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php 
                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center justify-center w-6 h-6 rounded-full <?php echo e($loop->iteration <= 3 ? 'bg-rose-100 text-rose-600 font-bold' : 'bg-slate-100 text-slate-500 font-medium'); ?>">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-slate-800 max-w-lg line-clamp-2 prose prose-sm prose-slate">
                                            <?php echo strip_tags($soal->soal ?? '-'); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-indigo-50 text-indigo-700">
                                            <?php echo e($soal->cpl ? $soal->cpl->kode : 'Unknown'); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="font-bold text-rose-600"><?php echo e($salahCount); ?></span>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\admin\cbt\analitik.blade.php ENDPATH**/ ?>
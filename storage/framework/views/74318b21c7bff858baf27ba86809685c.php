...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="page-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        ...
        <a href="<?php echo e(route('banksoal.admin.kontrol-umum.mata-kuliah')); ?>" class="btn btn-secondary" style="text-decoration: none; display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px;">
    ...
    <div class="upload-section">
        <div class="upload-header">
            ...
            <a href="<?php echo e(route('banksoal.api.v1.admin.mata-kuliah.export-template')); ?>" class="btn-template">
    ...
    <script>
        ...
        const IMPORT_URL = '<?php echo e(route("banksoal.api.v1.admin.mata-kuliah.import")); ?>';
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\BankSoal\resources\views\pages\admin\kontrol-umum\mata-kuliah-create.blade.php ENDPATH**/ ?>
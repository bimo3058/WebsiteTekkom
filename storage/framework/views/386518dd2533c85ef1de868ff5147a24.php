...
<div class="poll-container"
     id="poll-<?php echo e($poll->id); ?>"
     data-is-open="<?php echo e($isClosed ? '0' : '1'); ?>"
     data-voted-option="<?php echo e($userVotedId ?? ''); ?>"
     data-vote-url="<?php echo e($voteUrl); ?>"
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
        ...
        <span class="poll-total-votes" style="font-size:12px;color:#9ca3af;font-weight:500;">
            <?php echo e(number_format($totalVotes)); ?> suara
        </span>
    </div>

    
    <div class="poll-options" id="pollOptions-<?php echo e($poll->id); ?>">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $poll->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <?php
            ...
            ?>
            <div class="poll-option <?php echo e($showResults ? 'show-result' : ''); ?> <?php echo e($isVoted ? 'user-voted' : ''); ?>"
                 ...
                 style="position:relative;margin-bottom:10px;border-radius:10px;overflow:hidden;
                        border:1.5px solid <?php echo e($isVoted ? '#293C79' : '#e5e7eb'); ?>;
                        background:#fff;cursor:<?php echo e($cursor); ?>;transition:all 0.2s;">

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showResults): ?>
                    <div class="poll-bar"
                         style="position:absolute;top:0;left:0;height:100%;width:<?php echo e($pct); ?>%;
                                background:<?php echo e($isVoted ? 'rgba(41,60,121,0.12)' : 'rgba(0,0,0,0.04)'); ?>;
                ...
                <div style="position:relative;display:flex;align-items:center;justify-content:space-between;
                    ...
                    <div style="display:flex;align-items:center;gap:10px;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isVoted): ?>
                        ...
                        <span class="poll-option-label"
                              style="font-size:14px;font-weight:<?php echo e($isVoted ? '700' : '500'); ?>;
                                     color:<?php echo e($isVoted ? '#293C79' : '#374151'); ?>;">
                    ...
                    <span class="poll-pct"
                          style="font-size:13px;font-weight:700;white-space:nowrap;margin-left:8px;
                                 color:<?php echo e($isVoted ? '#293C79' : '#6b7280'); ?>;
                                 <?php echo e($showResults ? '' : 'display:none;'); ?>">
                        <?php echo e($pct); ?>%
                    </span>
                </div>
            </div>
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-top:8px;flex-wrap:wrap;gap:6px;">
        <span class="poll-status-label" style="font-size:12px;color:#9ca3af;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isClosed): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($poll->expires_at): ?>
                    &middot; <?php echo e($poll->expires_at->diffForHumans()); ?>

                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php elseif($poll->expires_at): ?>
                Berakhir <?php echo e($poll->expires_at->diffForHumans()); ?>
        ...
        <div style="display:flex;align-items:center;gap:8px;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasVoted && !$isClosed): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isOwner): ?>
                <button class="poll-toggle-btn"
                        data-poll-id="<?php echo e($poll->id); ?>"
                        data-close-url="<?php echo e($closeUrl); ?>"
                        data-is-closed="<?php echo e($isClosed ? '1' : '0'); ?>"
                        style="font-size:11px;font-weight:600;padding:3px 10px;border-radius:20px;border:1.5px solid;cursor:pointer;background:transparent;transition:all 0.2s;
                               <?php echo e($isClosed ? 'color:#16a34a;border-color:#16a34a;' : 'color:#dc2626;border-color:#dc2626;'); ?>">
                    <?php echo e($isClosed ? 'Buka Polling' : 'Tutup Polling'); ?>
...
<?php if (! $__env->hasRenderedOnce('1d56947b-b2be-4213-a5db-d13ddbeb82d1')): $__env->markAsRenderedOnce('1d56947b-b2be-4213-a5db-d13ddbeb82d1'); ?>
<style>
...
<?php endif; ?>
<?php /**PATH C:\WebsiteTekkom - Copy\Modules\ManajemenMahasiswa\resources\views\forum\_poll.blade.php ENDPATH**/ ?>
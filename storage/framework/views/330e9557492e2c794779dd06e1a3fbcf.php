...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => ['title' => 'Tambah Periode Baru']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Tambah Periode Baru']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div x-data="periodeWizard()" x-init="initDates()" class="w-full pb-20">
        ...
        <form x-ref="form" action="<?php echo e(route('eoffice.kp.koordinator.periode.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\periode\create.blade.php ENDPATH**/ ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'eoffice::components.layouts.koordinator','data' => ['title' => 'Edit Persyaratan Dokumen']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Persyaratan Dokumen']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

    <?php $__env->startSection('breadcrumbs'); ?>
        <a href="<?php echo e(route('eoffice.kp.koordinator.persyaratan_dokumen', ['periode_id' => $selectedPeriodeId])); ?>"
    ...
    <div x-data="{
        docs: <?php echo e(\Illuminate\Support\Js::from($templates->map(fn($t) => [
    'id' => $t->id,
    'title' => $t->title,
            ...
            <div class="flex flex-col lg:flex-row p-4 sm:p-6 lg:p-8 gap-6 lg:gap-8">
                ...
                <div class="lg:w-[30%]">
                    <h2 class="text-[18px] font-bold text-[#0D0D12] mb-1.5"
                        style="font-family:'Inter Tight',sans-serif;"><?php echo e(strtoupper($phaseLabel)); ?></h2>
                    <p class="text-[13px] text-[#666D80]">Kelola jenis dokumen untuk <?php echo e(strtoupper($phaseLabel)); ?>.</p>
                </div>

                <!-- Right: Document types table -->
                <div class="lg:w-[70%]">
                    <form id="persyaratan-form" method="POST" enctype="multipart/form-data"
                        action="<?php echo e(route('eoffice.kp.koordinator.persyaratan_dokumen.update', $phase)); ?>">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\WebsiteTekkom - Copy\Modules\EOffice\resources\views\koordinator\persyaratan\edit.blade.php ENDPATH**/ ?>
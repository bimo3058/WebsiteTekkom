<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-xl font-bold text-slate-800 tracking-tight">User Management</h1>
    ...
    <div class="flex items-center gap-3">
        ...
        <button onclick="openModal('modalImportUser')" 
            class="inline-flex items-center gap-2 bg-white hover:bg-slate-50 text-slate-700 font-bold px-3 py-1.5 rounded-lg transition-all text-[11px] border border-slate-200 shadow-sm">
        ...
        <button onclick="openModal('modalAddUser')"
            class="inline-flex items-center gap-2 bg-slate-800 hover:bg-black text-white font-bold px-3 py-1.5 rounded-lg transition-all shadow-sm text-[11px]">

<div class="bg-white border border-slate-200 rounded-xl overflow-hidden hover:border-purple-200 hover:shadow-md transition-all shadow-sm">
    <div class="p-4">
        ...
        <div class="flex justify-between items-start mb-4">
            <div class="bg-purple-50 p-2 rounded-lg border border-purple-100 relative">
        ...
        <div class="grid grid-cols-3 gap-2 mb-4">
            <div class="bg-slate-50/50 rounded-lg p-2 border border-slate-100">
                <p class="text-[8px] text-slate-400 font-black uppercase tracking-widest mb-0.5">Upload</p>
                <p class="text-slate-600 text-[10px] font-bold">{{ $module->setting('max_upload', 10) }} MB</p>
            </div>
            <div class="bg-slate-50/50 rounded-lg p-2 border border-slate-100">
                <p class="text-[8px] text-slate-400 font-black uppercase tracking-widest mb-0.5">Quota</p>
                <p class="text-slate-600 text-[10px] font-bold">{{ $module->setting('quota', 5) }} GB</p>
            </div>
            <div class="bg-slate-50/50 rounded-lg p-2 border border-slate-100">
                <p class="text-[8px] text-slate-400 font-black uppercase tracking-widest mb-0.5">Debug</p>
                <p class="text-[10px] font-bold {{ $module->setting('debug_mode') ? 'text-yellow-600' : 'text-slate-400' }}">
                    {{ $module->setting('debug_mode') ? 'ON' : 'OFF' }}
                </p>
            </div>
        </div>

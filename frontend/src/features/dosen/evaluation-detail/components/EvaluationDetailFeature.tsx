...
export function EvaluationDetailFeature({
    evaluationId,
    evaluationType,
    scheduleId: scheduleIdProp,
}: EvaluationDetailFeatureProps) {
    const router = useRouter()
    const type = evaluationType as 'SEMINAR' | 'TA_DEFENSE' | null // SEMINAR or TA_DEFENSE
    const scheduleId = scheduleIdProp ? String(scheduleIdProp) : null
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await api.post(finalizeEndpoint, {

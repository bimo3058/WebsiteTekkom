            ...
            {calendarDays.map((day, dayIdx) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "min-h-[100px] cursor-pointer border-r border-b p-2 transition-colors",
                ...
                >
                  ...
                  <div className="mb-1 flex justify-center">
                    {isTodayDate ? (
                      <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-black text-sm font-medium text-white">
                        {format(day, "d")}
                      </span>
                    ) : (
                      <span
                  ...
                  <div className="space-y-1">
                    {events.slice(0, 3).map((event) => {
                      const cfg =
                        TYPE_CONFIG[event.type] || TYPE_CONFIG.BIMBINGAN;
                      ...
                      return (
                        <div
                          key={event.id}
                          className={cn(
                            "cursor-pointer truncate rounded-md px-2 py-1 text-xs transition-opacity",
                            cfg.bgColor,
                            cfg.textColor,
                            cfg.borderColor,
                            "border",
              ...
              {selectedDayEvents.map((event, index) => {
                ...
                return (
                  <div
                    key={event.id}
                    className={cn(
                      "group p-5 transition-colors hover:bg-gray-50",
                          ...
                          <div>
                            ...
                            <span className="text-gray-900">
                              {event.examiners && event.examiners.length > 0
                                ...
                                : [event.examiner1?.name, event.examiner2?.name]
                                    .filter(Boolean)
                                    .join(", ")}
                            </span>
                          </div>
